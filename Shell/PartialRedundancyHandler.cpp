...
PartialRedundancyHandler* PartialRedundancyHandler::create(const Options& opts, const Ordering* ord, Splitter* splitter)
{
  if (!opts.partialRedundancyCheck()) {
    return new PartialRedundancyHandlerImpl</*enabled*/false,false,false,false,false>(opts,ord,splitter);
  }
  ...
  auto ordS = opts.partialRedundancySubsumption();
  if (ordC) {
    // if (avatarC) {
    //   if (litC) {
    ...
    // }
    if (ordS) {
      return new PartialRedundancyHandlerImpl<true,/*ordC*/true,/*ordS*/true,/*avatarC*/false,/*litC*/false>(opts,ord,splitter);  
    }
    return new PartialRedundancyHandlerImpl<true,/*ordC*/true,/*ordS*/false,/*avatarC*/false,/*litC*/false>(opts,ord,splitter);
  }
  // if (avatarC) {
  //   if (litC) {
  ...
  // }
  return new PartialRedundancyHandlerImpl<true,/*ordC*/false,/*ordS*/false,/*avatarC*/false,/*litC*/false>(opts,ord,splitter);
}
...
bool PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::checkSuperposition(
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
bool PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::checkSuperposition2(
  Clause* eqClause, Clause* rwClause, bool eqIsResult, ResultSubstitution* subs, TermList rwTermS, TermList tgtTermS) const
{
  ...
  auto checkFn = [](ConstraintIndex** index, const TermStack& ts,
    const TermOrderingDiagram::PrevPoly& prevPoly, const TermPartialOrdering* tpo)
  {
    if (!index) {
      return false;
    }
    ...
    {
      ASS(ec->tod);
      if (ec->tod->check(&applicator, prevPoly, tpo)) {
        matcher.reset();
        // success
        return true;
      }
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
void PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::insertSuperposition(
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
bool PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::handleResolution(
 ...
 */
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
bool PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::isSuperpositionPremiseRedundant(
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
const LiteralSet* PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::getRemainingLiterals(
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
const SplitSet* PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::getRemainingSplits(Clause* cl, Clause* other) const
{
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
void PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::tryInsert(
...
template<bool enabled, bool ordC, bool ordS, bool avatarC, bool litC>
void PartialRedundancyHandlerImpl<enabled, ordC, ordS, avatarC, litC>::checkEquations(Clause* cl) const
{
  if (!enabled || !ordC) {
    return;
  }
