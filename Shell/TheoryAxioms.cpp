...
void TheoryAxioms::addTheoryClauseFromLits(std::initializer_list<Literal*> lits, Inference::Rule rule, unsigned level)
{
  ...
  Clause* cl = Clause::fromStack(lit_stack, Unit::AXIOM, new Inference(rule));
...
void TheoryAxioms::addBooleanArrayExtensionalityAxioms(unsigned arraySort, unsigned skolemFn)
{
  ...
  addAndOutputTheoryUnit(new FormulaUnit(axiom, new Inference(Inference::THEORY_AXIOM_BOOLEAN_ARRAY_EXTENSIONALITY), Unit::AXIOM),CHEAP);
...
void TheoryAxioms::addBooleanArrayWriteAxioms(unsigned arraySort)
{
  ...
  for (TermList bval : {false_,true_}) {
    ...
    addAndOutputTheoryUnit(new FormulaUnit(ax, new Inference(Inference::THEORY_AXIOM_BOOLEAN_ARRAY_WRITE1), Unit::AXIOM),CHEAP);
  }
  ...
  addAndOutputTheoryUnit(new FormulaUnit(ax2, new Inference(Inference::THEORY_AXIOM_BOOLEAN_ARRAY_WRITE2), Unit::AXIOM),CHEAP);
} //
