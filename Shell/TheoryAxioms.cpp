...
void TheoryAxioms::addTheoryClauseFromLits(std::initializer_list<Literal*> lits, Inference::Rule rule, unsigned level)
{
  ...
  Clause* cl = Clause::fromStack(lit_stack, new Inference0(Inference::InputType::AXIOM,rule));
...
void TheoryAxioms::addCommutativity(Interpretation op)
{
  ...
  addTheoryClauseFromLits({eq}, Inference::Rule::THEORY_AXIOM_COMMUTATIVITY, EXPENSIVE);
} // addCommutativity
...
void TheoryAxioms::addAssociativity(Interpretation op)
{
  ...
  addTheoryClauseFromLits({eq}, Inference::Rule::THEORY_AXIOM_ASSOCIATIVITY, EXPENSIVE);
} // addAsssociativity
...
void TheoryAxioms::addRightIdentity(Interpretation op, TermList e)
{
  ...
  addTheoryClauseFromLits({eq}, Inference::Rule::THEORY_AXIOM_RIGHT_IDENTINTY, EXPENSIVE);
} // addRightIdentity
...
void TheoryAxioms::addLeftIdentity(Interpretation op, TermList e)
{
  ...
  addTheoryClauseFromLits({eq}, Inference::Rule::THEORY_AXIOM_LEFT_IDENTINTY, EXPENSIVE);
} // addLeftIdentity
...
void TheoryAxioms::addCommutativeGroupAxioms(Interpretation op, Interpretation inverse, TermList e)
{
  ...
  addTheoryClauseFromLits({eq1}, Inference::Rule::THEORY_AXIOM_INVERSE_OP_OP_INVERSES, EXPENSIVE);

  // f(x,i(x))=e
  TermList fx_ix(Term::create2(f,x,ix));
  Literal* eq2 = Literal::createEquality(true,fx_ix,e,srt);
  addTheoryClauseFromLits({eq2}, Inference::Rule::THEORY_AXIOM_INVERSE_OP_UNIT, EXPENSIVE);
...
void TheoryAxioms::addRightInverse(Interpretation op, Interpretation inverse)
{
  ...
  addTheoryClauseFromLits({eq}, Inference::Rule::THEORY_AXIOM_INVERSE_ASSOC, EXPENSIVE);
}
...
void TheoryAxioms::addNonReflexivity(Interpretation op)
{
  ...
  addTheoryClauseFromLits({l11}, Inference::Rule::THEORY_AXIOM_NONREFLEX, CHEAP);
} // addNonReflexivity
...
void TheoryAxioms::addTransitivity(Interpretation op)
{
  ...
  addTheoryClauseFromLits({nonL12,nonL23,l13}, Inference::Rule::THEORY_AXIOM_TRANSITIVITY, CHEAP);
}
...
void TheoryAxioms::addOrderingTotality(Interpretation less)
{
  ...
  addTheoryClauseFromLits({l12,l21,eq}, Inference::Rule::THEORY_AXIOM_ORDER_TOTALALITY, CHEAP);
}
...
void TheoryAxioms::addMonotonicity(Interpretation less, Interpretation addition)
{
  ...
  addTheoryClauseFromLits({nonLe,leAdded}, Inference::Rule::THEORY_AXIOM_ORDER_MONOTONICITY, EXPENSIVE);
}
                                     ...
                                     Interpretation less)
{
  ...
  addTheoryClauseFromLits({xPo_g_x}, Inference::Rule::THEORY_AXIOM_PLUS_ONE_GREATER, CHEAP);
}
    ...
    TermList zeroElement, TermList oneElement, Interpretation less)
{
  ...
  addTheoryClauseFromLits({xLy,yLxP}, Inference::Rule::THEORY_AXIOM_ORDER_PLUS_ONE_DICHOTOMY, EXPENSIVE);
  ...
  addTheoryClauseFromLits({mmxEqx}, Inference::Rule::THEORY_AXIOM_MINUS_MINUS_X, EXPENSIVE);
}
    ...
    TermList zeroElement, TermList oneElement, Interpretation less, Interpretation multiply)
{
  ...
  addTheoryClauseFromLits({xEqXMulZero}, Inference::Rule::THEORY_AXIOM_TIMES_ZERO, EXPENSIVE);
  ...
  addTheoryClauseFromLits({distrib}, Inference::Rule::THEORY_AXIOM_DISTRIBUTIVITY, EXPENSIVE);
  ...
  addTheoryClauseFromLits({xEz,xTznEy,xTwnEy,zEw}, Inference::Rule::THEORY_AXIOM_DIVISIBILITY, EXPENSIVE);
}
                                ...
                                TermList oneElement)
{
  ...
  addTheoryClauseFromLits({yis0,xeqsum}, Inference::Rule::THEORY_AXIOM_MODULO_MULTIPLY, EXPENSIVE);

  // y!=0 => (0 <= mod(x,y))
  // y=0 | ~(mod(x,y) < 0)
  Literal* modxyge0 = Literal::create2(lessPred,false,modxy,zeroElement);
  addTheoryClauseFromLits({yis0,modxyge0}, Inference::Rule::THEORY_AXIOM_MODULO_POSITIVE, EXPENSIVE);
  ...
  addTheoryClauseFromLits({yis0,modxyleabsym1}, Inference::Rule::THEORY_AXIOM_MODULO_SMALL, EXPENSIVE);
}
...
// divides(n,Y) | multiply(Z,n) != Y 
  ...
  addTheoryClauseFromLits({divsXY,mZXneY}, Inference::Rule::THEORY_AXIOM_DIVIDES_MULTIPLY, EXPENSIVE);
...
// ~divides(n,Y) | multiply(skolem(n,Y),n)=Y
  ...
  addTheoryClauseFromLits({ndivsXY,msxXeqY}, Inference::Rule::THEORY_AXIOM_NONDIVIDES_SKOLEM, EXPENSIVE);
}
                                       ...
                                       Interpretation unaryMinus, TermList zeroElement)
{
  ...
  addTheoryClauseFromLits({xNeg,absXeqX}, Inference::Rule::THEORY_AXIOM_ABS_EQUALS, EXPENSIVE);
  addTheoryClauseFromLits({xPos,absXeqmX}, Inference::Rule::THEORY_AXIOM_ABS_MINUS_EQUALS, EXPENSIVE);
}
    ...
    TermList zeroElement, TermList oneElement, Interpretation less)
{
  ...
  addTheoryClauseFromLits({guardx,oQxnot0}, Inference::Rule::THEORY_AXIOM_QUOTIENT_NON_ZERO, EXPENSIVE);
  ...
  addTheoryClauseFromLits({guardx,qmxisy}, Inference::Rule::THEORY_AXIOM_QUOTIENT_MULTIPLY, EXPENSIVE);
}
     ...
     Interpretation plus, TermList oneElement)
{
  ...
  addTheoryClauseFromLits({a1}, Inference::Rule::THEORY_AXIOM_FLOOR_SMALL, EXPENSIVE);
  ...
  addTheoryClauseFromLits({a2}, Inference::Rule::THEORY_AXIOM_FLOOR_BIG, EXPENSIVE);
} //addFloorAxioms
     ...
     Interpretation plus, TermList oneElement)
{
  ...
  addTheoryClauseFromLits({a1}, Inference::Rule::THEORY_AXIOM_CEILING_BIG, EXPENSIVE);

  //axiom( ceiling(X) < X+1 ) 
  TermList xp1(Term::create2(plusFun, x, oneElement));
  Literal* a2 = Literal::create2(lessPred,true, ceilingX, xp1);
  addTheoryClauseFromLits({a2}, Inference::Rule::THEORY_AXIOM_CEILING_SMALL, EXPENSIVE);
} //addCeilingAxioms
                      ...
                      Interpretation plus, TermList zeroElement, TermList oneElement)
{
  ...
  addTheoryClauseFromLits({xLz,a1}, Inference::Rule::THEORY_AXIOM_TRUNC1, EXPENSIVE);

  //x<0 | x-1 < tr(x)
  Literal* a2 = Literal::create2(lessPred,true,xm1,truncateX);
  addTheoryClauseFromLits({xLz,a2}, Inference::Rule::THEORY_AXIOM_TRUNC2, EXPENSIVE);

  // ~(x<0) | ~( tr(x) < x )
  Literal* a3 = Literal::create2(lessPred,false,truncateX,x);
  addTheoryClauseFromLits({nxLz,a3}, Inference::Rule::THEORY_AXIOM_TRUNC3, EXPENSIVE);

  // ~(x<0) | tr(x) < x+1
  Literal* a4 = Literal::create2(lessPred,true,truncateX,xp1);
  addTheoryClauseFromLits({nxLz,a4}, Inference::Rule::THEORY_AXIOM_TRUNC4, EXPENSIVE);
} //addTruncateAxioms
...
void TheoryAxioms::addArrayExtensionalityAxioms(unsigned arraySort, unsigned skolemFn)
{
  ...
  addTheoryClauseFromLits({eq,ineq}, Inference::Rule::THEORY_AXIOM_ARRAY_EXTENSIONALITY, CHEAP);
...
void TheoryAxioms::addBooleanArrayExtensionalityAxioms(unsigned arraySort, unsigned skolemFn)
{
  ...
  addAndOutputTheoryUnit(new FormulaUnit(axiom, new Inference0(Inference::InputType::AXIOM,Inference::Rule::THEORY_AXIOM_BOOLEAN_ARRAY_EXTENSIONALITY)),CHEAP);
...
void TheoryAxioms::addArrayWriteAxioms(unsigned arraySort)
{
  ...
  addTheoryClauseFromLits({ax}, Inference::Rule::THEORY_AXIOM_ARRAY_WRITE1, CHEAP);
  ...
  addTheoryClauseFromLits({indexEq,writeEq}, Inference::Rule::THEORY_AXIOM_ARRAY_WRITE2, CHEAP);
} //
...
void TheoryAxioms::addBooleanArrayWriteAxioms(unsigned arraySort)
{
  ...
  for (TermList bval : {false_,true_}) {
    ...
    addAndOutputTheoryUnit(new FormulaUnit(ax, new Inference0(Inference::InputType::AXIOM, Inference::Rule::THEORY_AXIOM_BOOLEAN_ARRAY_WRITE1)),CHEAP);
  }
  ...
  addAndOutputTheoryUnit(new FormulaUnit(ax2, new Inference0(Inference::InputType::AXIOM, Inference::Rule::THEORY_AXIOM_BOOLEAN_ARRAY_WRITE2)),CHEAP);
} //
...
void TheoryAxioms::applyFOOL() {
  ...
  addTheoryClauseFromLits({tneqf},Inference::Rule::FOOL_AXIOM_TRUE_NEQ_FALSE,CHEAP);
  ...
  addTheoryClauseFromLits({boolVar1,boolVar2},Inference::Rule::FOOL_AXIOM_ALL_IS_TRUE_OR_FALSE,CHEAP);
...
void TheoryAxioms::addExhaustivenessAxiom(TermAlgebra* ta) {
  ...
  Unit* axiom;
  if (!addsFOOL) {
    axiom = Clause::fromStack(lits, new Inference0(Inference::InputType::AXIOM, Inference::Rule::TERM_ALGEBRA_EXHAUSTIVENESS_AXIOM));
  } else {
    Formula* disjunction;
    if(lits.size() == 1) {
    ...
    axiom = new FormulaUnit(universal, new Inference0(Inference::InputType::AXIOM,Inference::Rule::TERM_ALGEBRA_EXHAUSTIVENESS_AXIOM));
...
void TheoryAxioms::addDistinctnessAxiom(TermAlgebra* ta) {
  ...
  for (unsigned i = 0; i < ta->nConstructors(); i++) {
    for (unsigned j = i + 1; j < ta->nConstructors(); j++) {
      ...
      addTheoryClauseFromLits({ineq}, Inference::Rule::TERM_ALGEBRA_DISTINCTNESS_AXIOM,CHEAP);
    }
  }
}
...
void TheoryAxioms::addInjectivityAxiom(TermAlgebra* ta)
{
  ...
  for (unsigned i = 0; i < ta->nConstructors(); i++) {
    ...
    for (unsigned j = 0; j < c->arity(); j++) {
      ...
      addTheoryClauseFromLits({eql,eqr},Inference::Rule::TERM_ALGEBRA_INJECTIVITY_AXIOM,CHEAP);
    }
  }
}
...
void TheoryAxioms::addDiscriminationAxiom(TermAlgebra* ta) {
  ...
  for (unsigned i = 0; i < ta->nConstructors(); i++) {
    ...
    for (unsigned c = 0; c < cases.size(); c++) {
      ...
      addTheoryClauseFromLits({lit}, Inference::Rule::TERM_ALGEBRA_DISCRIMINATION_AXIOM,CHEAP);
    }
  }
}
...
void TheoryAxioms::addAcyclicityAxiom(TermAlgebra* ta)
{
  ...
  addTheoryClauseFromLits({sub}, Inference::Rule::TERM_ALGEBRA_ACYCLICITY_AXIOM,CHEAP);
}
...
bool TheoryAxioms::addSubtermDefinitions(unsigned subtermPredicate, TermAlgebraConstructor* c)
{
  ...
  for (unsigned i = 0; i < c->arity(); i++) {
    ...
    addTheoryClauseFromLits({sub}, Inference::Rule::TERM_ALGEBRA_DIRECT_SUBTERMS_AXIOM,CHEAP);
    ...
    addTheoryClauseFromLits({trans1,trans2}, Inference::Rule::TERM_ALGEBRA_SUBTERMS_TRANSITIVE_AXIOM,CHEAP);
