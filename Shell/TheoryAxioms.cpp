                                                ...
                                                Interpretation less)
{
  ...
  addTheoryClauseFromLits({notXIsXPlusOne}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addZeroSmallestElementAxiom(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({lit}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addDefineSubEqAxiom(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({clause1Lit1, clause1Lit2, clause1Lit3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);

  // clause 2: x!=y or x<s(y), simplified to x<s(x)
  auto clause2Lit1 = nat->createLess(true, x, sx);

  addTheoryClauseFromLits({clause2Lit1}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);

  // clause 3: x!<y or x<s(y)
  auto clause3Lit1 = nat->createLess(false, x, y);
  auto clause3Lit2 = nat->createLess(true, x, sy);

  addTheoryClauseFromLits({clause3Lit1, clause3Lit2}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addMonotonicityAxiom(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({clause1Lit1, clause1Lit2}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);

  // clause 2: s(x)!<s(y) or x<y
  auto clause2Lit1 = nat->createLess(false, sx, sy);
  auto clause2Lit2 = nat->createLess(true, x, y);

  addTheoryClauseFromLits({clause2Lit1, clause2Lit2}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addTransitivityAxioms(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({strict1, strict2, strict3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
  // variant 2: forall x,y,z. x!<s(y) or y!<z or x<z
  addTheoryClauseFromLits({nonStrict1, strict2, strict3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
  // variant 3: forall x,y,z. x!<y or y!<s(z) or x<z
  addTheoryClauseFromLits({strict1, nonStrict2, strict3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
  // variant 4: forall x,y,z. x!<s(y) or y!<s(z) or x<s(z)
  addTheoryClauseFromLits({nonStrict1, nonStrict2, nonStrict3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addTotalityAxiom(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({lit1, lit2, lit3}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
}
...
void TheoryAxioms::addDisjointnessAxioms(NatTermAlgebra* nat)
{
  ...
  addTheoryClauseFromLits({clause1Lit1}, InferenceRule::GENERIC_THEORY_AXIOM, CHEAP);
