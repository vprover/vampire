...
public:
  ...
  const vstring& lrsSaveTraceFile() const { return _lrsSaveTraceFile.actualValue; }
  const vstring& lrsLoadTraceFile() const { return _lrsLoadTraceFile.actualValue; }
  ...
  public:
    ...
    float next() {
      ...
      switch (_featureId) {
        ...
        case 23:
          return 0.0; // TODO: fill up with something relevant?
