...
public:
  ...
  /** number of theory descendants in proof search **/
  unsigned theoryDescendants;
  /** number of hol descendants in proof search **/
  unsigned holDescendants;
  /** number of defined equalities replaced by primitive equality */
  unsigned definedEqualities;
  ...
  /** number of extended narrowing inferences carried out */
  unsigned extendedNarrows;
