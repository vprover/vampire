...
void CASCMode::getSchedules(Property& property, Schedule& quick, Schedule& fallback)
{
  ...
  case Property::NEQ:
    if (prop == 131075) {
      ...
      quick.push("dis+11_50_bs=off:drc=off:gsp=input_only:nwc=1.3:nicw=on:ptb=off:ssec=off:spl=sat:sser=off:ssfp=4000:ssfq=2.0:ssnc=none_4");
      ...
      quick.push("dis+11_5:1_bs=off:drc=off:lcm=predicate:nwc=1.1:ptb=off:ssec=off:sos=all:sgo=on:sio=off:spo=on:spl=sat:sp=occurrence_57");
      ...
      quick.push("ott+1011_3_bs=off:drc=off:ep=on:fde=none:nwc=1.1:nicw=on:ptb=off:ssec=off:spl=sat_176");
      ...
      quick.push("dis-1002_40_bs=off:cond=on:drc=off:ecs=on:ep=on:gsp=input_only:nwc=2:ssec=off:sos=on:sac=on:sio=off:sp=reverse_arity_1");
      ...
      quick.push("dis+1011_7_bs=off:drc=off:ep=RS:fde=none:gsp=input_only:nwc=10:ptb=off:ssec=off:spl=sat:sser=off:ssfp=40000:ssfq=1.2:ssnc=none_3");
      ...
      quick.push("dis+11_24_bs=off:cond=on:drc=off:ep=on:gsp=input_only:lcm=predicate:nwc=1.7:ptb=off:ssec=off:spl=sat:sp=reverse_arity_35");
      ...
      quick.push("ott+11_2_bd=off:bs=off:cond=fast:drc=off:fde=none:gsp=input_only:lcm=predicate:nwc=10:ptb=off:ssec=off:spl=sat:sp=reverse_arity_226");
      ...
      quick.push("dis+11_50_bs=off:drc=off:gsp=input_only:nwc=1.3:nicw=on:ptb=off:ssec=off:spl=sat:sser=off:ssfp=4000:ssfq=2.0:ssnc=none_50");
    }
    else {
      ...
      quick.push("dis+1011_28_bs=off:cond=fast:drc=off:gs=on:nwc=1.1:ptb=off:ssec=off:spl=sat_6");
      quick.push("dis+11_24_bs=off:bms=on:cond=on:drc=off:ecs=on:fde=none:nwc=2.5:nicw=on:ssec=off:spo=on:sp=occurrence:urr=on_14");
      quick.push("ott+1011_6_bs=off:drc=off:ep=on:fde=none:nwc=1.1:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spo=on:spl=sat_4");
      ...
      quick.push("ott-11_2:3_bd=off:bs=off:lcm=predicate:nwc=5:nicw=on:ptb=off:ssec=off:spl=sat:sp=reverse_arity_19");
      quick.push("dis-2_50_bs=off:drc=off:lcm=predicate:nwc=1.7:ptb=off:ssec=off:sio=off:spl=backtracking:sp=occurrence_24");
      ...
      quick.push("ott+1011_3_bs=off:drc=off:ep=on:fde=none:nwc=1.1:nicw=on:ptb=off:ssec=off:spl=sat_106");
      ...
      quick.push("dis+1011_40_bs=off:cond=on:drc=off:fsr=off:nwc=1.2:nicw=on:ptb=off:ssec=off:sos=on:sagn=off:sgo=on:sio=off:spl=sat:sser=off:ssfp=4000:ssnc=none_2");
      ...
      quick.push("dis+11_40_bs=off:bms=on:drc=off:fde=none:gs=on:lcm=predicate:nwc=1.3:sd=4:ss=axioms:sac=on:spo=on:sp=occurrence_6");
      quick.push("dis-1003_50_bs=off:drc=off:fde=none:nwc=2:ptb=off:ssec=off:sio=off_1");
      ...
      quick.push("dis-1010_7_bs=off:cond=fast:drc=off:fsr=off:gsp=input_only:gs=on:nwc=1.1:ptb=off:ssec=off:sio=off:spo=on:urr=on_71");
      ...
      quick.push("ott+11_2_bd=off:bs=off:cond=fast:drc=off:fde=none:gsp=input_only:lcm=predicate:nwc=10:ptb=off:ssec=off:spl=sat:sp=reverse_arity_135");
      quick.push("ins+1_8:1_bs=off:cond=on:ep=RSTC:flr=on:gs=on:igbrr=0.8:igrr=1/4:igrp=1400:igrpq=1.05:igwr=on:nwc=2.5:ptb=off:ssec=off:sio=off:spl=off:urr=on_76");
      quick.push("lrs+10_20_bd=off:bs=off:cond=fast:drc=off:ecs=on:nwc=1.5:ptb=off:ssec=off:stl=30:sio=off:spo=on:spl=sat:sser=off:ssfp=1000:ssfq=1.2:ssnc=none:updr=off_160");
      ...
      quick.push("ott+4_12_bs=unit_only:br=off:cond=fast:drc=off:nwc=1.3:ptb=off:ssec=off:sos=on:spl=sat:sp=occurrence:urr=on_74");
    }
    break;
  ...
  case Property::HEQ:
    if (prop == 2) {
      ...
      quick.push("ott+4_1024_bs=off:drc=off:nwc=1.5:ptb=off:sio=off:spl=sat:sser=off:ssfp=4000:ssnc=none_190");
      ...
      quick.push("lrs+11_4:1_bs=unit_only:cond=fast:drc=off:fde=none:lcm=predicate:nwc=10:nicw=on:ptb=off:stl=60:sac=on:spo=on:spl=sat:ssac=none:ssfp=1000:ssfq=1.0:ssnc=all_226");
      ...
      quick.push("dis+11_7_bs=off:drc=off:lcm=reverse:nwc=5:ssec=off:sio=off:spl=off:updr=off_106");
    }
    break;
  ...
  case Property::PEQ:
    if (prop == 0) {
      ...
      quick.push("ott+11_7_bd=off:drc=off:flr=on:nwc=1.3:ptb=off:sgo=on:sio=off:spl=sat:sser=off:ssfp=4000:ssfq=1.2:ssnc=none_401");
    }
    else if (prop == 1) {
      ...
      quick.push("ott+4_6_bs=off:bsr=on:cond=on:drc=off:fsr=off:nwc=3:ssec=off:sswn=on:sac=on:sio=off:sp=occurrence_105");
      ...
      quick.push("dis+11_8_bsr=unit_only:cond=on:drc=off:fsr=off:gs=on:nwc=1.1:nicw=on:ptb=off:ssec=off:sos=all:sio=off:spo=on:spl=sat:sser=off:ssfq=1.4:ssnc=none_112");
    }
    break;
  ...
  case Property::HNE:
      ...
      quick.push("lrs+10_4:1_bs=off:cond=on:flr=on:nwc=10:ssec=off:stl=50:sio=off:spl=off:sp=reverse_arity_317");
  ...
  case Property::NNE:
    if (prop == 32768) {
      ...
      quick.push("dis-1_5_bs=off:ecs=on:nwc=1.7:ssec=off:sac=on:sgo=on:sio=off_6");
      quick.push("dis+1011_12_bs=off:cond=fast:ecs=on:flr=on:nwc=1:ssec=off_33");
  ...
  case Property::FEQ:
	...
	quick.push("dis+2_24_bs=off:ep=RSTC:flr=on:lcm=reverse:nwc=5:nicw=on:ssec=off:sac=on:sgo=on:spo=on:sfv=off_1179");
      ...
      quick.push("lrs+11_2:1_bs=off:cond=on:drc=off:ep=on:fde=none:gs=on:lcm=predicate:nwc=4:nicw=on:ptb=off:ssec=off:stl=30:sd=2:sgt=10:ss=axioms:sos=on:sagn=off:sio=off:spo=on:spl=backtracking:urr=on_8");
      quick.push("ott-1003_24_bs=off:cond=fast:drc=off:nwc=2.5:nicw=on:ptb=off:ssec=off:spl=sat:sser=off:ssfp=1000:ssnc=none:urr=on_2");
      ...
      quick.push("dis+3_4_bd=off:bs=off:cond=fast:drc=off:fsr=off:fde=none:gs=on:lcm=reverse:nwc=1.7:ptb=off:ssec=off:sos=on:spl=sat_12");
      quick.push("dis+1010_32_cond=fast:drc=off:ep=RS:fsr=off:nwc=1.7:ptb=off:ssec=off:spl=sat_1");
      ...
      quick.push("dis-1010_7_bs=off:drc=off:nwc=1.5:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:updr=off_29");
      ...
      quick.push("ott+1011_8:1_bs=off:bsr=unit_only:drc=off:ep=on:fde=none:nwc=1.3:ptb=off:sd=2:ss=axioms:sos=all:spl=sat:sser=off:ssfq=1.0:ssnc=none:sfv=off_27");
      quick.push("ott-1002_1024_bd=off:bs=off:cond=on:drc=off:nwc=1.5:nicw=on:ptb=off:ssec=off:sos=on:sgo=on:sio=off:spo=on:spl=backtracking:urr=on_89");
      ...
      quick.push("ott+1011_5:4_bs=off:bms=on:drc=off:fde=none:nwc=1.7:sd=3:ss=axioms:st=1.5:sio=off:sp=reverse_arity_8");
      ...
      quick.push("ott+1_10_bs=off:cond=fast:drc=off:flr=on:lcm=predicate:nwc=10:ptb=off:ssec=off:sac=on:sio=off:spo=on:sp=occurrence:urr=on_161");
      quick.push("ott+2_6_bs=off:cond=fast:drc=off:fde=none:nwc=1.2:ptb=off:ssec=off:sio=off:spl=sat_142");
      quick.push("lrs+10_8_bs=off:drc=off:gs=on:nwc=1.5:nicw=on:ptb=off:ssec=off:stl=60:sio=off:spo=on:spl=sat:updr=off_242");
      ...
      quick.push("lrs+1_4_bs=off:drc=off:ecs=on:ep=on:flr=on:fsr=off:lcm=predicate:nwc=1.3:nicw=on:ptb=off:ssec=off:stl=30:spl=sat:sser=off:ssfp=40000:ssfq=1.1:ssnc=none:sp=occurrence_267");
	...
	quick.push("dis+2_4_bs=off:cond=fast:drc=off:fde=none:gsp=input_only:lcm=reverse:nwc=1.2:nicw=on:ptb=off:ssec=off:sswn=on:sd=2:sgt=2:ss=axioms:sos=on:sgo=on:spl=backtracking:sp=reverse_arity_98");
      }
	...
	quick.push("ott-3_50_bs=off:cond=fast:drc=off:flr=on:nwc=1.7:ptb=off:ssec=off:sd=2:ss=axioms:st=3.0:sos=on:sio=off:urr=on_23");
	...
	quick.push("dis-1_2:3_bs=off:drc=off:ecs=on:ep=RST:fde=none:gs=on:nwc=4:nicw=on:ssec=off:sos=on:sio=off:spl=off_28");
	...
	quick.push("dis+10_5:1_bs=off:cond=fast:drc=off:lcm=predicate:nwc=5:nicw=on:ptb=off:ssec=off:sswn=on:sswsr=on:sd=2:sgt=5:ss=axioms:st=5.0:sos=on:spl=sat:sp=reverse_arity_142");
	quick.push("lrs+11_2:1_bs=off:cond=on:drc=off:ep=on:fde=none:gs=on:lcm=predicate:nwc=4:nicw=on:ptb=off:ssec=off:stl=30:sd=2:sgt=10:ss=axioms:sos=on:sagn=off:sio=off:spo=on:spl=backtracking:urr=on_299");
	quick.push("ott+1_5:1_bs=off:br=off:cond=fast:drc=off:nwc=1:nicw=on:ptb=off:ssec=off:sd=2:ss=axioms:st=5.0:sos=all:sio=off:spl=sat:urr=on_20");
	...
	quick.push("dis-1_2:3_bs=off:drc=off:ecs=on:ep=RST:fde=none:gs=on:nwc=4:nicw=on:ssec=off:sos=on:sio=off:spl=off_9");
	...
	quick.push("ott+1_2_bs=off:bsr=unit_only:drc=off:lcm=predicate:nwc=4:ptb=off:ssec=off:sd=3:sgt=7:ss=axioms:st=3.0:sos=on:spl=sat_117");
	...
	quick.push("dis+2_5:1_bd=off:bs=off:ep=RSTC:gs=on:lcm=reverse:nwc=1.2:nicw=on:sswn=on:sswsr=on:sd=2:sgt=5:ss=axioms:st=5.0:sos=on:sac=on:sio=off:sfv=off:sp=reverse_arity_27");
	...
	quick.push("ott+1_4_bs=off:cond=on:drc=off:ep=on:flr=on:nwc=4:nicw=on:ptb=off:ssec=off:sswsr=on:sd=2:sgt=20:ss=axioms:sos=on:sagn=off:spl=sat_153");
	quick.push("ott+1011_5:1_bs=off:cond=fast:drc=off:nwc=2.5:nicw=on:ptb=off:ssec=off:sos=on:sac=on:sio=off:spl=backtracking:sp=occurrence_105");
	...
	quick.push("dis-1010_7_bs=off:cond=fast:drc=off:fde=none:nwc=2:ptb=off:ssec=off:spo=on:sp=occurrence_45");
      }
    }
    else if (prop == 0) {
      if (atoms <= 70) {
	...
	quick.push("ott+11_2:3_bs=off:cond=on:drc=off:flr=on:lcm=predicate:nwc=1.5:nicw=on:ptb=off:ssec=off:spo=on:spl=sat:sp=reverse_arity:urr=on_15");
	quick.push("ott+3_16_bd=off:bs=off:bsr=unit_only:nwc=4:nicw=on:ptb=off:ssec=off:sio=off:spl=sat:sser=off:ssfp=100000:ssfq=1.2_66");
	...
	quick.push("dis-1010_2_bs=off:cond=fast:drc=off:nwc=1.7:nicw=on:ptb=off:ssec=off:sd=2:ss=axioms:st=1.5:sos=on:sio=off:spl=backtracking:updr=off_7");
	...
	quick.push("ott+1010_2:3_bs=off:drc=off:fde=none:nwc=1.2:sac=on_25");
	...
	quick.push("ott-11_8:1_bd=off:bs=off:drc=off:lcm=reverse:nwc=3:sio=off:spl=off:urr=on_100");
	...
	quick.push("ott+2_8:1_bs=off:bsr=on:cond=fast:drc=off:fde=none:lcm=reverse:nwc=4:nicw=on:ptb=off:ssec=off:sos=on:spl=sat:sser=off:ssfp=100000:ssnc=none:urr=on_36");
	...
	quick.push("ins-1003_3_bs=off:ep=RSTC:flr=on:gsp=input_only:igbrr=0.0:igrr=1/128:igrp=1400:igrpq=2.0:igwr=on:nwc=2:ptb=off:ssec=off:sos=on:sio=off:spl=off_264");
	...
	quick.push("dis+2_40_bs=off:drc=off:gs=on:lcm=predicate:nwc=5:ptb=off:ssec=off:sd=1:sgt=7:ss=axioms:sac=on:sgo=on:sio=off:spl=sat:sp=occurrence_1");
	...
	quick.push("dis-1010_2:1_bs=off:cond=fast:drc=off:gsp=input_only:nwc=4:ssec=off:sos=on:sac=on_1");
	...
	quick.push("ins-11_8:1_bs=off:bsr=unit_only:igbrr=0.9:igrr=1/128:igrp=400:igrpq=1.5:igwr=on:lcm=predicate:nwc=1.1:ptb=off:ssec=off:sos=all:spl=off:sp=occurrence:updr=off_7");
	quick.push("dis+1011_2_bs=off:cond=on:drc=off:gs=on:nwc=4:ptb=off:ssec=off:sd=1:ss=axioms:st=1.2:spl=sat:updr=off_8");
	quick.push("dis-1010_7_bs=off:cond=fast:drc=off:fde=none:nwc=2:ptb=off:ssec=off:spo=on:sp=occurrence_21");
	...
	quick.push("dis+10_5:1_bs=off:cond=fast:drc=off:lcm=predicate:nwc=5:nicw=on:ptb=off:ssec=off:sswn=on:sswsr=on:sd=2:sgt=5:ss=axioms:st=5.0:sos=on:spl=sat:sp=reverse_arity_4");
	quick.push("dis+11_2:1_bs=off:br=off:drc=off:gsp=input_only:gs=on:nwc=1.1:ptb=off:ssec=off:sac=on:sio=off:spo=on:spl=sat:urr=on_73");
	...
	quick.push("dis+2_5:1_bd=off:bs=off:ep=RSTC:gs=on:lcm=reverse:nwc=1.2:nicw=on:sswn=on:sswsr=on:sd=2:sgt=5:ss=axioms:st=5.0:sos=on:sac=on:sio=off:sfv=off:sp=reverse_arity_1");
	quick.push("dis+11_2:3_bs=off:bsr=unit_only:drc=off:gs=on:lcm=reverse:nwc=1.5:nicw=on:ptb=off:ssec=off:sos=on:spl=sat:sp=reverse_arity:urr=on:updr=off_1");
	...
	quick.push("dis+1010_24_bs=off:bsr=unit_only:cond=fast:drc=off:nwc=2.5:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:sp=occurrence_65");
      ...
      if (atoms > 300) {
	quick.push("dis-1010_7_bs=off:drc=off:nwc=1.5:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:updr=off_5");
	...
	quick.push("dis+1011_14_bd=off:bs=off:drc=off:nwc=4:ptb=off:ssec=off:sswn=on:sac=on:spl=sat:sp=occurrence_13");
	...
	quick.push("dis+2_8_bs=off:drc=off:ep=on:gsp=input_only:lcm=predicate:nwc=1.7:ptb=off:ssec=off:sswn=on:sd=2:sgt=2:ss=axioms:st=1.2:sos=on:spl=sat:sp=occurrence_9");
	...
	quick.push("ott-1010_4_bs=off:cond=fast:drc=off:fsr=off:gs=on:nwc=10:nicw=on:ptb=off:ssec=off:sd=4:ss=axioms:st=1.2:sos=on:sac=on:sio=off:spl=backtracking:sfv=off_4");
	quick.push("ott-1004_3:1_bs=off:br=off:cond=on:drc=off:nwc=2:nicw=on:ptb=off:ssec=off:sio=off:spo=on:spl=sat:urr=on_2");
	quick.push("dis+2_8:1_bd=off:bs=off:bsr=unit_only:drc=off:lcm=reverse:nwc=2.5:nicw=on:ptb=off:ssec=off:sswn=on:sswsr=on:sd=3:sgt=5:ss=axioms:st=1.5:sos=on:spl=sat:sp=reverse_arity_11");
	...
	quick.push("ott-4_7_bs=off:drc=off:fde=none:gs=on:lcm=reverse:nwc=1.7:nicw=on:ptb=off:ssec=off:sos=on:sac=on:sio=off:spl=backtracking:urr=on_6");
	quick.push("dis-1010_2:1_bs=off:cond=fast:drc=off:gsp=input_only:nwc=4:ssec=off:sos=on:sac=on_2");
	...
	quick.push("dis+2_24_bs=off:cond=on:drc=off:fde=none:nwc=1.1:nicw=on:sd=10:ss=axioms:sio=off:spl=off:sp=reverse_arity_15");
	...
	quick.push("dis+10_128_bd=off:bs=off:drc=off:nwc=3:ptb=off:ssec=off:sos=on:sio=off:spl=backtracking_88");
	quick.push("dis+2_40_bs=off:drc=off:gs=on:lcm=predicate:nwc=5:ptb=off:ssec=off:sd=1:sgt=7:ss=axioms:sac=on:sgo=on:sio=off:spl=sat:sp=occurrence_4");
	quick.push("dis+1011_12_bs=off:cond=fast:drc=off:ep=RS:flr=on:nwc=1.5:ptb=off:ssec=off:spl=sat_28");
	quick.push("dis+1011_7_cond=fast:drc=off:flr=on:fsr=off:nwc=3:nicw=on:ptb=off:ssec=off:spl=sat_49");
	...
	quick.push("dis-1010_3_bs=off:drc=off:fde=none:nwc=1:nicw=on:ptb=off:ssec=off:sd=1:ss=axioms:st=3.0:sac=on:sio=off:spl=sat_71");
	quick.push("ott+1011_8:1_bs=off:bsr=unit_only:drc=off:ep=on:fde=none:nwc=1.3:ptb=off:sd=2:ss=axioms:sos=all:spl=sat:sser=off:ssfq=1.0:ssnc=none:sfv=off_89");
	quick.push("dis+1011_64_bs=off:drc=off:fde=none:lcm=predicate:nwc=5:nicw=on:ssec=off:sswn=on:sp=reverse_arity_257");
	quick.push("dis+10_64_bd=off:bs=off:cond=fast:drc=off:ep=RSTC:flr=on:gsp=input_only:nwc=4:nicw=on:ptb=off:ssec=off:sswn=on:sd=10:ss=included:st=2.0:sos=all:spl=backtracking_1");
	...
	quick.push("ott-1_2:3_bs=off:bms=on:cond=on:drc=off:fde=none:lcm=predicate:nwc=1.7:nicw=on:sd=5:ss=axioms:st=1.2:sio=off:urr=on_14");
	...
	quick.push("dis-1010_7_bs=off:cond=fast:drc=off:fde=none:nwc=2:ptb=off:ssec=off:spo=on:sp=occurrence_49");
      }
      else {
	...
	quick.push("ott+1011_10_bd=off:bs=off:drc=off:ep=on:fde=none:gs=on:nwc=5:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:sp=reverse_arity_1");
	...
	quick.push("dis+1010_24_bs=off:bsr=unit_only:cond=fast:drc=off:nwc=2.5:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:sp=occurrence_131");
	quick.push("dis+1_16_bd=off:bs=off:cond=fast:drc=off:fsr=off:nwc=1.2:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spo=on:spl=backtracking:urr=on_26");
	...
	quick.push("ott-1002_1024_bd=off:bs=off:cond=on:drc=off:nwc=1.5:nicw=on:ptb=off:ssec=off:sos=on:sgo=on:sio=off:spo=on:spl=backtracking:urr=on_61");
	...
	quick.push("dis-2_8:1_bs=off:drc=off:lcm=predicate:nwc=3:ptb=off:ssec=off:sswn=on:sswsr=on:sgt=10:ss=axioms:sos=on:spl=sat_74");
	...
	quick.push("dis-1_6_bs=off:bsr=unit_only:cond=on:drc=off:fsr=off:gs=on:lcm=predicate:nwc=1.1:ptb=off:ssec=off:sos=on:sio=off:spo=on:urr=on_1");
	quick.push("dis+1_4:1_bs=off:drc=off:ep=on:fde=none:lcm=reverse:nwc=2:nicw=on:ptb=off:ssec=off:sswn=on:sswsr=on:sd=2:sgt=15:ss=axioms:sos=on:spl=sat:sp=reverse_arity:updr=off_2");
	quick.push("dis+1011_3_bs=off:drc=off:fde=none:nwc=10:nicw=on:ss=axioms:st=2.0:sac=on:sio=off_11");
      }
    }
      ...
      quick.push("dis+1011_64_bs=off:drc=off:fde=none:lcm=predicate:nwc=5:nicw=on:ssec=off:sswn=on:sp=reverse_arity_144");
      ...
      quick.push("dis+2_8:1_bs=off:drc=off:flr=on:lcm=reverse:nwc=1.5:ptb=off:ssec=off:sswn=on:sd=2:sgt=7:ss=axioms:sos=on:sio=off:spl=sat_1");
      ...
      quick.push("dis-1002_3_bs=off:cond=on:drc=off:gs=on:nwc=3:nicw=on:ssec=off:sgo=on:sio=off:sp=reverse_arity_5");
    }
    else if (prop <= 200000) {
      ...
      quick.push("dis+3_3:2_bs=off:bms=on:cond=on:drc=off:ecs=on:lcm=predicate:nwc=4:nicw=on:ssec=off:sd=7:ss=axioms:st=2.0:sac=on:sio=off:urr=on_1");
      ...
      quick.push("ott+11_3_bd=off:bs=off:gs=on:nwc=1.1:nicw=on:ptb=off:ssec=off:spl=sat:sser=off:ssfp=10000:ssfq=2.0_1");
      ...
      quick.push("ins+10_4:1_bs=off:bsr=unit_only:cond=on:ep=RSTC:gs=on:igbrr=0.4:igrr=1/128:igrp=100:igrpq=1.3:igwr=on:nwc=1.1:ptb=off:ssec=off:sos=on:sio=off:spl=off:urr=on_20");
      ...
      quick.push("ott+1011_1_bs=off:cond=on:drc=off:ecs=on:nwc=2:nicw=on:ptb=off:ssec=off:spl=sat:ssfp=1000:ssfq=1.2:ssnc=none_2");
      ...
      quick.push("ott-4_7_bs=off:drc=off:fde=none:gs=on:lcm=reverse:nwc=1.7:nicw=on:ptb=off:ssec=off:sos=on:sac=on:sio=off:spl=backtracking:urr=on_27");
      ...
      quick.push("lrs+1003_8:1_bs=off:drc=off:ep=on:fsr=off:gsp=input_only:gs=on:nwc=1.5:ptb=off:ssec=off:stl=30:sio=off:spl=sat_47");
      ...
      quick.push("ott+1010_2:3_bs=off:drc=off:fde=none:nwc=1.2:sac=on_97");
    }
    else {
      ...
      quick.push("lrs+10_8_bs=off:drc=off:gs=on:nwc=1.5:nicw=on:ptb=off:ssec=off:stl=60:sio=off:spo=on:spl=sat:updr=off_3");
      ...
      quick.push("dis-1010_5:1_bsr=on:drc=off:fde=none:gsp=input_only:gs=on:nwc=4:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spl=sat:updr=off_83");
  ...
  case Property::FNE:
    if (atoms > 2500) {
      ...
      quick.push("dis-1002_4_bs=off:bsr=unit_only:gsp=input_only:gs=on:nwc=3:nicw=on:ptb=off:ssec=off:spl=sat:urr=on:updr=off_87");
      ...
      quick.push("ins+1011_128_bs=off:cond=fast:gs=on:igbrr=0.3:igrr=1/64:igrpq=1.3:igwr=on:nwc=5:ptb=off:sos=all:sio=off:spl=off_168");
    }
    else {
      ...
      quick.push("dis+1011_64_bs=off:gs=on:nwc=3:nicw=on:ptb=off:ssec=off:sos=on:sac=on:sio=off:spl=sat_138");
      quick.push("dis+3_2_bs=off:gs=on:nwc=2.5:ptb=off:ssec=off:sac=on:spl=sat:sp=reverse_arity_4");
      ...
      quick.push("dis+1010_10_bs=off:nwc=1.1:ptb=off:ssec=off:sio=off_119");
  ...
  case Property::UEQ:
	...
	quick.push("dis+10_28_bs=unit_only:bsr=on:drc=off:fsr=off:nwc=2.5_218");
	quick.push("ott+10_1_bs=off:drc=off:fsr=off:fde=none:nwc=5_250");
	quick.push("lrs+10_8:1_nwc=1:stl=90:sfv=off:sp=reverse_arity_264");
      }
      else if (atoms > 10) {
	quick.push("lrs+10_14_bs=off:drc=off:fsr=off:gsp=input_only:nwc=1.1:stl=20:sio=off:sp=occurrence_177");
	quick.push("ott+10_32_bs=off:bsr=on:drc=off:fsr=off:fde=none:nwc=1.3_170");
	quick.push("lrs+10_1024_bms=on:drc=off:nwc=5:ssec=off:stl=30:sio=off_146");
	quick.push("ott+10_50_bd=off:drc=off:fsr=off:nwc=1.1:sp=occurrence_283");
	quick.push("dis+10_6_bd=off:bs=off:bms=on:drc=off:ecs=on:gs=on:nwc=1.7:ssec=off:sp=occurrence_188");
	quick.push("lrs+10_8:1_nwc=1:stl=90:sfv=off:sp=reverse_arity_271");
      }
      else {
	quick.push("lrs+10_14_bs=off:drc=off:fsr=off:gsp=input_only:nwc=1.1:stl=20:sio=off:sp=occurrence_69");
	quick.push("ott+10_8_bd=off:bs=off:drc=off:fsr=off:fde=none:nwc=2:sp=occurrence_44");
	quick.push("lrs+10_8:1_nwc=1:stl=90:sfv=off:sp=reverse_arity_13");
	quick.push("ott+10_50_bd=off:drc=off:fsr=off:nwc=1.1:sp=occurrence_50");
	quick.push("dis+4_5:1_bs=off:br=off:ep=RSTC:fsr=off:nwc=3:ptb=off:sos=all:sio=off:spl=sat:ssfq=1.4:ssnc=none:urr=on_94");
	quick.push("lrs+10_1024_bms=on:drc=off:nwc=5:ssec=off:stl=30:sio=off_211");
	quick.push("ott+10_1_bs=off:drc=off:fsr=off:fde=none:nwc=5_253");
	quick.push("lrs+10_2:1_bd=off:bs=off:drc=off:fsr=off:nwc=2.5:stl=30_143");
	quick.push("ott+10_8:1_bd=off:bs=off:drc=off:fsr=off:nwc=1.3:ssec=off_281");
      }
    }
    else if (prop == 2) {
      quick.push("ott+10_7_bs=off:drc=off:fsr=off:nwc=1.1:sp=occurrence_224");
      quick.push("ott+10_8_bd=off:bs=off:drc=off:fsr=off:fde=none:nwc=2:sp=occurrence_45");
      quick.push("ott+10_6_bs=off:drc=off:fsr=off:fde=none:nwc=1.2_108");
      quick.push("lrs+10_1024_bms=on:drc=off:nwc=5:ssec=off:stl=30:sio=off_119");
      quick.push("ott+10_32_bs=off:bsr=on:drc=off:fsr=off:fde=none:nwc=1.3_170");
      quick.push("dis+10_6_bd=off:bs=off:bms=on:drc=off:ecs=on:gs=on:nwc=1.7:ssec=off:sp=occurrence_188");
      quick.push("ott+10_1_bs=off:drc=off:fsr=off:fde=none:nwc=5_250");
      quick.push("ott+10_50_bd=off:drc=off:fsr=off:nwc=1.1:sp=occurrence_283");
      ...
      quick.push("ott+10_64_bs=off:drc=off:fsr=off:nwc=5_33");
      quick.push("dis+4_5:1_bs=off:br=off:ep=RSTC:fsr=off:nwc=3:ptb=off:sos=all:sio=off:spl=sat:ssfq=1.4:ssnc=none:urr=on_94");
      quick.push("lrs+10_1024_bms=on:drc=off:nwc=5:ssec=off:stl=30:sio=off_162");
      quick.push("lrs+10_2:1_bd=off:bs=off:drc=off:fsr=off:nwc=2.5:stl=30_143");
    }
    break;
  }
  ...
  case Property::NEQ:
    ...
    fallback.push("dis+11_3:1_bs=off:drc=off:ep=on:nwc=10:ptb=off:ssec=off:spl=sat:urr=on_300");
    fallback.push("dis+11_3_bs=off:bms=on:cond=fast:drc=off:gsp=input_only:lcm=reverse:nwc=3:ssec=off:sos=on:sac=on:spo=on:sp=occurrence_300");
    ...
    fallback.push("dis+11_24_bs=off:cond=on:drc=off:ep=on:gsp=input_only:lcm=predicate:nwc=1.7:ptb=off:ssec=off:spl=sat:sp=reverse_arity_300");
    ...
    fallback.push("dis+1011_40_bs=off:cond=on:drc=off:fsr=off:nwc=1.2:nicw=on:ptb=off:ssec=off:sos=on:sagn=off:sgo=on:sio=off:spl=sat:sser=off:ssfp=4000:ssnc=none_300");
    ...
    fallback.push("dis+1010_4:1_bs=off:bms=on:drc=off:ep=RST:nwc=4:sswn=on:sos=on:sgo=on:spo=on_300");
    ...
    fallback.push("ott+1_1_bd=off:bs=off:bsr=unit_only:br=off:cond=on:drc=off:ep=on:lcm=reverse:nwc=3:ptb=off:ssec=off:sd=4:ss=axioms:st=2.0:sio=off:urr=on_300");
    ...
    fallback.push("ins+1_8:1_bs=off:cond=on:ep=RSTC:flr=on:gs=on:igbrr=0.8:igrr=1/4:igrp=1400:igrpq=1.05:igwr=on:nwc=2.5:ptb=off:ssec=off:sio=off:spl=off:urr=on_300");
  ...
  case Property::PEQ:
  case Property::EPR:
    fallback.push("lrs+1_40_bs=unit_only:cond=on:drc=off:ecs=on:nwc=1:nicw=on:ptb=off:ssec=off:sio=off:spo=on:spl=sat:ssfq=1.0:ssnc=none_300");
    ...
    fallback.push("dis+1_2_bd=off:bs=off:drc=off:flr=on:fsr=off:nwc=10:ptb=off:ssec=off:sio=off:spl=sat:sser=off:ssfq=1.4:ssnc=none_300");
    ...
    fallback.push("lrs-1_2:1_bs=off:drc=off:gs=on:nwc=1.1:nicw=on:ssec=off:sio=off:spl=off:updr=off_500");
    ...
    fallback.push("ott+11_7_bd=off:drc=off:flr=on:nwc=1.3:ptb=off:sgo=on:sio=off:spl=sat:sser=off:ssfp=4000:ssfq=1.2:ssnc=none_900");
  ...
  case Property::NNE: 
    ...
    fallback.push("dis+1_50_bs=off:cond=on:nwc=3:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:sp=occurrence_300");
    ...
    fallback.push("lrs+10_4:1_bs=off:cond=on:flr=on:nwc=10:ssec=off:sio=off:spl=off:sp=reverse_arity_500");
    ...
    fallback.push("dis+4_14_fsr=off:lcm=reverse:nwc=1:sac=on:sio=off_300");
    ...
    fallback.push("dis-1_5_bs=off:ecs=on:nwc=1.7:ssec=off:sac=on:sgo=on:sio=off_300");
  ...
  case Property::FEQ: 
    ...
    fallback.push("lrs+2_40_bs=off:cond=fast:drc=off:nwc=1.7:ptb=off:ssec=off:sio=off:spo=on:spl=sat_300");
    ...
    fallback.push("dis-1010_2:1_bs=off:cond=fast:drc=off:gsp=input_only:nwc=4:ssec=off:sos=on:sac=on_300");
    ...
    fallback.push("dis+1011_1_bs=off:bsr=on:cond=fast:drc=off:flr=on:fde=none:gs=on:nwc=1.5:ptb=off:ssec=off:sos=on:sac=on:sio=off:urr=on_300");
    ...
    fallback.push("dis-1_2:3_bs=off:drc=off:ecs=on:ep=RST:fde=none:gs=on:nwc=4:nicw=on:ssec=off:sos=on:sio=off:spl=off_300");
    ...
    fallback.push("lrs+10_8_bs=off:drc=off:gs=on:nwc=1.5:nicw=on:ptb=off:ssec=off:sio=off:spo=on:spl=sat:updr=off_600");
    fallback.push("ott-3_50_bs=off:cond=fast:drc=off:flr=on:nwc=1.7:ptb=off:ssec=off:sd=2:ss=axioms:st=3.0:sos=on:sio=off:urr=on_300");
    ...
    fallback.push("dis+1011_7_cond=fast:drc=off:flr=on:fsr=off:nwc=3:nicw=on:ptb=off:ssec=off:spl=sat_300");
    ...
    fallback.push("dis+11_2:3_bs=off:bsr=unit_only:drc=off:gs=on:lcm=reverse:nwc=1.5:nicw=on:ptb=off:ssec=off:sos=on:spl=sat:sp=reverse_arity:urr=on:updr=off_300");
    ...
    fallback.push("dis+2_40_bs=off:drc=off:gs=on:lcm=predicate:nwc=5:ptb=off:ssec=off:sd=1:sgt=7:ss=axioms:sac=on:sgo=on:sio=off:spl=sat:sp=occurrence_300");
    ...
    fallback.push("dis-1002_5:1_bs=off:bms=on:drc=off:ecs=on:flr=on:gs=on:nwc=10:nicw=on:ssec=off:sac=on:sgo=on:urr=on_300");
    ...
    fallback.push("ott+4_64_bs=off:drc=off:flr=on:lcm=predicate:nwc=10:ptb=off:ssec=off:spl=sat:sp=reverse_arity_300");
  ...
  case Property::UEQ:
    ...
    fallback.push("dis+10_28_bs=unit_only:bsr=on:drc=off:fsr=off:nwc=2.5_300");
    fallback.push("ott+10_6_bs=off:drc=off:fsr=off:fde=none:nwc=1.2_300");
    fallback.push("lrs+10_14_bs=off:drc=off:fsr=off:gsp=input_only:nwc=1.1:sio=off:sp=occurrence_200");
    fallback.push("lrs+10_1024_bms=on:drc=off:nwc=5:ssec=off:sio=off_300");
    fallback.push("ott+10_50_bd=off:drc=off:fsr=off:nwc=1.1:sp=occurrence_300");
    fallback.push("ott+10_1_bs=off:drc=off:fsr=off:fde=none:nwc=5_300");
    ...
    fallback.push("ott+10_8:1_bd=off:bs=off:drc=off:fsr=off:nwc=1.3:ssec=off_300");
    ...
    fallback.push("dis+10_6_bd=off:bs=off:bms=on:drc=off:ecs=on:gs=on:nwc=1.7:ssec=off:sp=occurrence_300");
    break;
  }
}
...
void CASCMode::getSchedulesSat(Property& property, Schedule& quick, Schedule& fallback)
{
  ...
  case Property::PEQ:
    quick.push("dis+10_40_bs=off:cond=fast:fde=none:gsp=input_only:nwc=1.5:nicw=on:ptb=off:ssec=off:sio=off:spo=on:spl=sat:sp=reverse_arity_11");
    ...
    quick.push("dis+11_50_bs=off:fde=none:gs=on:nwc=4:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:ssfq=2.0:ssnc=none_62");
  ...
  case Property::FEQ:
    ...
    quick.push("dis+2_4_bs=off:cond=fast:drc=off:fde=none:gsp=input_only:lcm=reverse:nwc=1.2:nicw=on:ptb=off:ssec=off:sswn=on:sd=2:sgt=2:ss=axioms:sos=on:sgo=on:spl=backtracking:sp=reverse_arity_1");
    quick.push("dis+4_40_bs=off:bfnt=on:cond=on:gsp=input_only:nwc=1:nicw=on:ptb=off:ssec=off:sac=on:sio=off:spo=on:spl=backtracking:urr=on_298");
    quick.push("ins+1_40_bs=off:bsr=unit_only:bfnt=on:cond=on:ep=RSTC:igbrr=0.5:igrr=128/1:igrp=100:igrpq=1.5:igwr=on:nwc=1.7:ptb=off:ssec=off:sos=on:sio=off:spl=off_92");
  ...
  case Property::FNE:
    ...
    quick.push("dis+2_1024_bs=off:fsr=off:gsp=input_only:nwc=2:nicw=on:ptb=off:sio=off:spl=backtracking_56");
  ...
  case Property::UEQ:
    ...
    fallback.push("dis+11_50_bs=off:fde=none:gs=on:nwc=4:ptb=off:ssec=off:sac=on:sio=off:spl=backtracking:ssfq=2.0:ssnc=none_300");
  ...
  case Property::FNE:
    ...
    fallback.push("dis+2_1024_bs=off:fsr=off:gsp=input_only:nwc=2:nicw=on:ptb=off:sio=off:spl=backtracking_100");
    fallback.push("ott+1_1024_bs=off:lcm=predicate:nwc=2.5:ptb=off:ssec=off:sac=on:spl=sat:updr=off_300");
    fallback.push("ins+1_40_bs=off:bsr=unit_only:bfnt=on:cond=on:ep=RSTC:igbrr=0.5:igrr=128/1:igrp=100:igrpq=1.5:igwr=on:nwc=1.7:ptb=off:ssec=off:sos=on:sio=off:spl=off_300");
    ...
    fallback.push("dis-1002_12_bs=off:cond=fast:drc=off:ep=on:flr=on:lcm=predicate:nwc=1:nicw=on:ptb=off:ssec=off:sswsr=on:sd=3:ss=axioms:st=1.5:sos=on:sagn=off:sio=off:spl=sat_300");
