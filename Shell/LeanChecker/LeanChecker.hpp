...
public:
  ...
  static void outputSignature(std::ostream &out);

  static void outputPreamble(std::ostream &out, std::set<Signature::Symbol*>& usedFunctionSymbols, std::set<Signature::Symbol*>& usedPredicateSymbols);
...
private:
  ...
  void outputCumulativeSplits(std::initializer_list<Kernel::Clause *>& cl, std::string seperator = " ",std::string splitPrefix = env.options->leanProofPrefix() + "sA", bool ignoreNegation = false);

  void outputCumulativeSplits(std::set<Kernel::Unit*, CompareUnits>& cl, std::string seperator = " ", std::string splitPrefix = env.options->leanProofPrefix() + "sA", std::string prefix = "", std::string suffix = "");
  ...
  void outputFullProofPreamble(std::ostream &out, std::deque<Unit*>& premises, std::deque<Unit*>& negatedConjectures, std::set<Unit*>& conjectures, std::set<Signature::Symbol*>& unusedFunctionSymbols, std::set<Signature::Symbol*>& unusedPredicateSymbols);
  ...
  inline static const std::string preambleLean = "-- Lean proof output generated by Vampire\n"
  ...
  inline static const std::string stepIdent = "step";
  inline static const std::string indent = "  ";
  inline static const std::string intIdent = "i";
  inline static const std::string avatarSplitPrefix = "sA";
