...
void Preprocess::preprocess(Problem& prb)
{
  ...
  if (_options.sineToAge() || _options.useAvatarSplitQueues() || (_options.sineToPredLevels() != Options::PredicateSineLevels::OFF)) {
    env.statistics->phase=Statistics::SINE_SELECTION;

    if (_options.sineToAge() || _options.useAvatarSplitQueues()) {
