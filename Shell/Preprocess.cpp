...
void Preprocess::preprocess(Problem& prb)
{
  ...
  if (_options.showForKarel() || _options.evalForKarel() || _options.sineToAge() || _options.useSineLevelSplitQueues() ||
      (_options.sineToPredLevels() != Options::PredicateSineLevels::OFF)) {
