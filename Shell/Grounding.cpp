...
ClauseList* Grounding::ground(Clause* cl)
{
  ...
  while(_ga.newAssignment()) {
    Clause* rcl=new(clen) Clause(clen, new Inference1(Inference::Rule::GROUNDING, cl));
    rcl->setAge(cl->age());
...
void Grounding::getLocalEqualityAxioms(unsigned sort, bool otherThanReflexivity, ClauseList*& acc)
{
  ...
  Clause* axR = new(1) Clause(1, new Inference0(Inference::InputType::AXIOM,Inference::Rule::EQUALITY_AXIOM));
  ...
  if(otherThanReflexivity) {
    Clause* axT = new(3) Clause(3, new Inference0(Inference::InputType::AXIOM,Inference::Rule::EQUALITY_AXIOM));
...
*/
  ...
  if(otherThanReflexivity) {
	...
	Clause* axCong = new(3) Clause(3, new Inference0(Inference::InputType::AXIOM,Inference::Rule::EQUALITY_AXIOM));
	(*axCong)[0]=eqLit;
