...
public:
  ...
  static Clause* generateClause(Clause* queryCl, Literal* queryLit, 
                                ...
                                SmartPtr<ResultSubstitution> subs, Stack<Literal*> const& constraints, const Options& opts, PassiveClauseContainer* passive=0, Ordering* ord=0, LiteralSelector* ls = 0);
