...
Inference::Rule ProxyElimination::constToInfRule(SS::HOLConstant cnst){
...
TermList ProxyElimination::sigmaRemoval(TermList sigmaTerm, unsigned expsrt){
...
TermList ProxyElimination::piRemoval(TermList piTerm, Clause* clause, unsigned expsrt){
...
bool ProxyElimination::isPISIGMAapp(Literal* lit, TermList &t1, TermList &rhs, bool &applyPIrule, unsigned &srt1)
{
...
bool ProxyElimination::isEQUALSApp(Literal* lit, TermList &t1, TermList &t2, bool &positive, unsigned &sort)
{
...
Clause* ProxyElimination::CombinatorEliminationISE::simplify(Clause* premise)
{
...
struct ProxyElimination::ORIMPANDIFFXORRemovalGIE::ProxyEliminationIterator
{
...
struct ProxyElimination::ORIMPANDIFFXORRemovalGIE::ProxyEliminationFn
{
...
ClauseIterator ProxyElimination::ORIMPANDIFFXORRemovalGIE::generateClauses(Clause* c)
{
