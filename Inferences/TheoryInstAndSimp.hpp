...
public:
  ...
  TheoryInstAndSimp(Options::TheoryInstSimp mode, bool thiTautologyDeletion, bool showZ3, bool generalisation, std::string const& exportFile, Options::ProblemExportSyntax syntax);
