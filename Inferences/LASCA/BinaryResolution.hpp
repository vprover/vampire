...
#ifndef __LASCA_BinaryResolution__
#define __LASCA_BinaryResolution__
...
struct BinaryResolutionConf
{
  ...
  static const char* name() { return "lasca binary resolution"; }

  BinaryResolutionConf(std::shared_ptr<LascaState> shared) : _shared(shared) {  }

  struct Lhs : public SelectedLiteral
  {
    static const char* name() { return "lasca binary resolution lhs"; }
    ...
    static IndexType indexType() { return Indexing::LASCA_BINARY_RESOLUTION_LHS_SUBST_TREE; }
  };


  struct Rhs : public SelectedLiteral
  {
    static const char* name() { return "lasca binary resolution rhs"; }
    ...
    static IndexType indexType() { return Indexing::LASCA_BINARY_RESOLUTION_RHS_SUBST_TREE; }
  };
...
{
  BinaryResolution(std::shared_ptr<LascaState> shared) : BinInf<BinaryResolutionConf>(shared, BinaryResolutionConf(shared)) {}
};
...
#endif /*__LASCA_BinaryResolution__*/
