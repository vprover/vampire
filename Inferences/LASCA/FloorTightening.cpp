 ...
 */
/**
 * @file FloorTightening.cpp
 * Implements class FloorTightening.
 */
...
void FloorTightening::attach(SaturationAlgorithm* salg)
{
  CALL("FloorTightening::attach");
  GeneratingInferenceEngine::attach(salg);
}

void FloorTightening::detach()
{
  CALL("FloorTightening::detach");
  ASS(_salg);
...
#if VDEBUG
void FloorTightening::setTestIndices(Stack<Indexing::Index*> const& indices)
{  }
#endif
...
Option<Clause*> FloorTightening::applyRule(
...
{
  ASSERTION_VIOLATION
//   CALL("LASCA::FloorTightening::applyRule(...)")
...
ClauseIterator FloorTightening::generateClauses(Clause* premise)
{
  ASSERTION_VIOLATION
