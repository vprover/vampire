...
#ifndef __LASCA_InequalityResolution__
#define __LASCA_InequalityResolution__
...
public:
  ...
  InequalityResolution(shared_ptr<LascaState> shared) 
  ...
  public: 
    ...
    { 
      CALL("Lasca::InequalityResolution::Lhs::iter")
  ...
  public: 
    ...
    static auto iter(LascaState& shared, Clause* cl) 
    { 
      CALL("Lasca::InequalityResolution::Rhs::iter")
      return shared.selectedSummands(cl, 
                        /* literal*/ SelectionCriterion::STRICTLY_MAX,
...
#endif /*__LASCA_InequalityResolution__*/
