...
#define FOR_NUM(Num) \
  ALASCA_COHERENCE_DEMOD_TO_SIMPL_SUBST_TREE_ ## Num, \
  ALASCA_COHERENCE_DEMOD_CONDITION_SUBST_TREE_ ## Num, \
  ALASCA_COHERENCE_RHS_SUBST_TREE_ ## Num, \
  ALASCA_COHERENCE_LHS_SUBST_TREE_ ## Num, \

  FOR_NUM_TRAITS_FRAC_PREFIX(FOR_NUM)
#undef FOR_NUM
  ALASCA_SUPERPOSITION_DEMOD_TO_SIMPL_SUBST_TREE,
  ALASCA_SUPERPOSITION_DEMOD_CONDITION_SUBST_TREE,
