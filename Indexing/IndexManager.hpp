...
enum IndexType {
  ...
  IRC_INEQUALITY_RESOLUTION_LHS_SUBST_TREE,
  IRC_INEQUALITY_RESOLUTION_RHS_SUBST_TREE,
  IRC_SUPERPOSITION_LHS_SUBST_TREE,
  IRC_SUPERPOSITION_RHS_SUBST_TREE,
  IRC_FWD_DEMODULATION_SUBST_TREE,
  IRC_BWD_DEMODULATION_SUBST_TREE,
