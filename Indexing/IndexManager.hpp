...
enum IndexType {
  ...
  REVERSE_SUPERPOSITION_SUBTERM_SUBST_TREE,
  ...
  GOAL_PARAMODULATION_LHS_INDEX,
  GOAL_PARAMODULATION_SUBTERM_INDEX,
  LEFT_UPWARD_CHAINING_LHS_INDEX,
  RIGHT_UPWARD_CHAINING_LHS_INDEX,
  LEFT_UPWARD_CHAINING_SUBTERM_INDEX,
  RIGHT_UPWARD_CHAINING_SUBTERM_INDEX,
