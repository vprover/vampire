...
public:
  ...
  VirtualIterator<QueryRes<AbstractingUnifier*, Data>> getUwaHOL(TypedTermList t, Options::UnificationWithAbstraction, bool fixedPointIteration, HOLUnificationHandler* holHandler) override { NOT_IMPLEMENTED; }
