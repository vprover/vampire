...
// { return pvi(getResultIterator<FastInstancesIterator>(lit, complementary, retrieveSubstitutions, subsTreeQueryBank(0), subsTreeNormResultBank(0), subsTreeResultBank(0))); }
//
//
