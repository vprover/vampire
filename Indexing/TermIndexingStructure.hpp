...
public:
  ...
  virtual VirtualIterator<TQueryRes<RobSubstitution*>> getUnifications(TypedTermList t, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
  ...
  virtual VirtualIterator<TQueryRes<RobSubstitution*>> getUnificationsUsingSorts(TypedTermList tt, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }  
