...
public:
  ...
  virtual VirtualIterator<QueryRes<SmartPtr<ResultSubstitution>, Data>> getUnifications(TypedTermList t, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
  ...
  virtual VirtualIterator<QueryRes<SmartPtr<GenSubstitution>, Data>> getGeneralizations(TypedTermList t, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
  virtual VirtualIterator<QueryRes<SmartPtr<InstSubstitution>, Data>> getInstances(TypedTermList t, bool retrieveSubstitutions = true) { NOT_IMPLEMENTED; }
