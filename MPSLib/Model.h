...
public:
    ...
    */
   BaseConstraint(const char* _name, bool _redundant = false);
...
class LinearConstraint : public BaseConstraint
{
public:
   /**
...
class SOSConstraint : public BaseConstraint
{
public:
   /**
...
public:
    ...
    */
   void pushCons(BaseConstraint* cons);
   ...
   std::map<std::string, BaseConstraint*> conss; //< set of constraints
};
