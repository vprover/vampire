...
void ModelCheck::doCheck(UnitList* units)
{
  // find model size
...
void ModelCheck::checkIsDomainLiteral(Literal* l, int& single_var, Set<Term*>& domainConstants)
{
...
void ModelCheck::addDefinition(FiniteModelMultiSorted& model,Literal* lit,bool negated,
