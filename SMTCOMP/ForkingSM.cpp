...
bool ForkingSM::runSlice(Options& opt)
{
  CALL("ForkingSM::runSlice");
  ...
  if(!fres) {
    ...
    INVALID_OPERATION("ForkingSM::childRun should never return.");
  }
 ...
 */
void ForkingSM::childRun(Options& strategyOpt)
{
  CALL("ForkingSM::childRun");
