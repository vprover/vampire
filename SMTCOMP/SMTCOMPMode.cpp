...
void SMTCOMPMode::getSchedules(Property& property, Schedule& quick, Schedule& fallback)
{
  ...
  case SMT_UFDT:
    ...
    quick.push("lrs-1_3:1_av=off:bd=off:cond=on:gs=on:ile=on:lcm=reverse:lma=on:nm=32:nwc=1.2:stl=30:urr=on:updr=off_167");
  ...
  case SMT_LRA:
      ...
      quick.push("lrs+11_24_afr=on:afp=1000:afq=1.1:anc=none:gs=on:gsaa=full_model:gsem=on:ile=on:lma=on:nm=64:nwc=1:stl=30:sos=all:uwa=interpreted_only:updr=off_2");
