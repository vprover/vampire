...
void SMTCOMPMode::getSchedules(Property& property, Schedule& quick, Schedule& fallback)
{
    ...
    case SMT_LIA:
      quick.push("dis+10_3_afr=on:afp=40000:afq=1.1:anc=none:gs=on:gsem=on:ile=on:irw=on:lma=on:nm=64:newcnf=on:nwc=1:sas=z3:sos=all:sp=occurrence_0");
      ...
      quick.push("lrs+4_2_afp=100000:afq=1.1:amm=off:anc=all_dependent:fsr=off:gs=on:gsaa=from_current:gsem=on:lma=on:lwlo=on:nm=64:nwc=2.5:stl=30:sp=occurrence_0");
      quick.push("lrs+10_2:3_aac=none:add=off:afr=on:afp=100000:afq=1.0:amm=sco:anc=none:bd=off:gs=on:gsem=on:inw=on:newcnf=on:nwc=1:sas=z3:stl=30:sos=all:sp=reverse_arity:tha=off_0");
      quick.push("lrs+1011_2:1_add=large:afr=on:afp=4000:afq=1.1:amm=off:anc=none:cond=on:fsr=off:gs=on:irw=on:nm=64:nwc=1:sas=z3:stl=30:sos=on:sp=reverse_arity:thf=on:urr=on:updr=off_0");
      quick.push("lrs-11_5:1_afp=1000:afq=1.2:amm=sco:cond=on:fsr=off:nm=64:nwc=1.5:sas=z3:stl=30:sp=reverse_arity:tha=off_0");
      quick.push("dis+10_12_add=large:afr=on:afp=40000:afq=1.0:amm=off:anc=none:cond=on:ile=on:irw=on:lma=on:nm=16:newcnf=on:nwc=1:sac=on:sp=occurrence:tha=off_0");
      quick.push("dis+4_3:2_afr=on:afp=1000:afq=1.1:amm=sco:bs=unit_only:cond=fast:fsr=off:fde=none:gsp=input_only:gs=on:gsem=off:inw=on:lcm=reverse:nwc=1:sas=z3:sos=all:sp=reverse_arity:tha=off:updr=off_0");
      quick.push("dis+10_5_add=large:amm=sco:anc=none:fsr=off:gs=on:irw=on:lma=on:nm=64:nwc=1:sas=z3:sos=all:tha=off:thf=on_0");
      quick.push("dis+10_10_add=large:afp=4000:afq=1.1:amm=sco:anc=none:irw=on:lcm=reverse:lma=on:nm=6:nwc=1:sos=all:sac=on:sp=reverse_arity:urr=on_0");
      quick.push("dis+10_3:2_afr=on:afp=1000:afq=1.2:bd=off:irw=on:lcm=predicate:lwlo=on:nm=0:newcnf=on:nwc=2:sos=on:tha=off:thf=on:urr=ec_only_0");
      quick.push("ott-11_3_add=large:afp=100000:afq=1.2:anc=none:bs=on:cond=fast:fde=none:gs=on:gsem=off:lma=on:lwlo=on:nm=64:newcnf=on:nwc=1:sos=all:sp=occurrence:tha=off:urr=on:uhcvi=on_0");
      quick.push("dis-10_28_aac=none:add=large:afr=on:afp=4000:afq=1.2:bd=preordered:bsr=on:bce=on:fde=none:gs=on:gsem=off:ile=on:irw=on:lma=on:nm=6:newcnf=on:nwc=1:sas=z3:tha=off:thi=overlap:uwa=all:urr=on_0");
      quick.push("lrs+1_32_aac=none:add=off:afr=on:afp=100000:afq=1.1:anc=none:bd=off:gsp=input_only:gs=on:lcm=predicate:nm=16:nwc=3:stl=30:sac=on:sp=occurrence:urr=on_0");
      quick.push("lrs-11_4:1_afp=4000:afq=2.0:anc=none:br=off:gs=on:lwlo=on:nm=64:nwc=3:stl=30:urr=on_0");
      quick.push("dis+2_3:1_av=off:cond=on:fsr=off:lcm=reverse:lma=on:nm=64:newcnf=on:nwc=1:sos=on:sp=reverse_arity:tha=off:thf=on:updr=off_0");
      quick.push("dis+11_40_afr=on:afp=40000:afq=1.2:amm=sco:anc=none:br=off:fsr=off:gs=on:nm=64:nwc=1:sas=z3:sos=all:sp=reverse_arity:thf=on:urr=on:updr=off_0");
      quick.push("dis+10_6_afr=on:afp=1000:afq=1.2:anc=none:bsr=on:fsr=off:gs=on:lcm=reverse:nm=64:newcnf=on:nwc=1.7:sas=z3:tha=off_0");
      quick.push("lrs+1010_10_av=off:bs=on:cond=on:fsr=off:fde=unused:gs=on:gsem=on:ile=on:nm=32:newcnf=on:nwc=1:stl=30:sp=occurrence:tha=off:thi=all:updr=off_0");
      quick.push("dis+10_3_afp=1000:afq=2.0:amm=off:anc=none:cond=on:gs=on:inw=on:irw=on:lma=on:nm=64:nwc=1:sas=z3:sos=on:sac=on:sp=reverse_arity:updr=off_0");
      quick.push("lrs-10_8_add=large:afr=on:afp=4000:afq=2.0:amm=off:anc=none:bsr=on:gsp=input_only:gs=on:lma=on:nm=64:nwc=1:stl=30:sos=all:sac=on:updr=off_0");
      quick.push("dis+1_3:1_acc=on:afp=100000:afq=1.1:amm=off:anc=none:bd=off:cond=on:fsr=off:gs=on:inw=on:lma=on:nm=32:nwc=1:urr=on_0");
      quick.push("dis+1010_4_add=off:afp=100000:afq=1.0:anc=none:fsr=off:gs=on:gsem=off:inw=on:irw=on:lma=on:nm=64:nwc=1:sas=z3:sos=on:sac=on:tha=off:thf=on_0");
      quick.push("dis+1010_24_aac=none:afr=on:anc=none:cond=on:fsr=off:gs=on:gsem=on:nm=6:nwc=1:sas=z3:sos=on:sp=reverse_arity:tha=off_0");
      quick.push("dis+11_5_add=off:afp=1000:afq=1.2:amm=sco:anc=none:cond=on:fsr=off:gs=on:lcm=reverse:lma=on:nm=64:nwc=1:sas=z3:sos=all:sac=on:sp=occurrence:tha=off:updr=off_0");
      quick.push("dis+1011_2:3_add=off:afr=on:afp=4000:afq=1.4:anc=none:bs=unit_only:fsr=off:gs=on:gsem=on:lwlo=on:nm=16:nwc=1.3:nicw=on:sas=z3:sac=on:tha=off_0");
      quick.push("dis+1002_4_add=off:afp=10000:afq=2.0:amm=off:anc=none:fsr=off:gsp=input_only:gs=on:gsem=on:irw=on:lwlo=on:nm=2:newcnf=on:nwc=1:sos=on:sac=on:sp=occurrence:tha=off:updr=off_0");
      quick.push("dis+10_5_add=large:afp=100000:afq=1.0:amm=sco:anc=none:cond=on:gs=on:gsem=off:lcm=reverse:nm=64:newcnf=on:nwc=2:sas=z3:sp=reverse_arity:tha=off:updr=off_0");
      quick.push("dis+11_3_afr=on:afp=4000:afq=1.4:amm=off:anc=none:bd=preordered:bce=on:fsr=off:fde=none:gs=on:gsem=on:irw=on:lma=on:nm=6:nwc=1:sd=10:ss=axioms:st=5.0:sac=on:sp=occurrence:tha=off:urr=ec_only_0");
      quick.push("dis+10_4_add=off:afp=10000:afq=1.2:amm=sco:anc=none:gs=on:inw=on:ile=on:lma=on:lwlo=on:newcnf=on:nwc=1:sp=reverse_arity:thf=on:thi=overlap:updr=off:uhcvi=on_0");
      quick.push("dis+10_50_add=large:afr=on:afp=4000:afq=1.0:amm=off:anc=none:cond=on:fsr=off:gs=on:lma=on:nm=64:nwc=1:sas=z3:sos=on:sp=occurrence:thf=on:updr=off_0");
      quick.push("dis+11_5_afr=on:afp=1000:afq=1.0:amm=off:anc=none:ile=on:lma=on:nm=0:newcnf=on:nwc=1:sos=all:sp=occurrence_0");
      quick.push("dis+11_1_add=off:afp=1000:afq=1.4:amm=off:anc=none:fsr=off:gs=on:nm=64:nwc=1.2:sas=z3:sac=on:sp=occurrence:thf=on:urr=on_0");
      quick.push("lrs+1_1024_av=off:bs=on:fde=none:inw=on:irw=on:nm=64:nwc=1.2:stl=60:sp=reverse_arity:tha=off:urr=on:updr=off:uhcvi=on_0");
      quick.push("dis+1011_2_afp=40000:afq=1.1:anc=none:nm=64:nwc=1:sp=reverse_arity:thf=on:urr=on_0");
      quick.push("dis-1_20_acc=on:afp=10000:afq=1.1:amm=sco:anc=none:bce=on:ccuc=first:cond=on:fde=unused:ile=on:newcnf=on:nwc=1:nicw=on:sp=reverse_arity:tha=off_0");
      quick.push("dis+1011_4_aac=none:acc=model:afr=on:afp=4000:afq=1.1:ccuc=small_ones:cond=on:inw=on:nm=64:nwc=2.5:nicw=on:sp=reverse_arity:tha=off:thf=on:urr=ec_only:updr=off_0");
      quick.push("dis+1003_20_av=off:cond=on:er=filter:fsr=off:fde=none:irw=on:lma=on:lwlo=on:nm=64:newcnf=on:nwc=1:uhcvi=on_0");
      quick.push("dis+1010_2:3_add=off:afr=on:afp=10000:afq=1.1:anc=none:fsr=off:gs=on:gsem=off:nwc=1:sas=z3:sos=all:sac=on:sp=reverse_arity:tha=off_0");
      quick.push("dis+11_3_aac=none:add=off:afp=40000:afq=1.2:amm=off:anc=none:fsr=off:gs=on:ile=on:nm=32:newcnf=on:nwc=1:sas=z3:sos=all:thi=overlap_0");
      ...
      quick.push("lrs+2_3:1_afr=on:afp=10000:afq=1.0:amm=sco:anc=none:bs=unit_only:lcm=reverse:lma=on:nm=64:nwc=1.7:sas=z3:stl=30:updr=off_0");
      quick.push("dis+11_3_afp=1000:afq=1.2:amm=off:anc=none:bs=unit_only:fsr=off:gs=on:ile=on:nm=0:newcnf=on:nwc=1.2:sas=z3:sp=occurrence:updr=off_0");
      quick.push("ott+1010_4:1_av=off:br=off:gs=on:lma=on:nm=64:nwc=1:sp=occurrence:urr=on_0");
      quick.push("dis+11_3_add=large:afr=on:afp=4000:afq=1.0:amm=off:anc=none:cond=on:ile=on:lma=on:nm=64:nwc=1:sas=z3:sac=on:tha=off:thf=on:updr=off_0");
      quick.push("dis-10_5_aac=none:add=off:afp=100000:afq=2.0:amm=sco:anc=all:bsr=on:cond=fast:fsr=off:fde=none:gs=on:gsaa=full_model:ile=on:lma=on:nm=64:newcnf=on:nwc=1:nicw=on:sac=on:sp=occurrence:tha=off:thi=overlap_0");
      quick.push("dis+1002_3_add=large:afr=on:afp=100000:afq=1.0:amm=off:anc=none:cond=on:inw=on:ile=on:irw=on:lma=on:lwlo=on:nm=32:newcnf=on:nwc=1:tha=off_0");
      quick.push("dis+1011_5_aac=none:add=large:afp=40000:afq=1.2:amm=off:anc=none:bd=off:fsr=off:gsp=input_only:inw=on:irw=on:lma=on:nm=64:nwc=1:sas=z3:sos=on:sp=occurrence:tha=off:updr=off_0");
      quick.push("lrs+1002_3_av=off:cond=on:fsr=off:gs=on:gsem=off:lwlo=on:nm=64:nwc=2.5:stl=30:sp=reverse_arity_0");
      quick.push("dis+11_3_add=large:afr=on:afp=4000:afq=1.2:amm=off:anc=none:gs=on:gsem=on:lwlo=on:nm=64:nwc=1:sas=z3:sac=on:sp=reverse_arity:tha=off:thf=on:updr=off_0");
      quick.push("dis+11_5_add=large:afp=10000:afq=1.1:amm=sco:anc=none:cond=on:fde=none:gs=on:gsaa=full_model:gsem=on:inw=on:ile=on:irw=on:nm=64:newcnf=on:nwc=1:tha=off:thi=all:updr=off_0");
      quick.push("lrs+11_1024_add=large:afr=on:afp=1000:afq=1.4:anc=none:br=off:cond=fast:ep=RSTC:inw=on:nm=32:nwc=1:stl=30:sac=on:sp=occurrence:tha=off:urr=on_0");
      quick.push("lrs+10_7_add=off:afr=on:afp=4000:afq=2.0:amm=off:anc=all:bsr=on:bce=on:cond=on:inw=on:irw=on:lma=on:nm=4:newcnf=on:nwc=1.1:nicw=on:stl=30:sos=theory:uhcvi=on_0");
      quick.push("dis+11_4_add=off:afp=4000:afq=1.2:anc=none:fsr=off:gs=on:gsem=off:inw=on:irw=on:nm=64:nwc=1:sas=z3:sos=all:sp=reverse_arity:tha=off:updr=off_0");
      quick.push("lrs+1_5:4_aac=none:add=off:afr=on:afp=4000:afq=1.2:amm=sco:anc=none:gsp=input_only:gs=on:irw=on:nm=64:newcnf=on:nwc=1.3:nicw=on:sas=z3:stl=30:sp=occurrence:tha=off_0");
      quick.push("dis+11_3_afp=100000:afq=2.0:amm=sco:anc=none:gs=on:gsem=off:inw=on:lma=on:nm=64:nwc=1:sas=z3:sd=10:ss=axioms:st=5.0:sp=occurrence:tha=off:updr=off_0");
      quick.push("dis+2_2_afp=10000:afq=1.4:amm=off:anc=none:cond=on:fsr=off:inw=on:irw=on:lwlo=on:nm=64:newcnf=on:nwc=1:sp=occurrence:tha=off_0");
      quick.push("dis+1_3_av=off:cond=on:gs=on:gsem=off:inw=on:lcm=reverse:lma=on:nm=64:nwc=1:sos=all:sp=reverse_arity:updr=off_0");
      quick.push("lrs+11_4:1_add=off:afr=on:afp=10000:afq=1.2:amm=sco:anc=none:bs=unit_only:bsr=on:bce=on:cond=fast:fde=unused:inw=on:ile=on:irw=on:newcnf=on:nwc=1:stl=30:sos=all:sac=on:updr=off:uhcvi=on_0");
      quick.push("dis+10_1_add=off:afp=40000:afq=1.1:amm=off:anc=none:cond=on:fsr=off:irw=on:nm=64:nwc=1:sas=z3:sac=on_0");
      quick.push("lrs+10_5:4_afr=on:afp=40000:afq=1.2:bd=off:gsp=input_only:gs=on:inw=on:nm=0:nwc=1:sas=z3:stl=30:sos=all:sp=reverse_arity:tha=off:thf=on:urr=on_0");
      quick.push("lrs+1003_2:3_afr=on:afp=100000:afq=1.1:amm=off:anc=none:bs=on:fde=unused:gs=on:inw=on:nm=0:newcnf=on:nwc=1:sas=z3:stl=30:sac=on:sp=occurrence:tha=off:updr=off:uhcvi=on_0");
      quick.push("dis+1011_5_add=off:afp=4000:afq=2.0:anc=none:fsr=off:inw=on:lwlo=on:nm=64:nwc=1:sos=all:sac=on:sp=reverse_arity_0");
      quick.push("dis-3_4_add=off:afp=40000:afq=1.1:amm=off:anc=none:bs=unit_only:cond=fast:fsr=off:gs=on:inw=on:lma=on:nm=64:nwc=1.5:nicw=on:sas=z3:sp=reverse_arity:tha=off:thf=on:uhcvi=on_0");
      quick.push("ott-2_28_add=large:afp=40000:afq=1.0:anc=none:bd=off:bsr=on:cond=on:fsr=off:gs=on:gsem=off:irw=on:nm=16:newcnf=on:nwc=1:nicw=on:sp=occurrence:thf=on_0");
      quick.push("lrs+1010_4:1_aac=none:add=off:afp=40000:afq=1.0:amm=sco:anc=none:bd=off:cond=on:gs=on:gsem=on:irw=on:nm=0:nwc=2.5:sas=z3:stl=30:sos=theory:sp=reverse_arity:updr=off_0");
      return;
