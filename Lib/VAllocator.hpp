 ...
 *
 * @since 13/12/2005 Redmond, made from the Shell VAllocator.
 * @since 10/01/2008 Manchester, reimplemented
 */


#ifndef __VAllocator__
#define __VAllocator__
...
#define BYPASSING_ALLOCATOR_(SEED) VAllocator::AllowBypassing __CAT(_tmpBypass_, SEED);
#define BYPASSING_ALLOCATOR BYPASSING_ALLOCATOR_(__LINE__)

#define START_CHECKING_FOR_BYPASSES(SEED) VAllocator::EnableBypassChecking __CAT(_tmpBypass_, SEED);
#define START_CHECKING_FOR_ALLOCATOR_BYPASSES START_CHECKING_FOR_BYPASSES(__LINE__)

#define STOP_CHECKING_FOR_BYPASSES(SEED) VAllocator::DisableBypassChecking __CAT(_tmpBypass_, SEED);
