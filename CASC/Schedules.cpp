...
// Sub-schedule for 1200Mi strat cap / 9600Mi overall limit
   quick.push("dis+10_1:1_cnfonf=lazy_gen:fe=off:i=3:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_au=on:c=on:fsr=off:piset=equals:i=52:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:s2a=on:s2agt=32:sgt=8:ss=axioms:i=449:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_add=large:cnfonf=lazy_pi_sigma_gen:fe=off:prag=on:i=3:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=1160:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cbe=off:cond=on:sp=occurrence:i=102:si=on:rtra=on_0");
   quick.push("dis+2_1:4_au=on:cbe=off:i=3:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_gen_be_off:fsr=off:spb=non_intro:i=2:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_av=off:bs=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fe=off:fsd=on:hud=5:prag=on:i=3:si=on:rtra=on_0");
   ...
   quick.push("dis-30_1:1_acc=on:bd=off:fsr=off:plsq=on:plsqr=32,1:i=41:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:8_bd=off:fd=off:hud=10:tnu=1:i=218:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_c=on:cnfonf=conj_eager:fd=off:fe=off:kws=frequency:spb=intro:i=3:si=on:rtra=on_0");
   ...
   quick.push("ott+1002_1:1_apa=on:au=on:bd=off:cnfonf=off:fd=off:sos=on:sp=weighted_frequency:i=6:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_gen:hud=7:plsq=on:plsqc=1:plsqr=32,1:prag=on:tnu=1:i=103:si=on:rtra=on_0");
   quick.push("ott+21_1:5_bsd=on:sp=weighted_frequency:i=2:si=on:rtra=on_0");
   quick.push("lrs+21_1:16_au=on:bd=off:piset=and:i=39:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:cnfonf=lazy_gen:ins=3:plsq=on:plsqc=1:plsqr=15142123,262144:sp=reverse_arity:i=1174:si=on:rtra=on_0");
   quick.push("lrs+1002_1:8_av=off:fd=off:hud=5:tnu=1:i=8:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1024_avsq=on:avsqc=4:avsqr=584411,1048576:bd=off:bet=on:br=off:chr=on:fsd=on:fsdmm=1:hud=10:nm=0:ntd=on:nwc=9.0:piset=or:plsq=on:plsqc=2:plsql=on:plsqr=852219,1048576:rawr=on:sp=const_frequency:spb=units:i=28:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bet=on:cnfonf=off:fd=off:hud=5:i=3:si=on:rtra=on_0");
   quick.push("lrs+10_1:64_abs=on:bsd=on:fe=off:hud=10:ntd=on:tgt=ground:tnu=1:i=15:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_cnfonf=lazy_pi_sigma_gen:fe=off:hud=15:plsq=on:plsqc=1:plsqr=32,1:sos=all:sp=const_min:i=3:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bsd=on:cbe=off:cnfonf=conj_eager:hi=on:i=149:si=on:rtra=on_0");
   quick.push("lrs+10_1:10_au=on:av=off:cbe=off:cnfonf=lazy_pi_sigma_gen:ntd=on:plsq=on:plsqc=1:plsqr=32,1:i=103:si=on:rtra=on_0");
   quick.push("lrs+1004_1:4_av=off:bsd=on:e2e=on:i=27:si=on:rtra=on_0");
   quick.push("lrs+10_1:5_av=off:bd=off:fd=off:kws=precedence:nwc=3.0:prag=on:rawr=on:sos=all:sp=reverse_frequency:i=654:si=on:rtra=on_0");
   quick.push("lrs+1004_1:1_chr=on:prag=on:i=8:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cbe=off:hud=5:nm=4:plsq=on:plsqr=7,1:prag=on:sp=const_max:tnu=1:i=102:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_aac=none:au=on:e2e=on:nm=2:nwc=10.0:sd=1:ss=axioms:st=3.0:i=1126:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cbe=off:fd=off:fs=off:fsr=off:nm=0:i=15:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bsd=on:cbe=off:cnfonf=conj_eager:fd=off:fsr=off:hi=on:i=19:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sd=1:sgt=8:ss=axioms:i=710:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cnfonf=lazy_not_gen:ntd=on:piset=and:ss=axioms:st=1.5:i=665:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=254:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=401:si=on:rtra=on_0");
   quick.push("dis+10_1:1_aac=none:cs=on:i=47:si=on:rtra=on_0");
   quick.push("lrs+10_1:1024_cnfonf=lazy_pi_sigma_gen:nwc=3.0:ss=axioms:st=1.2:i=322:si=on:rtra=on_0");
   ...
   quick.push("lrs+1003_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sp=const_max:i=2:si=on:rtra=on_0");
  ...
  // Improves by expected 2293.194267929746 probs costing 9588 Mi
  // Sub-schedule for 1200Mi strat cap / 9600Mi overall limit
   ...
   quick.push("lrs+1002_1:1_au=on:s2a=on:sgt=32:slsq=on:slsqc=1:slsql=off:ss=axioms:i=165:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_au=on:s2a=on:sd=7:ss=axioms:st=1.5:i=1076:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=472:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_au=on:fe=axiom:lwlo=on:nm=0:ntd=on:nwc=10.0:spb=non_intro:uhcvi=on:i=130:si=on:rtra=on_0");
   quick.push("lrs+21_1:16_au=on:cbe=off:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=7,4:i=484:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_au=on:cbe=off:nm=2:i=59:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_au=on:cnfonf=off:sd=1:sgt=16:ss=axioms:i=301:si=on:rtra=on_0");
   quick.push("dis-30_1:1_acc=on:bd=off:fsr=off:plsq=on:plsqr=32,1:i=368:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cnfonf=conj_eager:e2e=on:fe=axiom:fsr=off:ntd=on:nwc=10.0:s2a=on:sgt=5:sp=occurrence:ss=axioms:i=549:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sos=on:ss=axioms:i=203:si=on:rtra=on_0");
   quick.push("dis+1010_1:64_cnfonf=lazy_simp:fd=off:i=279:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:i=1111:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:12_bd=off:hud=1:ntd=on:piset=equals:prag=on:i=197:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1024_fde=none:kws=precedence:prag=on:sac=on:sos=on:i=409:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3548551,65536:s2a=on:i=879:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_au=on:avsq=on:avsqr=1,16:cond=on:sp=frequency:i=371:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_kws=precedence:prag=on:rawr=on:sos=all:sp=unary_first:i=102:si=on:rtra=on_0");
  // Improves by expected 72.73105914379634 probs costing 9563 Mi
  // Sub-schedule for 12000Mi strat cap / 96000Mi overall limit
   quick.push("lrs+10_1:64_hud=5:plsq=on:plsqr=2011171,524288:i=584:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cha=on:hud=10:nwc=10.0:prag=on:tnu=1:i=96:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=1678:si=on:rtra=on_0");
   quick.push("ott+1002_1:256_anc=all_dependent:awrs=converge:awrsf=60:bd=off:cbe=off:fe=off:nwc=10.0:s2a=on:s2agt=10:sac=on:i=914:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=1207:si=on:rtra=on_0");
   quick.push("dis+1002_1:14_au=on:kws=precedence:nwc=10.0:piset=and:i=623:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:4_chr=on:cnfonf=lazy_gen:hud=5:ins=1:ntd=on:prag=on:i=190:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:4_avsq=on:avsqr=16,1:bet=on:cbe=off:cnfonf=lazy_not_be_gen:hud=5:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=668:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_cbe=off:fde=unused:fe=axiom:prag=on:s2a=on:s2agt=30:sp=frequency:i=316:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_amm=off:cs=on:kws=precedence:nwc=10.0:piset=all:s2a=on:sac=on:sp=unary_frequency:spb=goal:ss=axioms:st=3.0:i=584:si=on:rtra=on_0");
   quick.push("dis+10_8:1_apa=on:cnfonf=off:e2e=on:plsq=on:plsqc=1:plsqr=32,1:ss=axioms:i=783:si=on:rtra=on_0");
   quick.push("dis+2_1:1_au=on:cbe=off:cnfonf=lazy_gen:plsq=on:plsqc=2:plsqr=32,1:i=445:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=1103:si=on:rtra=on_0");
   quick.push("ott+1004_1:24_anc=none:cbe=off:cnfonf=lazy_not_gen:fe=off:piset=not:prag=on:rp=on:i=2028:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:12_bd=off:hud=1:ntd=on:piset=equals:prag=on:i=1992:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:cnfonf=lazy_gen:ins=3:plsq=on:plsqc=1:plsqr=15142123,262144:sp=reverse_arity:i=3882:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cbe=off:chr=on:er=known:hud=4:i=146:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3548551,65536:s2a=on:i=3768:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:fd=preordered:fde=none:plsq=on:plsqr=32,1:i=368:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_bd=off:cnfonf=off:e2e=on:fd=off:fe=axiom:hud=5:prag=on:sos=on:i=746:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:bsd=on:bsr=unit_only:fd=off:hud=8:nm=16:prag=on:i=713:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=11942:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=model:avsq=on:ntd=on:i=1234:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:10_au=on:bd=off:cnfonf=lazy_pi_sigma_gen:sp=occurrence:i=420:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:4_amm=sco:awrs=converge:bd=off:nwc=5.0:sd=3:sgt=15:ss=axioms:st=2.0:i=2870:si=on:rtra=on_0");
   quick.push("ott+1010_1:1024_au=on:av=off:c=on:cnfonf=conj_eager:piset=equals:s2a=on:sp=occurrence:spb=units:ss=axioms:i=171:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=390:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_etr=on:plsq=on:plsqc=1:plsqr=32,1:i=1480:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_kws=precedence:prag=on:rawr=on:sos=all:sp=unary_first:i=423:si=on:rtra=on_0");
   quick.push("lrs+10_1:8_av=off:fe=off:hud=5:piset=or:prag=on:i=441:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=conj_eager:s2a=on:sd=4:sgt=16:ss=axioms:i=786:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:plsq=on:i=89:si=on:rtra=on_0");
   ...
   quick.push("lrs+21_1:1_hud=5:kws=inv_frequency:nm=16:nwc=2.0:prag=on:sos=on:ss=axioms:i=496:si=on:rtra=on_0");
  // Improves by expected 209.52517752282986 probs costing 95997 Mi
  // Sub-schedule for 12000Mi strat cap / 96000Mi overall limit
   quick.push("ott+1010_1:20_cnfonf=lazy_pi_sigma_gen:fe=axiom:plsq=on:plsqc=2:plsqr=32,1:sac=on:sos=all:i=2475:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_chr=on:cnfonf=lazy_not_be_gen:gs=on:hud=5:plsq=on:plsqc=1:plsqr=5,1:prag=on:rawr=on:i=419:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=137:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cs=on:sd=1:sgt=8:ss=axioms:i=1400:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=3883:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=3098:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=1976:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:fe=off:sd=2:slsq=on:slsqr=1,16:ss=axioms:st=5.0:i=3037:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=conj_eager:tgt=ground:i=393:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=8,1:sp=weighted_frequency:i=3520:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_anc=none:au=on:cnfonf=off:ins=3:sd=1:ss=axioms:i=4543:si=on:rtra=on_0");
   quick.push("lrs+1010_1:128_av=off:cbe=off:cnfonf=lazy_simp:fsr=off:ntd=on:ss=axioms:st=1.5:i=1483:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:8_bd=off:fd=off:hud=10:tnu=1:i=2012:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_3:1_anc=none:avsq=on:bd=off:fd=off:kws=frequency:i=1184:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1024_atotf=0.3:bd=off:cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3,1:i=1273:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=off:cs=on:sd=1:sgt=64:ss=axioms:i=4935:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_avsq=on:fe=off:fsr=off:hud=10:kws=arity:prag=on:i=3461:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:cs=on:sos=on:i=835:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cbe=off:chr=on:er=known:hud=4:i=492:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:fd=preordered:fde=none:plsq=on:plsqr=32,1:i=368:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:cnfonf=off:fe=off:hud=10:prag=on:s2a=on:ss=axioms:st=2.0:i=535:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_apa=on:atotf=0.3:au=on:c=on:cnfonf=off:fe=off:fsr=off:nm=6:piset=or:sac=on:sos=on:i=571:si=on:rtra=on_0");
   quick.push("ott+1002_1:4_c=on:chr=on:cnfonf=lazy_not_be_gen:hud=10:nm=10:piset=all_but_not_eq:rp=on:spb=goal:uhcvi=on:i=2655:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_16:1_apa=on:au=on:av=off:cnfonf=off:e2e=on:nm=0:nwc=10.0:i=2780:si=on:rtra=on_0");
   quick.push("lrs-1002_1:128_abs=on:bd=preordered:cbe=off:e2e=on:fde=unused:fe=off:tgt=full:i=739:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_avsq=on:avsqr=1,16:kws=inv_arity:nwc=5.0:sd=1:ss=axioms:i=754:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1024_kws=precedence:prag=on:rawr=on:sos=all:sp=unary_first:i=423:si=on:rtra=on_0");
   quick.push("dis+1002_1:20_c=on:e2e=on:er=filter:piset=pi_sigma:sac=on:i=1472:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=off:ntd=on:nwc=3.0:s2a=on:sp=const_frequency:i=871:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_anc=all_dependent:apa=on:au=on:bd=off:c=on:cnfonf=off:ntd=on:i=2616:si=on:rtra=on_0");
   quick.push("dis+10_1:4_atotf=0.1:avsq=on:bsr=unit_only:e2e=on:sd=1:sp=const_max:ss=axioms:i=1516:si=on:rtra=on_0");
  // Improves by expected 51.003424385479114 probs costing 95790 Mi
  // Sub-schedule for 120000Mi strat cap / 960000Mi overall limit
   ...
   quick.push("lrs+10_1:1_cnfonf=conj_eager:sd=1:ss=axioms:i=10980:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_chr=on:cnfonf=lazy_not_be_gen:gs=on:hud=5:plsq=on:plsqc=1:plsqr=5,1:prag=on:rawr=on:i=435:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_atotf=0.5:au=on:cbe=off:cnfonf=lazy_not_be_gen:fe=off:nwc=5.0:spb=units:i=4010:si=on:rtra=on_0");
   quick.push("ott+30_4:1_bsr=unit_only:cond=fast:plsq=on:sac=on:i=1901:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=3883:si=on:rtra=on_0");
   quick.push("lrs+1004_1:1_prag=on:i=8631:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_add=large:c=on:cbe=off:cnfonf=lazy_gen:fde=none:nm=30:piset=and:sac=on:uhcvi=on:i=578:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_e2e=on:fde=unused:fe=axiom:prag=on:sd=1:sos=on:ss=axioms:st=2.0:i=7527:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bd=preordered:cnfonf=off:e2e=on:kws=inv_precedence:lwlo=on:sd=2:ss=axioms:i=7311:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=15453:si=on:rtra=on_0");
   quick.push("lrs+21_1:16_au=on:cbe=off:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=7,4:i=3941:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:e2e=on:nm=2:sos=all:sp=const_min:spb=non_intro:i=3003:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=14596:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_anc=all_dependent:au=on:avsq=on:cnfonf=lazy_pi_sigma_gen:piset=not:i=27944:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=5474:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:fe=off:sd=2:slsq=on:slsqr=1,16:ss=axioms:st=5.0:i=82696:si=on:rtra=on_0");
   ...
   quick.push("dis-30_1:1_acc=on:bd=off:fsr=off:plsq=on:plsqr=32,1:i=406:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=43570:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cbe=off:fde=unused:fe=axiom:prag=on:s2a=on:s2agt=30:sp=frequency:i=14926:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=8,1:sp=weighted_frequency:i=12732:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_sd=1:sgt=32:ss=axioms:i=24918:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_amm=sco:cnfonf=lazy_pi_sigma_gen:fe=off:nm=60:piset=all_but_not_eq:plsq=on:plsqc=1:plsqr=2,1:rawr=on:sp=occurrence:ss=included:st=-1.0:i=9801:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:bsd=on:cha=on:cnfonf=lazy_not_gen_be_off:piset=small_set:s2a=on:s2at=7.0:i=24107:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cnfonf=lazy_simp:nwc=5.0:sgt=5:ss=axioms:st=1.5:i=22947:si=on:rtra=on_0");
   quick.push("dis+21_3:2_avsq=on:cbe=off:e2e=on:flr=on:ile=on:nwc=5.0:piset=or:rawr=on:sp=occurrence:i=3205:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_gen:nwc=7.0:sup=off:i=6325:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:cnfonf=conj_eager:nwc=10.0:sac=on:i=27021:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_bd=preordered:cnfonf=lazy_gen:fe=off:ins=1:ixr=off:ntd=on:piset=pi_sigma:plsq=on:plsqc=1:plsql=on:plsqr=9,8:s2a=on:i=12596:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:bd=off:bsd=on:ixr=off:sp=const_max:i=2812:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=10:s2a=on:i=35700:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cbe=off:chr=on:er=known:hud=4:i=492:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3548551,65536:s2a=on:i=5115:si=on:rtra=on_0");
   quick.push("lrs+1002_1:8_av=off:fd=off:hud=5:tnu=1:i=3772:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:bd=off:e2e=on:fde=none:fe=off:piset=or:prag=on:rawr=on:sos=on:updr=off:i=13593:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:cnfonf=off:fe=off:hud=10:prag=on:s2a=on:ss=axioms:st=2.0:i=535:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:avsq=on:avsqr=1,16:cbe=off:sac=on:i=6454:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fde=none:ins=2:nwc=10.0:piset=or:i=1936:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_cnfonf=off:e2e=on:nm=4:ntd=on:s2a=on:i=13735:si=on:rtra=on_0");
   ...
   quick.push("ott+1010_1:32_cnfonf=lazy_pi_sigma_gen:fe=off:hud=15:plsq=on:plsqc=1:plsqr=32,1:sos=all:sp=const_min:i=2864:si=on:rtra=on_0");
   quick.push("ott+1004_64217:1048576_cnfonf=lazy_simp:fe=off:fsr=off:piset=and:rawr=on:sp=frequency:spb=units:i=4710:si=on:rtra=on_0");
   quick.push("ott+10_1:1_au=on:av=off:sd=1:ss=axioms:st=2.0:i=5439:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_apa=on:atotf=0.3:au=on:c=on:cnfonf=off:fe=off:fsr=off:nm=6:piset=or:sac=on:sos=on:i=571:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_anc=all_dependent:au=on:bd=off:e2e=on:fde=unused:fs=off:fsr=off:s2a=on:sos=on:i=10369:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:avsq=on:bd=off:cbe=off:cnfonf=off:cs=on:hud=5:nm=0:plsq=on:plsqc=1:plsqr=7,1:ss=axioms:tgt=full:i=3661:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:4_amm=sco:awrs=converge:bd=off:nwc=5.0:sd=3:sgt=15:ss=axioms:st=2.0:i=38797:si=on:rtra=on_0");
   quick.push("dis+10_5:1_av=off:ntd=on:s2a=on:s2at=3.0:sgt=16:sp=unary_frequency:ss=axioms:i=7186:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:nm=0:i=15715:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=346:si=on:rtra=on_0");
   quick.push("lrs+21_1:3_apa=on:cnfonf=off:prag=on:sac=on:sos=on:ss=axioms:i=14611:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:sgt=100:sos=all:ss=axioms:i=31900:si=on:rtra=on_0");
   quick.push("lrs+10_1:16_aac=none:au=on:cnfonf=lazy_simp:kws=inv_frequency:nwc=10.0:s2a=on:i=14741:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=13193:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_cbe=off:cnfonf=lazy_not_gen_be_off:ins=1:i=4147:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:20_c=on:e2e=on:er=filter:piset=pi_sigma:sac=on:i=1472:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=off:ntd=on:nwc=3.0:s2a=on:sp=const_frequency:i=840:si=on:rtra=on_0");
   quick.push("dis+1002_1:1024_fe=off:hud=5:prag=on:i=5473:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:nwc=10.0:s2a=on:i=1426:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_au=on:fde=unused:i=11062:si=on:rtra=on_0");
  // Improves by expected 98.48336766889406 probs costing 955826 Mi
  // Sub-schedule for 120000Mi strat cap / 960000Mi overall limit
   quick.push("lrs+1010_1:1_ntd=on:s2a=on:ss=axioms:i=57572:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:av=off:fde=none:ins=2:i=91905:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=7002:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=17754:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=5474:si=on:rtra=on_0");
   quick.push("dis+1003_1:1_cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=2725:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=8,1:sp=weighted_frequency:i=12631:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_anc=none:au=on:cnfonf=off:ins=3:sd=1:ss=axioms:i=5974:si=on:rtra=on_0");
   quick.push("dis-1010_1:40_cnfonf=lazy_simp:fe=off:ntd=on:s2a=on:sac=on:ss=axioms:st=1.5:i=5166:si=on:rtra=on_0");
   quick.push("ott+10_1:4_cnfonf=lazy_gen:fde=unused:i=15783:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_amm=sco:cnfonf=lazy_pi_sigma_gen:fe=off:nm=60:piset=all_but_not_eq:plsq=on:plsqc=1:plsqr=2,1:rawr=on:sp=occurrence:ss=included:st=-1.0:i=9801:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:bsd=on:cha=on:cnfonf=lazy_not_gen_be_off:piset=small_set:s2a=on:s2at=7.0:i=24107:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cnfonf=lazy_simp:nwc=5.0:sgt=5:ss=axioms:st=1.5:i=22899:si=on:rtra=on_0");
   quick.push("dis+1002_8:1_cnfonf=off:fsr=off:ins=2:prag=on:sd=1:sos=on:sp=occurrence:ss=axioms:i=58969:si=on:rtra=on_0");
   quick.push("dis+21_3:2_avsq=on:cbe=off:e2e=on:flr=on:ile=on:nwc=5.0:piset=or:rawr=on:sp=occurrence:i=3205:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:fde=none:ixr=off:nwc=5.0:i=24372:si=on:rtra=on_0");
   quick.push("lrs+10_1:156_afp=4000:avsq=on:avsqr=4,1:fe=axiom:ss=axioms:tgt=ground:i=19001:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=8216:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_aac=none:bd=preordered:e2e=on:fde=none:fe=axiom:nm=16:nwc=10.0:prag=on:i=48065:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=8612:si=on:rtra=on_0");
   quick.push("lrs+1010_1:3_au=on:bd=off:c=on:cbe=off:fsr=off:ins=1:ss=axioms:st=1.5:i=15670:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:bd=off:e2e=on:fde=none:fe=off:piset=or:prag=on:rawr=on:sos=on:updr=off:i=9527:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=45798:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:cond=fast:e2e=on:fd=off:nm=16:nwc=5.0:prag=on:i=64127:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:64_abs=on:bsd=on:fe=off:hud=10:ntd=on:tgt=ground:tnu=1:i=59589:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_apa=on:atotf=0.3:au=on:c=on:cnfonf=off:fe=off:fsr=off:nm=6:piset=or:sac=on:sos=on:i=571:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:avsq=on:bd=off:cbe=off:cnfonf=off:cs=on:hud=5:nm=0:plsq=on:plsqc=1:plsqr=7,1:ss=axioms:tgt=full:i=3789:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=9265:si=on:rtra=on_0");
   quick.push("lrs+10_1:16_aac=none:au=on:cnfonf=lazy_simp:kws=inv_frequency:nwc=10.0:s2a=on:i=14741:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=7768:si=on:rtra=on_0");
   quick.push("ott+10_1:10_cnfonf=lazy_gen:fde=none:sp=const_frequency:i=15814:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_au=on:fde=unused:i=11062:si=on:rtra=on_0");
  // Improves by expected 15.939604502306919 probs costing 957648 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   ...
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=210001:si=on:rtra=on_0");
   quick.push("dis+10_1:1_amm=sco:au=on:cbe=off:nm=0:i=33863:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_ntd=on:s2a=on:ss=axioms:i=82733:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=82591:si=on:rtra=on_0");
   quick.push("ott+2_1:1024_bd=off:cbe=off:cnfonf=off:e2e=on:fde=none:kws=precedence:pe=on:prag=on:rawr=on:rp=on:ss=included:st=3.0:tgt=full:i=5410:si=on:rtra=on_0");
   quick.push("lrs+1004_1:1_au=on:cnfonf=lazy_simp:i=18738:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=9867:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=162850:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:fe=off:sd=2:slsq=on:slsqr=1,16:ss=axioms:st=5.0:i=80644:si=on:rtra=on_0");
   quick.push("dis+1004_1:16_cnfonf=lazy_gen:fe=off:fsr=off:hud=10:ntd=on:nwc=10.0:prag=on:tgt=ground:i=19233:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=46248:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_au=on:fde=none:ixr=off:nwc=5.0:i=24372:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:cnfonf=conj_eager:nwc=10.0:sac=on:i=22890:si=on:rtra=on_0");
   quick.push("lrs+10_1:156_afp=4000:avsq=on:avsqr=4,1:fe=axiom:ss=axioms:tgt=ground:i=19001:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_au=on:kws=precedence:i=39735:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=10:s2a=on:i=35001:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ss=axioms:i=61571:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:bd=off:e2e=on:fde=none:fe=off:piset=or:prag=on:rawr=on:sos=on:updr=off:i=89805:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=45798:si=on:rtra=on_0");
   ...
   quick.push("ott+1002_1:1_au=on:bd=off:cbe=off:cha=on:cnfonf=lazy_pi_sigma_gen:fd=off:fe=off:ntd=on:sp=const_frequency:i=62412:si=on:rtra=on_0");
   quick.push("lrs+10_1:64_abs=on:bsd=on:fe=off:hud=10:ntd=on:tgt=ground:tnu=1:i=102759:si=on:rtra=on_0");
   quick.push("ott+10_1:1_au=on:av=off:sd=1:ss=axioms:st=2.0:i=38843:si=on:rtra=on_0");
   quick.push("lrs-1002_8:1_bd=off:bsd=on:e2e=on:fd=off:prag=on:s2a=on:i=93333:si=on:rtra=on_0");
   quick.push("ott+1010_1:4_cnfonf=lazy_simp:fe=off:hud=5:piset=or:prag=on:i=112304:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_bet=on:bsr=on:cnfonf=lazy_pi_sigma_gen:er=filter:kws=inv_frequency:ntd=on:sd=3:ss=axioms:i=69001:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_amm=sco:awrs=converge:bd=off:nwc=5.0:sd=3:sgt=15:ss=axioms:st=2.0:i=38797:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:nm=0:i=12072:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=224352:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=lazy_pi_sigma_gen:fe=off:fsr=off:piset=or:sp=weighted_frequency:i=197488:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:sgt=100:sos=all:ss=axioms:i=30417:si=on:rtra=on_0");
   quick.push("lrs+10_1:16_aac=none:au=on:cnfonf=lazy_simp:kws=inv_frequency:nwc=10.0:s2a=on:i=56516:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=12939:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("dis+1002_1:1024_fe=off:hud=5:prag=on:i=20955:si=on:rtra=on_0");
   quick.push("dis+10_1:4_atotf=0.1:avsq=on:bsr=unit_only:e2e=on:sd=1:sp=const_max:ss=axioms:i=55093:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
  // Improves by expected 12.477386319606756 probs costing 3384970 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   quick.push("lrs+1010_1:1_anc=all_dependent:cnfonf=conj_eager:cond=fast:fe=axiom:nm=16:s2a=on:s2at=4.0:sd=2:ss=axioms:st=3.0:i=96745:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=82591:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=143300:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:fde=none:ixr=off:nwc=5.0:i=24372:si=on:rtra=on_0");
   quick.push("lrs+10_1:156_afp=4000:avsq=on:avsqr=4,1:fe=axiom:ss=axioms:tgt=ground:i=19001:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=102602:si=on:rtra=on_0");
   ...
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=224352:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=lazy_pi_sigma_gen:fe=off:fsr=off:piset=or:sp=weighted_frequency:i=192754:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
  // Improves by expected 3.3735699273399193 probs costing 1810162 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=82591:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=224352:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
  // Improves by expected 1.6920481140418748 probs costing 1320837 Mi
  // Overall score 2758.4199055140407 probs on average / budget 8640381 Mi
}