...
void Schedules::getSnakeSlh2Schedule(const Shell::Property& property, Schedule& quick) {
  // Sub-schedule for 10000Mi strat cap / 10000Mi overall limit
   quick.push("lrs+10_1:1_apa=on:cnfonf=off:e2e=on:ss=axioms:st=2.0:i=2:si=on:rtra=on_0");
   quick.push("lrs+1010_1:8_cbe=off:hfsq=on:ixr=off:prag=on:sac=on:sd=1:sgt=40:ss=axioms:i=373:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=1370:si=on:rtra=on_0");
   quick.push("ott+21_1:1_au=on:av=off:bd=off:fde=unused:hud=10:prag=on:sos=all:i=703:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=688:si=on:rtra=on_0");
   quick.push("dis+1010_1:2_cnfonf=lazy_pi_sigma_gen:ss=axioms:st=3.0:i=11:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_au=on:bd=off:e2e=on:sos=on:ss=axioms:i=754:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=635:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:fd=off:sos=all:i=847:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=1619:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=758:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sd=1:slsq=on:ss=axioms:i=510:si=on:rtra=on_0");
   quick.push("dis+10_8:1_au=on:e2e=on:sgt=8:ss=axioms:i=438:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=1158:si=on:rtra=on_0");
  // Improves by expected 2172.5762599517398 probs costing 9852 Mi
  // Sub-schedule for 20000Mi strat cap / 20000Mi overall limit
   quick.push("lrs+10_1:28_au=on:lma=on:sgt=8:sos=all:ss=axioms:i=1106:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:fde=none:kws=inv_precedence:nwc=5.0:plsq=on:plsqc=1:plsqr=6,1:prag=on:s2a=on:i=1981:si=on:rtra=on_0");
   quick.push("dis+2_1:1_apa=on:au=on:bd=off:c=on:cnfonf=off:fsr=off:sd=1:sos=on:ss=axioms:i=571:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=1900:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fsr=off:prag=on:sos=on:ss=axioms:i=1500:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_afp=1010:fde=unused:fe=off:hud=10:kws=arity_squared:prag=on:sos=on:sp=reverse_arity:i=1082:si=on:rtra=on_0");
   quick.push("lrs+10_3:1_au=on:fsr=off:sd=1:sgt=100:ss=axioms:i=1240:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=1543:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=1:sgt=30:sp=reverse_arity:ss=axioms:tgt=full:i=496:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_atotf=0.2:au=on:bd=off:cnfonf=off:e2e=on:sos=all:i=2614:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:fde=none:s2a=on:i=818:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sd=1:slsq=on:ss=axioms:i=1097:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fde=unused:fe=off:fs=off:fsr=off:hud=10:sos=on:i=577:si=on:rtra=on_0");
   quick.push("lrs-1002_1:1_au=on:ins=2:sos=on:ss=axioms:st=1.5:i=752:si=on:rtra=on_0");
   quick.push("ott+10_1:1_atotf=0.1:au=on:cnfonf=off:e2e=on:fsr=off:ins=4:kws=precedence:s2a=on:i=2170:si=on:rtra=on_0");
   quick.push("dis+10_2:3_fd=off:fde=none:hfsq=on:hfsqc=2:lcm=reverse:prag=on:sac=on:sos=on:i=457:si=on:rtra=on_0");
  // Improves by expected 217.37812352117618 probs costing 19888 Mi
  // Sub-schedule for 30000Mi strat cap / 30000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=1128:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=1160:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=5325:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:e2e=on:fde=none:sos=on:i=636:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=4472:si=on:rtra=on_0");
   quick.push("dis+10_1:1_hud=15:kws=precedence:nm=30:sos=on:sp=unary_frequency:ss=axioms:i=474:si=on:rtra=on_0");
   quick.push("lrs+1010_1:5_au=on:bd=off:cnfonf=off:nm=10:sos=on:i=605:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_erd=off:ins=3:sd=1:sos=on:ss=axioms:i=263:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_atotf=0.1:bd=off:cnfonf=off:fd=off:sos=on:i=678:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:nm=0:sac=on:sd=1:sp=unary_frequency:ss=axioms:st=3.0:i=925:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sd=1:ss=axioms:st=3.0:i=799:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fde=none:ss=axioms:i=278:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=2610:si=on:rtra=on_0");
   quick.push("dis+2_2:3_e2e=on:fsr=off:prag=on:sos=on:ss=axioms:i=2199:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_er=filter:fd=off:flr=on:nwc=10.0:ss=axioms:st=3.0:i=359:si=on:rtra=on_0");
   quick.push("dis+1002_1:5_au=on:bsr=on:fde=unused:piset=not:sos=on:i=1503:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=1390:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_hud=10:ins=2:sos=all:ss=axioms:tnu=1:i=229:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=3739:si=on:rtra=on_0");
  // Improves by expected 134.87186242860707 probs costing 29966 Mi
  // Sub-schedule for 60000Mi strat cap / 60000Mi overall limit
   ...
   quick.push("lrs+10_1:8_au=on:sos=on:ss=axioms:i=1651:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_bd=off:e2e=on:ins=1:sac=on:sd=1:sos=on:ss=axioms:st=2.0:i=585:si=on:rtra=on_0");
   quick.push("ott+21_1:1_au=on:av=off:bd=off:fde=unused:hud=10:prag=on:sos=all:i=1813:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_pi_sigma_gen:rawr=on:i=1168:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_au=on:e2e=on:hud=10:sd=4:sos=on:ss=axioms:st=2.0:i=830:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_fd=off:prag=on:sac=on:sos=on:i=1268:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_au=on:bd=off:e2e=on:sos=on:ss=axioms:i=2277:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_aac=none:cbe=off:cnfonf=lazy_pi_sigma_gen:sos=all:sp=const_max:uhcvi=on:i=753:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_add=off:apa=on:au=on:bsr=unit_only:cnfonf=off:e2e=on:s2a=on:s2at=2.0:ss=axioms:st=2.0:i=485:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:fd=off:sos=all:i=1468:si=on:rtra=on_0");
   quick.push("dis+10_1:12_cnfonf=conj_eager:ss=axioms:st=3.0:tgt=full:i=620:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_fde=unused:hud=10:sac=on:sos=on:tnu=1:i=552:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=10950:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_au=on:av=off:e2e=on:fd=off:rawr=on:s2a=on:s2at=3.0:sos=on:sp=occurrence:i=1713:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_cnfonf=off:fde=unused:prag=on:sos=all:i=2076:si=on:rtra=on_0");
   quick.push("lrs-1002_1:1_au=on:ins=2:sos=on:ss=axioms:st=1.5:i=3275:si=on:rtra=on_0");
   quick.push("lrs+21_1:128_acc=model:au=on:cbe=off:e2e=on:pe=on:piset=small_set:sos=on:sp=occurrence:ss=axioms:i=532:si=on:rtra=on_0");
   quick.push("dis+10_8:1_au=on:e2e=on:sgt=8:ss=axioms:i=9567:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fd=off:fde=unused:nm=2:sos=all:i=703:si=on:rtra=on_0");
   quick.push("lrs+1010_3:1_au=on:bd=off:fde=none:lecc=1.5:nwc=10.0:i=10773:si=on:rtra=on_0");
   quick.push("dis+10_5:1_cnfonf=off:slsq=on:sp=const_max:i=534:si=on:rtra=on_0");
  // Improves by expected 118.98358120947206 probs costing 59777 Mi
  // Sub-schedule for 120000Mi strat cap / 120000Mi overall limit
   quick.push("dis+10_1:1_acc=on:fde=none:kws=inv_precedence:nwc=5.0:plsq=on:plsqc=1:plsqr=6,1:prag=on:s2a=on:i=6146:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:fde=unused:prag=on:sos=all:i=2085:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=3976:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=1682:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=9314:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fsr=off:prag=on:sos=on:ss=axioms:i=5900:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_apa=on:bsr=on:cnfonf=off:hud=10:ins=2:kws=inv_frequency:sd=2:slsq=on:slsqc=5:sos=on:ss=axioms:i=240:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=4293:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_av=off:fe=off:hud=10:ins=5:nwc=3.0:prag=on:rawr=on:i=922:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_acc=on:au=on:bd=off:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=8134:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fsr=off:nm=32:sd=1:sgt=16:sos=on:ss=axioms:i=1302:si=on:rtra=on_0");
   quick.push("lrs+10_2:1_fde=none:prag=on:sd=2:sgt=8:ss=axioms:tgt=ground:i=5005:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=1:sgt=30:sp=reverse_arity:ss=axioms:tgt=full:i=633:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:nm=0:sac=on:sd=1:sp=unary_frequency:ss=axioms:st=3.0:i=4965:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_e2e=on:sd=1:ss=axioms:st=3.0:i=3345:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:fd=off:sos=all:i=5097:si=on:rtra=on_0");
   quick.push("ott+1002_23:4_fsd=on:ins=3:nwc=10.0:prag=on:i=1592:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=2697:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_atotf=0.2:au=on:bd=off:cnfonf=off:e2e=on:sos=all:i=3354:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=8611:si=on:rtra=on_0");
   quick.push("dis+2_2:3_e2e=on:fsr=off:prag=on:sos=on:ss=axioms:i=3247:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_er=filter:fd=off:flr=on:nwc=10.0:ss=axioms:st=3.0:i=359:si=on:rtra=on_0");
   quick.push("ott+1010_41:4_bd=off:cnfonf=off:hud=14:ntd=on:s2a=on:i=1584:si=on:rtra=on_0");
   quick.push("dis+10_1:2_au=on:cnfonf=lazy_pi_sigma_gen:ss=axioms:st=1.2:tgt=ground:i=937:si=on:rtra=on_0");
   quick.push("dis+2_5:1_au=on:e2e=on:fsr=off:sos=on:sp=unary_first:ss=axioms:i=4885:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fde=unused:fe=off:fs=off:fsr=off:hud=10:sos=on:i=577:si=on:rtra=on_0");
   quick.push("dis+10_4:1_cnfonf=lazy_simp:gs=on:hud=22:sd=1:ss=axioms:tnu=1:i=2352:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=1630:si=on:rtra=on_0");
   quick.push("dis+1010_3:1_au=on:bd=off:cnfonf=lazy_gen:fde=none:sd=1:ss=axioms:i=2759:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=333:si=on:rtra=on_0");
   quick.push("lrs+21_1:128_acc=model:au=on:cbe=off:e2e=on:pe=on:piset=small_set:sos=on:sp=occurrence:ss=axioms:i=1104:si=on:rtra=on_0");
   quick.push("dis+2_1:8_atotf=0.1:au=on:bd=off:c=on:sos=on:i=321:si=on:rtra=on_0");
   quick.push("lrs+10_16:1_au=on:bd=off:sac=on:sos=all:i=544:si=on:rtra=on_0");
  // Improves by expected 99.95339010887623 probs costing 119995 Mi
  // Sub-schedule for 240000Mi strat cap / 240000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=7595:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_hfsq=on:nm=2:nwc=10.0:sos=on:sp=occurrence:i=602:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cs=on:e2e=on:hfsq=on:i=645:si=on:rtra=on_0");
   quick.push("dis+1010_8:1_cnfonf=lazy_gen:fe=off:fsr=off:hud=15:nwc=10.0:s2a=on:i=4270:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=964:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_cbe=off:hfsq=on:hfsqc=5:hfsql=off:hud=25:ntd=on:prag=on:sos=on:i=2257:si=on:rtra=on_0");
   quick.push("dis+10_4:1_av=off:cnfonf=off:hud=5:nwc=10.0:s2a=on:s2agt=16:i=2558:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_bd=off:bsd=on:fde=unused:hud=5:nwc=10.0:sac=on:sp=weighted_frequency:ss=axioms:i=519:si=on:rtra=on_0");
   quick.push("lrs+31_1:1_au=on:bd=off:fde=none:ins=3:sos=on:sp=unary_first:i=7140:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=10942:si=on:rtra=on_0");
   ...
   quick.push("ott+21_1:1_au=on:av=off:bd=off:fde=unused:hud=10:prag=on:sos=all:i=9989:si=on:rtra=on_0");
   quick.push("dis+1010_13:15_au=on:bd=off:bet=on:cnfonf=off:fe=axiom:hud=10:nm=0:ntd=on:nwc=5.0:sp=const_max:updr=off:i=1577:si=on:rtra=on_0");
   quick.push("lrs+1010_1:16_av=off:awrs=converge:cnfonf=off:nwc=4.0:plsq=on:plsqc=1:plsql=on:plsqr=3090729,1048576:ss=axioms:tgt=ground:i=51846:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_au=on:e2e=on:hud=10:sd=4:sos=on:ss=axioms:st=2.0:i=3081:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_c=on:cnfonf=off:fd=off:fe=axiom:prag=on:sos=on:i=2002:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_erd=off:ins=3:sd=1:sos=on:ss=axioms:i=4744:si=on:rtra=on_0");
   quick.push("dis+1010_16:1_abs=on:acc=model:avsq=on:prag=on:sp=const_frequency:i=22147:si=on:rtra=on_0");
   quick.push("lrs+10_3:1_au=on:fsr=off:sd=1:sgt=100:ss=axioms:i=11167:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fsr=off:nm=32:sd=1:sgt=16:sos=on:ss=axioms:i=3174:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_atotf=0.1:bd=off:cnfonf=off:fd=off:sos=on:i=674:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_aac=none:ins=2:ntd=on:prag=on:sos=on:i=2446:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=6983:si=on:rtra=on_0");
   quick.push("lrs+10_1:4_atotf=0.4:au=on:cnfonf=off:sos=all:i=5459:si=on:rtra=on_0");
   quick.push("lrs+1003_1:1_cbe=off:cnfonf=lazy_not_be_gen:ins=1:sac=on:sup=off:i=1816:si=on:rtra=on_0");
   quick.push("ott+10_2:1_cnfonf=lazy_simp:fde=unused:fsr=off:s2a=on:sd=2:ss=axioms:i=10811:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:5_au=on:bsr=on:fde=unused:piset=not:sos=on:i=1741:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_cnfonf=lazy_pi_sigma_gen:fe=axiom:hud=5:prag=on:slsq=on:slsqr=4,1:i=12066:si=on:rtra=on_0");
   quick.push("ott+2_4:1_au=on:cnfonf=lazy_pi_sigma_gen:hud=16:ins=3:nm=20:plsq=on:plsqc=1:plsqr=13,2:rawr=on:sp=reverse_arity:ss=axioms:st=3.0:i=2136:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:fsr=off:ins=1:sd=10:ss=axioms:uhcvi=on:i=3580:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_not_be_gen:hud=5:s2a=on:sos=on:i=2813:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=333:si=on:rtra=on_0");
   quick.push("ott+10_1:1_atotf=0.1:au=on:cnfonf=off:e2e=on:fsr=off:ins=4:kws=precedence:s2a=on:i=7039:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen:nwc=13.0:prag=on:s2a=on:sp=weighted_frequency:i=1957:si=on:rtra=on_0");
   quick.push("lrs+21_1:128_acc=model:au=on:cbe=off:e2e=on:pe=on:piset=small_set:sos=on:sp=occurrence:ss=axioms:i=1104:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=18559:si=on:rtra=on_0");
   quick.push("dis+2_1:8_atotf=0.1:au=on:bd=off:c=on:sos=on:i=321:si=on:rtra=on_0");
  // Improves by expected 78.79002860798212 probs costing 239970 Mi
  // Sub-schedule for 480000Mi strat cap / 480000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=19975:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:fde=none:kws=inv_precedence:nwc=5.0:plsq=on:plsqc=1:plsqr=6,1:prag=on:s2a=on:i=34023:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_hfsq=on:nm=2:nwc=10.0:sos=on:sp=occurrence:i=602:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cs=on:e2e=on:hfsq=on:i=638:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=6264:si=on:rtra=on_0");
   quick.push("dis+10_1:3_au=on:cnfonf=lazy_pi_sigma_gen:i=1623:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=3976:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=3605:si=on:rtra=on_0");
   quick.push("dis+2_1:1_apa=on:au=on:bd=off:c=on:cnfonf=off:fsr=off:sd=1:sos=on:ss=axioms:i=4381:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fd=off:fde=unused:prag=on:sos=all:i=3445:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_hud=25:ins=3:nm=32:prag=on:ss=axioms:uhcvi=on:i=14326:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_pi_sigma_gen:plsq=on:sos=on:i=7877:si=on:rtra=on_0");
   quick.push("lrs+21_1:50_nm=30:sp=const_min:tgt=ground:i=4199:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=22230:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:prag=on:sos=on:i=4861:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_bd=off:bsd=on:fde=unused:hud=5:nwc=10.0:sac=on:sp=weighted_frequency:ss=axioms:i=9418:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=10942:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_afp=1010:fde=unused:fe=off:hud=10:kws=arity_squared:prag=on:sos=on:sp=reverse_arity:i=1666:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:e2e=on:fde=none:sos=on:i=4035:si=on:rtra=on_0");
   quick.push("ott+1010_1:64_au=on:cbe=off:cnfonf=off:nwc=10.0:s2a=on:ss=axioms:i=6296:si=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:bsr=on:cnfonf=lazy_gen:ntd=on:nwc=10.0:sims=off:sp=const_frequency:i=1981:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=16686:si=on:rtra=on_0");
   quick.push("dis+10_1:1_hud=15:kws=precedence:nm=30:sos=on:sp=unary_frequency:ss=axioms:i=1735:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_c=on:cnfonf=off:fd=off:fe=axiom:prag=on:sos=on:i=1991:si=on:rtra=on_0");
   quick.push("lrs+10_4:1_au=on:cnfonf=lazy_pi_sigma_gen:nwc=10.0:i=5123:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_acc=on:au=on:bd=off:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=32405:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fd=off:fe=off:sos=on:i=986:si=on:rtra=on_0");
   quick.push("dis+2_1:1_au=on:nwc=10.0:piset=not:plsq=on:plsqc=1:plsqr=32,1:rawr=on:sac=on:sp=unary_first:i=27878:si=on:rtra=on_0");
   quick.push("ott+10_1:1_cha=on:hud=10:ins=3:sac=on:sos=on:i=3178:si=on:rtra=on_0");
   quick.push("ott+2_1:1_au=on:cnfonf=off:sos=all:ss=axioms:st=3.0:i=19261:si=on:rtra=on_0");
   quick.push("lrs+10_2:1_fde=none:prag=on:sd=2:sgt=8:ss=axioms:tgt=ground:i=14667:si=on:rtra=on_0");
   quick.push("lrs+1003_1:1_cbe=off:cnfonf=lazy_not_be_gen:ins=1:sac=on:sup=off:i=11208:si=on:rtra=on_0");
   quick.push("dis+10_16:1_au=on:bet=on:cbe=off:cnfonf=off:hfsq=on:ins=3:ntd=on:plsq=on:plsqc=1:plsqr=32,1:i=7803:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_add=off:apa=on:au=on:bsr=unit_only:cnfonf=off:e2e=on:s2a=on:s2at=2.0:ss=axioms:st=2.0:i=3973:si=on:rtra=on_0");
   quick.push("ott+1002_23:4_fsd=on:ins=3:nwc=10.0:prag=on:i=1577:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_atotf=0.2:au=on:bd=off:cnfonf=off:e2e=on:sos=all:i=5575:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=12001:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=19878:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_fe=off:prag=on:sos=all:ss=axioms:i=1398:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:bd=off:fde=none:plsq=on:plsqc=2:plsqr=10,1:s2a=on:s2agt=16:i=33811:si=on:rtra=on_0");
   quick.push("dis+2_5:1_au=on:e2e=on:fsr=off:sos=on:sp=unary_first:ss=axioms:i=4885:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fde=unused:fe=off:fs=off:fsr=off:hud=10:sos=on:i=536:si=on:rtra=on_0");
   quick.push("dis+2_1:1_bd=off:prag=on:sos=all:sp=frequency:ss=axioms:uhcvi=on:i=8613:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bet=on:fde=none:nm=20:sos=on:i=16012:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_cnfonf=lazy_pi_sigma_gen:ixr=off:plsq=on:plsqr=32,1:sos=on:i=4801:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=4504:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cbe=off:sos=theory:i=7132:si=on:rtra=on_0");
   quick.push("lrs+1_1:50_bsd=on:hfsq=on:hud=5:piset=or:sac=on:sos=all:sp=reverse_arity:i=3251:si=on:rtra=on_0");
   quick.push("ott+10_5:1_cnfonf=off:kws=arity:nm=2:s2a=on:s2at=5.0:ss=axioms:i=13492:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=333:si=on:rtra=on_0");
   quick.push("dis+10_2:3_fd=off:fde=none:hfsq=on:hfsqc=2:lcm=reverse:prag=on:sac=on:sos=on:i=1013:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen:nwc=13.0:prag=on:s2a=on:sp=weighted_frequency:i=1957:si=on:rtra=on_0");
   quick.push("lrs+21_1:128_acc=model:au=on:cbe=off:e2e=on:pe=on:piset=small_set:sos=on:sp=occurrence:ss=axioms:i=1083:si=on:rtra=on_0");
  // Improves by expected 66.32785975645233 probs costing 479855 Mi
  // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=6264:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:fde=unused:prag=on:sos=all:i=3668:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=43102:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=9797:si=on:rtra=on_0");
   quick.push("dis+2_1:1_apa=on:au=on:bd=off:c=on:cnfonf=off:fsr=off:sd=1:sos=on:ss=axioms:i=4124:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fd=off:fde=unused:prag=on:sos=all:i=7279:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_bd=off:bsd=on:fde=unused:hud=5:nwc=10.0:sac=on:sp=weighted_frequency:ss=axioms:i=9406:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=53898:si=on:rtra=on_0");
   quick.push("dis+1010_4:1_amm=off:bs=on:c=on:cbe=off:nm=64:nwc=6.0:s2a=on:s2at=5.0:sac=on:slsq=on:slsqr=1,8:i=4357:si=on:rtra=on_0");
   quick.push("ott+1010_1:64_au=on:cbe=off:cnfonf=off:nwc=10.0:s2a=on:ss=axioms:i=4603:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:bsd=on:cnfonf=lazy_not_gen:er=tagged:fd=off:s2a=on:sos=all:i=4701:si=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:bsr=on:cnfonf=lazy_gen:ntd=on:nwc=10.0:sims=off:sp=const_frequency:i=2932:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=52327:si=on:rtra=on_0");
   quick.push("lrs+1010_1:16_av=off:awrs=converge:cnfonf=off:nwc=4.0:plsq=on:plsqc=1:plsql=on:plsqr=3090729,1048576:ss=axioms:tgt=ground:i=95903:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_c=on:cnfonf=off:fd=off:fe=axiom:prag=on:sos=on:i=1991:si=on:rtra=on_0");
   quick.push("lrs+10_4:1_au=on:cnfonf=lazy_pi_sigma_gen:nwc=10.0:i=14413:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_acc=on:au=on:bd=off:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=34887:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_atotf=0.1:bd=off:cnfonf=off:fd=off:sos=on:i=4206:si=on:rtra=on_0");
   quick.push("ott+10_1:1_cha=on:hud=10:ins=3:sac=on:sos=on:i=3132:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_atotf=0.0319537:au=on:sos=on:sp=unary_frequency:i=5755:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=6900:si=on:rtra=on_0");
   quick.push("lrs+10_1:4_atotf=0.4:au=on:cnfonf=off:sos=all:i=5022:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:bd=off:ntd=on:slsq=on:i=5558:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bd=off:cnfonf=lazy_simp:fde=none:sp=occurrence:i=19539:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:sos=on:sp=unary_first:i=75579:si=on:rtra=on_0");
   quick.push("lrs+10_5:4_au=on:bet=on:bs=unit_only:bsd=on:cnfonf=off:ins=2:kws=precedence:plsq=on:plsqc=1:plsqr=89,8:rawr=on:sac=on:i=76163:si=on:rtra=on_0");
   quick.push("ott+10_2:1_cnfonf=lazy_simp:fde=unused:fsr=off:s2a=on:sd=2:ss=axioms:i=7067:si=on:rtra=on_0");
   quick.push("ott+1002_14:1_c=on:cnfonf=lazy_gen:er=tagged:fe=axiom:s2a=on:ss=included:i=9328:si=on:rtra=on_0");
   quick.push("dis+2_1:1_au=on:cha=on:cnfonf=off:cond=on:sos=on:sp=const_frequency:i=3878:si=on:rtra=on_0");
   quick.push("dis+21_1:1_fd=off:kws=inv_arity:prag=on:sac=on:sos=all:i=4206:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=2695:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_atotf=0.2:au=on:bd=off:cnfonf=off:e2e=on:sos=all:i=5575:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=10362:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=5278:si=on:rtra=on_0");
   quick.push("dis+2_2:3_e2e=on:fsr=off:prag=on:sos=on:ss=axioms:i=3247:si=on:rtra=on_0");
   quick.push("dis+1002_1:4_cnfonf=off:e2e=on:fde=unused:fsr=off:sac=on:sfv=off:tgt=full:i=13657:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fe=off:nwc=10.0:s2a=on:s2agt=8:sd=1:ss=axioms:st=5.0:i=8991:si=on:rtra=on_0");
   quick.push("dis+1002_1:5_au=on:bsr=on:fde=unused:piset=not:sos=on:i=40255:si=on:rtra=on_0");
   quick.push("dis+1010_1:16_amm=sco:cnfonf=off:sd=1:ss=axioms:st=2.0:tgt=full:tnu=5:i=50001:si=on:rtra=on_0");
   quick.push("dis+2_1:1_bd=off:prag=on:sos=all:sp=frequency:ss=axioms:uhcvi=on:i=8613:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_cnfonf=lazy_pi_sigma_gen:fe=axiom:hud=5:prag=on:slsq=on:slsqr=4,1:i=17844:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bet=on:fde=none:nm=20:sos=on:i=81936:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:fsr=off:ins=1:sd=10:ss=axioms:uhcvi=on:i=4637:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=4479:si=on:rtra=on_0");
   quick.push("lrs+1_1:50_bsd=on:hfsq=on:hud=5:piset=or:sac=on:sos=all:sp=reverse_arity:i=3219:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:av=off:e2e=on:fd=off:rawr=on:s2a=on:s2at=3.0:sos=on:sp=occurrence:i=9451:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_hud=10:ins=2:sos=all:ss=axioms:tnu=1:i=3948:si=on:rtra=on_0");
   quick.push("dis+10_2:3_fd=off:fde=none:hfsq=on:hfsqc=2:lcm=reverse:prag=on:sac=on:sos=on:i=2555:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen:nwc=13.0:prag=on:s2a=on:sp=weighted_frequency:i=16919:si=on:rtra=on_0");
   quick.push("lrs+21_1:128_acc=model:au=on:cbe=off:e2e=on:pe=on:piset=small_set:sos=on:sp=occurrence:ss=axioms:i=1083:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_e2e=on:prag=on:rawr=on:sos=on:sp=weighted_frequency:i=25547:si=on:rtra=on_0");
   quick.push("dis+10_8:1_au=on:e2e=on:sgt=8:ss=axioms:i=9855:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=21726:si=on:rtra=on_0");
   quick.push("lrs+10_16:1_au=on:bd=off:sac=on:sos=all:i=27149:si=on:rtra=on_0");
  // Improves by expected 49.982594209671426 probs costing 958953 Mi
