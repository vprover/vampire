...
void Schedules::getCasc2024Schedule(const Property& property, Schedule& quick)
{
  ...
  if (property.hasNumerals() || property.hasInterpretedOperations()) {
    ...
    getAlascaAwareAriSchedule(quick);
...
void Schedules::getAlascaAwareAriSchedule(Schedule& quick) {
...
void Schedules::get2025EPRSchedule(Schedule& quick, Schedule& champions)
{
...
void Schedules::getCasc2025Schedule(const Property& property, Schedule& quick, Schedule& champions)
{
  ...
  if (property.hasNumerals() || property.hasInterpretedOperations()) {
    ...
    get2025EPRSchedule(quick,champions);
...
void Schedules::getCasc2026Schedule(const Property& property, Schedule& quick, Schedule& champions)
{
  Property::Category cat = property.category();
  ...
  if (property.hasNumerals() || property.hasInterpretedOperations()) {
    ...
    champions.push("lrs+1002_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=ground:npcc=on:drc=off:sp=reverse_frequency:spb=goal:acc=on:s2agt=16:kmz=on:sac=on:i=138329:kws=inv_arity_squared:fgj=on:bd=preordered_0");
    champions.push("lrs+11_1:1_ncem=casc2026/models/loop6.pt:sil=128000:npcc=on:spb=units:s2agt=64:updr=off:i=130792:nm=16:lma=off:aac=none:urr=ec_only:ss=included:sd=20:sgt=10:bce=on_0");
    champions.push("lrs+10_1:1_ncem=casc2026/models/loop5.pt:sil=128000:tgt=ground:npcc=on:spb=goal_then_units:i=130716:gtgl=4:add=on:bd=all:gtg=exists_sym:urr=ec_only:doe=on_0");
    // 971 + 41 + 13 = 1025 pre-covered

    quick.push("ott-1010_1:1_to=lpo:sil=8000:sp=reverse_frequency:spb=goal_then_units:fd=preordered:i=136:bd=preordered:ins=2:av=off:sfv=off:fdtod=off_0");
    quick.push("dis+10_1:14_to=lpo:sil=8000:tgt=full:drc=off:sp=const_frequency:sos=all:i=181:gtgl=5:fsr=off:gtg=exists_all:bs=unit_only_0");
    quick.push("lrs+10_1:3_to=lpo:sil=64000:drc=off:fde=unused:sp=reverse_frequency:fd=preordered:nwc=1.0:avsq=on:i=257:avsqr=16,3:fsr=off:acc=on:bd=preordered:bsr=on_0");
    quick.push("dis-1010_1:7_sil=8000:fde=unused:flr=on:i=1187:sd=4:ss=axioms:sgt=32:av=off_0");
    quick.push("lrs-1011_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:prc=on:i=2051:fgj=on:bd=all:gtg=exists_top:lcm=predicate:gtgl=2:flr=on:fde=unused:bsr=on_0");
    quick.push("lrs-1002_1:1_ncem=casc2026/models/all5champsBiggishL14.pt:sil=16000:npcc=on:i=4948:ss=axioms:sgt=16_0");
    quick.push("lrs+10_5:1_sil=8000:sos=all:br=off:i=215:ep=RSTC:flr=on:urr=on_0");
    quick.push("lrs+11_1:1_sil=16000:tgt=full:fde=none:sp=reverse_frequency:i=317:kws=arity_squared:fgj=on:gtg=exists_sym:lma=off:bsr=unit_only:acc=on:add=off:avsq=on:avsqr=1,16:ins=10:fs=off:fsr=off:rp=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:sp=arity:lcm=predicate:urr=on:s2agt=16:i=12125:sd=2:ss=axioms:sgt=64:fgj=on:br=off_0");
    quick.push("lrs+10_1:32_sil=8000:tgt=ground:prc=on:sp=reverse_arity:spb=non_intro:i=2836:kws=inv_precedence:fgj=on:bd=preordered:ins=10_0");
    quick.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:i=14534:kws=arity:bd=preordered:ins=6:ss=axioms:sgt=30:fgj=on:lma=off:kmz=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:sas=cadical:sp=reverse_frequency:alpa=false:sac=on:i=11832:s2at=3.0:bd=preordered:bs=on:fsd=on:bsr=on_0");
    quick.push("lrs+10_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:npcc=on:drc=off:fde=unused:sp=const_min:spb=goal:fd=preordered:i=2279:fgj=on:bd=all_0");
    quick.push("lrs-1010_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:drc=off:fde=none:sp=reverse_arity:gs=on:s2agt=16:st=3.0:i=6225:bd=all:gtg=exists_all:ss=included:er=filter:sgt=10:urr=ec_only_0");
    quick.push("lrs-1010_1:1_sil=32000:tgt=ground:sp=const_frequency:spb=goal_then_units:i=21755:kws=frequency:fgj=on:bd=preordered:nm=4:ins=20:lrd=on:lwlo=on:av=off:etr=on:rnwc=on_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:drc=off:flr=on:i=16427:s2at=1.5:bd=all:fsr=off:s2pl=no_0");
    quick.push("lrs+1011_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:drc=off:fde=none:sp=const_frequency:spb=goal:fd=preordered:i=9356:bd=preordered:av=off:fgj=on_0");
    quick.push("dis+10_1:6_sil=8000:tgt=ground:prc=on:drc=ordering:spb=non_intro:fd=preordered:i=2070:kws=inv_precedence:bd=all:slsq=on:slsql=off:slsqc=1:foolp=on_0");
    quick.push("lrs+1002_1:1_to=lpo:ncem=casc2026/models/loop4.pt:sil=8000:tgt=ground:npcc=on:fde=unused:sp=const_min:urr=ec_only:s2agt=32:st=3.0:i=6461:fgj=on:bd=preordered:av=off:ss=axioms_0");
    quick.push("lrs+10_1:6_to=lpo:sil=8000:tgt=ground:drc=off:sp=arity:spb=goal:fd=preordered:i=2310:bd=all:ss=included:lpd=off_0");
    quick.push("dis+11_1:1_sil=8000:nwc=20.0:i=2616:fsr=off:fd=off:ss=axioms:sgt=8:st=3.0:av=off:s2pl=on_0");
    quick.push("lrs+0_1:1_ncem=casc2026/models/loop3.pt:sil=32000:tgt=ground:npcc=on:sp=occurrence:urr=ec_only:fd=preordered:i=30521:gtgl=2:kws=inv_arity:bd=all:gtg=exists_sym_0");
    quick.push("lrs+11_1:1_to=lpo:ncem=casc2026/models/loop4.pt:sil=16000:tgt=full:npcc=on:fde=unused:sp=reverse_frequency:spb=goal:acc=on:urr=ec_only:i=3258:fgj=on:bd=all:ins=1:s2agt=32:prc=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:sp=reverse_frequency:kmz=on:i=5037:kws=precedence_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:urr=on:bsr=unit_only:br=off:i=65240:acc=on_0");
    quick.push("lrs-1011_1:1_ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:fde=unused:sp=weighted_frequency:i=16502:kws=inv_precedence:fgj=on:bd=preordered:ins=3:av=off:urr=ec_only_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop2.pt:sil=32000:npcc=on:drc=off:sp=const_max:spb=goal_then_units:urr=ec_only:i=7623:bd=preordered:er=filter:fd=preordered_0");
    quick.push("dis+1010_1:1_anc=none:ncem=casc2026/models/loop3.pt:sil=16000:tgt=full:npcc=on:sp=const_min:spb=non_intro:lcm=predicate:acc=on:urr=ec_only:rp=on:gs=on:i=8183:kws=frequency:add=off:gsp=on_0");
    quick.push("lrs-1011_1:1_anc=all_dependent:ncem=casc2026/models/loop4.pt:sil=32000:npcc=on:bsr=unit_only:i=8387_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=ground:npcc=on:drc=off:sp=reverse_frequency:spb=goal:acc=on:s2agt=16:kmz=on:sac=on:i=53964:kws=inv_arity_squared:fgj=on:bd=preordered_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:tgt=full:npcc=on:sp=reverse_frequency:urr=on:flr=on:i=10575:s2at=5.0:lsd=20:gtg=position:spb=goal_0");
    quick.push("ott-1011_1:1_ncem=casc2026/models/loop7.pt:sil=64000:tgt=ground:npcc=on:i=12036:s2at=3.0:kws=frequency:fgj=on:bd=preordered:ins=2:gtg=exists_sym:gtgl=2:lsd=50:add=off:urr=ec_only_0");
    quick.push("lrs+1011_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:npcc=on:drc=off:fde=none:sp=const_frequency:spb=goal:fd=preordered:i=16065:bd=preordered:av=off:fgj=on_0");
    quick.push("dis-1011_1:1_ncem=casc2026/models/loop4.pt:sil=64000:npcc=on:sp=arity:spb=non_intro:i=28442:cond=on:gtg=all:gtgl=3:ss=included:sd=8:st=8.34:tgt=ground:to=kbo_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=goal:fd=preordered:i=122896:foolp=on_0");
    quick.push("lrs+35_1:4096_sil=64000:sp=occurrence:i=40171:ss=included:sgt=8:updr=off_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop5.pt:sil=128000:npcc=on:i=81507:sd=3:ss=included:sgt=32_0");
    quick.push("lrs-1011_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:prc=on:drc=ordering:sp=weighted_frequency:sos=all:i=71792:kws=inv_arity_squared:bd=preordered:av=off:ss=included:sgt=8:proc=on_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop4.pt:sil=128000:tgt=ground:npcc=on:spb=goal:i=124714:bd=preordered:rp=on:kws=frequency:sp=const_frequency:er=filter:add=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop2.pt:sil=128000:npcc=on:s2pl=on:i=131645_0");
    // total_instr 958676
    // len(covered) 1065
  } else if (property.formulas() > 0) { // any FOL
    addCommentSignForSZS(std::cout);
    std::cout << "Detected formulas, will run a generic FOF schedule." << std::endl;

    champions.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=goal:fd=preordered:i=141193:foolp=on_0");
    champions.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:spb=units:s2agt=64:updr=off:i=134677:nm=16:lma=off:aac=none:urr=ec_only:ss=included:sd=20:sgt=10:bce=on_0");
    champions.push("lrs+1010_1:1_anc=all:sfv=off:to=kbo:ncem=casc2026/models/loop7.pt:sil=128000:npcc=on:i=141695:sd=1:nm=32:gsp=on:ss=included:prc=on:sac=on:sos=all:bsr=unit_only_0");
    // 6475 + 255 + 115 = 6845

    quick.push("lrs+1010_1:1_to=lpo:sil=32000:sos=on:spb=goal_then_units:bce=on:i=109:ins=1:gsp=on:ss=axioms:sd=1_0");
    quick.push("dis-1010_2:3_sil=16000:i=119:av=off:ss=axioms:sp=reverse_frequency_0");
    quick.push("dis-1011_1:1_sil=16000:fde=unused:i=139:s2a=on:s2agt=70:gtg=position_0");
    quick.push("dis-21_1:1_sil=8000:lcm=predicate:i=129:aac=none:fsr=off:avsq=on:avsqr=1,16:ep=RS:ss=included:sd=3:st=5.0_0");
    quick.push("lrs+10_1:1_sil=8000:sp=occurrence:i=285:sd=3:ss=axioms:sgt=8_0");
    quick.push("lrs+10_1:1_sil=32000:i=157:sd=1:gtg=position:ss=axioms:sgt=8:urr=on:br=off_0");
    quick.push("lrs+1011_1:1_sil=32000:sp=occurrence:i=325:sd=1:ss=axioms:sgt=32_0");
    quick.push("dis+10_5:1_sil=8000:fde=unused:erd=off:urr=full:fd=off:s2agt=8:br=off:s2a=on:i=248:s2at=1.23:gtg=position:slsq=on:slsqr=1,4_0");
    quick.push("lrs+1002_1:1_to=lpo:sil=8000:sos=on:st=4.0:i=294:sd=2:ins=7:ss=axioms:amm=off:cts=off_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=32000:tgt=ground:npcc=on:i=2350_0");
    quick.push("dis-1011_32:1_sfv=off:sil=16000:erd=off:acc=on:flr=on:i=113:ss=included:sgt=4:fd=off:fsr=off:cts=off:sos=all_0");
    quick.push("lrs-1004_1:1_sil=8000:sp=occurrence:sos=all:erd=off:i=127:av=off:sup=off:fs=off:fsr=off:bce=on_0");
    quick.push("dis-1003_1:1024_sil=8000:cond=fast:i=114:sd=1:nm=0:ss=axioms:fsr=off:gtg=exists_sym:sos=all:sac=on_0");
    quick.push("lrs+10_1:1_sil=8000:sp=occurrence:st=1.2:i=907:sd=14:ss=axioms:sgt=12_0");
    quick.push("dis-1010_1:1_sil=16000:fde=unused:sp=occurrence:sos=on:i=437:sd=1:ss=included:aac=none_0");
    quick.push("lrs-1002_1:1_ncem=casc2026/models/all5champsBiggishL14.pt:sil=16000:npcc=on:i=5202:ss=axioms:sgt=16_0");
    quick.push("dis+10_3:1_sil=8000:acc=on:urr=on:sac=on:newcnf=on:i=134:sd=2:nm=16:sup=off:ss=included:br=off:doe=on_0");
    quick.push("lrs+1002_1:8_sil=8000:sp=occurrence:sos=on:sac=on:i=592:ep=RST:ss=axioms:sd=3:st=8.0_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop6.pt:sil=32000:npcc=on:st=3.0:i=13193:sd=3:ss=axioms_0");
    quick.push("lrs+1666_1:7_sil=8000:i=125:bs=unit_only:gtg=position:ss=axioms:sgt=8:slsq=on:slsql=off:slsqr=4,1:sos=on:alpa=false:sac=on:urr=on:gsp=on:plsq=on:plsql=on:plsqc=1:fdi=2:rp=on_0");
    quick.push("lrs+10_1:1024_to=lpo:sil=8000:tgt=full:sp=arity:slsq=on:i=134:gtgl=5:slsql=off:gtg=exists_sym_0");
    quick.push("lrs+10_1:1_sil=16000:plsq=on:plsqc=1:plsqr=32,1:sos=on:newcnf=on:i=141:sd=1:sup=off:ss=axioms:sgt=8:fd=off:gsp=on:lcm=reverse_0");
    quick.push("lrs+1011_1:1_sil=8000:sp=occurrence:i=431:sd=1:ss=axioms:sgt=64:fs=off:fsr=off:plsq=on:sup=off_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop6.pt:sil=64000:tgt=full:npcc=on:fd=preordered:gs=on:sac=on:newcnf=on:i=6060:ins=25:urr=ec_only:bsr=on:aac=none:prc=on_0");
    quick.push("lrs+10_1:16_anc=all:sil=8000:avsql=on:sp=unary_frequency:lcm=predicate:urr=full:rp=on:br=off:flr=on:sac=on:avsqc=1:avsq=on:s2a=on:i=150:slsq=on:slsqc=4:slsqr=32,1:kws=precedence:gsp=on:nicw=on:rawr=on_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=ground:npcc=on:sp=arity:i=14155:bd=all:urr=on_0");
    quick.push("lrs+10_1:1024_sil=16000:sos=all:gs=on:newcnf=on:i=667:fs=off:fsr=off:av=off:plsq=on:plsqr=32,1_0");
    quick.push("ott-1011_3:1_to=lpo:sil=8000:sp=reverse_frequency:spb=goal_then_units:newcnf=on:i=185:s2at=1.8:fdi=4:lftc=20:fdtod=off:drc=ordering:sas=cadical:anc=all_dependent:urr=full:s2a=on_0");
    quick.push("dis+1010_1:14_to=lpo:sil=8000:sp=arity:slsq=on:i=193:ins=10:fsd=on:fsr=off:anc=all:ss=axioms_0");
    quick.push("dis+1011_1:7_sil=8000:sp=occurrence:sos=all:st=5.3:i=4850:sd=4:av=off:ss=included:sgt=16:sup=off:fd=off_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:sp=const_frequency:urr=on:i=12111:sd=1:ss=included:acc=on_0");
    quick.push("lrs-11_1:32_anc=all:sil=8000:spb=goal_then_units:sac=on:i=319:kws=precedence:fsr=off_0");
    quick.push("dis+2_1:1024_sil=8000:sp=reverse_arity:sos=on:lcm=reverse:sac=on:i=2064:ep=RST_0");
    quick.push("dis-1011_1:128_sil=32000:i=3706:av=off:ep=RST_0");
    quick.push("lrs-1002_1:1_sil=8000:sp=occurrence:sos=on:newcnf=on:i=757:sd=2:ss=axioms:sgt=40:fs=off:fsr=off:plsq=on:plsqr=32,1:gs=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:sp=occurrence:i=13913:ss=axioms:sgt=8_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=const_frequency:sos=all:i=9925:lma=off:aac=none_0");
    quick.push("dis-1010_1:50_to=lpo:sil=32000:sos=on:spb=goal_then_units:i=2479:nm=16:fsr=off:urr=ec_only:sp=arity:ss=axioms:sd=2:slsq=on_0");
    quick.push("ott+1002_1:64_sil=16000:sp=const_min:nwc=0.5:i=440:nm=2:gsp=on:gtg=exists_all:fdi=8:av=off_0");
    quick.push("dis-1011_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:st=1.5:i=11145:s2at=3.0:sd=3:fsr=off:ss=axioms:lsd=100:bsr=unit_only:erd=off_0");
    quick.push("lrs+1002_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=unary_frequency:lcm=reverse:urr=on:bsr=on:i=3034:av=off:fsd=on:cts=off:er=known_0");
    quick.push("lrs-1011_64:1_sil=8000:nwc=0.7:br=off:st=2.0:s2a=on:i=524:s2at=2.0:ss=axioms:urr=on:erd=off_0");
    quick.push("lrs+1011_16:1_sil=8000:acc=on:urr=on:fd=preordered:flr=on:i=1016:sd=1:ss=axioms:avsq=on:avsqr=676809,524288_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:drc=off:fde=none:s2agt=16:i=14123:bd=preordered:ins=4_0");
    quick.push("dis+10_1:4096_slsqr=16,1:sil=32000:tgt=full:plsq=on:bsr=unit_only:slsqc=1:slsq=on:i=5781:kws=precedence:bd=all:rawr=on_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:sp=reverse_frequency:urr=on:br=off:i=2448:bd=preordered:erd=off:gtg=all:gtgl=5:drc=off_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop5.pt:sil=32000:tgt=full:npcc=on:lcm=reverse:i=3223:kws=precedence:fgj=on:av=off_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop4.pt:sil=8000:npcc=on:sp=occurrence:sos=on:st=5.6:i=2033:sd=3:ss=axioms_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:i=2055:nm=16:fsd=on:ss=axioms:gtg=position:bsd=on_0");
    quick.push("dis+1010_1:1_ncem=casc2026/models/loop7.pt:sil=64000:tgt=full:npcc=on:fde=unused:sp=const_frequency:spb=goal:i=21611:sd=3:ss=axioms:acc=on_0");
    quick.push("lrs+10_1:1_sil=8000:sp=occurrence:sos=all:lma=off:i=4835:sd=13:ss=axioms:sgt=23_0");
    quick.push("lrs+10_1:1_to=lpo:sil=32000:bsd=on:sp=reverse_frequency:bsr=unit_only:slsqc=4:newcnf=on:slsq=on:st=5.0:i=797:s2at=3.0:sd=4:bs=unit_only:av=off:ss=included:fd=off:plsq=on:plsqc=1:plsqr=64,1:sup=off:plsql=on_0");
    quick.push("lrs-1011_1:5_sil=8000:sp=const_max:sos=on:lsd=50:rnwc=on:rp=on:nwc=2.6:alpa=false:i=2326:kws=inv_precedence:aac=none:nicw=on:bs=unit_only:nm=16:ins=2:fsd=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop5.pt:sil=8000:npcc=on:sos=all:urr=on:br=off:i=6038:nm=6_0");
    quick.push("lrs+10_1:1_sil=32000:sp=occurrence:st=2.0:i=33334:sd=3:ss=included:sgt=32_0");
    quick.push("lrs+10_1:4_sil=8000:plsq=on:plsqr=1,64:sp=occurrence:br=off:st=3.7:s2a=on:i=1008:s2at=1.2:sd=3:bd=all:fdi=8:ss=axioms:bsr=on:sup=off:av=off:urr=on_0");
    quick.push("lrs+10_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=128000:tgt=ground:npcc=on:fde=none:sp=const_frequency:spb=intro:gs=on:i=8327:s2at=5.0:bd=preordered_0");
    quick.push("lrs+1002_1:1_slsqr=3,2:sil=8000:sp=reverse_arity:urr=on:s2agt=16:br=off:slsqc=2:slsq=on:s2a=on:i=1083:s2at=1.873276285787:slsql=off:ep=RSTC:fdi=16:fde=unused:tgt=full:plsq=on:plsql=on:plsqc=1:plsqr=3,2:spb=intro_0");
    quick.push("lrs-1004_1:3_to=lpo:sil=16000:drc=off:sims=off:fd=preordered:i=1084:bd=preordered:av=off:ss=axioms:sgt=14:sd=1:fsr=off:spb=goal_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=full:npcc=on:erd=off:spb=goal:sac=on:newcnf=on:i=6995:s2at=5.0:gtg=all_0");
    quick.push("lrs+10_1:1_sil=32000:sp=occurrence:sos=on:rnwc=on:st=2.0:i=6225:ss=axioms:sd=15:urr=on_0");
    quick.push("dis-1011_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:lcm=reverse:cond=fast:i=3372:nm=16:ss=axioms:sd=1:gtg=position_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:sos=all:st=2.3:i=26457:sd=10:ss=included:sgt=8_0");
    quick.push("lrs+10_1:1_anc=all:sfv=off:to=kbo:ncem=casc2026/models/loop7.pt:sil=128000:tgt=ground:npcc=on:sp=const_frequency:urr=on:s2agt=20:sac=on:i=13494:s2at=1.31:bd=all:ins=10:foolp=on:acc=on:gtg=exists_top_0");
    quick.push("dis-1010_1:1_ncem=casc2026/models/loop5.pt:sil=32000:npcc=on:fde=unused:sp=const_min:spb=goal_then_units:lcm=predicate:flr=on:i=2503:nm=4:gsp=on:ss=axioms:sgt=15:acc=on_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop1.pt:sil=16000:npcc=on:sos=on:i=2559:sd=1:ep=RSTC:ss=axioms:lsd=10_0");
    quick.push("ott+1_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:i=30753:fdtod=off:ss=included:av=off_0");
    quick.push("lrs+10_1:1024_sil=64000:urr=on:br=off:i=26473:ep=RSTC:plsq=on:plsql=on:plsqc=4:plsqr=128,1_0");
    quick.push("dis-1011_1:1_ncem=casc2026/models/all5champsBiggishL14.pt:sil=32000:tgt=ground:npcc=on:sp=arity:sos=on:erd=off:rp=on:gs=on:i=2759:fgj=on:cts=off:kws=inv_arity:kmz=on_0");
    quick.push("lrs-1011_1:1_anc=all_dependent:ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:fde=unused:sp=weighted_frequency:sos=all:st=1.2:i=5665:sd=2:ep=RSTC:ss=axioms:spb=goal_then_units:sac=on:gsp=on:urr=ec_only_0");
    quick.push("dis+1011_1:1_ncem=casc2026/models/loop3.pt:sil=16000:npcc=on:sos=on:urr=full:alpa=true:sac=on:i=1532:ep=RS:ss=axioms:anc=none:lsd=20_0");
    quick.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=unary_first:flr=on:newcnf=on:i=1565:ss=axioms:sd=2:sgt=32:erd=off_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop4.pt:sil=16000:npcc=on:sims=off:bsd=on:sp=unary_first:erd=off:spb=goal:s2agt=8:i=1572:fgj=on:gsp=on:lcm=reverse:gs=on_0");
    quick.push("lrs-1002_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:fde=none:sp=occurrence:newcnf=on:i=6052:sd=4:ss=axioms:sgt=24:sos=on_0");
    quick.push("lrs+21_1:1_to=lpo:ncem=casc2026/models/loop2.pt:sil=16000:npcc=on:sp=arity:sos=on:erd=off:lcm=predicate:alpa=false:sac=on:i=3500:sd=1:bd=preordered:ss=included:sup=off_0");
    quick.push("lrs+35_1:1_anc=all_dependent:ncem=casc2026/models/all5champsBiggishL14.pt:sil=32000:npcc=on:fde=none:sp=weighted_frequency:erd=off:spb=non_intro:updr=off:newcnf=on:i=1842:sd=3:gtg=position:gsp=on:ss=axioms:sgt=20:fgj=on_0");
    quick.push("lrs+11_1:1_anc=all_dependent:ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:bsr=unit_only:i=66096:add=on_0");
    quick.push("lrs+1011_1:1_to=lpo:ncem=casc2026/models/loop3.pt:sil=64000:npcc=on:i=1884:sd=1:nm=60:ss=axioms_0");
    quick.push("lrs-1011_4:1_sil=16000:bsr=on:cts=off:i=5469:bs=on:fsr=off_0");
    quick.push("lrs-1010_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=64000:tgt=ground:npcc=on:sp=unary_frequency:urr=on:bce=on:alpa=false:sac=on:i=2037:s2at=10.0:ins=25:gtg=exists_all:gtgl=5:bd=preordered:add=off_0");
    quick.push("lrs-30_1:1_ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:urr=on:bce=on:rp=on:br=off:flr=on:st=-1.0:i=2110:kws=precedence:av=off:ss=axioms:er=known_0");
    quick.push("dis-1010_1:1_anc=all_dependent:ncem=casc2026/models/loop5.pt:sil=32000:tgt=full:npcc=on:sp=unary_first:spb=goal:lcm=reverse:fd=off:i=2430:nm=16:flr=on:add=off:aac=none_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=unary_first:spb=units:gs=on:i=4891:cond=fast:bsr=unit_only:acc=on:sac=on_0");
    quick.push("lrs+4_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=full:npcc=on:sos=on:s2agt=16:sac=on:newcnf=on:st=2.0:i=14845:sd=2:ss=included:fsd=on:anc=all:spb=goal_then_units:gs=on:lcm=reverse_0");
    quick.push("lrs-1010_1:1_to=lpo:ncem=casc2026/models/loop4.pt:sil=32000:npcc=on:urr=ec_only:i=7534:sd=3:ins=1:gtg=exists_top:ss=included:sgt=8:br=off_0");
    quick.push("lrs-1002_1:1_ncem=casc2026/models/loop5.pt:sil=32000:tgt=ground:npcc=on:prc=on:sims=off:spb=goal:s2agt=32:cond=fast:i=10353:av=off:fsd=on:bs=on:bsr=unit_only:fsdmm=10:fde=none:ss=axioms:sgt=64_0");
    quick.push("lrs+2_1:4096_sil=8000:plsq=on:plsqr=12672147,131072:sos=on:spb=goal:lcm=predicate:i=7860_0");
    quick.push("ott+1011_1:1_to=lpo:ncem=casc2026/models/loop5.pt:sil=8000:npcc=on:fde=unused:lsd=30:lcm=predicate:fd=off:gs=on:sac=on:i=7896:sd=2:ss=included:sgt=20:bs=on:spb=goal:anc=all_dependent_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop2.pt:sil=16000:tgt=ground:npcc=on:i=5812:gtgl=2:gtg=all:prc=on_0");
    quick.push("ott-1011_1:1_anc=none:ncem=casc2026/models/loop1.pt:sil=16000:npcc=on:sp=const_frequency:sos=on:lsd=100:i=2965:s2at=3.7:fdi=2:prc=on:aac=none:fgj=on:er=known_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop5.pt:sil=16000:npcc=on:sp=reverse_frequency:spb=units:lcm=predicate:urr=on:i=2967:kws=precedence:av=off:s2agt=8:updr=off:bd=preordered_0");
    quick.push("ott+1002_1:1_anc=all:ncem=casc2026/models/loop4.pt:sil=32000:npcc=on:sos=on:spb=goal_then_units:sac=on:i=3022:sd=1:kws=frequency:aac=none:ep=RST:nm=16:ss=axioms:alpa=false:er=known_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop4.pt:sil=32000:tgt=ground:npcc=on:prc=on:sos=all:lcm=predicate:acc=on:gs=on:sac=on:newcnf=on:prac=on:i=3207:kws=frequency:fgj=on:ss=axioms:sgt=8:er=filter:sp=const_frequency:bsr=unit_only_0");
    quick.push("lrs+1011_1:1_anc=all:ncem=casc2026/models/loop7.pt:sil=128000:npcc=on:sos=on:lcm=predicate:st=4.2:i=3289:aac=none:ss=included:sgt=10:sd=5_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:i=38569:sd=3:ss=axioms:sgt=32_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop5.pt:sil=16000:npcc=on:bsr=on:i=3394:cts=off_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:sp=arity:spb=intro:lcm=reverse:urr=ec_only:fd=preordered:gs=on:sac=on:i=33824:bd=preordered_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop3.pt:sil=64000:tgt=ground:npcc=on:i=20684:bd=all:gtg=exists_sym_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:irw=on:npcc=on:bsd=on:sp=reverse_frequency:sos=on:erd=off:spb=goal:urr=full:bsr=on:s2agt=32:alpa=random:kmz=on:st=3.0:i=7222:add=on:fgj=on:bd=preordered:gtg=exists_top:gsp=on:ss=axioms:sgt=8:prc=on:prac=on:lcm=reverse:kws=arity_squared:proc=on:er=known_0");
    quick.push("ott-1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:spb=goal_then_units:st=4.0:i=7295:sd=4:ss=axioms:ep=R_0");
    quick.push("lrs+32_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:tgt=full:npcc=on:fde=none:sp=occurrence:urr=ec_only:fd=preordered:i=4036:ins=10_0");
    quick.push("lrs+10_1:1_sil=128000:lcm=predicate:i=43697:ss=axioms:sd=5:st=3.0_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:sp=const_frequency:urr=on:i=17599:ss=axioms:s2agt=20:drc=off:sac=on:gtg=all:fsd=on:lcm=predicate:sos=all_0");
    quick.push("lrs+1011_1:1_to=lpo:ncem=casc2026/models/loop1.pt:sil=16000:npcc=on:prc=on:sp=occurrence:lcm=reverse:urr=ec_only:gs=on:i=4547:bd=preordered_0");
    quick.push("lrs+1010_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:tgt=full:npcc=on:sp=unary_first:spb=goal:urr=ec_only:newcnf=on:i=9294:av=off_0");
    quick.push("lrs+11_1:1_anc=all_dependent:ncem=casc2026/models/loop7.pt:sil=128000:npcc=on:bsr=unit_only:i=32849:add=on_0");
    quick.push("dis-1011_1:1_ncem=casc2026/models/loop5.pt:sil=64000:tgt=full:npcc=on:st=1.5:i=4793:s2at=3.0:sd=3:fsr=off:ss=axioms:lsd=100:bsr=unit_only:erd=off_0");
    quick.push("dis+1011_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:prc=on:drc=off:sims=off:sp=const_frequency:sos=on:spb=non_intro:gs=on:updr=off:newcnf=on:i=4840:nm=4:av=off_0");
    quick.push("lrs-1004_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:gs=on:newcnf=on:cts=off:i=5002_0");
    quick.push("dis+1010_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:fde=unused:sp=const_frequency:spb=goal:i=30479:sd=3:ss=axioms:acc=on_0");
    quick.push("lrs+1011_1:1_anc=none:ncem=casc2026/models/loop2.pt:sil=32000:tgt=full:npcc=on:fde=unused:sas=cadical:sp=const_frequency:spb=non_intro:lcm=predicate:rp=on:sac=on:newcnf=on:i=11035:s2at=5.0:kws=inv_arity:bs=on:gsp=on:lsd=10_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop4.pt:sil=8000:npcc=on:i=5835_0");
    quick.push("ott+1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=arity:urr=on:i=5890:s2at=2.0:ins=4:av=off:bsr=on:fd=preordered:kws=inv_precedence:foolp=on_0");
    quick.push("lrs+10_1:1_sil=32000:sos=all:lma=off:i=19910:ep=RS:cts=off_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=32000:tgt=ground:npcc=on:drc=off:sp=arity:fd=preordered:s2agt=16:i=20312:bd=preordered:fsr=off:sac=on:er=filter_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop2.pt:sil=32000:tgt=ground:npcc=on:drc=off:sp=reverse_frequency:spb=goal_then_units:urr=on:gs=on:sac=on:i=13822:bd=preordered:ins=5:kws=inv_arity_squared_0");
    quick.push("ott-1011_1:91_sil=128000:prc=on:sp=unary_first:i=7144:kws=inv_arity_squared:bd=all:ins=1:urr=on:ss=included:sgt=10:st=2.0:sims=off_0");
    quick.push("lrs+21_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=non_intro:urr=on:fd=preordered:i=15184:kws=inv_frequency:bd=preordered:av=off:er=known_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=goal:fd=preordered:i=107375:foolp=on_0");
    quick.push("dis+11_1:1_ncem=casc2026/models/loop2.pt:sil=16000:tgt=full:npcc=on:sp=const_frequency:spb=units:lcm=predicate:fd=off:sac=on:newcnf=on:cts=off:i=7958:kws=inv_frequency:fgj=on:bs=unit_only:ins=1:fsr=off_0");
    quick.push("dis+10_1:128_sil=16000:nwc=0.7:i=15999:nm=2:gsp=on_0");
    quick.push("ott+10_1:64_sil=128000:nwc=1.0:i=8139:bd=all:av=off:fsr=off:plsq=on:plsqc=2:ss=included:st=3.0:drc=off:sgt=8:fgj=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop2.pt:sil=16000:npcc=on:sp=occurrence:sos=on:urr=on:sac=on:st=4.0:i=8950:sd=5:ss=axioms_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:prc=on:drc=off:spb=goal:i=9809:ins=10:av=off_0");
    quick.push("ott+11_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=arity:fd=off:newcnf=on:st=2.6:i=9885:s2at=1.5:sd=2:fgj=on:ss=included:ins=3:acc=on:cond=fast_0");
    quick.push("ott+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:etr=on:i=32078:av=off:flr=on:cond=fast:fgj=on:kmz=on_0");
    quick.push("dis-1010_1:64_to=lpo:sil=16000:tgt=ground:prc=on:fde=none:spb=goal_then_units:nwc=1.0:i=11101:ss=axioms:sgt=8:bd=all_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:sp=reverse_frequency:flr=on:i=13220:s2at=3.0:fd=preordered:cond=on:fsd=on:aac=none_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:spb=goal:urr=on:newcnf=on:st=5.0:i=13528:sd=2:gtg=exists_top:ss=axioms:kws=inv_frequency_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop6.pt:sil=32000:npcc=on:sp=reverse_frequency:bce=on:newcnf=on:i=14854:nm=2:av=off:bsr=unit_only:ss=included:st=6.0:gtg=exists_all:ep=RS:s2agt=32_0");
    quick.push("lrs+10_1:1_to=lpo:ncem=casc2026/models/loop6.pt:sil=128000:npcc=on:spb=goal_then_units:i=14974:ss=axioms:sgt=16_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:drc=off:sas=cadical:sp=arity:spb=units:acc=on:urr=ec_only:fd=preordered:gs=on:s2agt=16:i=33081:aac=none:fgj=on:bd=all:fsr=off:lsd=1_0");
    quick.push("ott+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=ground:npcc=on:spb=goal:i=50856:s2at=6.0:kws=arity:nm=0:bd=preordered:s2agt=60:er=filter:etr=on:sims=off:sas=cadical:acc=on:alpa=true_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:urr=on:bsr=unit_only:br=off:i=69865:acc=on_0");
    quick.push("lrs+1002_1:1_anc=none:to=lpo:ncem=casc2026/models/loop7.pt:sil=32000:tgt=full:npcc=on:sp=arity:sos=on:spb=intro:lcm=reverse:cond=fast:i=17802:gtgl=3:gtg=all_0");
    quick.push("lrs+10_1:1_sil=128000:urr=on:br=off:i=96644:sas=cadical_0");
    quick.push("dis+1011_1:1_bce=on:bd=preordered:bsr=unit_only:cond=fast:drc=off:er=known:ins=9:irw=on:kmz=on:kws=arity_squared:ncem=casc2026/models/loop8.pt:nm=16:sac=on:sp=unary_first:tgt=ground:to=kbo:i=21161_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=const_frequency:urr=on:i=22761:ss=axioms:s2agt=20:drc=off:sac=on:gtg=all:fsd=on:lcm=predicate:sos=all_0");
    quick.push("dis-1011_1:7_sil=128000:nwc=1.0:st=2.0:s2a=on:i=23713:s2at=2.0:sd=4:sup=off:ss=axioms:fd=off:fde=none:erd=off_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:drc=off:sp=unary_first:kmz=on:i=26509:kws=inv_arity:fgj=on:bd=preordered:av=off_0");
    quick.push("dis+1011_1:1_add=on:bd=all:bs=on:bsr=on:drc=off:er=known:fde=unused:fgj=on:kws=inv_frequency:ncem=casc2026/models/loop6.pt:sac=on:sp=const_frequency:spb=units:tgt=ground:to=kbo:i=28957_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop7.pt:sil=32000:tgt=full:npcc=on:drc=off:sp=const_max:spb=goal_then_units:lcm=predicate:fd=preordered:i=29246:s2at=-1.0:kws=inv_arity:ins=10:sac=on:urr=ec_only:gs=on_0");
    quick.push("ott+1010_1:1_ncem=casc2026/models/loop5.pt:sil=64000:tgt=full:npcc=on:sp=weighted_frequency:gs=on:sac=on:cond=on:i=30082:s2at=6.0:kws=inv_precedence:ins=10:s2agt=32:urr=on:aac=none:anc=all_dependent:gsp=on_0");
    quick.push("lrs+1011_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:drc=off:sp=reverse_frequency:fd=preordered:i=32262:bd=preordered_0");
    quick.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:i=32870:sd=4:fgj=on:ss=axioms:sgt=128_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop4.pt:sil=64000:npcc=on:prc=on:sp=reverse_frequency:spb=goal:kmz=on:i=33295:kws=precedence:fgj=on:bd=preordered:ins=1:acc=on_0");
    quick.push("dis+11_1:1_anc=none:bd=preordered:bsr=unit_only:fgj=on:gtg=position:kmz=on:kws=arity_squared:lma=off:ncem=casc2026/models/loop6.pt:nm=32:s2a=on:s2agt=8:sac=on:sfv=off:to=kbo:i=36826_0");
    quick.push("lrs-1003_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:sp=const_frequency:spb=goal:bsr=unit_only:gs=on:br=off:flr=on:sac=on:st=2.0:i=92981:kws=inv_arity:fgj=on:ins=2:ss=axioms_0");
    quick.push("lrs-1011_1:1_anc=all_dependent:ncem=casc2026/models/all5champsBiggishL14.pt:sil=64000:npcc=on:bsr=unit_only:i=49423:s2pl=on_0");
    quick.push("lrs+1002_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=64000:tgt=ground:npcc=on:sp=reverse_frequency:spb=goal_then_units:rp=on:updr=off:i=57299:s2at=6.0:prc=on:ss=axioms:sd=10:st=3.0:fdtod=off:fd=preordered:prac=on:add=on:sac=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:sas=cadical:sp=reverse_frequency:alpa=false:sac=on:i=127679:s2at=3.0:bd=preordered:bs=on:fsd=on:bsr=on_0");
    quick.push("lrs+31_1:1_anc=all:to=lpo:ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:sp=reverse_arity:fs=off:lcm=predicate:flr=on:i=69402:add=on:aac=none:fsr=off:alpa=false_0");
    quick.push("lrs-2_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:drc=off:sas=cadical:sp=reverse_frequency:lcm=predicate:acc=on:bsr=unit_only:fd=preordered:sac=on:i=100512:doe=on:fgj=on:bd=all:fsd=on_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:drc=off:sp=reverse_frequency:spb=goal:acc=on:s2agt=16:kmz=on:sac=on:i=138761:kws=inv_arity_squared:fgj=on:bd=preordered_0");
    // total_instr 2378702
    // len(covered) 7296
    ...
    champions.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=goal:fd=preordered:i=140167:foolp=on_0");
    champions.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:urr=on:br=off:i=132376:av=off_0");
    champions.push("lrs+1002_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:sp=reverse_frequency:i=137899:s2at=10.0:kws=precedence:bd=preordered:gtg=position:gtgl=3:add=on:spb=intro_0");
    // 3790 + 131 + 58 = 3979

    quick.push("lrs+10_1:1_sil=8000:sp=occurrence:i=107:sd=3:ss=axioms:sgt=8_0");
    quick.push("dis-1002_1:1_to=lpo:sil=16000:fd=off:i=114:aac=none:ins=7:fsd=on:ss=axioms:st=1.5_0");
    quick.push("dis-1011_1:1_sil=16000:fde=unused:i=180:s2a=on:s2agt=70:gtg=position_0");
    quick.push("dis-21_1:1_sil=8000:lcm=predicate:i=117:aac=none:fsr=off:avsq=on:avsqr=1,16:ep=RS:ss=included:sd=3:st=5.0_0");
    quick.push("dis+1010_1:3_sil=8000:drc=off:fde=none:sos=on:spb=goal_then_units:i=143:sd=2:ss=axioms:sgt=16:aac=none:plsq=on:plsqc=1:plsqr=7,2:bsd=on_0");
    quick.push("ott-1010_1:1_to=lpo:sil=16000:sos=on:spb=units:urr=on:br=off:st=3.0:avsq=on:i=189:avsqr=1,16:sd=2:bd=all:nm=64:ss=axioms:sgt=30:bce=on:s2a=on:s2at=1.2_0");
    quick.push("lrs-1002_1:1_to=lpo:sil=8000:fde=none:sos=on:st=4.0:i=219:sd=3:ss=axioms_0");
    quick.push("lrs+10_1:64_to=lpo:sil=8000:i=126:bd=preordered_0");
    quick.push("lrs+1011_1:16_to=lpo:sil=8000:drc=off:sp=reverse_frequency:spb=goal_then_units:i=194:fgj=on:bd=preordered:avsq=on_0");
    quick.push("lrs+10_1:1_sil=8000:tgt=full:i=157:gtg=all:acc=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=128000:npcc=on:i=3394:sd=4:ss=included:sgt=64_0");
    quick.push("lrs+1011_1:5_to=lpo:sil=8000:tgt=full:plsq=on:prc=on:drc=off:plsqr=31,4:sp=occurrence:nwc=0.8:s2agt=16:br=off:cts=off:s2a=on:i=106:fsr=off:gsp=on:ss=axioms:sgt=16:rawr=on:urr=on_0");
    quick.push("lrs+2_1:4096_sil=8000:plsq=on:plsqr=12672147,131072:sos=on:spb=goal:lcm=predicate:i=107_0");
    quick.push("lrs+1011_1:20_sil=64000:tgt=ground:plsq=on:plsqc=1:plsqr=14,1:plsql=on:nwc=0.6:st=6.0:i=242:gtgl=5:av=off:gtg=exists_sym:ss=included:kws=arity_squared:fde=unused_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/all5champsBiggishL14.pt:sil=16000:tgt=ground:npcc=on:sims=off:cond=fast:i=5208:av=off_0");
    quick.push("lrs+1011_1:16_sil=32000:i=134:sd=2:ss=axioms:sgt=14:bce=on:doe=on:erd=off_0");
    quick.push("ott+10_5:4_to=lpo:sil=8000:fde=unused:sp=unary_frequency:spb=goal:i=499:bd=all:urr=on:prc=on_0");
    quick.push("lrs+10_1:64_to=lpo:sil=8000:sp=reverse_frequency:nwc=5.0:flr=on:i=191:bd=all:fgj=on:alpa=false:prc=on_0");
    quick.push("lrs-11_1:32_anc=all:sil=8000:spb=goal_then_units:sac=on:i=264:kws=precedence:fsr=off_0");
    quick.push("lrs-22_1:64_to=lpo:sil=8000:sp=const_frequency:nwc=4.0:cond=on:i=156:flr=on:gtg=exists_all:er=known:urr=ec_only:bs=on_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=reverse_frequency:spb=units:lcm=predicate:urr=on:i=3256:kws=precedence:av=off:s2agt=8:updr=off:bd=preordered_0");
    quick.push("dis+1003_1:128_sil=8000:tgt=full:i=537:av=off:fd=off:ss=included_0");
    quick.push("ott+1010_1:32_to=lpo:sil=8000:urr=on:nwc=4.0:i=180:bd=preordered:av=off_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:sas=cadical:sp=reverse_frequency:alpa=false:sac=on:i=10307:s2at=3.0:bd=preordered:bs=on:fsd=on:bsr=on_0");
    quick.push("lrs-1010_1:1024_to=lpo:sil=8000:tgt=ground:plsq=on:sas=cadical:plsqr=1,32:sp=arity:acc=on:nwc=1.2:alpa=false:i=412:gtgl=4:gtg=exists_all:plsqc=1:bce=on:spb=goal:lma=off_0");
    quick.push("ott+1002_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:etr=on:gs=on:s2agt=16:br=off:i=8478:s2at=4.0:nm=6:urr=on:tgt=ground:bsr=unit_only:s2pl=no:spb=units_0");
    quick.push("ott-1011_1:2_sil=32000:sp=reverse_frequency:erd=off:rnwc=on:s2agt=70:s2a=on:i=303:s2at=2.0:sd=1:ins=10:ss=included:sup=off:fdi=1024:bs=on:urr=on:gs=on:lftc=20:bsd=on:updr=off:kws=inv_arity_0");
    quick.push("lrs+10_1:1_to=lpo:sil=16000:sos=on:i=720:fsr=off:urr=on:ss=axioms:sd=3:st=4.0:fde=none:bsr=on_0");
    quick.push("lrs-20_1:1_to=lpo:sil=32000:tgt=ground:sp=reverse_frequency:spb=goal:urr=on:nwc=1.5:i=598:bd=preordered:av=off:ss=axioms:bs=on:bsr=unit_only_0");
    quick.push("dis-1010_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:sp=occurrence:i=2989:sd=3:ss=axioms:sgt=60_0");
    quick.push("dis+1011_1:1_ncem=casc2026/models/loop5.pt:sil=8000:tgt=full:npcc=on:sp=const_min:spb=goal_then_units:urr=ec_only:s2agt=16:i=1997:av=off:gtg=all:bsd=on:gsp=on:lcm=predicate:bd=preordered_0");
    quick.push("lrs-1010_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:sp=unary_frequency:urr=ec_only:fd=preordered:i=2088:bd=preordered:av=off:drc=off_0");
    quick.push("lrs+1010_64:1_anc=all:to=lpo:sil=16000:sp=const_frequency:urr=full:sac=on:i=1098:nicw=on:fde=none_0");
    quick.push("lrs-1011_32:1_to=lpo:sil=32000:tgt=ground:sos=on:spb=goal_then_units:acc=on:i=433:bd=preordered_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop3.pt:sil=32000:npcc=on:flr=on:i=2942:s2at=20.0:fgj=on:bs=on:er=filter:cond=on:gtg=exists_sym:spb=goal:prc=on:ss=axioms:sgt=16:st=5.37:etr=on:aac=none_0");
    quick.push("lrs+35_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:sp=reverse_arity:urr=full:rp=on:br=off:i=6922:s2at=5.0:sd=3:ss=axioms:sgt=32:er=known:bd=all_0");
    quick.push("dis+10_5:1_sil=8000:urr=on:fd=off:nwc=0.5:br=off:s2a=on:i=596:s2at=2.3:gtgl=5:gtg=all:tgt=full:slsq=on:slsqc=3:plsq=on:plsqc=1:plsqr=32,1:sup=off_0");
    quick.push("lrs+21_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=non_intro:urr=on:fd=preordered:i=4123:kws=inv_frequency:bd=preordered:av=off:er=known_0");
    quick.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:i=16411:kws=arity:bd=preordered:ins=6:ss=axioms:sgt=30:fgj=on:lma=off:kmz=on_0");
    quick.push("lrs+0_1:1_ncem=casc2026/models/loop1.pt:sil=8000:tgt=full:npcc=on:sp=reverse_frequency:i=1670:kws=inv_precedence:bd=all:av=off:gtg=exists_all:gs=on_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:drc=off:fde=unused:sp=reverse_frequency:st=3.0:i=1722:sd=2:ss=included:fsd=on:cond=fast:prc=on:updr=off_0");
    quick.push("ott-1004_1:1_anc=all_dependent:to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:tgt=full:npcc=on:sas=cadical:sp=const_frequency:gs=on:s2agt=40:sac=on:cond=on:i=9530:bs=on:alpa=false:urr=ec_only:cts=off:acc=on:fsd=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop4.pt:sil=64000:npcc=on:sp=occurrence:i=4495:ss=included:sd=10:st=2.0_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=ground:npcc=on:sp=reverse_arity:spb=non_intro:s2agt=16:i=4920:s2at=1.9:kws=inv_frequency:av=off:sfv=off:er=filter:cond=fast_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop6.pt:sil=32000:tgt=ground:npcc=on:sp=const_frequency:bce=on:bsr=unit_only:cond=on:i=2083:s2at=-1.0:fgj=on:av=off:lcm=reverse:cts=off_0");
    quick.push("lrs+31_1:1_to=lpo:ncem=casc2026/models/loop2.pt:sil=16000:npcc=on:sp=weighted_frequency:spb=units:bsr=on:gs=on:i=4629:gsp=on:sos=all:av=off:lcm=predicate_0");
    quick.push("dis+10_1:64_sil=16000:tgt=full:plsq=on:drc=off:plsqc=2:plsqr=32,1:spb=goal:i=1258:av=off:prc=on_0");
    quick.push("ott+1_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:i=7343:fdtod=off:ss=included:av=off_0");
    quick.push("lrs-1002_1:1_to=lpo:sil=16000:sp=reverse_arity:i=1325:sd=2:ss=axioms:sgt=16:sos=on_0");
    quick.push("dis+1011_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:sp=arity:spb=intro:st=3.9:cond=fast:i=2646:s2at=1.8:sd=5:ss=axioms:fsd=on:gtg=position:sac=on:lma=off:prc=on:amm=off:urr=ec_only_0");
    quick.push("dis-1003_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:sp=arity:sos=on:urr=on:i=1489:sd=2:ep=R:ss=axioms_0");
    quick.push("lrs+20_1:1_ncem=casc2026/models/loop3.pt:sil=32000:npcc=on:fde=unused:sp=occurrence:sos=on:lcm=predicate:urr=full:sac=on:i=1503_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop3.pt:sil=16000:tgt=ground:npcc=on:i=13942:kws=frequency_0");
    quick.push("lrs-1002_1:1_to=lpo:ncem=casc2026/models/loop4.pt:sil=16000:npcc=on:bsd=on:sp=unary_frequency:spb=goal:lcm=predicate:acc=on:urr=full:bce=on:bsr=unit_only:s2agt=64:sac=on:i=3604:er=filter:fsr=off_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop5.pt:sil=32000:npcc=on:i=1876:ss=included:sd=1:sgt=32_0");
    quick.push("lrs+10_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:fde=none:sp=arity:urr=on:br=off:i=1932:bd=preordered:ins=10:sup=off:ss=axioms_0");
    quick.push("dis-1010_1:1_ncem=casc2026/models/loop1.pt:sil=8000:npcc=on:fde=unused:sp=weighted_frequency:spb=goal_then_units:urr=ec_only:cond=fast:i=1980:s2at=2.0:kws=inv_precedence:ins=1:av=off:s2pl=on:doe=on:etr=on:gsp=on:kmz=on:fd=preordered_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:npcc=on:sp=unary_first:sos=all:spb=units:urr=on:br=off:i=3902:ss=axioms:sgt=11:kws=inv_arity_squared:fgj=on_0");
    quick.push("dis+10_1:32_sil=16000:tgt=ground:drc=off:sas=cadical:acc=on:alpa=false:avsqc=3:avsq=on:i=3916:aac=none:amm=off_0");
    quick.push("dis+10_1:1_ncem=casc2026/models/all5champsBiggishL14.pt:sil=16000:npcc=on:lcm=predicate:i=3940:er=known:cond=on:tgt=full:av=off:drc=ordering_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:sp=reverse_frequency:bce=on:s2pl=on:i=3980:gtg=all:gtgl=3:kws=precedence:fgj=on_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:sp=reverse_frequency:lsd=20:bce=on:i=2087:s2at=3.0:av=off:spb=units:urr=ec_only:kmz=on:kws=frequency:fsr=off:prc=on:fd=off_0");
    quick.push("ott-1004_1:1_anc=all_dependent:to=lpo:ncem=casc2026/models/loop5.pt:sil=8000:tgt=full:npcc=on:sas=cadical:sp=const_frequency:gs=on:s2agt=40:sac=on:cond=on:i=4272:bs=on:alpa=false:urr=ec_only:cts=off:acc=on:fsd=on_0");
    quick.push("lrs-30_1:1_ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:urr=on:bce=on:rp=on:br=off:flr=on:st=-1.0:i=2197:kws=precedence:av=off:ss=axioms:er=known_0");
    quick.push("dis+21_1:1_sil=8000:spb=goal_then_units:i=6508:fgj=on:avsq=on:avsqr=1,16:kws=arity_squared_0");
    quick.push("dis-1002_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=occurrence:i=2330:av=off:fgj=on:fsr=off_0");
    quick.push("dis+10_1:2_anc=none:sil=64000:bsr=on:rp=on:alpa=true:avsqc=1:avsq=on:i=7592:avsqr=1,16:bs=on:gsp=on_0");
    quick.push("lrs-1002_1:1_ncem=casc2026/models/loop6.pt:sil=64000:tgt=ground:npcc=on:sp=reverse_frequency:spb=goal_then_units:bce=on:gs=on:flr=on:i=2693:kws=precedence:ins=1:av=off:prc=on:bsr=unit_only:sims=off_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:i=28651:sd=4:ss=included:sgt=64_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop5.pt:sil=32000:tgt=full:npcc=on:sp=unary_frequency:i=2700:kws=precedence:fgj=on:ins=1:bd=preordered_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop8.pt:sil=32000:npcc=on:sp=const_min:sos=on:spb=goal:urr=full:sac=on:i=3196:nm=4:lsd=20:erd=off_0");
    quick.push("ott+11_1:1_ncem=casc2026/models/loop4.pt:sil=64000:tgt=full:irw=on:npcc=on:flr=on:cts=off:i=3254:spb=units:av=off_0");
    quick.push("dis+1011_1:1_ncem=casc2026/models/loop2.pt:sil=32000:tgt=ground:npcc=on:lcm=predicate:i=3264:gtg=exists_sym:bce=on:sac=on:er=known:sfv=off:ss=included:bd=all_0");
    quick.push("lrs+11_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:sp=unary_first:sos=on:lma=off:lsd=20:urr=on:sac=on:i=9708:doe=on:fgj=on:ss=axioms:st=6.0:kmz=on:kws=inv_frequency_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop7.pt:sil=32000:tgt=full:npcc=on:erd=off:spb=goal:sac=on:newcnf=on:i=21997:s2at=5.0:gtg=all_0");
    quick.push("dis+10_1:14_to=lpo:sil=8000:tgt=full:drc=off:sp=const_frequency:sos=all:i=7551:gtgl=5:fsr=off:gtg=exists_all:bs=unit_only_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop7.pt:sil=32000:tgt=ground:npcc=on:sp=const_frequency:urr=on:i=8924:sd=1:ss=included:acc=on_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop2.pt:sil=16000:npcc=on:sp=arity:fd=preordered:i=9638:bd=preordered:kws=frequency_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop4.pt:sil=8000:npcc=on:prc=on:drc=off:sp=const_min:sos=on:s2agt=20:br=off:flr=on:i=5177:s2at=1.5:bd=preordered:ins=10:fdi=128:lcm=predicate_0");
    quick.push("lrs-1011_1:1_ncem=casc2026/models/loop4.pt:sil=32000:tgt=ground:npcc=on:sas=cadical:sp=unary_first:acc=on:alpa=false:i=6464:aac=none:ins=10_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=128000:npcc=on:urr=on:fd=preordered:i=19192:av=off:erd=off:bsr=on_0");
    quick.push("lrs+10_1:1_to=lpo:ncem=casc2026/models/loop3.pt:sil=8000:npcc=on:prc=on:fde=unused:sp=const_min:i=7136:fgj=on:bd=preordered:ins=3:ss=included_0");
    quick.push("ott-1004_1:1_anc=all_dependent:to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:tgt=full:npcc=on:sas=cadical:sp=const_frequency:gs=on:s2agt=40:sac=on:cond=on:i=7540:bs=on:alpa=false:urr=ec_only:cts=off:acc=on:fsd=on_0");
    quick.push("ott+1011_1:1_to=lpo:ncem=casc2026/models/loop5.pt:sil=64000:tgt=ground:npcc=on:drc=off:sp=const_frequency:i=15570:s2at=5.0:gtgl=4:gtg=exists_sym_0");
    quick.push("lrs+1011_1:1_anc=none:to=lpo:ncem=casc2026/models/loop6.pt:sil=32000:tgt=full:npcc=on:sp=unary_first:spb=goal:lsd=20:bce=on:bsr=on:fd=preordered:gs=on:i=15957:fgj=on:add=on_0");
    quick.push("lrs+1010_1:1_to=lpo:ncem=casc2026/models/loop3.pt:sil=32000:tgt=full:npcc=on:drc=ordering:sp=arity:spb=intro:urr=ec_only:cond=on:i=8289:prc=on:proc=on:er=filter:s2agt=40:fde=none:erml=3:bd=preordered_0");
    quick.push("lrs+4_1:4_to=lpo:sil=128000:i=16865:bs=unit_only:lwlo=on:nicw=on:sac=on:flr=on_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:sp=arity:lcm=predicate:urr=on:s2agt=16:i=67727:sd=2:ss=axioms:sgt=64:fgj=on:br=off_0");
    quick.push("lrs+1011_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=ground:npcc=on:sp=reverse_frequency:flr=on:i=17955:s2at=3.0:fd=preordered:cond=on:fsd=on:aac=none_0");
    quick.push("dis-1010_1:1_ncem=casc2026/models/loop6.pt:sil=64000:tgt=ground:irw=on:npcc=on:sac=on:i=10108:bd=preordered_0");
    quick.push("lrs+2_1:1_ncem=casc2026/models/loop4.pt:sil=64000:npcc=on:spb=goal:lcm=predicate:i=10307:kws=inv_arity_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop8.pt:sil=64000:tgt=ground:npcc=on:sp=arity:i=25534:bd=all:urr=on_0");
    quick.push("lrs+31_1:1_ncem=casc2026/models/loop3.pt:sil=16000:npcc=on:i=12907:kws=precedence_0");
    quick.push("dis+11_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:sp=unary_first:lcm=reverse:urr=on:gs=on:s2agt=64:br=off:i=14634:s2at=20.0:av=off:to=lpo:fsr=off_0");
    quick.push("lrs-1011_1:1_ncem=casc2026/models/loop5.pt:sil=32000:npcc=on:sp=reverse_frequency:urr=on:br=off:flr=on:i=14826:s2at=5.0:fdi=4:gtg=exists_sym:gtgl=2:spb=goal_then_units:to=lpo:er=filter_0");
    quick.push("ott+1011_1:16_slsqr=800179,524288:sil=16000:lsd=1:slsq=on:i=16431:aac=none:bs=unit_only:fsr=off:slsql=off:nicw=on_0");
    quick.push("lrs-1011_1:1_to=lpo:ncem=casc2026/models/loop7.pt:sil=32000:npcc=on:drc=off:sas=cadical:sp=arity:spb=units:acc=on:urr=ec_only:fd=preordered:gs=on:s2agt=16:i=17138:aac=none:fgj=on:bd=all:fsr=off:lsd=1_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop7.pt:sil=64000:tgt=ground:npcc=on:sp=arity:i=19809:bd=all:urr=on_0");
    quick.push("lrs+1010_1:1_to=lpo:ncem=casc2026/models/loop8.pt:sil=64000:tgt=full:npcc=on:drc=off:fde=none:sp=const_min:urr=on:st=3.0:i=19814:s2at=5.0:fgj=on:bd=preordered:ins=2:ss=axioms:sgt=8_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=full:npcc=on:drc=off:sp=weighted_frequency:spb=goal:fd=preordered:i=80579:foolp=on_0");
    quick.push("lrs-1010_1:1_ncem=casc2026/models/loop8.pt:sil=32000:tgt=ground:npcc=on:sp=arity:lcm=predicate:kmz=on:i=33336:s2at=2.0:kws=precedence:ins=1:fsd=on:fsdmm=10_0");
    quick.push("lrs+10_1:1_ncem=casc2026/models/loop5.pt:sil=128000:npcc=on:sp=reverse_frequency:bce=on:s2pl=on:i=90455:gtg=all:gtgl=3:kws=precedence:fgj=on_0");
    quick.push("lrs+1010_1:1_ncem=casc2026/models/loop7.pt:sil=64000:npcc=on:spb=units:s2agt=4:st=3.0:i=55875:sd=6:ss=axioms_0");
    quick.push("ott+11_1:1_ncem=casc2026/models/loop8.pt:sil=128000:npcc=on:sp=reverse_frequency:spb=goal_then_units:urr=on:i=65234:nm=2:av=off:kws=inv_precedence:br=off_0");
    quick.push("lrs+10_1:1_anc=all:sfv=off:to=kbo:ncem=casc2026/models/loop7.pt:sil=128000:tgt=ground:npcc=on:sp=const_frequency:urr=on:s2agt=20:sac=on:i=76806:s2at=1.31:bd=all:ins=10:foolp=on:acc=on:gtg=exists_top_0");
    quick.push("dis-1010_1:16_sil=128000:plsq=on:plsqc=1:acc=on:urr=on:fd=off:br=off:i=90192:nicw=on:prc=on_0");
    quick.push("dis+10_1:1_ncem=casc2026/models/loop7.pt:sil=128000:tgt=full:npcc=on:drc=ordering:sp=const_frequency:i=109431:bd=all:gtg=exists_top:spb=goal:fd=preordered:fgj=on_0");
    quick.push("lrs+1002_1:1_ncem=casc2026/models/loop8.pt:sil=128000:tgt=ground:npcc=on:drc=off:sp=reverse_frequency:spb=goal:acc=on:s2agt=16:kmz=on:sac=on:i=122881:kws=inv_arity_squared:fgj=on:bd=preordered_0");
    // total_instr 1360653
    // len(covered) 4174
  }
}