...
{
  quick.push("fmb+1_1473:930133_bsr=unit_only:fmbas=function:irw=on:bsd=on:avsqr=5419031,624300:etr=on:sp=frequency:sos=all:lma=on:fs=off:drc=off:urr=on:bce=on:fmbes=contour:awrs=decay:awrsf=12:flr=on:avsqc=2:fmbswr=7:lwlo=on:gsem=off:avsq=on:fmbsr=1.43447:fmbswo=diagonal:ins=2:bd=preordered:nm=11:av=off:fsr=off:gs=on:gsp=input_only_50");
