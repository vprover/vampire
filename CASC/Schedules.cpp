...
void Schedules::getCasc2025Schedule(const Property& property, Schedule& quick, Schedule& champions)
{
  ...
  if (property.higherOrder()) {
    ...
    // Sub-schedule for 2000Mi strat cap / 2000Mi overall limit
    quick.push("dis+1004_4:1_acc=on:add=off:bd=all:c=on:e2e=on:fd=preordered:fde=unused:gtg=position:hsq=on:hsqr=16,1:nm=64:ntd=on:plsq=on:s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,2:spb=goal_then_units:to=lpo:urr=on:uwa=off:i=694:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cbe=off:cs=on:e2e=on:fsr=off:s2a=on:sil=128000:uwa=interpreted_only:i=2:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen_be_off:drc=ordering:lma=off:ntd=on:s2a=on:uwa=off:i=2:si=on:rtra=on_0");
    ...
    quick.push("dis+21_1:4_av=off:e2e=on:fde=none:foolp=on:uwa=off:i=22:si=on:rtra=on_0");
    quick.push("lrs+1010_2:3_av=off:cha=on:fe=axiom:fgj=on:ntd=on:nwc=1.0:uwa=off:i=5:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cs=on:ntd=on:i=13:si=on:rtra=on_0");
    quick.push("dis+1002_1:8_add=on:cbe=off:drc=off:hsqr=1,8:lma=off:nm=2:s2at=5.0:sil=128000:sp=const_max:spb=non_intro:tgt=full:to=kbo:uwa=interpreted_only:i=141:si=on:rtra=on_0");
    quick.push("dis+10_1:1_aac=none:anc=all_dependent:chr=on:fe=abstraction:sil=128000:to=kbo:uwa_fpi=on:i=3:si=on:rtra=on_0");
    quick.push("lrs+10_1:40_drc=off:e2e=on:ntd=on:s2a=on:uwa=one_side_interpreted:i=108:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=off:inj=on:ntd=on:uwa=one_side_interpreted:i=3:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=85:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_sd=1:sil=128000:sos=on:spb=goal_then_units:ss=axioms:st=2.0:to=lpo:uwa=off:i=241:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_bsd=on:cbe=off:drc=ordering:fde=none:flr=on:gsp=on:s2a=on:ser=on:sp=const_min:to=lpo:uwa=off:i=11:si=on:rtra=on_0");
    quick.push("ott+21_1:1_add=off:bsd=on:cnfonf=lazy_gen:foolp=on:lma=off:lwlo=on:nm=40:rawr=on:s2agt=10:sil=128000:sp=const_frequency:to=kbo:uwa=off:i=15:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_e2e=on:fd=off:fde=unused:nm=16:s2a=on:sil=128000:sos=on:urr=on:uwa=one_side_constant:i=9:si=on:rtra=on_0");
    quick.push("dis+10_3:2_acc=on:avsq=on:e2e=on:fd=preordered:fde=unused:hsq=on:hsql=off:hsqr=16,1:ins=20:nicw=on:nm=16:ntd=on:pe=on:plsq=on:s2a=on:sfv=off:slsq=on:slsqc=1:sp=reverse_frequency:ss=axioms:to=kbo:uwa=off:i=16:si=on:rtra=on_0");
    quick.push("lrs+1003_3:2_bd=all:bs=unit_only:bsr=unit_only:cnfonf=lazy_gen:flr=on:hud=7:nicw=on:pe=on:piset=and:rawr=on:s2a=on:s2agt=16:slsq=on:slsqr=2,1:sp=reverse_frequency:to=lpo:uwa=hol:uwa_fpi=on:i=38:si=on:rtra=on_0");
    quick.push("dis+10_1:1024_bd=preordered:bet=on:cnfonf=off:fd=off:hud=5:sil=128000:i=7:si=on:rtra=on_0");
    quick.push("lrs+1010_4:1_cha=on:chr=on:drc=off:fd=preordered:fe=abstraction:gs=on:inj=on:kmz=on:lcm=predicate:nm=2:nwc=5.0:pe=on:s2agt=32:slsq=on:slsqc=1:slsqr=8,1:sp=arity:to=kbo:updr=off:uwa=off:i=24:si=on:rtra=on_0");
    quick.push("ott+1002_1:3_av=off:cbe=off:cts=off:fsr=off:ntd=on:slsqc=2:sp=weighted_frequency:spb=goal:uwa_fpi=on:i=27:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_ntd=on:sd=4:sil=128000:ss=axioms:st=3.0:uwa=off:i=457:si=on:rtra=on_0");
    quick.push("dis+1002_1:16_av=off:cond=fast:fe=abstraction:hud=1:ntd=on:sil=128000:sp=occurrence:i=23:si=on:rtra=on_0");
    // Improves by expected 2438.292915567203 probs costing 1999 Mi
    // Sub-schedule for 4000Mi strat cap / 4000Mi overall limit
    quick.push("dis+1010_2:1_cnfonf=lazy_pi_sigma_gen:ixr=off:sil=128000:slsq=on:uwa=off:i=688:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=1:sil=128000:sos=on:ss=axioms:urr=on:i=238:si=on:rtra=on_0");
    quick.push("ott+1002_1:32_acc=on:fe=abstraction:fgj=on:nwc=0.5:piset=pi_sigma:sp=const_max:tgt=ground:i=135:si=on:rtra=on_0");
    quick.push("dis+10_1:1024_fd=off:hud=10:sil=128000:sp=unary_first:urr=on:uwa=all:i=43:si=on:rtra=on_0");
    quick.push("dis+10_1:8_avsq=on:avsqr=8,1:bd=preordered:foolp=on:kws=precedence:lma=off:ntd=on:plsq=on:plsqc=1:plsqr=64,1:sd=2:sil=128000:sos=on:sp=unary_first:ss=axioms:st=3.0:uwa=interpreted_only:i=219:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_acc=on:add=on:c=on:e2e=on:fd=preordered:fde=none:foolp=on:gtg=position:hsq=on:hsqr=16,1:inj=on:ixr=off:nicw=on:nm=16:ntd=on:plsq=on:rawr=on:s2a=on:s2agt=32:sfv=off:slsq=on:slsqc=1:spb=non_intro:ss=included:to=lpo:uwa=off:i=1349:si=on:rtra=on_0");
    quick.push("lrs+21_3:1_bd=preordered:cnfonf=lazy_gen:fgj=on:plsq=on:plsqc=1:plsqr=1070,37:s2a=on:uwa=interpreted_only:i=55:si=on:rtra=on_0");
    quick.push("dis+10_1:2_av=off:fe=abstraction:fsd=on:ntd=on:s2a=on:sil=128000:ss=axioms:i=203:si=on:rtra=on_0");
    quick.push("lrs+10_5:1_bd=all:sil=128000:urr=on:uwa=one_side_constant:i=11:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=lazy_gen:hud=10:sos=on:to=lpo:i=8:si=on:rtra=on_0");
    quick.push("ott+1010_1:64_av=off:bd=all:cnfonf=lazy_simp:fsdmm=1:hud=10:ixr=off:lcm=predicate:lma=off:piset=not:s2at=5.0:spb=goal:tgt=ground:i=29:si=on:rtra=on_0");
    quick.push("lrs+10_1:16_fe=abstraction:kws=arity_squared:ntd=on:nwc=1.5:i=18:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_cnfonf=lazy_pi_sigma_gen:ss=axioms:st=1.5:uwa=off:i=299:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=65:si=on:rtra=on_0");
    quick.push("lrs+1010_1:3_avsq=on:avsqr=8,1:fsr=off:hud=5:ins=1:sil=128000:slsq=on:i=12:si=on:rtra=on_0");
    ...
    quick.push("lrs+1002_1:1024_cond=on:e2e=on:fde=none:ntd=on:nwc=1.0:sil=128000:tgt=ground:uwa=off:i=59:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=54:si=on:rtra=on_0");
    quick.push("ott+1002_1:3_av=off:cbe=off:cts=off:fsr=off:ntd=on:slsqc=2:sp=weighted_frequency:spb=goal:uwa_fpi=on:i=187:si=on:rtra=on_0");
    // Improves by expected 252.99283020201668 probs costing 3993 Mi
    // Sub-schedule for 4000Mi strat cap / 4000Mi overall limit
    quick.push("lrs+10_1:1024_add=on:avsq=on:avsqr=1,32:bd=all:cnfonf=lazy_pi_sigma_gen:hud=10:rawr=on:s2a=on:sil=128000:sp=const_max:to=lpo:i=22:si=on:rtra=on_0");
    quick.push("lrs+1004_1:128_fsr=off:sos=all:uwa=off:i=53:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_av=off:bd=all:fd=preordered:fde=none:sp=const_max:spb=non_intro:to=lpo:uwa=off:i=87:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_bd=preordered:e2e=on:fde=none:fe=abstraction:fsr=off:ixr=off:nm=2:rawr=on:sgt=16:sil=128000:spb=units:ss=axioms:uwa=interpreted_only:i=23:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_fe=abstraction:hsq=on:hsqaw=5:hsqc=4:ntd=on:sil=128000:sos=on:i=44:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=44:si=on:rtra=on_0");
    quick.push("dis+2_1:1_bd=preordered:c=on:e2e=on:kws=inv_arity:nm=64:ntd=on:nwc=2.0:sd=50:sil=128000:sos=on:ss=axioms:tgt=ground:urr=on:uwa=off:i=69:si=on:rtra=on_0");
    ...
    quick.push("lrs+10_1:1_cs=on:ntd=on:i=22:si=on:rtra=on_0");
    quick.push("dis+10_1:3_nm=0:s2a=on:s2agt=8:sac=on:sfv=off:sil=128000:tgt=full:uwa=off:i=269:si=on:rtra=on_0");
    quick.push("ott-1010_1:32_avsqr=2,1:cbe=off:doe=on:fdtod=off:ins=25:ntd=on:sil=128000:to=kbo:uwa=off:i=287:si=on:rtra=on_0");
    quick.push("lrs+10_5:1_bd=all:sil=128000:urr=on:uwa=one_side_constant:i=11:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_anc=none:br=off:cts=off:fe=axiom:nm=30:rawr=on:sas=cadical:sil=128000:sp=const_frequency:uwa=one_side_interpreted:i=134:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=lazy_gen:hud=10:sos=on:to=lpo:i=8:si=on:rtra=on_0");
    quick.push("lrs+10_1:16_fe=abstraction:kws=arity_squared:ntd=on:nwc=1.5:i=60:si=on:rtra=on_0");
    quick.push("dis+1010_1:16_fe=axiom:nwc=1.0:urr=on:i=59:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=63:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:kws=inv_frequency:s2at=2.0:sil=128000:slsq=on:slsqc=1:urr=on:i=14:si=on:rtra=on_0");
    quick.push("lrs+1002_4:1_bd=all:cnfonf=lazy_gen:ntd=on:plsq=on:plsqc=1:plsql=on:plsqr=32,1:sac=on:sil=128000:sos=all:st=3.0:uwa=one_side_interpreted:i=12:si=on:rtra=on_0");
    quick.push("dis+10_1:1_erd=off:s2a=on:s2at=5.0:sil=128000:uwa=off:i=143:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_e2e=on:fd=off:fde=unused:nm=16:s2a=on:sil=128000:sos=on:urr=on:uwa=one_side_constant:i=594:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_kws=precedence:sil=128000:sos=all:sp=unary_frequency:uwa=off:i=205:si=on:rtra=on_0");
    quick.push("lrs+1010_4:1_cha=on:chr=on:drc=off:fd=preordered:fe=abstraction:gs=on:inj=on:kmz=on:lcm=predicate:nm=2:nwc=5.0:pe=on:s2agt=32:slsq=on:slsqc=1:slsqr=8,1:sp=arity:to=kbo:updr=off:uwa=off:i=997:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_ntd=on:piset=and:uwa=one_side_interpreted:i=251:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_sd=3:sil=128000:ss=axioms:st=2.0:uwa=off:i=306:si=on:rtra=on_0");
    quick.push("ott+10_1:1_cnfonf=lazy_pi_sigma_gen:hud=5:lcm=reverse:lma=off:piset=pi_sigma:rp=on:sil=128000:sp=reverse_frequency:to=lpo:i=64:si=on:rtra=on_0");
    // Improves by expected 76.57798905936455 probs costing 3995 Mi
    // Sub-schedule for 8000Mi strat cap / 8000Mi overall limit
    quick.push("lrs+10_1:1024_add=on:avsq=on:avsqr=1,32:bd=all:cnfonf=lazy_pi_sigma_gen:hud=10:rawr=on:s2a=on:sil=128000:sp=const_max:to=lpo:i=129:si=on:rtra=on_0");
    quick.push("ott+2_2:1_cbe=off:drc=off:lma=off:lrd=on:nm=0:sil=128000:tgt=full:urr=on:uwa=interpreted_only:i=123:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen_be_off:drc=ordering:lma=off:ntd=on:s2a=on:uwa=off:i=216:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=1294:si=on:rtra=on_0");
    quick.push("ott+21_1:128_add=on:bd=preordered:cbe=off:cnfonf=lazy_not_be_gen:fd=preordered:fe=abstraction:ins=20:lma=off:sos=all:ss=axioms:st=1.5:uwa_fpi=on:i=515:si=on:rtra=on_0");
    quick.push("dis+10_4:1_acc=on:c=on:cnfonf=off:e2e=on:fd=preordered:fde=unused:foolp=on:hsq=on:hsqr=16,1:nm=32:piset=or:rawr=on:s2a=on:sas=cadical:sfv=off:sgt=8:sp=occurrence:ss=axioms:to=kbo:uwa=off:i=5656:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=57:si=on:rtra=on_0");
    quick.push("lrs+1002_4:1_bd=all:cnfonf=lazy_gen:ntd=on:plsq=on:plsqc=1:plsql=on:plsqr=32,1:sac=on:sil=128000:sos=all:st=3.0:uwa=one_side_interpreted:i=12:si=on:rtra=on_0");
    // Improves by expected 132.38192515241548 probs costing 7994 Mi
    // Sub-schedule for 20000Mi strat cap / 20000Mi overall limit
    quick.push("lrs+10_1:1024_add=on:avsq=on:avsqr=1,32:bd=all:cnfonf=lazy_pi_sigma_gen:hud=10:rawr=on:s2a=on:sil=128000:sp=const_max:to=lpo:i=22:si=on:rtra=on_0");
    quick.push("dis+1010_3:2_anc=all_dependent:avsq=on:avsqr=1,32:bce=on:fd=off:hud=15:lma=off:nm=0:ntd=on:sil=128000:sos=on:spb=goal_then_units:uwa_fpi=on:i=139:si=on:rtra=on_0");
    quick.push("dis+10_1:1024_bd=all:lma=off:sac=on:sil=128000:to=lpo:uwa=interpreted_only:i=122:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_cnfonf=lazy_pi_sigma_gen:ixr=off:sil=128000:slsq=on:uwa=off:i=2191:si=on:rtra=on_0");
    quick.push("dis-1010_1:128_fde=unused:sil=128000:tgt=ground:tsa=off:uwa=off:i=213:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_bd=preordered:e2e=on:fde=none:fe=abstraction:fsr=off:ixr=off:nm=2:rawr=on:sgt=16:sil=128000:spb=units:ss=axioms:uwa=interpreted_only:i=40:si=on:rtra=on_0");
    quick.push("dis+1002_5:4_add=on:cnfonf=lazy_simp:fdi=1024:fe=axiom:lwlo=on:plsq=on:plsqc=1:plsql=on:plsqr=878,253:s2a=on:sil=128000:uwa=interpreted_only:i=334:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sil=128000:sos=on:urr=on:uwa=one_side_constant:i=399:si=on:rtra=on_0");
    quick.push("lrs+2_16:1_add=on:cbe=off:fdi=1024:fgj=on:uwa=interpreted_only:i=110:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_fe=abstraction:hud=5:nwc=1.0:piset=or:s2a=on:tgt=ground:tsa=off:i=90:si=on:rtra=on_0");
    quick.push("lrs+10_1:64_anc=all_dependent:cbe=off:e2e=on:ep=RSTC:ntd=on:sil=128000:uwa=off:i=87:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:fe=abstraction:sil=128000:ss=axioms:i=233:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_acc=on:add=on:c=on:e2e=on:fd=preordered:fde=none:foolp=on:gtg=position:hsq=on:hsqr=16,1:inj=on:ixr=off:nicw=on:nm=16:ntd=on:plsq=on:rawr=on:s2a=on:s2agt=32:sfv=off:slsq=on:slsqc=1:spb=non_intro:ss=included:to=lpo:uwa=off:i=11428:si=on:rtra=on_0");
    quick.push("dis+10_1:1024_bd=preordered:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:rawr=on:sil=128000:to=lpo:i=131:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=594:si=on:rtra=on_0");
    quick.push("ott+1003_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:hud=10:ixr=off:sp=weighted_frequency:spb=units:to=kbo:urr=on:uwa_fpi=on:i=427:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=65:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=on:cnfonf=lazy_pi_sigma_gen:sac=on:sas=cadical:sil=128000:sos=all:to=lpo:uwa=off:i=601:si=on:rtra=on_0");
    quick.push("lrs-1002_4:1_acc=on:e2e=on:foolp=on:gtg=exists_top:hsq=on:hsqlw=5:hsqr=16,1:nm=16:plsq=on:prc=on:proc=on:s2a=on:s2agt=16:ser=on:sfv=off:slsq=on:slsqc=1:spb=goal:to=lpo:uwa=off:i=650:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:kws=inv_frequency:s2at=2.0:sil=128000:slsq=on:slsqc=1:urr=on:i=446:si=on:rtra=on_0");
    quick.push("dis+1002_1:20_cbe=off:e2e=on:fsr=off:ins=7:sil=128000:tgt=full:uwa=off:i=1271:si=on:rtra=on_0");
    ...
    quick.push("dis+10_3:2_acc=on:avsq=on:e2e=on:fd=preordered:fde=unused:hsq=on:hsql=off:hsqr=16,1:ins=20:nicw=on:nm=16:ntd=on:pe=on:plsq=on:s2a=on:sfv=off:slsq=on:slsqc=1:sp=reverse_frequency:ss=axioms:to=kbo:uwa=off:i=145:si=on:rtra=on_0");
    quick.push("ott+1002_1:3_av=off:cbe=off:cts=off:fsr=off:ntd=on:slsqc=2:sp=weighted_frequency:spb=goal:uwa_fpi=on:i=129:si=on:rtra=on_0");
    // Improves by expected 129.6370133806636 probs costing 19973 Mi
    // Sub-schedule for 40000Mi strat cap / 40000Mi overall limit
    quick.push("dis+10_1:1_av=off:fsr=off:ixr=off:sil=128000:urr=on:uwa=off:i=344:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cbe=off:cs=on:e2e=on:fsr=off:s2a=on:sil=128000:uwa=interpreted_only:i=251:si=on:rtra=on_0");
    quick.push("dis+1010_1:7_acc=on:cbe=off:cnfonf=lazy_not_gen:erd=off:nm=32:nwc=2.0:piset=all:sil=128000:sos=all:uwa=one_side_interpreted:i=241:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_bd=preordered:e2e=on:fde=none:fe=abstraction:fsr=off:ixr=off:nm=2:rawr=on:sgt=16:sil=128000:spb=units:ss=axioms:uwa=interpreted_only:i=23:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen_be_off:drc=ordering:lma=off:ntd=on:s2a=on:uwa=off:i=429:si=on:rtra=on_0");
    quick.push("lrs-1002_1:1_aac=none:cbe=off:cond=on:ep=R:fe=abstraction:lma=off:ntd=on:plsql=on:slsq=on:sp=arity:spb=intro:uwa=off:i=424:si=on:rtra=on_0");
    quick.push("dis+10_3:1_e2e=on:sil=128000:ss=axioms:st=2.0:urr=ec_only:uwa=one_side_constant:i=514:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_avsqc=4:fe=abstraction:fgj=on:hud=5:ixr=off:nm=16:ntd=on:piset=pi_sigma:sos=on:sp=const_frequency:spb=non_intro:ss=axioms:st=3.0:to=kbo:uwa=hol:uwa_fpi=on:i=683:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=off:c=on:cbe=off:cnfonf=lazy_simp:drc=ordering:fsr=off:irw=on:lwlo=on:nm=10:piset=or:plsq=on:plsqc=4:plsqr=32,1:rp=on:sos=on:sp=reverse_frequency:to=lpo:uwa=off:i=368:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=818:si=on:rtra=on_0");
    quick.push("ott+10_1:1_bd=all:e2e=on:sac=on:sil=128000:sos=on:to=lpo:uwa=off:i=486:si=on:rtra=on_0");
    quick.push("dis+1002_8:1_e2e=on:sil=128000:uwa=off:i=368:si=on:rtra=on_0");
    quick.push("dis+1004_1:8_bd=preordered:bet=on:cnfonf=lazy_pi_sigma_gen:drc=off:hsqr=1,4:nm=0:sil=128000:sos=on:sp=reverse_frequency:ss=axioms:uwa=off:i=694:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_bsr=on:chr=on:gs=on:kws=inv_arity_squared:nwc=11.4:sgt=30:sil=128000:sos=all:to=kbo:uwa=off:i=264:si=on:rtra=on_0");
    quick.push("dis+10_1:128_nm=32:piset=and:sil=128000:spb=intro:to=lpo:uwa=off:i=284:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:cnfonf=off:fde=none:s2a=on:s2at=3.0:sil=128000:sp=unary_first:to=lpo:urr=on:uwa=one_side_constant:i=417:si=on:rtra=on_0");
    quick.push("dis+10_1:6_bce=on:cbe=off:doe=on:fdi=1024:fgj=on:ntd=on:piset=and:sil=128000:slsq=on:slsqc=4:slsql=off:sp=arity:uwa=interpreted_only:i=931:si=on:rtra=on_0");
    quick.push("dis+10_1:1_bd=all:cnfonf=lazy_not_gen_be_off:ntd=on:s2a=on:s2at=10.0:sil=128000:uwa=off:i=300:si=on:rtra=on_0");
    quick.push("dis+10_1:1_fsr=off:ixr=off:sac=on:sil=128000:sp=unary_first:tgt=ground:to=lpo:uwa=off:i=934:si=on:rtra=on_0");
    quick.push("lrs+1010_2:3_av=off:cha=on:fe=axiom:fgj=on:ntd=on:nwc=1.0:uwa=off:i=696:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_lma=off:sd=2:sil=128000:sos=all:ss=axioms:st=2.0:urr=on:i=790:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_fe=abstraction:hud=5:nwc=1.0:piset=or:s2a=on:tgt=ground:tsa=off:i=90:si=on:rtra=on_0");
    quick.push("dis+1010_1:4_add=off:anc=all_dependent:cbe=off:cnfonf=conj_eager:fde=unused:fe=abstraction:fsr=off:lma=off:ntd=on:sil=128000:sp=reverse_frequency:spb=intro:to=lpo:uwa=off:i=792:si=on:rtra=on_0");
    quick.push("lrs+10_1:64_anc=all_dependent:cbe=off:e2e=on:ep=RSTC:ntd=on:sil=128000:uwa=off:i=144:si=on:rtra=on_0");
    quick.push("lrs+10_1:40_drc=off:e2e=on:ntd=on:s2a=on:uwa=one_side_interpreted:i=1522:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_av=off:bd=preordered:cnfonf=lazy_gen:kws=precedence:plsq=on:plsqc=1:plsqr=256,1:sil=128000:sos=on:tgt=ground:uwa=off:i=742:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=1696:si=on:rtra=on_0");
    quick.push("lrs+21_3:1_bd=preordered:cnfonf=lazy_gen:fgj=on:plsq=on:plsqc=1:plsqr=1070,37:s2a=on:uwa=interpreted_only:i=297:si=on:rtra=on_0");
    quick.push("dis+10_1:1_aac=none:bd=all:cbe=off:doe=on:fe=abstraction:nwc=5.0:piset=not:sil=128000:tgt=ground:to=lpo:urr=on:uwa=one_side_constant:i=767:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=off:hud=10:ins=1:ntd=on:i=81:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_anc=none:br=off:cts=off:fe=axiom:nm=30:rawr=on:sas=cadical:sil=128000:sp=const_frequency:uwa=one_side_interpreted:i=127:si=on:rtra=on_0");
    quick.push("dis+10_1:16_av=off:bsd=on:cnfonf=conj_eager:cts=off:fe=abstraction:nwc=1.0:ss=axioms:i=803:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_e2e=on:ntd=on:sd=1:sil=128000:ss=axioms:st=2.0:uwa=interpreted_only:i=437:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=1420:si=on:rtra=on_0");
    quick.push("lrs+10_1:16_fe=abstraction:kws=arity_squared:ntd=on:nwc=1.5:i=60:si=on:rtra=on_0");
    quick.push("ott+1003_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:hud=10:ixr=off:sp=weighted_frequency:spb=units:to=kbo:urr=on:uwa_fpi=on:i=83:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_cbe=off:cnfonf=lazy_not_be_gen:fde=none:fe=abstraction:hsq=on:hsqlw=0:hud=5:lsd=20:ntd=on:nwc=1.0:rawr=on:s2at=3.0:sil=128000:st=5.0:uwa=hol:i=435:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=65:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_bsd=on:cbe=off:drc=ordering:fde=none:flr=on:gsp=on:s2a=on:ser=on:sp=const_min:to=lpo:uwa=off:i=746:si=on:rtra=on_0");
    quick.push("dis+10_1:1_e2e=on:nm=2:s2a=on:s2at=3.0:sil=128000:uwa=off:i=543:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1024_cond=on:e2e=on:fde=none:ntd=on:nwc=1.0:sil=128000:tgt=ground:uwa=off:i=306:si=on:rtra=on_0");
    quick.push("dis+21_1:1_e2e=on:fde=none:nm=2:s2a=on:s2agt=32:s2at=6.0:sac=on:sil=128000:tgt=full:urr=on:uwa=interpreted_only:i=905:si=on:rtra=on_0");
    quick.push("dis+10_8:1_bd=preordered:sd=2:sgt=8:sil=128000:ss=axioms:uwa=off:i=4596:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=6712:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=preordered:sd=3:sil=128000:ss=axioms:st=5.0:i=566:si=on:rtra=on_0");
    quick.push("dis+10_8:1_acc=on:bd=all:kws=inv_frequency:nm=0:s2a=on:s2agt=64:uwa=interpreted_only:i=100:si=on:rtra=on_0");
    quick.push("ott+1002_1:16_add=on:fe=abstraction:hsqr=1,3:sil=128000:i=414:si=on:rtra=on_0");
    quick.push("ott+1002_3:2_bd=preordered:cnfonf=lazy_gen:cond=fast:fgj=on:foolp=on:lma=off:nwc=1.5:plsqr=32,1:sil=128000:sp=reverse_frequency:to=kbo:uwa=interpreted_only:i=351:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_fde=none:kws=inv_precedence:sil=128000:sos=on:spb=goal_then_units:urr=on:i=786:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=145:si=on:rtra=on_0");
    quick.push("ott+1002_1:3_av=off:cbe=off:cts=off:fsr=off:ntd=on:slsqc=2:sp=weighted_frequency:spb=goal:uwa_fpi=on:i=923:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_ntd=on:sd=4:sil=128000:ss=axioms:st=3.0:uwa=off:i=1177:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_sd=3:sil=128000:ss=axioms:st=2.0:uwa=off:i=537:si=on:rtra=on_0");
    quick.push("ott+10_1:1_cnfonf=lazy_pi_sigma_gen:hud=5:lcm=reverse:lma=off:piset=pi_sigma:rp=on:sil=128000:sp=reverse_frequency:to=lpo:i=64:si=on:rtra=on_0");
    quick.push("dis+10_1:128_add=off:cnfonf=off:kws=frequency:ntd=on:nwc=1.5:plsq=on:plsqc=3:sil=128000:sp=arity:spb=goal_then_units:tgt=full:uwa=one_side_interpreted:i=1351:si=on:rtra=on_0");
    // Improves by expected 108.85066346767465 probs costing 39987 Mi
    // Sub-schedule for 120000Mi strat cap / 120000Mi overall limit
    quick.push("dis+1004_4:1_acc=on:add=off:bd=all:c=on:e2e=on:fd=preordered:fde=unused:gtg=position:hsq=on:hsqr=16,1:nm=64:ntd=on:plsq=on:s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,2:spb=goal_then_units:to=lpo:urr=on:uwa=off:i=3456:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_anc=none:bd=all:sas=cadical:sil=128000:sos=on:sp=weighted_frequency:uwa=one_side_interpreted:i=771:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=1:sil=128000:sos=on:ss=axioms:urr=on:i=8290:si=on:rtra=on_0");
    quick.push("dis+10_1:128_add=off:avsq=on:avsqc=4:bd=preordered:drc=ordering:fde=unused:kws=inv_frequency:lma=off:sil=128000:uwa=interpreted_only:i=628:si=on:rtra=on_0");
    quick.push("ott+1002_1:20_add=on:bce=on:cnfonf=lazy_not_gen_be_off:foolp=on:plsqr=1,32:sil=128000:sp=unary_frequency:uwa=interpreted_only:i=1162:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_bd=preordered:e2e=on:fde=none:fe=abstraction:fsr=off:ixr=off:nm=2:rawr=on:sgt=16:sil=128000:spb=units:ss=axioms:uwa=interpreted_only:i=40:si=on:rtra=on_0");
    ...
    quick.push("dis+1010_1:32_ntd=on:uwa=off:i=206:si=on:rtra=on_0");
    quick.push("lrs+1010_3:1_cnfonf=lazy_gen:fde=none:fsr=off:nm=64:plsq=on:plsqc=1:plsqr=64,1:s2agt=20:s2at=5.0:sas=cadical:sil=128000:sp=unary_first:uwa=off:i=372:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_fe=abstraction:hsq=on:hsqaw=5:hsqc=4:ntd=on:sil=128000:sos=on:i=3019:si=on:rtra=on_0");
    quick.push("ott+21_1:20_add=off:foolp=on:fsr=off:lma=off:nm=16:ntd=on:sd=3:sgt=8:sil=128000:sp=arity:ss=axioms:st=4.0:tgt=ground:to=lpo:uwa=off:i=2168:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=3:sil=128000:ss=axioms:st=4.0:i=2228:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=off:c=on:cbe=off:cnfonf=lazy_simp:drc=ordering:fsr=off:irw=on:lwlo=on:nm=10:piset=or:plsq=on:plsqc=4:plsqr=32,1:rp=on:sos=on:sp=reverse_frequency:to=lpo:uwa=off:i=363:si=on:rtra=on_0");
    quick.push("ott+1002_1:32_acc=on:fe=abstraction:fgj=on:nwc=0.5:piset=pi_sigma:sp=const_max:tgt=ground:i=916:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=7166:si=on:rtra=on_0");
    quick.push("dis+1002_8:1_e2e=on:sil=128000:uwa=off:i=865:si=on:rtra=on_0");
    quick.push("dis+2_1:1_bd=preordered:c=on:e2e=on:kws=inv_arity:nm=64:ntd=on:nwc=2.0:sd=50:sil=128000:sos=on:ss=axioms:tgt=ground:urr=on:uwa=off:i=677:si=on:rtra=on_0");
    quick.push("dis+1004_1:8_bd=preordered:bet=on:cnfonf=lazy_pi_sigma_gen:drc=off:hsqr=1,4:nm=0:sil=128000:sos=on:sp=reverse_frequency:ss=axioms:uwa=off:i=694:si=on:rtra=on_0");
    quick.push("dis+2_1:1_bd=preordered:kws=inv_frequency:nm=0:tgt=full:uwa=one_side_interpreted:i=1100:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_bsr=on:chr=on:gs=on:kws=inv_arity_squared:nwc=11.4:sgt=30:sil=128000:sos=all:to=kbo:uwa=off:i=264:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_aac=none:bd=preordered:e2e=on:fe=abstraction:s2a=on:s2at=3.0:sil=128000:to=lpo:i=275:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:kws=precedence:sd=2:sgt=16:sil=128000:ss=axioms:uwa=all:i=1939:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_fdi=2:fe=abstraction:fgj=on:hud=5:inj=on:ixr=off:rawr=on:s2at=4.0:slsq=on:spb=goal_then_units:ss=included:i=474:si=on:rtra=on_0");
    quick.push("ott+1010_1:1_bd=preordered:cnfonf=lazy_not_gen:nwc=2.0:sil=128000:slsqc=4:sp=unary_frequency:to=lpo:uwa=off:i=1205:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_add=on:bd=all:c=on:cbe=off:cnfonf=lazy_not_be_gen:cond=on:erd=off:hsq=on:lma=off:sil=128000:sos=on:sp=reverse_arity:spb=units:to=lpo:urr=on:uwa=one_side_constant:i=933:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_bsr=on:cnfonf=lazy_pi_sigma_gen:e2e=on:lma=off:nwc=1.0:s2a=on:sac=on:sas=cadical:sil=128000:uwa=interpreted_only:i=3787:si=on:rtra=on_0");
    quick.push("lrs+10_6:13_add=on:anc=all_dependent:bd=all:chr=on:cnfonf=lazy_pi_sigma_gen:cts=off:fd=off:fde=unused:lma=off:ntd=on:nwc=2.0:s2agt=70:sil=128000:slsq=on:slsqc=1:slsql=off:slsqr=2,1:sp=arity:tgt=ground:uwa=interpreted_only:i=964:si=on:rtra=on_0");
    quick.push("dis+1010_1:2_chr=on:sil=128000:uwa=one_side_constant:i=1317:si=on:rtra=on_0");
    quick.push("lrs+10_3:1_anc=all:bd=all:fd=preordered:hsq=on:hsqc=2:hsqr=8,1:ins=10:ntd=on:nwc=1.0:sac=on:sil=128000:sp=unary_first:to=lpo:uwa=interpreted_only:i=1532:si=on:rtra=on_0");
    quick.push("dis+10_1:1_aac=none:anc=all_dependent:chr=on:fe=abstraction:sil=128000:to=kbo:uwa_fpi=on:i=1352:si=on:rtra=on_0");
    quick.push("dis+1004_1:3_add=off:cbe=off:cnfonf=conj_eager:fgj=on:nm=16:nwc=14.0:sil=128000:sp=reverse_arity:uwa=off:uwa_fpi=on:i=2442:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=233:si=on:rtra=on_0");
    quick.push("lrs+21_3:1_bd=preordered:cnfonf=lazy_gen:fgj=on:plsq=on:plsqc=1:plsqr=1070,37:s2a=on:uwa=interpreted_only:i=825:si=on:rtra=on_0");
    quick.push("dis+1010_1:1024_aac=none:add=on:c=on:e2e=on:er=filter:fd=off:kws=inv_frequency:lma=off:ntd=on:plsq=on:plsqc=1:plsqr=64,1:sil=128000:uwa=interpreted_only:i=12243:si=on:rtra=on_0");
    quick.push("dis+10_4:1_acc=on:c=on:cnfonf=off:e2e=on:fd=preordered:fde=unused:foolp=on:hsq=on:hsqr=16,1:nm=32:piset=or:rawr=on:s2a=on:sas=cadical:sfv=off:sgt=8:sp=occurrence:ss=axioms:to=kbo:uwa=off:i=15823:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=off:hud=10:ins=1:ntd=on:i=81:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_anc=none:br=off:cts=off:fe=axiom:nm=30:rawr=on:sas=cadical:sil=128000:sp=const_frequency:uwa=one_side_interpreted:i=461:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_anc=none:bd=all:cnfonf=lazy_gen:doe=on:drc=off:foolp=on:fsr=off:hsqaw=2:hsqc=5:lwlo=on:sil=128000:spb=units:to=kbo:uwa=off:i=229:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=1:sgt=64:sil=128000:ss=axioms:urr=on:i=6641:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=1624:si=on:rtra=on_0");
    quick.push("ott+1003_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:hud=10:ixr=off:sp=weighted_frequency:spb=units:to=kbo:urr=on:uwa_fpi=on:i=2301:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_bd=all:cnfonf=lazy_gen:drc=ordering:fe=abstraction:ntd=on:nwc=2.0:s2a=on:sil=128000:to=lpo:i=280:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:sil=128000:sos=on:ss=axioms:uwa=off:i=1661:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_sd=1:sil=128000:sos=on:spb=goal_then_units:ss=axioms:st=2.0:to=lpo:uwa=off:i=5300:si=on:rtra=on_0");
    quick.push("dis+10_5:4_bd=preordered:e2e=on:nwc=3.0:s2a=on:urr=on:uwa=interpreted_only:i=3060:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_cbe=off:cnfonf=lazy_not_be_gen:fde=none:fe=abstraction:hsq=on:hsqlw=0:hud=5:lsd=20:ntd=on:nwc=1.0:rawr=on:s2at=3.0:sil=128000:st=5.0:uwa=hol:i=435:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=65:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=on:cnfonf=lazy_pi_sigma_gen:sac=on:sas=cadical:sil=128000:sos=all:to=lpo:uwa=off:i=1561:si=on:rtra=on_0");
    quick.push("lrs+1002_4:1_bd=all:cnfonf=lazy_gen:ntd=on:plsq=on:plsqc=1:plsql=on:plsqr=32,1:sac=on:sil=128000:sos=all:st=3.0:uwa=one_side_interpreted:i=2681:si=on:rtra=on_0");
    quick.push("lrs+21_1:8_bd=preordered:e2e=on:fde=unused:fe=abstraction:foolp=on:kws=frequency:tgt=ground:to=kbo:uwa=hol:uwa_fpi=on:i=1346:si=on:rtra=on_0");
    quick.push("dis+1002_1:72_cnfonf=lazy_pi_sigma_gen:cs=on:nwc=1.2:s2a=on:uwa=interpreted_only:i=1710:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_bd=all:chr=on:fd=preordered:sil=128000:slsqc=2:sos=on:sp=const_min:tgt=full:to=lpo:i=331:si=on:rtra=on_0");
    quick.push("dis+10_8:1_acc=on:bd=all:kws=inv_frequency:nm=0:s2a=on:s2agt=64:uwa=interpreted_only:i=100:si=on:rtra=on_0");
    quick.push("ott+1002_3:2_bd=preordered:cnfonf=lazy_gen:cond=fast:fgj=on:foolp=on:lma=off:nwc=1.5:plsqr=32,1:sil=128000:sp=reverse_frequency:to=kbo:uwa=interpreted_only:i=1950:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=2457:si=on:rtra=on_0");
    quick.push("lrs+1003_3:2_bd=all:bs=unit_only:bsr=unit_only:cnfonf=lazy_gen:flr=on:hud=7:nicw=on:pe=on:piset=and:rawr=on:s2a=on:s2agt=16:slsq=on:slsqr=2,1:sp=reverse_frequency:to=lpo:uwa=hol:uwa_fpi=on:i=259:si=on:rtra=on_0");
    quick.push("dis+10_1:1_cnfonf=lazy_pi_sigma_gen:s2a=on:s2at=1.5:sil=128000:uwa=off:i=828:si=on:rtra=on_0");
    quick.push("lrs+10_2:1_fe=abstraction:s2a=on:i=958:si=on:rtra=on_0");
    quick.push("ott+1010_8:1_add=off:bs=on:cnfonf=lazy_pi_sigma_gen:ep=RST:fgj=on:lcm=reverse:sac=on:sgt=64:sil=128000:sp=reverse_arity:spb=goal:to=kbo:i=368:si=on:rtra=on_0");
    quick.push("dis+1002_1:16_av=off:cond=fast:fe=abstraction:hud=1:ntd=on:sil=128000:sp=occurrence:i=1134:si=on:rtra=on_0");
    quick.push("dis+10_1:128_add=off:cnfonf=off:kws=frequency:ntd=on:nwc=1.5:plsq=on:plsqc=3:sil=128000:sp=arity:spb=goal_then_units:tgt=full:uwa=one_side_interpreted:i=1153:si=on:rtra=on_0");
    quick.push("lrs+21_5:1_add=off:amm=off:bd=all:c=on:chr=on:cnfonf=lazy_gen:drc=ordering:fsr=off:kws=inv_arity_squared:lftc=20:nm=0:ntd=on:s2agt=128:s2at=5.5:sd=1:sil=128000:spb=goal:ss=axioms:st=2.0:uwa=off:i=320:si=on:rtra=on_0");
    // Improves by expected 106.53657138113475 probs costing 119784 Mi
    // Sub-schedule for 240000Mi strat cap / 240000Mi overall limit
    quick.push("dis+1002_1:1_fd=off:nwc=1.0:ss=axioms:st=2.5:i=498:si=on:rtra=on_0");
    quick.push("lrs+1010_4:7_amm=off:anc=none:cnfonf=lazy_gen:nm=2:ntd=on:s2agt=60:sac=on:sas=cadical:ss=axioms:tgt=ground:uwa=interpreted_only:i=3235:si=on:rtra=on_0");
    quick.push("lrs+1010_3:1_cnfonf=lazy_gen:fde=none:fsr=off:nm=64:plsq=on:plsqc=1:plsqr=64,1:s2agt=20:s2at=5.0:sas=cadical:sil=128000:sp=unary_first:uwa=off:i=366:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_avsqc=4:fe=abstraction:fgj=on:hud=5:ixr=off:nm=16:ntd=on:piset=pi_sigma:sos=on:sp=const_frequency:spb=non_intro:ss=axioms:st=3.0:to=kbo:uwa=hol:uwa_fpi=on:i=955:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=off:c=on:cbe=off:cnfonf=lazy_simp:drc=ordering:fsr=off:irw=on:lwlo=on:nm=10:piset=or:plsq=on:plsqc=4:plsqr=32,1:rp=on:sos=on:sp=reverse_frequency:to=lpo:uwa=off:i=1925:si=on:rtra=on_0");
    quick.push("ott+1002_1:32_acc=on:fe=abstraction:fgj=on:nwc=0.5:piset=pi_sigma:sp=const_max:tgt=ground:i=2396:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=15757:si=on:rtra=on_0");
    quick.push("ott+10_1:1_bd=all:cnfonf=lazy_simp:cond=on:drc=ordering:nm=64:rawr=on:sac=on:sd=3:sp=weighted_frequency:ss=axioms:to=kbo:uwa=hol:i=8348:si=on:rtra=on_0");
    quick.push("dis+1002_8:1_e2e=on:sil=128000:uwa=off:i=865:si=on:rtra=on_0");
    quick.push("ott+10_1:1_cnfonf=lazy_not_be_gen:ixr=off:ntd=on:sd=1:sil=128000:ss=axioms:i=4382:si=on:rtra=on_0");
    quick.push("dis+1004_1:8_bd=preordered:bet=on:cnfonf=lazy_pi_sigma_gen:drc=off:hsqr=1,4:nm=0:sil=128000:sos=on:sp=reverse_frequency:ss=axioms:uwa=off:i=694:si=on:rtra=on_0");
    quick.push("ott+1002_1:4_bsr=on:chr=on:gs=on:kws=inv_arity_squared:nwc=11.4:sgt=30:sil=128000:sos=all:to=kbo:uwa=off:i=259:si=on:rtra=on_0");
    quick.push("ott+1010_1:1_bd=preordered:cnfonf=lazy_not_gen:nwc=2.0:sil=128000:slsqc=4:sp=unary_frequency:to=lpo:uwa=off:i=1205:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_add=on:bd=all:c=on:cbe=off:cnfonf=lazy_not_be_gen:cond=on:erd=off:hsq=on:lma=off:sil=128000:sos=on:sp=reverse_arity:spb=units:to=lpo:urr=on:uwa=one_side_constant:i=933:si=on:rtra=on_0");
    quick.push("dis+21_1:4_av=off:e2e=on:fde=none:foolp=on:uwa=off:i=2036:si=on:rtra=on_0");
    quick.push("lrs+1010_2:3_av=off:cha=on:fe=axiom:fgj=on:ntd=on:nwc=1.0:uwa=off:i=440:si=on:rtra=on_0");
    quick.push("lrs-1002_1:1_bsd=on:fde=none:fe=abstraction:kws=arity:nm=0:sgt=4:ss=axioms:tgt=ground:uwa_fpi=on:i=2865:si=on:rtra=on_0");
    quick.push("dis+1010_1:4_add=off:anc=all_dependent:cbe=off:cnfonf=conj_eager:fde=unused:fe=abstraction:fsr=off:lma=off:ntd=on:sil=128000:sp=reverse_frequency:spb=intro:to=lpo:uwa=off:i=792:si=on:rtra=on_0");
    quick.push("dis+1004_1:3_add=off:cbe=off:cnfonf=conj_eager:fgj=on:nm=16:nwc=14.0:sil=128000:sp=reverse_arity:uwa=off:uwa_fpi=on:i=1921:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_acc=on:add=on:c=on:e2e=on:fd=preordered:fde=none:foolp=on:gtg=position:hsq=on:hsqr=16,1:inj=on:ixr=off:nicw=on:nm=16:ntd=on:plsq=on:rawr=on:s2a=on:s2agt=32:sfv=off:slsq=on:slsqc=1:spb=non_intro:ss=included:to=lpo:uwa=off:i=64786:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_av=off:bd=preordered:cnfonf=lazy_gen:kws=precedence:plsq=on:plsqc=1:plsqr=256,1:sil=128000:sos=on:tgt=ground:uwa=off:i=721:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=1515:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_anc=none:bd=all:cnfonf=lazy_gen:doe=on:drc=off:foolp=on:fsr=off:hsqaw=2:hsqc=5:lwlo=on:sil=128000:spb=units:to=kbo:uwa=off:i=958:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=1624:si=on:rtra=on_0");
    quick.push("ott+1003_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:hud=10:ixr=off:sp=weighted_frequency:spb=units:to=kbo:urr=on:uwa_fpi=on:i=2063:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_bd=all:cnfonf=lazy_gen:drc=ordering:fe=abstraction:ntd=on:nwc=2.0:s2a=on:sil=128000:to=lpo:i=280:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:sil=128000:sos=on:ss=axioms:uwa=off:i=1661:si=on:rtra=on_0");
    quick.push("dis+1010_1:10_bd=preordered:cnfonf=lazy_gen:foolp=on:nwc=4.0:sil=128000:uwa=off:i=643:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_bet=on:cnfonf=conj_eager:drc=ordering:er=filter:hi=on:nm=10:ntd=on:sil=128000:spb=units:uwa=off:i=65:si=on:rtra=on_0");
    quick.push("dis+10_1:32_av=off:bd=preordered:cnfonf=lazy_gen:hsq=on:hsql=off:hsqr=1,8:nwc=1.0:plsq=on:plsqc=1:plsqr=32,1:sil=128000:tgt=ground:uwa=one_side_interpreted:i=1770:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=preordered:cnfonf=off:fd=preordered:fe=abstraction:s2a=on:sil=128000:i=9248:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_bsd=on:cbe=off:drc=ordering:fde=none:flr=on:gsp=on:s2a=on:ser=on:sp=const_min:to=lpo:uwa=off:i=904:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:kws=inv_frequency:s2at=2.0:sil=128000:slsq=on:slsqc=1:urr=on:i=833:si=on:rtra=on_0");
    quick.push("dis+21_1:1_acc=on:cnfonf=off:e2e=on:ep=RST:kws=precedence:sil=128000:sos=on:spb=goal_then_units:ss=axioms:uwa=one_side_interpreted:i=6054:si=on:rtra=on_0");
    quick.push("ott+1003_1:256_aac=none:anc=none:cbe=off:cnfonf=lazy_pi_sigma_gen:ep=RSTC:kws=frequency:ntd=on:nwc=2.0:rawr=on:sil=128000:sp=const_frequency:i=804:si=on:rtra=on_0");
    quick.push("dis+10_1:1_bd=all:chr=on:cnfonf=lazy_gen:hsq=on:hsql=off:hsqr=1,8:ixr=off:nwc=1.0:sfv=off:sil=128000:uwa=off:i=28118:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_bd=all:cnfonf=lazy_gen:hsqr=1,8:lftc=60:lma=off:lsd=50:nm=2:nwc=4.0:sil=128000:sp=unary_frequency:spb=non_intro:tgt=ground:to=kbo:uwa=one_side_constant:i=4255:si=on:rtra=on_0");
    quick.push("dis+10_8:1_bd=preordered:sd=2:sgt=8:sil=128000:ss=axioms:uwa=off:i=6237:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_e2e=on:fd=off:fde=unused:nm=16:s2a=on:sil=128000:sos=on:urr=on:uwa=one_side_constant:i=8371:si=on:rtra=on_0");
    quick.push("dis+10_3:2_acc=on:avsq=on:e2e=on:fd=preordered:fde=unused:hsq=on:hsql=off:hsqr=16,1:ins=20:nicw=on:nm=16:ntd=on:pe=on:plsq=on:s2a=on:sfv=off:slsq=on:slsqc=1:sp=reverse_frequency:ss=axioms:to=kbo:uwa=off:i=21974:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_fde=none:kws=inv_precedence:sil=128000:sos=on:spb=goal_then_units:urr=on:i=14001:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=2283:si=on:rtra=on_0");
    quick.push("lrs+1003_3:2_bd=all:bs=unit_only:bsr=unit_only:cnfonf=lazy_gen:flr=on:hud=7:nicw=on:pe=on:piset=and:rawr=on:s2a=on:s2agt=16:slsq=on:slsqr=2,1:sp=reverse_frequency:to=lpo:uwa=hol:uwa_fpi=on:i=885:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_ntd=on:piset=and:uwa=one_side_interpreted:i=6109:si=on:rtra=on_0");
    quick.push("ott+1010_8:1_add=off:bs=on:cnfonf=lazy_pi_sigma_gen:ep=RST:fgj=on:lcm=reverse:sac=on:sgt=64:sil=128000:sp=reverse_arity:spb=goal:to=kbo:i=368:si=on:rtra=on_0");
    quick.push("dis+10_1:128_add=off:cnfonf=off:kws=frequency:ntd=on:nwc=1.5:plsq=on:plsqc=3:sil=128000:sp=arity:spb=goal_then_units:tgt=full:uwa=one_side_interpreted:i=1153:si=on:rtra=on_0");
    quick.push("lrs+21_5:1_add=off:amm=off:bd=all:c=on:chr=on:cnfonf=lazy_gen:drc=ordering:fsr=off:kws=inv_arity_squared:lftc=20:nm=0:ntd=on:s2agt=128:s2at=5.5:sd=1:sil=128000:spb=goal:ss=axioms:st=2.0:uwa=off:i=1906:si=on:rtra=on_0");
    // Improves by expected 64.3201473176548 probs costing 239414 Mi
    // Sub-schedule for 480000Mi strat cap / 480000Mi overall limit
    quick.push("dis+1004_4:1_acc=on:add=off:bd=all:c=on:e2e=on:fd=preordered:fde=unused:gtg=position:hsq=on:hsqr=16,1:nm=64:ntd=on:plsq=on:s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,2:spb=goal_then_units:to=lpo:urr=on:uwa=off:i=17419:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_cnfonf=lazy_pi_sigma_gen:ixr=off:sil=128000:slsq=on:uwa=off:i=11748:si=on:rtra=on_0");
    quick.push("ott+1002_1:1_anc=none:bd=all:bsd=on:cnfonf=lazy_not_gen:drc=off:fde=none:sp=arity:spb=units:ss=axioms:uwa_fpi=on:i=17244:si=on:rtra=on_0");
    quick.push("lrs+2_1:1_bd=preordered:e2e=on:fde=none:fe=abstraction:fsr=off:ixr=off:nm=2:rawr=on:sgt=16:sil=128000:spb=units:ss=axioms:uwa=interpreted_only:i=1322:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=3:sil=128000:ss=axioms:st=4.0:i=2228:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_add=off:c=on:cbe=off:cnfonf=lazy_simp:drc=ordering:fsr=off:irw=on:lwlo=on:nm=10:piset=or:plsq=on:plsqc=4:plsqr=32,1:rp=on:sos=on:sp=reverse_frequency:to=lpo:uwa=off:i=362:si=on:rtra=on_0");
    quick.push("ott+1002_1:32_acc=on:fe=abstraction:fgj=on:nwc=0.5:piset=pi_sigma:sp=const_max:tgt=ground:i=2791:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=49931:si=on:rtra=on_0");
    quick.push("dis+1002_8:1_e2e=on:sil=128000:uwa=off:i=865:si=on:rtra=on_0");
    quick.push("ott+1010_1:1_bd=preordered:cnfonf=lazy_not_gen:nwc=2.0:sil=128000:slsqc=4:sp=unary_frequency:to=lpo:uwa=off:i=21984:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_bsr=on:cnfonf=lazy_pi_sigma_gen:e2e=on:lma=off:nwc=1.0:s2a=on:sac=on:sas=cadical:sil=128000:uwa=interpreted_only:i=6076:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_add=on:chr=on:cnfonf=conj_eager:ep=RSTC:fe=abstraction:gsp=on:lma=off:piset=equals:rp=on:sac=on:sil=128000:sp=reverse_arity:spb=non_intro:i=2650:si=on:rtra=on_0");
    quick.push("lrs-1002_1:1_bsd=on:fde=none:fe=abstraction:kws=arity:nm=0:sgt=4:ss=axioms:tgt=ground:uwa_fpi=on:i=2206:si=on:rtra=on_0");
    quick.push("dis+1004_1:3_add=off:cbe=off:cnfonf=conj_eager:fgj=on:nm=16:nwc=14.0:sil=128000:sp=reverse_arity:uwa=off:uwa_fpi=on:i=1281:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:fe=abstraction:sil=128000:ss=axioms:i=13007:si=on:rtra=on_0");
    quick.push("dis+10_1:1_cnfonf=lazy_simp:ixr=off:plsq=on:plsqc=2:plsqr=64,1:sgt=8:sil=128000:ss=axioms:i=2514:si=on:rtra=on_0");
    quick.push("dis+1010_1:10_add=off:cbe=off:cnfonf=off:fde=none:kws=inv_precedence:nm=10:ntd=on:nwc=1.0:sil=128000:sp=reverse_frequency:spb=intro:tgt=full:uwa=interpreted_only:i=5988:si=on:rtra=on_0");
    quick.push("dis+10_1:1024_bd=preordered:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:rawr=on:sil=128000:to=lpo:i=3115:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=18833:si=on:rtra=on_0");
    quick.push("dis+1010_1:1024_aac=none:add=on:c=on:e2e=on:er=filter:fd=off:kws=inv_frequency:lma=off:ntd=on:plsq=on:plsqc=1:plsqr=64,1:sil=128000:uwa=interpreted_only:i=23523:si=on:rtra=on_0");
    quick.push("dis+1002_1:64_bet=on:fe=axiom:nm=16:ntd=on:sil=128000:slsq=on:uwa_fpi=on:i=4300:si=on:rtra=on_0");
    quick.push("dis+10_4:1_acc=on:c=on:cnfonf=off:e2e=on:fd=preordered:fde=unused:foolp=on:hsq=on:hsqr=16,1:nm=32:piset=or:rawr=on:s2a=on:sas=cadical:sfv=off:sgt=8:sp=occurrence:ss=axioms:to=kbo:uwa=off:i=62818:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_anc=none:bd=all:cnfonf=lazy_gen:doe=on:drc=off:foolp=on:fsr=off:hsqaw=2:hsqc=5:lwlo=on:sil=128000:spb=units:to=kbo:uwa=off:i=623:si=on:rtra=on_0");
    quick.push("lrs+1010_8:1_aac=none:bsr=unit_only:cs=on:e2e=on:fde=none:ins=7:nm=64:nwc=3.0:sil=128000:spb=goal:uwa=off:i=12572:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=1:sgt=64:sil=128000:ss=axioms:urr=on:i=59260:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=24146:si=on:rtra=on_0");
    quick.push("ott+1003_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:hud=10:ixr=off:sp=weighted_frequency:spb=units:to=kbo:urr=on:uwa_fpi=on:i=7096:si=on:rtra=on_0");
    quick.push("dis+1010_1:16_av=off:cnfonf=lazy_not_gen:fsr=off:ixr=off:lma=off:sil=128000:sp=const_max:uwa=interpreted_only:i=11705:si=on:rtra=on_0");
    quick.push("lrs+1010_1:1_bd=all:cnfonf=lazy_gen:drc=ordering:fe=abstraction:ntd=on:nwc=2.0:s2a=on:sil=128000:to=lpo:i=2996:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_bd=all:sil=128000:sos=on:ss=axioms:uwa=off:i=5999:si=on:rtra=on_0");
    quick.push("lrs+1002_1:1_sd=1:sil=128000:sos=on:spb=goal_then_units:ss=axioms:st=2.0:to=lpo:uwa=off:i=3757:si=on:rtra=on_0");
    quick.push("dis+1010_1:10_bd=preordered:cnfonf=lazy_gen:foolp=on:nwc=4.0:sil=128000:uwa=off:i=2792:si=on:rtra=on_0");
    quick.push("dis+10_5:4_bd=preordered:e2e=on:nwc=3.0:s2a=on:urr=on:uwa=interpreted_only:i=3060:si=on:rtra=on_0");
    quick.push("lrs-1002_1:5_cond=on:fsd=on:fsdmm=10:ntd=on:sil=128000:i=12849:si=on:rtra=on_0");
    quick.push("lrs+1010_5:1_bd=preordered:fsr=off:kws=arity:lrd=on:lwlo=on:sil=128000:sos=all:tgt=ground:i=1245:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=16934:si=on:rtra=on_0");
    quick.push("dis+10_8:1_acc=on:bd=all:kws=inv_frequency:nm=0:s2a=on:s2agt=64:uwa=interpreted_only:i=4135:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=5306:si=on:rtra=on_0");
    quick.push("lrs+1003_3:2_bd=all:bs=unit_only:bsr=unit_only:cnfonf=lazy_gen:flr=on:hud=7:nicw=on:pe=on:piset=and:rawr=on:s2a=on:s2agt=16:slsq=on:slsqr=2,1:sp=reverse_frequency:to=lpo:uwa=hol:uwa_fpi=on:i=885:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_ntd=on:piset=and:uwa=one_side_interpreted:i=6101:si=on:rtra=on_0");
    quick.push("dis+1002_1:1_ntd=on:sd=4:sil=128000:ss=axioms:st=3.0:uwa=off:i=18232:si=on:rtra=on_0");
    quick.push("ott+1010_8:1_add=off:bs=on:cnfonf=lazy_pi_sigma_gen:ep=RST:fgj=on:lcm=reverse:sac=on:sgt=64:sil=128000:sp=reverse_arity:spb=goal:to=kbo:i=368:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_fd=off:ixr=off:kws=inv_precedence:lma=off:sil=128000:ss=included:st=2.0:tgt=full:to=lpo:uwa=interpreted_only:i=2642:si=on:rtra=on_0");
    // Improves by expected 35.80138567402195 probs costing 474865 Mi
    // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
    quick.push("dis+1004_4:1_acc=on:add=off:bd=all:c=on:e2e=on:fd=preordered:fde=unused:gtg=position:hsq=on:hsqr=16,1:nm=64:ntd=on:plsq=on:s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,2:spb=goal_then_units:to=lpo:urr=on:uwa=off:i=70409:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_cnfonf=lazy_pi_sigma_gen:ixr=off:sil=128000:slsq=on:uwa=off:i=11552:si=on:rtra=on_0");
    quick.push("dis+1010_1:7_acc=on:cbe=off:cnfonf=lazy_not_gen:erd=off:nm=32:nwc=2.0:piset=all:sil=128000:sos=all:uwa=one_side_interpreted:i=76073:si=on:rtra=on_0");
    quick.push("ott+1002_1:1_anc=none:bd=all:bsd=on:cnfonf=lazy_not_gen:drc=off:fde=none:sp=arity:spb=units:ss=axioms:uwa_fpi=on:i=17244:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=77493:si=on:rtra=on_0");
    quick.push("ott+1010_1:1_bd=preordered:cnfonf=lazy_not_gen:nwc=2.0:sil=128000:slsqc=4:sp=unary_frequency:to=lpo:uwa=off:i=21984:si=on:rtra=on_0");
    quick.push("dis+10_1:1_fsr=off:ixr=off:sac=on:sil=128000:sp=unary_first:tgt=ground:to=lpo:uwa=off:i=58366:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_bsr=on:cnfonf=lazy_pi_sigma_gen:e2e=on:lma=off:nwc=1.0:s2a=on:sac=on:sas=cadical:sil=128000:uwa=interpreted_only:i=20655:si=on:rtra=on_0");
    quick.push("dis+1002_1:8_add=on:cbe=off:drc=off:hsqr=1,8:lma=off:nm=2:s2at=5.0:sil=128000:sp=const_max:spb=non_intro:tgt=full:to=kbo:uwa=interpreted_only:i=20730:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_lma=off:sd=2:sil=128000:sos=all:ss=axioms:st=2.0:urr=on:i=42463:si=on:rtra=on_0");
    quick.push("dis+1004_1:1_add=on:avsq=on:avsqr=1,16:cnfonf=lazy_pi_sigma_gen:fde=unused:lftc=50:lrd=on:s2at=10.0:sil=128000:slsq=on:slsqr=1,7:uwa=interpreted_only:i=23494:si=on:rtra=on_0");
    quick.push("lrs-1002_1:1_bsd=on:fde=none:fe=abstraction:kws=arity:nm=0:sgt=4:ss=axioms:tgt=ground:uwa_fpi=on:i=2206:si=on:rtra=on_0");
    quick.push("lrs+10_1:64_anc=all_dependent:cbe=off:e2e=on:ep=RSTC:ntd=on:sil=128000:uwa=off:i=83476:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_acc=on:add=on:c=on:e2e=on:fd=preordered:fde=none:foolp=on:gtg=position:hsq=on:hsqr=16,1:inj=on:ixr=off:nicw=on:nm=16:ntd=on:plsq=on:rawr=on:s2a=on:s2agt=32:sfv=off:slsq=on:slsqc=1:spb=non_intro:ss=included:to=lpo:uwa=off:i=58748:si=on:rtra=on_0");
    quick.push("dis+10_1:1_cnfonf=lazy_simp:ixr=off:plsq=on:plsqc=2:plsqr=64,1:sgt=8:sil=128000:ss=axioms:i=9331:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=18833:si=on:rtra=on_0");
    quick.push("dis+1010_1:1024_aac=none:add=on:c=on:e2e=on:er=filter:fd=off:kws=inv_frequency:lma=off:ntd=on:plsq=on:plsqc=1:plsqr=64,1:sil=128000:uwa=interpreted_only:i=23395:si=on:rtra=on_0");
    quick.push("dis+1002_1:64_bet=on:fe=axiom:nm=16:ntd=on:sil=128000:slsq=on:uwa_fpi=on:i=4300:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=22459:si=on:rtra=on_0");
    quick.push("lrs-1002_4:1_acc=on:e2e=on:foolp=on:gtg=exists_top:hsq=on:hsqlw=5:hsqr=16,1:nm=16:plsq=on:prc=on:proc=on:s2a=on:s2agt=16:ser=on:sfv=off:slsq=on:slsqc=1:spb=goal:to=lpo:uwa=off:i=68012:si=on:rtra=on_0");
    quick.push("lrs+1010_5:1_bd=preordered:fsr=off:kws=arity:lrd=on:lwlo=on:sil=128000:sos=all:tgt=ground:i=34475:si=on:rtra=on_0");
    quick.push("dis+21_1:1_acc=on:cnfonf=off:e2e=on:ep=RST:kws=precedence:sil=128000:sos=on:spb=goal_then_units:ss=axioms:uwa=one_side_interpreted:i=45761:si=on:rtra=on_0");
    quick.push("dis+10_1:1_bd=all:chr=on:cnfonf=lazy_gen:hsq=on:hsql=off:hsqr=1,8:ixr=off:nwc=1.0:sfv=off:sil=128000:uwa=off:i=32512:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=16934:si=on:rtra=on_0");
    quick.push("dis+10_8:1_acc=on:bd=all:kws=inv_frequency:nm=0:s2a=on:s2agt=64:uwa=interpreted_only:i=2636:si=on:rtra=on_0");
    quick.push("ott+1002_3:2_bd=preordered:cnfonf=lazy_gen:cond=fast:fgj=on:foolp=on:lma=off:nwc=1.5:plsqr=32,1:sil=128000:sp=reverse_frequency:to=kbo:uwa=interpreted_only:i=69453:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=5306:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_ntd=on:piset=and:uwa=one_side_interpreted:i=6101:si=on:rtra=on_0");
    quick.push("ott+10_1:1_cnfonf=lazy_pi_sigma_gen:hud=5:lcm=reverse:lma=off:piset=pi_sigma:rp=on:sil=128000:sp=reverse_frequency:to=lpo:i=6595:si=on:rtra=on_0");
    quick.push("dis+1010_1:3_fd=off:ixr=off:kws=inv_precedence:lma=off:sil=128000:ss=included:st=2.0:tgt=full:to=lpo:uwa=interpreted_only:i=2642:si=on:rtra=on_0");
    // Improves by expected 17.464803505939184 probs costing 953608 Mi
    // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
    quick.push("lrs+10_1:1_cbe=off:cs=on:e2e=on:fsr=off:s2a=on:sil=128000:uwa=interpreted_only:i=103809:si=on:rtra=on_0");
    quick.push("dis+10_1:128_add=off:avsq=on:avsqc=4:bd=preordered:drc=ordering:fde=unused:kws=inv_frequency:lma=off:sil=128000:uwa=interpreted_only:i=29030:si=on:rtra=on_0");
    quick.push("lrs+1010_3:1_cnfonf=lazy_gen:fde=none:fsr=off:nm=64:plsq=on:plsqc=1:plsqr=64,1:s2agt=20:s2at=5.0:sas=cadical:sil=128000:sp=unary_first:uwa=off:i=115893:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_sd=3:sil=128000:ss=axioms:st=4.0:i=87669:si=on:rtra=on_0");
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=49884:si=on:rtra=on_0");
    quick.push("ott+1010_1:1_bd=preordered:cnfonf=lazy_not_gen:nwc=2.0:sil=128000:slsqc=4:sp=unary_frequency:to=lpo:uwa=off:i=21984:si=on:rtra=on_0");
    quick.push("dis+1002_4:1_acc=on:add=on:c=on:e2e=on:fd=preordered:fde=none:foolp=on:gtg=position:hsq=on:hsqr=16,1:inj=on:ixr=off:nicw=on:nm=16:ntd=on:plsq=on:rawr=on:s2a=on:s2agt=32:sfv=off:slsq=on:slsqc=1:spb=non_intro:ss=included:to=lpo:uwa=off:i=58001:si=on:rtra=on_0");
    quick.push("lrs+1002_1:64_cnfonf=lazy_gen:lma=off:ntd=on:piset=equals:plsq=on:plsqc=1:plsqr=32,1:sil=128000:sp=occurrence:uwa=interpreted_only:i=18833:si=on:rtra=on_0");
    quick.push("dis+1010_1:1024_aac=none:add=on:c=on:e2e=on:er=filter:fd=off:kws=inv_frequency:lma=off:ntd=on:plsq=on:plsqc=1:plsqr=64,1:sil=128000:uwa=interpreted_only:i=32001:si=on:rtra=on_0");
    quick.push("dis+1002_1:64_bet=on:fe=axiom:nm=16:ntd=on:sil=128000:slsq=on:uwa_fpi=on:i=4300:si=on:rtra=on_0");
    quick.push("lrs+10_1:1_cnfonf=conj_eager:s2a=on:ss=axioms:st=1.5:i=22459:si=on:rtra=on_0");
    quick.push("lrs+1010_1:3_avsq=on:avsqr=8,1:fsr=off:hud=5:ins=1:sil=128000:slsq=on:i=108096:si=on:rtra=on_0");
    quick.push("lrs+1010_5:1_bd=preordered:fsr=off:kws=arity:lrd=on:lwlo=on:sil=128000:sos=all:tgt=ground:i=34475:si=on:rtra=on_0");
    quick.push("dis+1002_1:20_cbe=off:e2e=on:fsr=off:ins=7:sil=128000:tgt=full:uwa=off:i=71117:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=16934:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=5306:si=on:rtra=on_0");
    // Improves by expected 2.840141480159192 probs costing 779775 Mi
    // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
    quick.push("dis+1010_2:1_aac=none:acc=on:avsq=on:cnfonf=lazy_pi_sigma_gen:cond=fast:er=filter:fd=preordered:fgj=on:flr=on:fsr=off:hud=3:pe=on:piset=and:plsq=on:rawr=on:s2a=on:s2agt=16:s2at=1.5:slsq=on:slsqr=2,1:sp=reverse_arity:to=lpo:uwa=hol:uwa_fpi=on:i=49884:si=on:rtra=on_0");
    quick.push("dis+1002_1:64_bet=on:fe=axiom:nm=16:ntd=on:sil=128000:slsq=on:uwa_fpi=on:i=4300:si=on:rtra=on_0");
    quick.push("dis+1003_3:4_acc=on:e2e=on:er=filter:erml=3:foolp=on:gtg=exists_top:hsq=on:hsqr=16,1:ntd=on:plsq=on:prc=on:s2a=on:s2agt=32:sims=off:slsq=on:slsqc=3:slsql=off:spb=intro:to=kbo:urr=on:uwa=off:i=16934:si=on:rtra=on_0");
    quick.push("dis+1010_1:1_aac=none:avsq=on:avsqr=1,16:cbe=off:cnfonf=lazy_simp:cond=fast:hud=3:nwc=2.0:plsq=on:s2a=on:s2agt=16:sfv=off:slsq=on:slsqr=2,1:to=kbo:uwa=hol:uwa_fpi=on:i=5306:si=on:rtra=on_0");
    // Improves by expected 0.49859066938706537 probs costing 76420 Mi
