...
void Schedules::getCasc2024Schedule(const Property& property, Schedule& quick, Schedule& fallback)
{
  ...
  if (property.hasNumerals() || property.hasInterpretedOperations()) {
    ...
    auto [small,large] = (atoms <= 11) ? std::tie(quick,fallback) : std::tie(fallback,quick);

    small.push("dis+10_1:50_sil=256000:nwc=4.1:i=103:bd=off:irc=eager:fd=off_0");
    small.push("lrs+10_1:6_drc=encompass:sil=2000:tgt=full:sp=unary_frequency:i=115:kws=precedence:irc=eager_0");
    small.push("dis+10_1:32_sil=256000:tgt=ground:sp=const_max:i=175:kws=precedence_0");
    small.push("lrs+10_85441:1048576_drc=encompass:sil=64000:i=206:awrs=converge:sp=reverse_frequency:dpc=on:bd=preordered:fsr=off:ss=included:st=3.0:fde=none_0");
    small.push("lrs+10_1:1_sil=2000:sos=on:urr=on:st=5.0:i=152:ep=RSTC:ss=axioms:flr=on:fsr=off:br=off_0");
    small.push("dis+10_1:1024_sil=256000:sp=weighted_frequency:i=549:fsr=off:ss=axioms:drc=encompass_0");
    small.push("lrs+10_1:10_drc=encompass:sil=2000:tgt=ground:plsq=on:plsqr=92626939,1048576:sp=occurrence:fd=preordered:i=498:kws=precedence:ins=8:rawr=on_0");
    small.push("lrs+10_1:128_drc=encompass:sil=2000:spb=goal_then_units:i=1837:irc=eager_0");
    small.push("dis+10_1:1_to=lpo:drc=encompass:sil=256000:i=196:irc=lazy_0");
    small.push("dis+10_1:1_sil=256000:nwc=10.0:s2agt=32:s2a=on:i=151:fde=none:fd=off_0");
    small.push("lrs+10_1:1024_sil=2000:slsqc=1:slsq=on:i=161:rawr=on:bd=off_0");
    small.push("dis+10_1:14_bsr=unit_only:to=lpo:drc=encompass:sil=256000:tgt=ground:urr=on:slsq=on:i=481:awrs=converge:awrsf=50:rawr=on:fsr=off_0");
    small.push("lrs+10_1:4_slsqr=23,97:drc=encompass:sil=4000:spb=goal:gs=on:slsqc=1:slsq=on:s2pl=on:i=1646:doe=on:rawr=on:gsem=off:bs=on:slsql=off:bsr=unit_only:kws=inv_frequency:sfv=off:irc=lazy:lwlo=on:plsq=on:plsqr=35,2:gsssp=full_0");
    small.push("lrs+10_1:1024_sil=2000:tgt=ground:plsq=on:sp=frequency:s2a=on:i=1825:kws=precedence:rawr=on:bd=off:awrs=converge:awrsf=10:ins=2_0");
    small.push("lrs+10_1:8_sil=2000:nwc=3.0:i=249:bd=off:fsr=off:rawr=on:sp=occurrence:fd=off:kws=inv_precedence_0");
    small.push("lrs+10_16:1_bsr=on:drc=encompass:sil=64000:i=265:bd=off:to=lpo_0");
    small.push("lrs+10_1:14_slsqr=3,4:drc=encompass:sil=4000:tgt=ground:sp=const_max:s2agt=16:slsqc=3:slsq=on:i=1061:kws=precedence:slsql=off:irc=lazy:rawr=on_0");
    small.push("lrs+10_1:64_sil=256000:tgt=full:spb=non_intro:i=4424:kws=precedence:awrs=converge:awrsf=30:sp=weighted_frequency:drc=encompass:irc=eager:fd=preordered:bd=preordered_0");
    small.push("dis+10_1:16_slsqr=167,244:drc=encompass:sil=256000:slsqc=1:slsq=on:i=446:kws=inv_arity:awrs=converge:slsql=off:awrsf=61:bd=off:ins=2:rawr=on_0");
    small.push("dis+10_1:2_to=lpo:sil=256000:i=1509:irc=eager:fd=preordered_0");
    small.push("dis+10_4:1_to=lpo:sil=256000:tgt=ground:spb=goal:fd=preordered:i=487:irc=lazy_0");
    small.push("lrs+10_1:4_drc=encompass:sil=16000:lwlo=on:st=-1.0:i=5711:ss=axioms_0");
    small.push("ott+10_21691:1048576_drc=encompass:sil=256000:tgt=ground:sims=off:sp=occurrence:spb=goal_then_units:fd=preordered:i=2074:fibus=on:kws=precedence:av=off:fsr=off:uhcvi=on:fsd=on:fsdmm=2:slsq=on:slsql=off:slsqc=1:slsqr=320859,1048576:s2at=3.0:irc=lazy:rawr=on:ss=axioms:sd=2_0");
    small.push("dis+10_1:1024_slsqr=7,2:to=lpo:sil=256000:tgt=full:s2agt=8:slsqc=1:slsq=on:s2a=on:i=644:rawr=on_0");
    small.push("lrs+10_1:512_sil=4000:tgt=ground:sp=reverse_frequency:s2a=on:i=648:bs=unit_only:bd=off:ss=axioms:rawr=on:slsq=on:slsqc=3:slsqr=19,8_0");
    small.push("lrs+10_1:1_slsqr=455249,524288:drc=encompass:sil=2000:tgt=ground:bsd=on:plsq=on:plsqr=32,1:urr=ec_only:slsqc=1:slsq=on:s2a=on:i=710:kws=precedence:slsql=off:rawr=on_0");
    small.push("dis+10_4:27_drc=encompass:sil=256000:tgt=ground:plsq=on:sp=weighted_frequency:s2a=on:i=739:kws=precedence:bd=off:ins=4:rawr=on:fd=preordered:s2agt=8_0");
    small.push("lrs+10_2:1_to=lpo:drc=encompass:sil=4000:tgt=full:sp=const_min:urr=on:nwc=5.0:i=772:rawr=on_0");
    small.push("dis+10_1:16_to=lpo:drc=encompass:sil=256000:tgt=ground:plsq=on:plsqr=1,32:sp=unary_frequency:s2a=on:i=863:awrs=converge:awrsf=340:rawr=on:s2at=2.0_0");
    small.push("lrs+10_1:40_drc=encompass:sil=256000:tgt=full:sp=unary_frequency:spb=goal_then_units:i=4827:kws=frequency:rawr=on:irc=eager:fd=preordered_0");
    small.push("lrs+10_7:24_to=lpo:drc=encompass:sil=128000:fde=unused:sp=const_min:spb=goal:i=974:irc=lazy:slsq=on:fdi=256:nwc=10.0:dpc=on:ss=included:st=2.0_0");
    small.push("lrs+10_1:10_drc=encompass:sil=16000:tgt=ground:plsq=on:fd=preordered:i=14330:bd=preordered:ins=1:rawr=on:ss=axioms:sgt=16_0");
    small.push("lrs+10_25:999_drc=encompass:sil=256000:tgt=full:spb=intro:i=1266:kws=precedence:awrs=converge:awrsf=53:irc=eager:bd=off:bs=unit_only_0");
    small.push("lrs+10_1:128_drc=encompass:sil=256000:tgt=full:sp=unary_frequency:spb=non_intro:i=2184:kws=precedence:irc=eager_0");
    small.push("dis+10_1:17_bsr=unit_only:to=lpo:sil=256000:tgt=full:urr=on:i=2192:doe=on:ins=3:irc=eager:ss=axioms:rawr=on:plsq=on:plsqr=48394909,1048576_0");
    small.push("ott+10_1:128_drc=encompass:sil=256000:plsq=on:s2a=on:i=2322:kws=precedence:dpc=on:bd=preordered:ss=axioms_0");
    small.push("ott+10_1:6_drc=encompass:sil=256000:tgt=ground:fde=none:plsq=on:sp=weighted_frequency:s2a=on:i=2369:s2at=2.0:kws=precedence:bd=off:ins=4:dpc=on:ss=axioms:sgt=16:rawr=on_0");
    small.push("ott+10_2:5_bsr=unit_only:to=lpo:drc=encompass:sil=256000:sp=reverse_frequency:i=2615:ins=1:dpc=on:rawr=on_0");
    small.push("ott+10_1:128_slsqr=1,2:drc=encompass:sil=256000:fde=unused:sp=frequency:slsq=on:i=2652:slsql=off_0");
    small.push("dis+10_1:1024_slsqr=5,2:sil=256000:tgt=ground:urr=on:slsqc=2:slsq=on:i=2967:ins=1:irc=lazy:rawr=on_0");
    small.push("dis+10_1182389:524288_bsr=on:slsqr=1454583,524288:sil=256000:tgt=full:fde=unused:sims=off:sp=weighted_frequency:lma=on:nwc=3.02695:slsqc=1:slsq=on:i=5908:s2at=3.5:bs=unit_only:awrs=converge:awrsf=457:av=off:irc=eager:drc=encompass:dpc=on:rawr=on:bd=preordered_0");
    small.push("ott+10_10:3_sil=256000:fde=unused:sp=frequency:spb=goal:i=10188:bs=on:kws=precedence:ins=1:dpc=on:rawr=on:nwc=3.0:drc=encompass_0");
    small.push("ott+10_1:16_drc=encompass:sil=256000:tgt=full:i=7090:awrs=converge:awrsf=320:ins=3:dpc=on:ss=axioms:irc=lazy:bd=off_0");
    small.push("lrs+10_5:7_slsqr=1,16:drc=encompass:sil=8000:tgt=ground:sp=occurrence:slsq=on:lwlo=on:i=3699:slsql=off:ss=axioms:sgt=8:rawr=on:urr=on:ins=1:plsq=on_0");
    small.push("ott+10_1:10_drc=encompass:sil=256000:sp=reverse_frequency:fsoe=on:fd=preordered:i=3799:ins=2:bd=off:ss=axioms_0");
    small.push("dis+10_1:16_sil=256000:i=5301:bs=unit_only:rawr=on:plsq=on:to=lpo_0");
    small.push("dis+10_1:1_drc=encompass:sil=256000:tgt=full:i=19371:to=lpo:fde=unused_0");
    small.push("dis+10_8125:131072_drc=encompass:sil=256000:tgt=full:sp=occurrence:lma=on:fd=preordered:i=13020:fibus=on:kws=precedence:doe=on:awrs=decay:awrsf=50:dpc=on:uhcvi=on:ss=axioms:irc=lazy_0");
    small.push("lrs+10_16:1_to=lpo:sil=32000:urr=ec_only:fd=preordered:nwc=10.0:i=14037:bd=off:irc=lazy:drc=encompass_0");
    small.push("ott+10_1:1_drc=encompass:sil=256000:plsq=on:fd=preordered:st=5.0:s2a=on:i=32571:ins=1:ss=axioms:rawr=on_0");
    small.push("lrs+10_1:1_drc=encompass:sil=16000:fd=preordered:i=8331:bs=on:irc=lazy_0");
    small.push("lrs+10_1:1_drc=encompass:sil=256000:tgt=ground:sp=unary_first:sos=on:i=32988:kws=precedence:lwlo=on:irc=lazy_0");
    small.push("lrs+10_13:1_bsr=on:drc=encompass:sil=64000:fd=preordered:i=11381:bd=off:irc=lazy_0");
    small.push("lrs+10_1:1024_sil=256000:lwlo=on:i=28796:kws=precedence:awrs=converge:awrsf=240:drc=encompass:fd=preordered:tgt=ground_0");
    small.push("dis+10_1:256_to=lpo:drc=encompass:sil=256000:spb=goal:fd=preordered:i=16724:irc=eager:bs=unit_only_0");
    small.push("dis+10_1:20_drc=encompass:sil=256000:tgt=full:sp=reverse_frequency:spb=intro:fd=preordered:i=20301:kws=precedence:irc=eager:ins=1_0");
    small.push("lrs+10_3:58_drc=encompass:sil=256000:tgt=full:bsd=on:sp=reverse_arity:lwlo=on:s2a=on:i=143429:s2at=2.0:kws=precedence:bsr=on:irw=on:dpc=on:fibus=on:doe=on:bs=on:br=off:erd=off:s2agt=20:nwc=8.95214440448525:cond=fast:foolp=on:spb=non_intro:sfv=off:irc=lazy:fde=unused:ins=3_0");
    small.push("dis+10_1:128_drc=encompass:sil=256000:nwc=6.0:i=43654:fsr=off_0");
    small.push("dis+10_1:166_drc=encompass:sil=256000:tgt=full:i=24129:fsr=off:spb=non_intro:dpc=on:to=lpo:rawr=on_0");
    small.push("ott+10_1:4_drc=encompass:sil=256000:st=3.0:i=29513:ss=axioms:dpc=on:bd=preordered:slsq=on:slsqc=1:slsqr=1,2_0");
    small.push("lrs+10_1:34_drc=encompass:sil=64000:tgt=ground:lwlo=on:i=34092:kws=frequency:irc=eager_0");
    small.push("dis+10_1:54_sil=256000:tgt=ground:plsq=on:plsqr=9145955,131072:sp=frequency:spb=goal_then_units:plsql=on:i=68336:doe=on:ins=3:rawr=on:slsq=on:slsqr=1,4:s2at=2.0:slsqc=1_0");
    small.push("lrs+10_1:6_drc=encompass:sil=256000:tgt=full:spb=non_intro:i=36117:ins=2:irc=eager:ss=included:bd=preordered_0");
    small.push("ott+10_4:13_drc=encompass:sil=256000:bsd=on:sp=reverse_frequency:urr=on:i=113960:rawr=on_0");
    small.push("lrs+10_25:89_sil=256000:tgt=ground:lwlo=on:s2a=on:i=204051:s2at=5.0:fsr=off:awrs=converge:awrsf=90_0");
    small.push("lrs+10_1:16_drc=encompass:sil=256000:tgt=full:spb=intro:i=53216:kws=precedence:awrs=converge:awrsf=200:ss=axioms:irc=eager:st=3.0:sp=unary_first_0");
    small.push("lrs+10_1:12_drc=encompass:sil=256000:tgt=full:spb=intro:i=65772:kws=precedence:awrs=converge:awrsf=500:irc=lazy_0");
    small.push("ott+10_11413117:1048576_drc=encompass:sil=256000:tgt=ground:fde=unused:plsqc=2:plsq=on:plsqr=1149513,1048576:sp=occurrence:nwc=9.10417:i=113940:kws=precedence:doe=on:awrs=converge:awrsf=286:bd=off:dpc=on:irc=eager:uhcvi=on:rawr=on:ss=included:st=2.0_0");
    small.push("dis+10_1:28_drc=encompass:sil=256000:tgt=ground:i=133597:dpc=on:bs=on_0");
    small.push("lrs+10_54503:1048576_drc=encompass:sil=256000:tgt=ground:bsd=on:sp=reverse_frequency:lwlo=on:st=3.5:s2a=on:i=159083:s2at=5.5:kws=precedence:ss=included:sgt=50:bsr=unit_only:irw=on:dpc=on:uhcvi=on:fibus=on:doe=on:bs=on:br=off:erd=off_0");
    // slack 100
    // total_instr 1523789
    // len(covered) 635

    large.push("lrs+10_1:64_drc=encompass:sil=2000:i=105:plsq=on:ss=axioms_0");
    large.push("ott+10_8:1_drc=encompass:sil=256000:i=115:rawr=on:irc=lazy_0");
    large.push("ott+10_2:5_bsr=unit_only:to=lpo:drc=encompass:sil=256000:sp=reverse_frequency:i=163:ins=1:dpc=on:rawr=on_0");
    large.push("dis+10_8125:131072_drc=encompass:sil=256000:tgt=full:sp=occurrence:lma=on:fd=preordered:i=110:fibus=on:kws=precedence:doe=on:awrs=decay:awrsf=50:dpc=on:uhcvi=on:ss=axioms:irc=lazy_0");
    large.push("lrs+10_1:3_drc=encompass:sil=256000:tgt=ground:sp=unary_first:i=261:ss=axioms:sgt=10:rawr=on:urr=on:ins=1:plsq=on:dpc=on:spb=intro:sd=4:fsr=off:bs=on:kws=inv_arity:irc=lazy:nwc=5.0_0");
    large.push("lrs+10_1:1_sil=2000:sos=on:urr=on:st=5.0:i=110:ep=RSTC:ss=axioms:flr=on:fsr=off:br=off_0");
    large.push("lrs+10_16:7_drc=encompass:sil=128000:sp=weighted_frequency:lwlo=on:i=117:bs=on:to=lpo:tgt=full:bd=off_0");
    large.push("lrs+10_2:1_to=lpo:drc=encompass:sil=4000:tgt=full:sp=const_min:urr=on:nwc=5.0:i=245:rawr=on_0");
    large.push("lrs+10_1:12_drc=encompass:sil=256000:tgt=full:spb=intro:i=389:kws=precedence:awrs=converge:awrsf=500:irc=lazy_0");
    large.push("dis+10_577:524288_drc=encompass:sil=256000:sp=const_frequency:spb=units:i=204:doe=on:bd=off:av=off:dpc=on:irc=eager:uhcvi=on:ss=included:rawr=on:to=lpo:slsq=on:slsqr=8,31:s2agt=5:s2at=4.0:fdi=2_0");
    large.push("lrs+10_15:74_drc=encompass:sil=4000:tgt=full:fde=none:sp=const_min:i=788:kws=inv_frequency:awrs=converge:awrsf=120:rawr=on:nwc=0.9964432792968732:fsr=off:urr=on_0");
    large.push("lrs+10_1:1_sil=4000:sp=occurrence:i=158:ss=axioms:st=3.0:sd=2_0");
    large.push("lrs+10_1:4_to=lpo:drc=encompass:sil=4000:tgt=full:i=2545:bd=preordered:fd=preordered_0");
    large.push("lrs+10_1:1_to=lpo:drc=encompass:sil=2000:fde=unused:sp=const_min:i=413:fd=preordered:irc=eager:bd=preordered:ss=axioms_0");
    large.push("lrs+10_7:24_to=lpo:drc=encompass:sil=128000:fde=unused:sp=const_min:spb=goal:i=484:irc=lazy:slsq=on:fdi=256:nwc=10.0:dpc=on:ss=included:st=2.0_0");
    large.push("ott+10_1:6_drc=encompass:sil=512000:tgt=ground:fde=unused:sp=const_min:spb=goal:nwc=1.1:i=5367:kws=precedence:dpc=on_0");
    large.push("dis+10_1:1_sil=256000:nwc=10.0:s2agt=32:s2a=on:i=1761:fde=none:fd=off_0");
    large.push("lrs+10_2:1_to=lpo:drc=encompass:sil=8000:tgt=full:sp=const_frequency:i=442:lwlo=on:nwc=10.0:rawr=on_0");
    large.push("lrs+10_1:1_drc=encompass:sil=32000:tgt=ground:sp=unary_frequency:lwlo=on:i=21404:irc=eager:kws=precedence_0");
    large.push("lrs+10_1:1_drc=encompass:sil=2000:st=5.0:s2a=on:i=534:s2at=5.0:sd=1:bd=preordered:irc=lazy:ss=axioms:sgt=10_0");
    large.push("lrs+10_1:4_to=lpo:drc=encompass:sil=128000:fde=unused:sp=const_min:spb=goal:fd=preordered:i=545:irc=lazy:slsq=on:slsqr=1,4_0");
    large.push("lrs+10_8:1_drc=encompass:sil=4000:tgt=ground:spb=non_intro:i=776:bd=off:irc=lazy_0");
    large.push("lrs+10_1:25_to=lpo:drc=encompass:sil=2000:fde=none:sp=const_min:fd=preordered:i=1003_0");
    large.push("lrs+10_8:1_drc=encompass:sil=256000:st=3.0:s2a=on:i=2812:s2at=1.2:ss=axioms:sd=15_0");
    large.push("lrs+10_1:1_drc=encompass:sil=2000:slsq=on:s2a=on:i=1149:s2at=7.0_0");
    large.push("dis+10_1:1024_slsqr=7,2:to=lpo:sil=256000:tgt=full:s2agt=8:slsqc=1:slsq=on:s2a=on:i=1192:rawr=on_0");
    large.push("lrs+10_16:1_to=lpo:sil=32000:urr=ec_only:fd=preordered:nwc=10.0:i=1205:bd=off:irc=lazy:drc=encompass_0");
    large.push("ott+10_1:2_sil=256000:tgt=ground:sp=reverse_frequency:spb=goal:i=1221:kws=precedence:irc=lazy_0");
    large.push("lrs+10_11:1_sil=4000:fde=none:nwc=5.0:st=3.0:i=1611:bd=off:ss=axioms:fd=off_0");
    large.push("lrs+10_1:7_drc=encompass:sil=64000:tgt=full:spb=non_intro:i=5146:awrs=converge:awrsf=67:sp=reverse_frequency:nwc=1.5_0");
    large.push("lrs+10_3:1_drc=encompass:sil=4000:tgt=full:sp=unary_first:sos=all:lwlo=on:i=3527:irc=lazy_0");
    large.push("lrs+10_1:4_drc=encompass:sil=32000:tgt=full:fde=unused:sp=const_frequency:nwc=10.0:i=8884:dpc=on:rawr=on:bd=preordered:to=lpo_0");
    large.push("lrs+10_1:1_drc=encompass:sil=256000:tgt=ground:s2agt=8:s2a=on:i=1865_0");
    large.push("ott+10_1:14_bsr=unit_only:sil=256000:i=2291:sp=weighted_frequency:irc=lazy_0");
    large.push("dis+10_1:5_sil=256000:tgt=full:sp=frequency:i=5812:kws=precedence:rawr=on:spb=intro:ss=axioms_0");
    large.push("lrs+10_1:64_drc=encompass:sil=16000:tgt=full:sp=reverse_frequency:slsq=on:i=3741:kws=precedence:slsql=off:ss=axioms:bs=unit_only:irc=lazy:spb=goal_0");
    large.push("lrs+10_5:7_slsqr=1,16:drc=encompass:sil=8000:tgt=ground:sp=occurrence:slsq=on:lwlo=on:i=7709:slsql=off:ss=axioms:sgt=8:rawr=on:urr=on:ins=1:plsq=on_0");
    large.push("lrs+10_1:27_bsr=unit_only:to=lpo:drc=encompass:sil=128000:fde=unused:sp=const_min:spb=goal:fd=preordered:i=8986:bs=on:dpc=on:uhcvi=on:rawr=on:irc=lazy:er=filter:erape=on:erml=3_0");
    large.push("ott+10_1:64_sil=256000:tgt=full:i=9295:sp=reverse_frequency:bd=off:drc=encompass_0");
    large.push("lrs+10_3:14_drc=encompass:sil=128000:sp=const_frequency:spb=goal:lwlo=on:i=27148:kws=precedence:irc=lazy:ins=4_0");
    large.push("lrs+10_1:16_drc=encompass:sil=16000:sp=unary_frequency:i=5651:kws=precedence_0");
    large.push("lrs+10_1:4_drc=encompass:sil=16000:tgt=ground:lwlo=on:s2a=on:i=6612:s2at=2.0_0");
    large.push("dis+10_1:4_to=lpo:sil=256000:tgt=full:sp=reverse_frequency:spb=goal:i=10830:awrs=converge:awrsf=500:fd=preordered:irc=lazy:bd=off_0");
    large.push("dis+10_1:4_drc=encompass:sil=256000:tgt=ground:sos=all:i=11862:kws=inv_arity_squared:fsr=off:dpc=on_0");
    large.push("lrs+10_2:3_sil=128000:fde=none:s2a=on:i=12422:s2at=3.0:lwlo=on:bd=off_0");
    large.push("lrs+10_1:16_drc=encompass:sil=32000:sp=reverse_frequency:spb=goal:i=25729:kws=inv_arity_squared_0");
    large.push("ott+10_2:9_drc=encompass:sil=128000:tgt=full:sp=frequency:nwc=5.0:st=3.0:i=52532:kws=precedence:bd=preordered:dpc=on:ss=axioms:rawr=on:rnwc=on_0");
    large.push("dis+10_1:166_drc=encompass:sil=256000:tgt=full:i=17813:fsr=off:spb=non_intro:kws=inv_frequency_0");
    large.push("dis+10_1:32_drc=encompass:sil=256000:tgt=ground:sp=const_frequency:spb=goal:i=29210:kws=precedence:bd=off:dpc=on:irc=lazy:s2a=on:s2at=3.0_0");
    large.push("dis+10_1:1_drc=encompass:sil=256000:tgt=full:i=69601:to=lpo:fde=unused_0");
    large.push("lrs+10_1:16_drc=encompass:sil=256000:tgt=full:spb=intro:i=104809:kws=precedence:awrs=converge:awrsf=200:ss=axioms:irc=eager:st=3.0:sp=const_frequency_0");
    large.push("dis+10_1:166_drc=encompass:sil=256000:tgt=full:i=71085:fsr=off:spb=non_intro:dpc=on:to=lpo:rawr=on_0");
    large.push("ott+10_8355:1048576_drc=encompass:sil=256000:tgt=ground:fde=unused:sp=frequency:nwc=7.4163:i=138914:awrs=decay:awrsf=294:fsr=off:irc=lazy:er=known:fsd=on:rawr=on:irw=on:etr=on:dpc=on:doe=on_0");
    large.push("dis+10_1:64_sil=256000:tgt=full:sp=const_frequency:sos=on:i=52615:bs=on_0");
    large.push("lrs+10_1:1024_drc=encompass:sil=128000:tgt=ground:sp=frequency:i=53029:kws=precedence_0");
    large.push("lrs+10_2:23_drc=encompass:sil=256000:tgt=full:s2a=on:i=115310:s2at=2.0:irc=lazy:dpc=on_0");
    large.push("lrs+10_1:24_bsr=unit_only:to=lpo:drc=encompass:sil=128000:fde=unused:sp=const_min:spb=goal:fd=preordered:i=61351:bs=on:dpc=on:rawr=on:irc=lazy:er=filter:erape=on:nwc=3.0:ss=axioms:st=6.0:urr=ec_only_0");
    large.push("lrs+10_1:3_drc=encompass:sil=256000:tgt=full:fd=preordered:s2a=on:i=77829:s2at=4.0_0");
    large.push("ott+10_1:128_bsr=on:drc=encompass:sil=128000:sp=frequency:i=90005:bd=preordered:dpc=on:rawr=on_0");
    large.push("lrs+10_1:4_to=lpo:sil=256000:tgt=ground:sp=reverse_arity:spb=goal_then_units:i=96565:fdi=10:bs=unit_only:s2a=on_0");
    large.push("dis+10_28091:1048576_to=lpo:drc=encompass:sil=128000:tgt=full:erd=off:cond=on:i=98072:doe=on:ins=2:av=off:dpc=on:irc=eager:s2pl=on:s2agt=5:s2at=4.0:foolp=on_0");
    large.push("lrs+10_1:1_drc=encompass:sil=256000:tgt=ground:sp=unary_first:sos=on:i=200293:kws=precedence:lwlo=on:irc=lazy_0");
    large.push("dis+10_5:2_drc=encompass:sil=256000:tgt=ground:sp=reverse_frequency:sos=all:i=188493:bd=off:fsr=off:dpc=on_0");
    // slack = 100
    // total_instr 1722265
    // len(covered) 395
  } else {
