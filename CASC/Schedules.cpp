...
void Schedules::getSnakeTptpUnsSchedule(const Shell::Property& property, Schedule& quick) {    
  ...
  // problemsARIUNS.txt
   ...
   quick.push("dis+1011_1:64_drc=off:flr=on:nwc=2.0:sac=on:urr=ec_only:i=19:si=on:rawr=on:rtra=on_0");
   quick.push("ott+21_1:1_erd=off:s2a=on:sac=on:sd=1:sgt=64:sos=on:ss=included:st=3.0:to=lpo:urr=on:i=51:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:1024_awrs=decay:awrsf=32:ep=RSTC:s2a=on:sd=1:skr=on:ss=axioms:st=2.0:i=4:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1010_1:50_awrs=decay:awrsf=128:nwc=10.0:s2pl=no:sp=frequency:ss=axioms:i=6:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:1_bd=off:fd=preordered:fde=unused:sfv=off:sos=on:sp=reverse_frequency:spb=goal:to=lpo:i=8:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bd=off:fd=off:fde=none:ins=3:sac=on:sos=on:spb=goal:to=lpo:i=42:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:128_fde=none:sos=on:spb=goal:to=lpo:i=11:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:32_br=off:nm=16:sd=2:ss=axioms:st=2.0:urr=on:i=17:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:1_av=off:plsq=on:sd=1:sos=all:ss=axioms:st=1.2:i=4:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:1_ep=RST:s2a=on:s2at=5.0:sos=all:i=24:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_br=off:canc=force:drc=off:s2a=on:sos=on:sp=reverse_frequency:urr=on:i=38:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+22_1:1_amm=sco:fsr=off:gve=force:sos=on:uwa=all:i=51:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_bs=unit_only:ev=force:foolp=on:sp=reverse_arity:to=lpo:i=18:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_canc=force:tha=off:to=lpo:i=5:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_bce=on:ins=3:s2a=on:sp=reverse_frequency:to=lpo:i=2:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+30_1:1024_acc=on:asg=force:bce=on:ep=R:ev=force:nwc=2.0:plsq=on:plsqc=1:plsqr=32,1:slsq=on:slsql=off:slsqr=1,4:sp=const_frequency:to=lpo:uwa=interpreted_only:i=7:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_ins=2:sd=1:ss=axioms:i=45:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_2:3_anc=all:br=off:fsr=off:nwc=5.0:s2a=on:s2agt=10:urr=on:i=75:si=on:rawr=on:rtra=on_0");
   quick.push("ott+3_1:1_flr=on:gsp=on:lcm=predicate:plsq=on:plsqr=7,41:sac=on:sos=on:sp=frequency:spb=goal_then_units:urr=on:i=54:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_5:1_br=off:fde=none:nwc=3.0:sd=1:sgt=10:sos=on:ss=axioms:urr=on:i=35:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_bce=on:br=off:erd=off:gs=on:ins=1:newcnf=on:s2at=1.1:s2pl=no:slsq=on:slsqc=1:slsqr=1,1:to=lpo:urr=on:i=141:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_s2a=on:sp=frequency:to=lpo:i=271:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+20_1:1_fd=preordered:sos=on:spb=goal:to=lpo:i=68:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_1:1024_awrs=converge:br=off:bs=unit_only:flr=on:nwc=1.2:rnwc=on:sp=weighted_frequency:thsq=on:thsqc=32:thsqd=64:thsqr=1376520,872807:to=lpo:urr=on:i=39:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:1_ins=3:sp=reverse_frequency:spb=goal:to=lpo:i=39:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_afp=1:sac=on:sas=z3:tha=off:i=181:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_thi=all:thigen=on:i=101:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:32_newcnf=on:sas=z3:tgt=ground:tha=off:i=382:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+20_1:12_aac=none:acc=model:awrs=converge:fd=preordered:fsr=off:nicw=on:nwc=3.0:s2a=on:s2agt=16:spb=goal:to=lpo:i=43:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_canc=force:tha=off:to=lpo:i=31:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_5:1_aer=off:norm_ineq=on:sas=z3:sos=all:ss=axioms:tha=off:i=399:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:1_br=off:fde=none:norm_ineq=on:nwc=10.0:sas=z3:slsq=on:slsqc=2:slsql=off:slsqr=1,4:sp=reverse_frequency:i=201:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+2_1:1_aac=none:amm=off:avsq=on:avsqc=1:avsqr=10,7:bd=off:fde=unused:lcm=reverse:sac=on:sas=z3:sos=on:sp=const_min:spb=goal_then_units:to=lpo:urr=ec_only:i=134:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:64_nwc=1.4:rp=on:tha=off:i=41:si=on:rawr=on:rtra=on_0");
   quick.push("ott+1004_1:1_anc=all_dependent:bsr=on:gs=on:nwc=3.0:rp=on:s2a=on:s2at=2.0:sac=on:slsq=on:slsqc=0:slsql=off:slsqr=1,4:sp=reverse_arity:spb=goal_then_units:to=lpo:urr=on:i=115:si=on:rawr=on:rtra=on_0");

   quick.push("lrs+1010_1:1_aac=none:bce=on:nicw=on:nm=0:plsq=on:plsql=on:sac=on:sos=on:sp=frequency:spb=units:to=lpo:i=153:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_gsp=on:sd=1:sgt=32:sos=on:ss=axioms:i=764:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_acc=model:br=off:ins=1:newcnf=on:nwc=5.0:s2a=on:sac=on:sp=frequency:to=lpo:urr=on:i=185:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_br=off:ss=axioms:st=2.0:urr=on:i=1822:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:drc=off:fd=preordered:nwc=5.0:sp=reverse_frequency:i=492:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:sd=10:sos=all:ss=axioms:st=4.0:i=73:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_3:1_br=off:flr=on:sgt=8:ss=axioms:urr=on:i=207:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1002_1:1_nm=0:sd=1:ss=axioms:urr=ec_only:i=331:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:64_s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,1:i=1717:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+11_1:1024_awrs=converge:br=off:bs=unit_only:flr=on:nwc=1.2:rnwc=on:sp=weighted_frequency:thsq=on:thsqc=32:thsqd=64:thsqr=1376520,872807:to=lpo:urr=on:i=49:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_ep=RS:fsr=off:sos=all:i=3120:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+3_5:1_av=off:awrs=decay:br=off:bs=unit_only:ins=1:lwlo=on:plsq=on:plsqr=16,99:s2a=on:s2at=1.5:urr=ec_only:i=667:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_ep=RST:ins=2:s2a=on:s2agt=8:sac=on:sas=z3:i=230:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+22_1:1_amm=sco:fsr=off:gve=force:sos=on:uwa=all:i=151:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:6_aac=none:afr=on:bce=on:bsr=unit_only:canc=cautious:cond=fast:fde=unused:newcnf=on:nwc=3.0:s2a=on:s2agt=40:sas=z3:sfv=off:sp=weighted_frequency:spb=units:tha=off:to=lpo:i=2494:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_aac=none:abs=on:nicw=on:sac=on:sas=z3:tgt=ground:tha=some:to=lpo:i=921:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:1_aac=none:abs=on:bd=off:fd=off:nm=0:sas=z3:sims=off:tha=off:to=lpo:i=1303:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:nm=0:nwc=1.5:tgt=full:tha=off:i=548:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_4:1_abs=on:afp=10:afq=1.45:asg=cautious:bd=off:br=off:canc=force:ev=force:kws=inv_arity_squared:nwc=3.0:plsq=on:plsqc=1:plsql=on:plsqr=8,27:s2a=on:s2at=2.0:sas=z3:sffsmt=on:skr=on:sp=unary_frequency:spb=intro:urr=on:i=791:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1010_137062:920759_aac=none:abs=on:amm=sco:anc=none:asg=cautious:atotf=0.5:avsq=on:avsqc=2:avsqr=383,440:bce=on:bsd=on:erd=off:fde=unused:gs=on:gve=cautious:newcnf=on:nwc=3.3:sac=on:sas=z3:sfv=off:skr=on:spb=goal:tgt=ground:thsq=on:thsqc=128:thsql=off:uwa=all:i=2692:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_bd=off:br=off:sas=z3:spb=goal:tgt=full:tha=some:to=lpo:uwa=all:i=404:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:128_asg=cautious:drc=off:fde=none:gve=force:norm_ineq=on:sas=z3:sos=all:sp=reverse_arity:spb=intro:ss=axioms:to=lpo:uwa=one_side_constant:i=434:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_bd=off:fde=unused:gsp=on:ins=1:norm_ineq=on:sas=z3:sos=all:tha=off:i=671:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_5:1_norm_ineq=on:sas=z3:sos=all:ss=axioms:tha=off:i=1093:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+2_1:1_aac=none:amm=off:avsq=on:avsqc=1:avsqr=10,7:bd=off:fde=unused:lcm=reverse:sac=on:sas=z3:sos=on:sp=const_min:spb=goal_then_units:to=lpo:urr=ec_only:i=2694:si=on:rawr=on:rtra=on_0");
   quick.push("dis+31_1:1_lcm=reverse:norm_ineq=on:nwc=10.0:sas=z3:tha=off:urr=on:i=1540:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:128_aac=none:afp=10:anc=all_dependent:avsq=on:avsqr=117,34:awrs=converge:bd=preordered:drc=off:ins=1:nwc=5.0:ss=axioms:st=5.0:to=lpo:urr=on:uwa=interpreted_only:i=201:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_acc=on:anc=all_dependent:canc=force:fd=preordered:newcnf=on:sac=on:sp=unary_frequency:spb=non_intro:tha=off:urr=on:i=2705:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_1:1_avsq=on:avsql=on:avsqr=1,16:norm_ineq=on:nwc=10.0:plsq=on:sas=z3:tha=off:urr=on:i=2593:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_amm=sco:norm_ineq=on:nwc=3.0:plsq=on:plsqc=2:plsqr=32,1:sas=z3:sp=const_min:tha=off:to=lpo:i=262:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1002_1:1_fsr=off:newcnf=on:rp=on:slsq=on:slsqc=0:slsqr=5,4:i=229:si=on:rawr=on:rtra=on_0");

   quick.push("lrs+10_1:5_drc=off:s2a=on:s2at=1.5:i=3684:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_nwc=2.0:ss=axioms:st=1.3:urr=on:i=5890:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:sd=10:sos=all:ss=axioms:st=4.0:i=10410:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_3:1_abs=on:ep=RST:newcnf=on:nm=2:sas=z3:sd=1:sos=all:ss=included:to=lpo:i=35001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1002_1:1_nm=0:sd=1:ss=axioms:urr=ec_only:i=7994:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("ott+0_1:128_afr=on:amm=sco:anc=none:awrs=converge:awrsf=110:bsd=on:cond=fast:etr=on:fde=unused:flr=on:fsd=on:gve=force:irw=on:norm_ineq=on:sas=z3:sos=all:spb=units:tha=off:thi=strong:to=lpo:uwa=one_side_interpreted:i=21995:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1002_5:1_av=off:awrs=decay:awrsf=16:cond=on:fd=preordered:sfv=off:sp=const_frequency:thi=neg_eq:thsq=on:thsqc=16:thsqd=64:i=24001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+35_1:1_aac=none:abs=on:amm=off:norm_ineq=on:s2a=on:s2at=3.0:tha=off:i=24625:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+30_1:64_flr=on:sp=frequency:to=lpo:i=33748:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:1_abs=on:bd=off:flr=on:nm=0:s2at=3.0:sas=z3:sfv=off:slsq=on:slsqc=2:slsqr=46,31:sp=const_frequency:tgt=ground:tha=some:thi=overlap:thitd=on:thsq=on:thsqc=32:thsqd=32:thsqr=7,4:i=34994:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:1_aac=none:abs=on:bd=off:fd=off:nm=0:sas=z3:sims=off:tha=off:to=lpo:i=16992:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_ev=force:newcnf=on:sas=z3:spb=goal:tgt=full:tha=off:uwa=ground:i=9298:si=on:rawr=on:rtra=on_0");
   quick.push("dis+11_5:1_av=off:fde=unused:lcm=reverse:nwc=3.0:sp=const_frequency:tgt=ground:i=7601:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_abs=on:afp=1000:nicw=on:sas=z3:tgt=ground:tha=off:uwa=all:i=16995:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+31_1:3_abs=on:add=large:afp=329:afq=1.2:anc=none:avsq=on:avsqr=160,201:awrs=decay:bce=on:bsr=unit_only:canc=cautious:etr=on:ev=force:flr=on:fs=off:fsd=on:fsr=off:irw=on:lcm=reverse:newcnf=on:nicw=on:nwc=1.55:pum=on:rnwc=on:s2agt=32:sas=z3:sffsmt=on:sims=off:skr=on:slsq=on:slsqc=2:slsqr=433504,723351:sp=unary_first:spb=goal_then_units:tgt=full:tha=some:to=lpo:uhcvi=on:uwa=one_side_constant:i=8388:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1024_drc=off:fde=none:gve=force:nm=4:norm_ineq=on:sas=z3:sos=all:sp=const_min:spb=non_intro:to=lpo:uwa=one_side_constant:i=774:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_9:8_amm=off:bsd=on:etr=on:fsd=on:fsr=off:lma=on:newcnf=on:nm=0:nwc=3.0:s2a=on:s2agt=10:sas=z3:tha=some:i=6398:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:128_asg=cautious:drc=off:fde=none:gve=force:norm_ineq=on:sas=z3:sos=all:sp=reverse_arity:spb=intro:ss=axioms:to=lpo:uwa=one_side_constant:i=434:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_1:1_avsq=on:avsql=on:avsqr=1,16:norm_ineq=on:nwc=10.0:plsq=on:sas=z3:tha=off:urr=on:i=7098:si=on:rawr=on:rtra=on_0");

   quick.push("lrs+10_1:1_br=off:ep=RSTC:newcnf=on:plsq=on:plsqr=32,1:urr=on:i=49427:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_3:1_abs=on:ep=RST:newcnf=on:nm=2:sas=z3:sd=1:sos=all:ss=included:to=lpo:i=130001:si=on:rawr=on:rtra=on_0");
  ...
  // problemsUEQUNS.txt
   quick.push("lrs+10_1:1_atotf=0.1:bsr=unit_only:plsq=on:sd=1:sos=all:ss=included:i=2:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:32_drc=off:i=49:si=on:rawr=on:rtra=on_0");
   quick.push("dis+21_1:1_av=off:sos=on:sp=frequency:ss=included:to=lpo:i=11:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:50_drc=off:fde=unused:ss=included:st=2.0:i=51:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:1_av=off:br=off:erd=off:ins=1:nm=3:nwc=3.0:s2a=on:urr=on:i=12:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_nwc=10.0:sp=reverse_frequency:spb=goal:to=lpo:i=6:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:2_drc=off:ins=3:plsq=on:sac=on:sp=reverse_frequency:to=lpo:i=48:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_br=off:ep=RSTC:sos=all:urr=on:i=3:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1002_1:1_br=off:canc=force:drc=off:s2a=on:sos=on:sp=reverse_frequency:urr=on:i=2:si=on:rawr=on:rtra=on_0");
   quick.push("dis+11_1:32_newcnf=on:nwc=5.0:i=2:si=on:rawr=on:rtra=on_0");
   quick.push("ott+1_1:1_abs=on:afq=1.0:atotf=0.1:avsq=on:drc=off:lcm=predicate:nwc=1.1:plsq=on:sp=unary_first:spb=units:i=47:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:2_drc=off:fd=preordered:kws=inv_arity:tgt=full:i=46:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_5:1_br=off:ep=RSTC:sos=all:urr=on:i=22:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_av=off:br=off:bsd=on:drc=off:s2a=on:sos=all:sp=reverse_arity:spb=goal:to=lpo:urr=on:i=15:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_3:29_av=off:awrs=decay:awrsf=32:bce=on:drc=off:fde=unused:gsp=on:irw=on:nwc=2.0:spb=goal_then_units:updr=off:urr=ec_only:i=50:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+1004_1:1024_av=off:awrs=decay:bce=on:bd=off:br=off:dr=on:fde=unused:lcm=predicate:nwc=3.0:plsq=on:plsqr=31,7:rp=on:slsq=on:slsqc=1:slsql=off:slsqr=1697477,978948:sp=frequency:to=lpo:updr=off:urr=ec_only:i=27:si=on:rawr=on:rtra=on_0");

   quick.push("dis+1011_1:64_drc=off:flr=on:nwc=2.0:sac=on:urr=ec_only:i=481:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:16_awrs=converge:awrsf=40:br=off:ep=RSTC:flr=on:gsp=on:nwc=3.0:sos=on:urr=on:i=67:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=1:sos=on:spb=goal_then_units:ss=included:to=lpo:i=40:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_br=off:drc=off:erd=off:ss=axioms:urr=on:i=110:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_alpa=true:bd=off:br=off:fde=unused:fsr=off:nwc=5.0:sos=all:sp=frequency:ss=axioms:to=lpo:urr=ec_only:i=25:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:1_add=large:avsq=on:avsqc=1:br=off:fsr=off:ins=1:nwc=10.0:spb=units:urr=ec_only:i=72:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1024_drc=off:fde=none:sp=reverse_frequency:i=429:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:7_drc=off:fd=preordered:plsq=on:sp=reverse_frequency:to=lpo:i=262:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_drc=off:fd=preordered:plsq=on:sp=occurrence:to=lpo:i=81:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_fd=off:ins=2:nwc=5.0:sp=occurrence:to=lpo:i=21:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_5:1_drc=off:sos=all:sp=reverse_arity:spb=goal:to=lpo:i=266:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1024_drc=off:sp=unary_frequency:tgt=full:to=lpo:i=131:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_br=off:drc=off:kmz=on:plsq=on:plsqc=1:plsqr=32,1:sp=reverse_arity:suph=off:urr=ec_only:i=8:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+34_1:1024_av=off:awrs=converge:awrsf=230:bd=off:lma=on:nwc=5.0:s2pl=no:sos=on:tgt=ground:to=lpo:i=71:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_drc=off:fd=preordered:plsq=on:rp=on:sp=occurrence:to=lpo:i=31:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_br=off:rp=on:sp=occurrence:to=lpo:urr=ec_only:i=181:si=on:rawr=on:rtra=on_0");
   quick.push("ott+1_4:1_drc=off:flr=on:plsq=on:plsqc=1:plsqr=32,1:rp=on:s2a=on:s2at=2.4:s2pl=no:to=lpo:i=71:si=on:rawr=on:rtra=on_0");

   quick.push("lrs+10_1:16_awrs=converge:awrsf=40:br=off:ep=RSTC:flr=on:gsp=on:nwc=3.0:sos=on:urr=on:i=561:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_bd=off:drc=off:lcm=reverse:nwc=5.0:sd=1:sgt=16:spb=goal_then_units:ss=axioms:to=lpo:i=333:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:8_drc=off:fd=preordered:fde=unused:sp=reverse_frequency:ss=axioms:st=2.0:i=3229:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:6_bs=on:drc=off:fd=preordered:fde=none:ins=1:plsq=on:s2a=on:sas=z3:sp=reverse_frequency:ss=included:to=lpo:i=741:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:3_aac=none:afr=on:amm=off:anc=all_dependent:avsq=on:avsqr=51857,726697:bce=on:bd=off:nm=16:plsq=on:plsqc=2:plsql=on:sas=z3:slsq=on:slsqc=0:slsqr=10,119:sp=weighted_frequency:ss=axioms:i=299:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_br=off:newcnf=on:ss=included:urr=on:i=635:si=on:rawr=on:rtra=on_0");
   quick.push("ott+21_1:1_bd=off:bsr=unit_only:drc=off:fd=preordered:fsr=off:nwc=3.0:sac=on:to=lpo:urr=on:i=784:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1002_1:28_av=off:nwc=5.0:s2a=on:s2at=3.0:i=1111:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1010_1:173_acc=on:aer=off:alpa=true:anc=none:avsq=on:avsqr=497233,912204:awrs=decay:awrsf=4:bce=on:bs=on:bsd=on:cond=on:drc=off:erd=off:flr=on:gsp=on:nicw=on:nm=16:nwc=3.0:sd=2:sfv=off:skr=on:sp=reverse_arity:ss=axioms:st=2.0:updr=off:urr=ec_only:i=2701:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=10:sos=all:ss=axioms:st=3.0:i=1001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_6339:827045_acc=on:anc=all:awrs=decay:awrsf=1:bce=on:br=off:bs=unit_only:cond=on:foolp=on:nicw=on:nwc=2.0:s2a=on:s2agt=8:sd=1:sgt=16:sp=occurrence:ss=axioms:st=1.2:updr=off:urr=on:uwa=all:i=2301:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:4_drc=off:sos=on:to=lpo:i=1166:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_drc=off:flr=on:s2a=on:slsq=on:slsqc=1:slsql=off:slsqr=5,3:sp=weighted_frequency:urr=on:i=271:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_avsq=on:avsql=on:bsr=unit_only:drc=off:fsr=off:inw=on:nwc=10.0:rnwc=on:sgt=16:slsq=on:slsqc=0:slsql=off:slsqr=211,119:sp=reverse_frequency:spb=goal_then_units:ss=included:st=2.0:to=lpo:i=571:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1_3:1_ep=RSTC:sos=on:urr=on:i=278:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1024_drc=off:fde=none:sp=frequency:i=1834:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:nwc=2.0:spb=non_intro:tgt=full:to=lpo:urr=ec_only:i=1139:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_26459:191296_av=off:awrs=converge:awrsf=30:bd=preordered:bs=unit_only:drc=off:etr=on:flr=on:lwlo=on:nwc=5.0:plsq=on:plsqc=1:plsql=on:plsqr=1,32:skr=on:slsq=on:slsqr=18,107:sp=const_min:tgt=ground:to=lpo:urr=ec_only:i=4645:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_drc=off:fd=preordered:tgt=full:to=lpo:i=4001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1002_1:12_drc=off:fd=preordered:tgt=full:i=4952:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:28_bd=off:bs=on:tgt=ground:i=3294:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("dis+1011_1:2_av=off:flr=on:s2a=on:s2at=1.5:sp=const_max:spb=goal:tgt=ground:to=lpo:i=491:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:drc=off:slsq=on:slsqc=1:slsqr=29,16:sp=reverse_frequency:to=lpo:i=471:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:2_bd=preordered:drc=off:fd=preordered:fde=unused:sp=const_min:to=lpo:i=570:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:64_spb=goal:tgt=ground:thsq=on:thsqc=64:to=lpo:i=581:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_drc=off:fd=preordered:plsq=on:rp=on:sp=occurrence:to=lpo:i=845:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_br=off:rp=on:sp=occurrence:to=lpo:urr=ec_only:i=181:si=on:rawr=on:rtra=on_0");
   quick.push("ott+1_1:1_nm=21:plsq=on:rp=on:s2a=on:s2at=2.0:slsq=on:slsqc=2:slsqr=1,1:ss=included:st=1.5:i=771:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_8:1_bd=off:br=off:fd=off:plsq=on:plsqr=278,15:rp=on:s2at=1.5:slsq=on:slsqc=1:spb=goal_then_units:urr=ec_only:i=91:si=on:rawr=on:rtra=on_0");

   quick.push("ins+10_1:1_drc=off:igrr=1/8:igs=1002:igwr=on:ss=axioms:st=3.0:i=2553:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:16_awrs=converge:awrsf=40:br=off:ep=RSTC:flr=on:gsp=on:nwc=3.0:sos=on:urr=on:i=561:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:227_abs=on:amm=off:avsq=on:avsqc=1:avsqr=97,32:awrs=converge:awrsf=256:bsr=unit_only:drc=off:fd=preordered:plsq=on:plsqc=1:plsql=on:plsqr=27942579,963352:sas=z3:slsq=on:slsqc=1:slsql=off:slsqr=307,512:sp=occurrence:ss=axioms:st=3.0:i=13001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_8:1_bd=preordered:drc=off:fd=preordered:sp=reverse_frequency:i=4701:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:14_aac=none:abs=on:bce=on:erd=off:fde=unused:nwc=3.0:sac=on:sas=z3:sp=frequency:to=lpo:urr=on:i=1682:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1002_1:28_av=off:bsr=on:cond=on:fde=none:fsd=on:gsp=on:irw=on:s2a=on:s2at=1.5:sims=off:slsq=on:slsqc=0:slsqr=5,3:i=2672:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:12_drc=off:i=8321:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:8_anc=all_dependent:atotf=0.2:drc=off:fde=unused:nicw=on:nwc=3.0:sas=z3:slsq=on:slsqc=1:slsqr=3,2:sp=reverse_frequency:i=17001:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("ott+10_1:1_bd=preordered:drc=off:fd=preordered:nwc=5.0:sp=reverse_frequency:i=12328:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:64_s2a=on:s2agt=16:slsq=on:slsqc=1:slsqr=1,1:i=4714:si=on:rawr=on:rtra=on_0");
   quick.push("ott+21_1:1_bd=off:bsr=unit_only:drc=off:fd=preordered:fsr=off:nwc=3.0:sac=on:to=lpo:urr=on:i=1500:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:128_awrs=converge:bd=preordered:drc=off:sp=reverse_frequency:to=lpo:i=22000:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_avsq=on:avsql=on:bsr=unit_only:drc=off:fsr=off:inw=on:nwc=10.0:rnwc=on:sgt=16:slsq=on:slsqc=0:slsql=off:slsqr=211,119:sp=reverse_frequency:spb=goal_then_units:ss=included:st=2.0:to=lpo:i=6001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_3:1_bd=off:fde=none:lwlo=on:i=26001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+2_1:1_av=off:flr=on:plsq=on:plsqc=1:plsqr=32,1:sp=reverse_frequency:to=lpo:urr=ec_only:uwa=all:i=5072:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:12_drc=off:fsr=off:urr=ec_only:i=25001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_26459:191296_av=off:awrs=converge:awrsf=30:bd=preordered:bs=unit_only:drc=off:etr=on:flr=on:lwlo=on:nwc=5.0:plsq=on:plsqc=1:plsql=on:plsqr=1,32:skr=on:slsq=on:slsqr=18,107:sp=const_min:tgt=ground:to=lpo:urr=ec_only:i=5801:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+21_1:14_awrs=converge:br=off:drc=off:ev=cautious:s2a=on:sfv=off:tgt=ground:tha=off:urr=on:i=45001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:16_ins=2:tgt=ground:i=17001:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:drc=off:fde=unused:slsq=on:slsqr=10,31:sp=const_min:tgt=ground:to=lpo:urr=ec_only:i=30000:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:512_drc=off:fd=preordered:ins=2:kws=precedence:s2a=on:sp=unary_first:spb=intro:tgt=ground:i=11001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_951:388159_awrs=decay:awrsf=60:fd=preordered:spb=goal:tgt=ground:i=7391:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:128_drc=off:ins=1:sp=const_frequency:tgt=ground:i=43676:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:32_awrs=converge:drc=off:kws=precedence:sp=reverse_arity:spb=goal:tgt=full:i=38001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:1_bsd=on:fde=none:fsd=on:s2a=on:s2agt=32:i=1538:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1010_1:10_fde=unused:fsr=off:tgt=ground:i=15156:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1002_1:128_av=off:bs=unit_only:ins=1:plsq=on:plsqr=32,1:urr=on:uwa=all:i=4235:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("ott+32_8:1_av=off:cond=fast:dr=on:drc=off:flr=on:foolp=on:nm=16:nwc=10.0:s2a=on:s2agt=8:spb=goal_then_units:thsq=on:thsqc=64:thsqd=16:thsql=off:to=lpo:i=7501:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1011_1:16_acc=on:drc=off:fd=preordered:fsd=on:nwc=2.0:slsq=on:slsqc=2:slsql=off:slsqr=1,16:thsq=on:thsqc=16:thsqd=16:urr=on:i=6301:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("ott+10_75:754_abs=on:add=large:anc=all:atotf=0.3115:drc=off:fd=preordered:fde=unused:gs=on:gsaa=from_current:gsem=off:nicw=on:nwc=4.0:slsq=on:slsqc=1:slsqr=1,1:spb=goal_then_units:to=lpo:i=83000:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:drc=off:fd=preordered:nwc=5.0:sp=reverse_frequency:i=16001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_13918:311883_atotf=0.1:awrs=decay:drc=off:er=filter:etr=on:fd=preordered:nicw=on:nwc=5.0:s2a=on:s2agt=32:sas=z3:i=48001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_ss=axioms:st=3.0:i=3238:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:128_plsq=on:plsqc=2:s2a=on:ss=axioms:st=1.5:urr=on:i=5460:si=on:rawr=on:rtra=on_0");
   quick.push("ott+4_1:1_atotf=0.5:bce=on:ins=1:sp=frequency:spb=units:i=260001:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:5_av=off:bs=unit_only:drc=off:fd=preordered:gs=on:lwlo=on:newcnf=on:plsq=on:plsql=on:plsqr=32,1:thi=neg_eq:i=69001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+1011_1:1_add=large:bd=off:bs=on:drc=off:fd=preordered:gs=on:ins=1:nwc=10.0:s2a=on:sp=reverse_arity:to=lpo:uwa=one_side_interpreted:i=63001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:6_bd=off:drc=off:tgt=full:i=62001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+1002_1:12_drc=off:fd=preordered:tgt=full:i=470001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+10_1:1_kws=precedence:lwlo=on:tgt=ground:i=57001:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:2_drc=off:fd=preordered:kws=inv_arity:tgt=full:i=20001:si=on:rawr=on:rtra=on_0");
   quick.push("dis+10_1:128_drc=off:ins=1:sp=const_frequency:tgt=ground:i=14001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+11_1:1_fd=preordered:kws=inv_frequency:tgt=full:i=350001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+33_1:4_lwlo=on:s2a=on:tgt=ground:i=46001:si=on:rawr=on:rtra=on_0");
   quick.push("ott+11_1:1024_bd=off:bs=on:drc=off:kmz=on:kws=precedence:plsq=on:spb=goal:tgt=full:i=130001:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:128_aac=none:afp=10:anc=all_dependent:avsq=on:avsqr=117,34:awrs=converge:bd=preordered:drc=off:ins=1:nwc=5.0:ss=axioms:st=5.0:to=lpo:urr=on:uwa=interpreted_only:i=130001:si=on:rawr=on:rtra=on_0");
   ...
   quick.push("ott+10_1:128_aac=none:acc=on:amm=off:atotf=0.1:bd=preordered:drc=off:fd=preordered:fde=none:gs=on:nicw=on:s2a=on:s2at=5.0:slsq=on:sp=const_max:spb=non_intro:tgt=ground:to=lpo:i=200001:si=on:rawr=on:rtra=on_0");
   quick.push("ott+10_1:5_bs=unit_only:drc=off:ins=1:nwc=2.16:rnwc=on:slsq=on:slsqr=13,149:sp=const_min:tgt=ground:to=lpo:uwa=interpreted_only:i=140001:si=on:rawr=on:rtra=on_0");
   quick.push("lrs+2_1:128_awrs=decay:awrsf=20:drc=off:fsd=on:lwlo=on:nm=2:nwc=1.94:rp=on:spb=units:thsq=on:thsqc=32:thsqd=32:thsqr=4,7:i=500001:si=on:rawr=on:rtra=on_0");
