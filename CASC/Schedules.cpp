...
void Schedules::getSnakeTptpHolSchedule(const Shell::Property& property, Schedule& quick) {  
  // Champion singleton-schedule for 100000Mi
   quick.push("lrs+1010_1:1_chr=on:ntd=on:i=99890:si=on:rtra=on_0");
  // Improves by expected 2036.1064401970548 probs costing 99889 Mi
  // Sub-schedule for 50Mi strat cap / 400Mi overall limit
   quick.push("dis+1002_1:128_acc=on:er=filter:i=10:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=2:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=29:si=on:rtra=on_0");
   ...
   quick.push("lrs+1003_1:1_au=on:e2e=on:kws=inv_frequency:i=4:si=on:rtra=on_0");
   ...
   quick.push("ott+1010_1:64_abs=on:acc=on:cbe=off:cnfonf=off:cs=on:fde=unused:ins=2:prag=on:i=21:si=on:rtra=on_0");
   quick.push("lrs+1004_1:128_cond=on:e2e=on:sp=weighted_frequency:i=14:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=51:si=on:rtra=on_0");
   quick.push("dis-30_1:1_acc=on:bd=off:fsr=off:plsq=on:plsqr=32,1:i=35:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=10:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_acc=on:bd=off:er=filter:fsr=off:nwc=3.0:piset=and:i=8:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_not_be_gen:ntd=on:sp=const_min:ss=axioms:sup=off:i=18:si=on:rtra=on_0");
   quick.push("lrs-3_4:1_au=on:kws=arity_squared:nm=2:sos=on:i=26:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_c=on:cnfonf=conj_eager:fd=off:fe=off:kws=frequency:spb=intro:i=5:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:fsr=off:i=51:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_anc=all_dependent:au=on:cbe=off:fde=unused:ntd=on:i=7:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bet=on:cnfonf=off:fd=off:hud=5:i=3:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:cs=on:hud=3:prag=on:sup=off:i=6:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_acc=on:amm=sco:cs=on:tgt=full:i=18:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:fe=off:hud=5:prag=on:i=24:si=on:rtra=on_0");
   quick.push("lrs+1004_1:1_chr=on:prag=on:i=6:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bsd=on:cbe=off:cnfonf=conj_eager:fd=off:fsr=off:hi=on:i=33:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cnfonf=lazy_not_be_gen:hud=14:prag=on:sp=weighted_frequency:tnu=1:i=4:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:i=4:si=on:rtra=on_0");
  // Improves by expected 115.21851314081785 probs costing 397 Mi
  // Sub-schedule for 100Mi strat cap / 800Mi overall limit
   quick.push("dis+1004_1:1_cha=on:cs=on:fe=off:hud=1:i=4:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_add=large:cnfonf=lazy_pi_sigma_gen:fe=off:prag=on:i=3:si=on:rtra=on_0");
   quick.push("lrs+1010_1:40_au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=3,1:sac=on:i=89:si=on:rtra=on_0");
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=51:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:bd=off:cnfonf=lazy_pi_sigma_gen:s2a=on:sac=on:sd=1:sgt=20:ss=axioms:i=100:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=100:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_cbe=off:hud=5:nm=4:plsq=on:plsqr=7,1:prag=on:sp=const_max:tnu=1:i=80:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:s2a=on:sd=2:ss=axioms:st=5.0:i=35:si=on:rtra=on_0");
   quick.push("dis+10_1:6_au=on:bd=off:plsq=on:plsqr=1,32:sd=1:sgt=100:ss=axioms:i=65:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cnfonf=lazy_not_be_gen:hud=14:prag=on:sp=weighted_frequency:tnu=1:i=25:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=conj_eager:nwc=3.0:s2a=on:ss=axioms:st=1.5:i=101:si=on:rtra=on_0");
  // Improves by expected 42.665333251487866 probs costing 796 Mi
  // Sub-schedule for 150Mi strat cap / 1200Mi overall limit
   quick.push("dis+1002_1:20_au=on:e2e=on:ss=axioms:uhcvi=on:i=98:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=151:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=151:si=on:rtra=on_0");
   quick.push("dis+10_1:1_avsq=on:cnfonf=off:e2e=on:nm=32:i=150:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_gen:hud=7:plsq=on:plsqc=1:plsqr=32,1:prag=on:tnu=1:i=105:si=on:rtra=on_0");
   quick.push("lrs+21_1:16_au=on:bd=off:piset=and:i=39:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sd=1:sgt=8:ss=axioms:i=150:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_apa=on:cnfonf=off:fd=off:flr=on:hud=1:lcm=reverse:prag=on:sd=1:sos=on:ss=axioms:i=151:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bd=off:c=on:fsr=off:ntd=on:prag=on:sd=1:sos=all:ss=axioms:st=5.0:i=23:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cnfonf=lazy_not_gen:ntd=on:piset=and:ss=axioms:st=1.5:i=144:si=on:rtra=on_0");
   quick.push("dis+10_1:1_aac=none:cs=on:i=47:si=on:rtra=on_0");
  // Improves by expected 45.8718568158491 probs costing 1198 Mi
  // Sub-schedule for 500Mi strat cap / 4000Mi overall limit
   quick.push("lrs+1002_1:5_er=filter:fsr=off:i=15:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=500:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:s2a=on:sd=1:sgt=50:ss=axioms:i=303:si=on:rtra=on_0");
   quick.push("dis+10_1:1_ixr=off:plsq=on:plsqc=1:plsqr=32,1:s2a=on:i=110:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_cond=on:e2e=on:i=61:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=495:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:64_cnfonf=lazy_simp:fd=off:i=118:si=on:rtra=on_0");
   ...
   quick.push("ott+1002_1:1_apa=on:au=on:bd=off:cnfonf=off:fd=off:sos=on:sp=weighted_frequency:i=498:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_hud=1:ss=axioms:i=85:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1024_au=on:cond=fast:ntd=on:piset=and:plsq=on:plsqc=1:plsqr=183491,1048576:sac=on:tgt=ground:i=88:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:bd=off:cnfonf=lazy_gen:fe=off:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:tnu=1:i=438:si=on:rtra=on_0");
   quick.push("lrs+10_1:50_fe=off:kws=frequency:nm=64:ntd=on:sp=frequency:i=18:si=on:rtra=on_0");
  ...
  // Improves by expected 97.0840642045528 probs costing 3984 Mi
  // Sub-schedule for 1000Mi strat cap / 8000Mi overall limit
   quick.push("dis+1002_1:1_cha=on:hud=10:nwc=10.0:prag=on:tnu=1:i=96:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=981:si=on:rtra=on_0");
   ...
   quick.push("lrs+1003_1:1_e2e=on:i=149:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=2:sos=all:ss=axioms:i=177:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:s2a=on:sgt=32:slsq=on:slsqc=1:slsql=off:ss=axioms:i=287:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_alpa=true:au=on:cs=on:tgt=ground:i=189:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=1000:si=on:rtra=on_0");
   quick.push("lrs+1002_1:4_au=on:av=off:bsr=on:cbe=off:nm=2:i=56:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=457:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=335:si=on:rtra=on_0");
   quick.push("lrs+2_1:8_erd=off:plsq=on:plsqr=32,1:sos=on:i=152:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bd=off:bsd=on:fe=axiom:fsd=on:ntd=on:nwc=10.0:i=166:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_aac=none:au=on:e2e=on:nm=2:nwc=10.0:sd=1:ss=axioms:st=3.0:i=770:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:sgt=100:sos=all:ss=axioms:i=324:si=on:rtra=on_0");
  // Improves by expected 64.69592254381683 probs costing 7995 Mi
  // Sub-schedule for 1500Mi strat cap / 12000Mi overall limit
   quick.push("lrs+1010_1:1_cnfonf=lazy_pi_sigma_gen:fd=off:ntd=on:sd=1:sgt=32:sos=on:ss=axioms:i=294:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=471:si=on:rtra=on_0");
   quick.push("dis+21_1:5_au=on:ntd=on:nwc=5.0:s2a=on:ss=axioms:st=5.0:i=201:si=on:rtra=on_0");
   quick.push("lrs+1010_1:3_cnfonf=conj_eager:fsr=off:prag=on:sd=4:sgt=10:ss=axioms:i=490:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_au=on:s2a=on:sd=7:ss=axioms:st=1.5:i=342:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=1456:si=on:rtra=on_0");
   quick.push("lrs+21_1:16_au=on:cbe=off:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=7,4:i=658:si=on:rtra=on_0");
   ...
   quick.push("lrs+1004_1:64_amm=sco:bd=off:chr=on:cnfonf=lazy_pi_sigma_gen:fe=off:hud=5:ins=3:ntd=on:rawr=on:uhcvi=on:i=65:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cnfonf=lazy_not_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=401:si=on:rtra=on_0");
   quick.push("dis+1003_1:64_cha=on:cnfonf=lazy_gen:hud=9:nwc=8.0:prag=on:i=247:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=1149:si=on:rtra=on_0");
   ...
   quick.push("lrs+1_1:1_au=on:cbe=off:ntd=on:i=161:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3548551,65536:s2a=on:i=1487:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_bd=off:fsr=off:ixr=off:nwc=10.0:plsq=on:plsqc=1:plsqr=5977431,65536:rnwc=on:i=844:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:avsq=on:avsqr=1,16:cond=on:sp=frequency:i=382:si=on:rtra=on_0");
   quick.push("lrs+2_11:1_bsr=unit_only:cnfonf=off:e2e=on:hud=10:nm=64:sos=all:i=50:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:nwc=10.0:s2a=on:i=460:si=on:rtra=on_0");
  // Improves by expected 41.07809882068872 probs costing 11987 Mi
  // Sub-schedule for 5000Mi strat cap / 40000Mi overall limit
   quick.push("dis+1002_1:1_cha=on:hud=10:nwc=10.0:prag=on:tnu=1:i=96:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1024_fde=none:kws=precedence:prag=on:sac=on:sos=on:i=409:si=on:rtra=on_0");
   quick.push("ott+1010_5:1_av=off:fe=off:ins=1:kws=precedence:sp=reverse_arity:i=794:si=on:rtra=on_0");
   quick.push("ott+10_1:1024_anc=none:bd=off:e2e=on:fde=none:fsr=off:hud=10:ixr=off:nm=4:nwc=5.0:spb=goal:i=348:si=on:rtra=on_0");
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=1372:si=on:rtra=on_0");
   quick.push("lrs+1002_1:40_au=on:bsd=on:cbe=off:cnfonf=lazy_gen:ntd=on:i=247:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=599:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:s2a=on:sd=1:sgt=50:ss=axioms:i=4913:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_bd=off:cnfonf=off:e2e=on:fd=off:fe=axiom:hud=5:prag=on:sos=on:i=746:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=4203469,65536:i=3756:si=on:rtra=on_0");
   quick.push("dis+10_1:1_atotf=0.1:cbe=off:sd=3:ss=axioms:st=2.0:i=372:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_avsq=on:fe=off:fsr=off:hud=10:plsq=on:plsqr=32,1:prag=on:i=187:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=conj_eager:tgt=ground:i=393:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:fde=unused:i=636:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_cnfonf=off:fde=none:sd=1:ss=axioms:st=3.0:i=4405:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:ixr=off:i=578:si=on:rtra=on_0");
   quick.push("dis+10_1:1_apa=on:au=on:avsq=on:cnfonf=off:kws=inv_arity:ntd=on:i=412:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:20_au=on:c=on:cbe=off:cnfonf=lazy_gen:ins=1:plsq=on:plsqc=1:plsqr=46,31:sac=on:i=1387:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_cnfonf=lazy_pi_sigma_gen:fe=off:hud=15:plsq=on:plsqc=1:plsqr=32,1:sos=all:sp=const_min:i=3183:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:4_amm=sco:awrs=converge:bd=off:nwc=5.0:sd=3:sgt=15:ss=axioms:st=2.0:i=2183:si=on:rtra=on_0");
  ...
  // Improves by expected 106.3086921640514 probs costing 39908 Mi
  // Sub-schedule for 10000Mi strat cap / 80000Mi overall limit
   quick.push("dis+10_1:1_etr=on:plsq=on:plsqc=1:plsqr=32,1:i=651:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=1511:si=on:rtra=on_0");
   quick.push("ott+10_1:1024_anc=none:bd=off:e2e=on:fde=none:fsr=off:hud=10:ixr=off:nm=4:nwc=5.0:spb=goal:i=301:si=on:rtra=on_0");
   quick.push("ott+1010_3:1_nm=20:s2a=on:s2at=3.0:sp=const_frequency:i=871:si=on:rtra=on_0");
   quick.push("lrs+1010_1:2_au=on:e2e=on:sd=3:ss=axioms:st=3.0:i=1208:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:avsq=on:cnfonf=off:e2e=on:plsq=on:i=584:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=8787:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=5605:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:cnfonf=lazy_not_be_gen:fd=preordered:hud=5:nm=10:ntd=on:nwc=10.0:piset=and:i=748:si=on:rtra=on_0");
   quick.push("dis+10_8:1_apa=on:cnfonf=off:e2e=on:plsq=on:plsqc=1:plsqr=32,1:ss=axioms:i=783:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_amm=sco:cnfonf=lazy_pi_sigma_gen:fe=off:nm=60:piset=all_but_not_eq:plsq=on:plsqc=1:plsqr=2,1:rawr=on:sp=occurrence:ss=included:st=-1.0:i=534:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:cbe=off:cnfonf=conj_eager:cond=on:hi=on:i=101:si=on:rtra=on_0");
   quick.push("dis+1002_8:1_cnfonf=off:fsr=off:ins=2:prag=on:sd=1:sos=on:sp=occurrence:ss=axioms:i=5390:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:ixr=off:i=578:si=on:rtra=on_0");
   quick.push("ott+1010_2:1_cha=on:cnfonf=lazy_not_gen_be_off:hud=22:nwc=10.0:piset=and:prag=on:i=327:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:av=off:cnfonf=lazy_not_gen_be_off:ntd=on:s2a=on:ss=axioms:st=1.5:i=1244:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_au=on:cnfonf=lazy_gen:ins=3:plsq=on:plsqc=1:plsqr=15142123,262144:sp=reverse_arity:i=3671:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bd=off:bsd=on:fe=axiom:fsd=on:ntd=on:nwc=10.0:i=166:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=9970:si=on:rtra=on_0");
   quick.push("ott+10_1:1_au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=32,1:sp=unary_first:i=153:si=on:rtra=on_0");
   ...
   quick.push("lrs+21_1:3_apa=on:cnfonf=off:prag=on:sac=on:sos=on:ss=axioms:i=882:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:cbe=off:fde=none:ins=1:sp=const_max:i=858:si=on:rtra=on_0");
   quick.push("lrs+1666_1:64_cnfonf=lazy_simp:hud=5:plsq=on:plsql=on:plsqr=152565,524288:tnu=2:i=1046:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=1302:si=on:rtra=on_0");
  ...
  // Improves by expected 76.459461923398 probs costing 79826 Mi
  // Sub-schedule for 15000Mi strat cap / 120000Mi overall limit
   quick.push("ott+1010_1:20_cnfonf=lazy_pi_sigma_gen:fe=axiom:plsq=on:plsqc=2:plsqr=32,1:sac=on:sos=all:i=2860:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_chr=on:cnfonf=lazy_not_be_gen:gs=on:hud=5:plsq=on:plsqc=1:plsqr=5,1:prag=on:rawr=on:i=419:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cnfonf=lazy_simp:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=464:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_aac=none:bd=preordered:e2e=on:fde=none:fe=axiom:nm=16:nwc=10.0:prag=on:i=2295:si=on:rtra=on_0");
   quick.push("dis+21_1:1_aac=none:bsr=on:nwc=3.0:s2a=on:i=3201:si=on:rtra=on_0");
   quick.push("lrs+1010_1:7_bd=off:cnfonf=lazy_not_be_gen:fe=off:hud=10:tnu=1:i=348:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bd=preordered:cnfonf=off:e2e=on:kws=inv_precedence:lwlo=on:sd=2:ss=axioms:i=4895:si=on:rtra=on_0");
   quick.push("lrs+1002_1:32_au=on:ins=2:nm=16:ntd=on:piset=all_but_not_eq:sp=occurrence:i=2962:si=on:rtra=on_0");
   ...
   quick.push("lrs+21_1:1_au=on:cnfonf=off:plsq=on:plsqc=1:plsqr=3,1:i=4962:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=5271:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_anc=none:au=on:cnfonf=off:ins=3:sd=1:ss=axioms:i=5974:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_avsq=on:fe=off:fsr=off:hud=10:kws=arity:prag=on:i=3321:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_3039923:1048576_bsr=unit_only:cbe=off:cha=on:cnfonf=off:e2e=on:fsr=off:hud=1:ixr=off:kws=precedence:lma=on:nm=4:piset=or:s2a=on:sp=frequency:spb=goal_then_units:i=5185:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_aac=none:au=on:e2e=on:nm=2:nwc=10.0:sd=1:ss=axioms:st=3.0:i=1219:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_aac=none:au=on:cnfonf=lazy_gen:plsq=on:plsqc=1:plsqr=32,1:spb=goal_then_units:i=877:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=346:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:s2a=on:sd=2:ss=axioms:st=5.0:i=1400:si=on:rtra=on_0");
   quick.push("lrs+21_1:3_apa=on:cnfonf=off:prag=on:sac=on:sos=on:ss=axioms:i=13994:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_chr=on:hud=4:nm=60:i=453:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:20_afp=1000:au=on:bsd=on:cnfonf=lazy_not_gen_be_off:sos=all:sp=const_max:i=2236:si=on:rtra=on_0");
   quick.push("dis+1002_16:1_apa=on:au=on:av=off:cnfonf=off:e2e=on:nm=0:nwc=10.0:i=4683:si=on:rtra=on_0");
   quick.push("dis-1_1:1_amm=off:au=on:cbe=off:spb=intro:i=468:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cnfonf=lazy_simp:hud=5:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=556:si=on:rtra=on_0");
  ...
  // Improves by expected 45.15315786953146 probs costing 119573 Mi
  // Sub-schedule for 50000Mi strat cap / 400000Mi overall limit
   quick.push("lrs+1002_1:28_bd=off:cnfonf=lazy_simp:plsq=on:plsqr=1,1:prag=on:i=1003:si=on:rtra=on_0");
   quick.push("dis-1010_4:1_c=on:fe=axiom:nwc=10.0:prag=on:sd=2:ss=axioms:st=5.0:i=8711:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:nm=2:i=1748:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_bsr=unit_only:cnfonf=lazy_not_be_gen:fe=off:ntd=on:i=13529:si=on:rtra=on_0");
   quick.push("ott+1002_1:1024_au=on:avsq=on:c=on:cnfonf=lazy_not_gen_be_off:sos=all:i=14611:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:bs=on:sd=5:sp=occurrence:ss=axioms:st=2.0:i=9808:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_au=on:s2a=on:sd=1:sgt=50:ss=axioms:i=5059:si=on:rtra=on_0");
   quick.push("lrs+1003_1:1_au=on:e2e=on:kws=inv_frequency:i=1332:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:e2e=on:nm=2:sos=all:sp=const_min:spb=non_intro:i=9526:si=on:rtra=on_0");
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=11933:si=on:rtra=on_0");
   quick.push("lrs+1004_1:128_cond=on:e2e=on:sp=weighted_frequency:i=12400:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:4_avsq=on:avsqr=16,1:bet=on:cbe=off:cnfonf=lazy_not_be_gen:hud=5:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=631:si=on:rtra=on_0");
   quick.push("dis+1004_1:16_cnfonf=lazy_gen:fe=off:fsr=off:hud=10:ntd=on:nwc=10.0:prag=on:tgt=ground:i=938:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_bd=off:cbe=off:piset=equals:sd=1:sgt=20:sos=all:ss=axioms:i=4218:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_av=off:bd=off:bet=on:e2e=on:fde=unused:fe=off:plsq=on:prag=on:sos=on:i=6576:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cnfonf=lazy_simp:nwc=5.0:sgt=5:ss=axioms:st=1.5:i=21060:si=on:rtra=on_0");
   quick.push("dis+21_3:2_avsq=on:cbe=off:e2e=on:flr=on:ile=on:nwc=5.0:piset=or:rawr=on:sp=occurrence:i=3205:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:ixr=off:i=578:si=on:rtra=on_0");
   quick.push("lrs+1002_3:1_anc=none:avsq=on:bd=off:fd=off:kws=frequency:i=6312:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:12_bd=off:hud=1:ntd=on:piset=equals:prag=on:i=641:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:bd=off:cbe=off:cha=on:cnfonf=lazy_pi_sigma_gen:fd=off:fe=off:ntd=on:sp=const_frequency:i=1868:si=on:rtra=on_0");
   quick.push("lrs+10_1:50_cbe=off:cnfonf=lazy_pi_sigma_gen:fe=off:hud=5:plsq=on:plsqr=1,32:sos=all:i=2971:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_cnfonf=lazy_pi_sigma_gen:fe=off:hud=15:plsq=on:plsqc=1:plsqr=32,1:sos=all:sp=const_min:i=3515:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_aac=none:au=on:e2e=on:nm=2:nwc=10.0:sd=1:ss=axioms:st=3.0:i=1219:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:avsq=on:bd=off:cbe=off:cnfonf=off:cs=on:hud=5:nm=0:plsq=on:plsqc=1:plsqr=7,1:ss=axioms:tgt=full:i=3789:si=on:rtra=on_0");
   ...
   quick.push("dis+10_5:1_av=off:ntd=on:s2a=on:s2at=3.0:sgt=16:sp=unary_frequency:ss=axioms:i=8390:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=346:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:s2a=on:sd=2:ss=axioms:st=5.0:i=1400:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:bd=off:cnfonf=lazy_gen:fe=off:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:tnu=1:i=5201:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=12597:si=on:rtra=on_0");
   quick.push("dis-1_1:1_amm=off:au=on:cbe=off:spb=intro:i=2011:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=8517:si=on:rtra=on_0");
   quick.push("ott+10_1:10_cnfonf=lazy_gen:fde=none:sp=const_frequency:i=3174:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=off:ntd=on:nwc=3.0:s2a=on:sp=const_frequency:i=865:si=on:rtra=on_0");
  ...
  // Improves by expected 54.905594552162924 probs costing 398841 Mi
  // Sub-schedule for 100000Mi strat cap / 800000Mi overall limit
   quick.push("lrs+10_1:1_cs=on:sd=1:sgt=8:ss=axioms:i=4020:si=on:rtra=on_0");
   quick.push("dis-1010_4:1_c=on:fe=axiom:nwc=10.0:prag=on:sd=2:ss=axioms:st=5.0:i=7625:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:nm=2:i=1748:si=on:rtra=on_0");
   ...
   quick.push("lrs+21_8:1_cs=on:e2e=on:sos=all:i=9071:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:bs=on:sd=5:sp=occurrence:ss=axioms:st=2.0:i=13682:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bd=preordered:cnfonf=off:e2e=on:kws=inv_precedence:lwlo=on:sd=2:ss=axioms:i=4895:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=6806:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:s2a=on:sd=1:sgt=50:ss=axioms:i=33498:si=on:rtra=on_0");
   quick.push("lrs+1004_1:128_cond=on:e2e=on:sp=weighted_frequency:i=12400:si=on:rtra=on_0");
   quick.push("ott+2_1:1024_bd=off:cbe=off:cnfonf=off:e2e=on:fde=none:kws=precedence:pe=on:prag=on:rawr=on:rp=on:ss=included:st=3.0:tgt=full:i=1863:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:5_av=off:awrs=converge:awrsf=200:kws=precedence:i=30351:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_anc=all_dependent:au=on:avsq=on:cnfonf=lazy_pi_sigma_gen:piset=not:i=27944:si=on:rtra=on_0");
   quick.push("dis+1010_1:128_au=on:awrs=converge:plsq=on:plsqc=1:tgt=full:i=10220:si=on:rtra=on_0");
   quick.push("dis+1003_1:1_cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=2725:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_anc=none:au=on:cnfonf=off:ins=3:sd=1:ss=axioms:i=3884:si=on:rtra=on_0");
   quick.push("dis-1010_1:40_cnfonf=lazy_simp:fe=off:ntd=on:s2a=on:sac=on:ss=axioms:st=1.5:i=5166:si=on:rtra=on_0");
   quick.push("ott+10_1:4_cnfonf=lazy_gen:fde=unused:i=3009:si=on:rtra=on_0");
   quick.push("dis+2_1:1_cbe=off:fe=off:i=13068:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cnfonf=lazy_simp:nwc=5.0:sgt=5:ss=axioms:st=1.5:i=17549:si=on:rtra=on_0");
   quick.push("dis+21_3:2_avsq=on:cbe=off:e2e=on:flr=on:ile=on:nwc=5.0:piset=or:rawr=on:sp=occurrence:i=3205:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_2:1_au=on:cnfonf=off:e2e=on:fd=off:plsq=on:plsqc=1:plsqr=32,1:i=31318:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=8612:si=on:rtra=on_0");
   quick.push("dis+1010_1:28_au=on:cnfonf=off:e2e=on:fde=none:nicw=on:s2a=on:s2at=5.0:tgt=full:i=7616:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bd=off:sd=3:sgt=10:ss=axioms:st=1.5:i=2801:si=on:rtra=on_0");
   quick.push("lrs+1_1:1_au=on:cbe=off:ntd=on:i=19350:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_cnfonf=off:e2e=on:nm=4:ntd=on:s2a=on:i=97713:si=on:rtra=on_0");
   ...
   quick.push("lrs+1666_1:1_av=off:hud=10:i=3847:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:nm=0:i=15536:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=579:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:20_afp=1000:au=on:bsd=on:cnfonf=lazy_not_gen_be_off:sos=all:sp=const_max:i=33085:si=on:rtra=on_0");
  ...
  // Improves by expected 26.42704028288048 probs costing 798251 Mi
  // Sub-schedule for 150000Mi strat cap / 1200000Mi overall limit
   ...
   quick.push("lrs+1002_1:14_au=on:bd=off:e2e=on:fde=unused:sac=on:sos=on:i=5756:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:cbe=off:i=89965:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:av=off:fde=none:ins=2:i=91905:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:bs=on:sd=5:sp=occurrence:ss=axioms:st=2.0:i=50164:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:128_au=on:awrs=converge:plsq=on:plsqc=1:tgt=full:i=10220:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=4919:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=2:sd=1:ss=axioms:st=3.0:i=133450:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_anc=none:au=on:cnfonf=off:ins=3:sd=1:ss=axioms:i=5974:si=on:rtra=on_0");
   quick.push("dis-1010_1:40_cnfonf=lazy_simp:fe=off:ntd=on:s2a=on:sac=on:ss=axioms:st=1.5:i=5166:si=on:rtra=on_0");
   quick.push("ott+10_1:4_cnfonf=lazy_gen:fde=unused:i=15783:si=on:rtra=on_0");
   quick.push("dis+2_1:1_cbe=off:fe=off:i=13068:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:cnfonf=lazy_simp:nwc=5.0:sgt=5:ss=axioms:st=1.5:i=20385:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=10:s2a=on:i=35602:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=45798:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_cnfonf=off:e2e=on:nm=4:ntd=on:s2a=on:i=25498:si=on:rtra=on_0");
   ...
   quick.push("lrs+1666_1:1_au=on:s2a=on:sd=2:ss=axioms:st=5.0:i=41327:si=on:rtra=on_0");
   quick.push("dis+1_1:1_amm=off:au=on:piset=and:i=15559:si=on:rtra=on_0");
   quick.push("ott+10_1:10_cnfonf=lazy_gen:fde=none:sp=const_frequency:i=15814:si=on:rtra=on_0");
   quick.push("lrs+1002_1:15_add=large:au=on:cbe=off:ntd=on:i=31057:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cond=fast:fde=unused:s2a=on:sd=2:ss=axioms:i=56980:si=on:rtra=on_0");
  // Improves by expected 11.751493524682386 probs costing 1179452 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   ...
   quick.push("lrs+1010_1:1_anc=all_dependent:cnfonf=conj_eager:cond=fast:fe=axiom:nm=16:s2a=on:s2at=4.0:sd=2:ss=axioms:st=3.0:i=96745:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("dis+10_1:1_amm=sco:au=on:cbe=off:nm=0:i=33863:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:cbe=off:i=90301:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:bs=on:sd=5:sp=occurrence:ss=axioms:st=2.0:i=49089:si=on:rtra=on_0");
   quick.push("lrs+1004_1:128_cond=on:e2e=on:sp=weighted_frequency:i=101333:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=17804:si=on:rtra=on_0");
   quick.push("lrs+10_1:5_av=off:awrs=converge:awrsf=200:kws=precedence:i=49053:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:16_cnfonf=conj_eager:i=73522:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=164895:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:kws=precedence:i=204173:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=10:s2a=on:i=35602:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3548551,65536:s2a=on:i=133059:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=45798:si=on:rtra=on_0");
   ...
   quick.push("ott+10_1:1_au=on:av=off:sd=1:ss=axioms:st=2.0:i=38843:si=on:rtra=on_0");
   quick.push("dis+1010_1:64_bet=on:cond=fast:e2e=on:fe=off:hud=5:nm=0:ntd=on:nwc=7.0:piset=and:prag=on:rawr=on:sgt=40:ss=included:uhcvi=on:i=42318:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_apa=on:cnfonf=off:fd=off:flr=on:hud=1:lcm=reverse:prag=on:sd=1:sos=on:ss=axioms:i=28134:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=224352:si=on:rtra=on_0");
   quick.push("dis-1_1:1_amm=off:au=on:cbe=off:spb=intro:i=70674:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:plsq=on:i=90575:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_awrs=converge:awrsf=80:bs=on:c=on:cbe=off:cnfonf=conj_eager:fsr=off:gs=on:pe=on:piset=and:sac=on:sd=1:sp=frequency:spb=goal:ss=included:i=254848:si=on:rtra=on_0");
  // Improves by expected 7.6847994483280955 probs costing 3025219 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:fde=none:ixr=off:nwc=5.0:i=25994:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_apa=on:cnfonf=off:fd=off:flr=on:hud=1:lcm=reverse:prag=on:sd=1:sos=on:ss=axioms:i=28134:si=on:rtra=on_0");
   quick.push("ott+1010_1:4_cnfonf=lazy_simp:fe=off:hud=5:piset=or:prag=on:i=112304:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_au=on:s2a=on:sd=2:ss=axioms:st=5.0:i=214497:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=224352:si=on:rtra=on_0");
   quick.push("dis-1_1:1_amm=off:au=on:cbe=off:spb=intro:i=70674:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:plsq=on:i=90575:si=on:rtra=on_0");
  // Improves by expected 2.8680061743442784 probs costing 1636682 Mi
  // Sub-schedule for 500000Mi strat cap / 4000000Mi overall limit
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:fde=none:ixr=off:nwc=5.0:i=25994:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:plsq=on:i=90575:si=on:rtra=on_0");
  // Improves by expected 1.2885448149069414 probs costing 869881 Mi
