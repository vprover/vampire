...
void Schedules::getInductionSchedule(Schedule& sched) {
  ...
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=off:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=off:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=off:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=off:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=on:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=on:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=on:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=off:indmc=on:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=off:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=off:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=off:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=off:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=on:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=on:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=on:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=off:indstr=on:indmc=on:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=off:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=off:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=off:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=off:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=on:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=on:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=on:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=off:indmc=on:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=off:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=off:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=off:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=off:fnrw=on:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=on:fnrw=off:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=on:fnrw=off:indtosh=two:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=on:fnrw=on:indtosh=one:inds=on_60");
  sched.push("lrs+10_1:1_newcnf=on:ind=struct:sik=four:indoct=on:indstr=on:indmc=on:fnrw=on:indtosh=two:inds=on_60");
