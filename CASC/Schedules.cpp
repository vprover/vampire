...
void Schedules::getSnakeTptpHolSchedule(const Shell::Property& property, Schedule& quick) {  
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("dis+10_1:128_hud=1:i=93:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:s2a=on:s2agt=32:sgt=8:ss=axioms:i=392:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:c=on:fsr=off:ixr=off:kws=precedence:nm=40:ntd=on:i=1142:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_cnfonf=lazy_pi_sigma_gen:fd=off:ntd=on:sd=1:sgt=32:sos=on:ss=axioms:i=294:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cnfonf=lazy_gen:ins=3:sac=on:sp=unary_frequency:uhcvi=on:i=57364:si=on:rtra=on_0");
   quick.push("dis+10_3:2_av=off:bsd=on:hud=9:nm=0:plsq=on:plsqc=1:plsql=on:prag=on:i=1495:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_acc=on:bd=preordered:cnfonf=conj_eager:fe=off:tgt=ground:i=7732:si=on:rtra=on_0");
   quick.push("dis-31_1:128_c=on:chr=on:cnfonf=lazy_not_gen:e2e=on:erd=off:fd=off:fe=off:hud=1:ins=2:piset=not:prag=on:sp=frequency:spb=goal:i=162:si=on:rtra=on_0");
   ...
   quick.push("dis+21_1:1_aac=none:bsr=on:nwc=3.0:s2a=on:i=3140:si=on:rtra=on_0");
   quick.push("dis+2_1:4_au=on:cbe=off:i=21810:si=on:rtra=on_0");
   quick.push("ott+1002_1:1024_au=on:avsq=on:c=on:cnfonf=lazy_not_gen_be_off:sos=all:i=14611:si=on:rtra=on_0");
   quick.push("dis+1010_913633:131072_aac=none:apa=on:au=on:awrs=converge:awrsf=150:bd=off:c=on:cbe=off:chr=on:cnfonf=off:e2e=on:fe=off:hud=13:kws=precedence:lma=on:nm=13:ntd=on:pe=on:plsq=on:sgt=15:sp=frequency:ss=axioms:tgt=ground:uhcvi=on:i=2:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fde=unused:fe=axiom:prag=on:sd=1:sos=on:ss=axioms:st=2.0:i=14199:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_gen_be_off:fsr=off:spb=non_intro:i=41:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bet=on:bsd=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fe=off:fs=off:fsr=off:ixr=off:nwc=5.0:prag=on:i=16:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=599:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_not_be_gen:hud=15:prag=on:i=48:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1024_au=on:fe=axiom:lwlo=on:nm=0:ntd=on:nwc=10.0:spb=non_intro:uhcvi=on:i=2221:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:e2e=on:nm=2:sos=all:sp=const_min:spb=non_intro:i=9526:si=on:rtra=on_0");
   quick.push("dis+666_1:594_bd=off:c=on:cnfonf=lazy_pi_sigma_gen:fde=none:fe=axiom:piset=all_but_not_eq:rawr=on:rp=on:s2a=on:sos=all:sp=const_frequency:i=1011:si=on:rtra=on_0");
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=29673:si=on:rtra=on_0");
   ...
   quick.push("ott+2_1:1024_bd=off:cbe=off:cnfonf=off:e2e=on:fde=none:kws=precedence:pe=on:prag=on:rawr=on:rp=on:ss=included:st=3.0:tgt=full:i=5401:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:4_chr=on:cnfonf=lazy_gen:hud=5:ins=1:ntd=on:prag=on:i=211:si=on:rtra=on_0");
   quick.push("dis+1004_1:1_cha=on:cs=on:fe=off:hud=1:i=4:si=on:rtra=on_0");
   quick.push("dis+10_1:1_bsr=on:cnfonf=lazy_pi_sigma_gen:fe=off:fsr=off:plsq=on:plsqc=2:plsqr=32,1:i=9:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=14314:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=5424:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:fe=off:sd=2:slsq=on:slsqr=1,16:ss=axioms:st=5.0:i=129217:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_avsq=on:avsqr=16,1:bet=on:cbe=off:cnfonf=lazy_not_be_gen:hud=5:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=2278:si=on:rtra=on_0");
   quick.push("dis+1004_1:16_cnfonf=lazy_gen:fe=off:fsr=off:hud=10:ntd=on:nwc=10.0:prag=on:tgt=ground:i=2928:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=off:sd=1:sgt=16:ss=axioms:i=294:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_bd=preordered:c=on:cbe=off:cnfonf=lazy_not_gen_be_off:hud=10:ixr=off:prag=on:i=2182:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=8250:si=on:rtra=on_0");
   quick.push("dis-30_1:1_acc=on:bd=off:fsr=off:plsq=on:plsqr=32,1:i=901:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:nm=4:piset=pi_sigma:i=1858:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=conj_eager:tgt=ground:i=393:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fs=off:fsr=off:hud=0:i=45:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_anc=all_dependent:au=on:bd=off:e2e=on:fsr=off:sac=on:ss=axioms:i=143:si=on:rtra=on_0");
   quick.push("ott+10_1:128_c=on:cbe=off:cha=on:cnfonf=lazy_not_gen_be_off:e2e=on:fe=axiom:hud=10:nm=0:nwc=10.0:piset=and:prag=on:rawr=on:i=2672:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_bd=off:e2e=on:fde=unused:kws=precedence:sac=on:sos=on:ss=axioms:i=434:si=on:rtra=on_0");
   quick.push("lrs+1666_1:14_er=filter:fsr=off:i=832:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_bd=off:fd=preordered:prag=on:sos=on:i=9527:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_3:1_chr=on:sp=reverse_arity:i=12:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_amm=off:au=on:bsd=on:cbe=off:cnfonf=lazy_gen:sp=unary_frequency:i=808:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:apa=on:au=on:cnfonf=off:fsd=on:hud=5:ins=2:piset=all:rawr=on:sos=on:spb=units:uhcvi=on:i=549:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_sd=1:sgt=32:ss=axioms:i=24918:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fe=axiom:fsr=off:hud=5:nwc=6.0:plsq=on:plsqc=2:plsqr=32,1:s2a=on:s2agt=40:sp=weighted_frequency:i=17179:si=on:rtra=on_0");
   ...
   quick.push("lrs-3_4:1_au=on:kws=arity_squared:nm=2:sos=on:i=23:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:cbe=off:cnfonf=conj_eager:tgt=ground:i=27:si=on:rtra=on_0");
   quick.push("dis+21_3:2_avsq=on:cbe=off:e2e=on:flr=on:ile=on:nwc=5.0:piset=or:rawr=on:sp=occurrence:i=3205:si=on:rtra=on_0");
   quick.push("dis+1010_1:64_cnfonf=lazy_simp:fd=off:i=334:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_gen:nwc=7.0:sup=off:i=6325:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_apa=on:chr=on:cnfonf=off:fe=off:piset=not:prag=on:sos=all:sp=frequency:i=13001:si=on:rtra=on_0");
   quick.push("dis+21_3:56_abs=on:anc=all:bsr=unit_only:cbe=off:chr=on:cnfonf=lazy_simp:cond=fast:fe=off:hud=15:kws=inv_arity:nm=46:ntd=on:pe=on:piset=or:plsq=on:plsqc=2:plsqr=32,1:rawr=on:rp=on:s2a=on:s2at=-1.0:i=329:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_au=on:bd=off:bsd=on:ixr=off:sp=const_max:i=2631:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:i=1094:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=29789:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_bd=off:e2e=on:fde=none:kws=inv_precedence:plsq=on:plsqr=32,1:sos=on:i=1360:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=20122:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=off:fde=unused:kws=precedence:tgt=full:i=406:si=on:rtra=on_0");
   quick.push("lrs+10_1:1024_atotf=0.3:bd=off:cnfonf=lazy_gen:fe=off:plsq=on:plsqc=1:plsqr=3,1:i=1276:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=off:cs=on:sd=1:sgt=64:ss=axioms:i=21660:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_fde=unused:prag=on:sd=2:sgt=32:ss=axioms:i=3174:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:fsr=off:i=886:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_chr=on:hud=3:ins=2:kws=precedence:ntd=on:prag=on:i=68:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_bd=off:fsr=off:ntd=on:s2a=on:ss=axioms:i=82:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_chr=on:hud=5:prag=on:i=8:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_not_gen:sos=on:ss=axioms:st=1.2:i=180:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:c=on:fe=off:ins=1:piset=and:i=351:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_2:3_apa=on:cnfonf=off:cond=on:e2e=on:gs=on:hud=7:piset=equals:prag=on:s2agt=32:s2at=5.0:s2pl=no:sos=on:sp=const_max:ss=axioms:i=27001:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:fd=preordered:fde=none:plsq=on:plsqr=32,1:i=697:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=lazy_gen:fde=none:s2a=on:s2agt=32:i=11228:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_amm=sco:atotf=0.1:c=on:cnfonf=lazy_simp:piset=and:sp=reverse_arity:i=4:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:bd=off:e2e=on:fde=none:fe=off:piset=or:prag=on:rawr=on:sos=on:updr=off:i=66825:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:cbe=off:cnfonf=off:e2e=on:ile=on:kws=inv_frequency:nm=0:piset=all:plsq=on:plsqc=1:plsqr=32,1:rawr=on:sd=1:sp=unary_first:spb=intro:ss=axioms:st=3.0:uhcvi=on:i=2175:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:er=filter:fe=off:flr=on:ixr=off:nm=4:s2a=on:s2at=2.0:i=7562:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_bd=off:cnfonf=off:e2e=on:fd=off:fe=axiom:hud=5:prag=on:sos=on:i=498:si=on:rtra=on_0");
   quick.push("ott+1010_1:6_aac=none:cbe=off:cnfonf=off:hud=5:nm=2:prag=on:spb=goal:i=2:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_anc=all_dependent:au=on:cbe=off:fde=unused:ntd=on:i=756:si=on:rtra=on_0");
   quick.push("dis+1002_4:1_bd=off:cnfonf=off:cs=on:e2e=on:i=7027:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1024_avsq=on:avsqc=4:avsqr=584411,1048576:bd=off:bet=on:br=off:chr=on:fsd=on:fsdmm=1:hud=10:nm=0:ntd=on:nwc=9.0:piset=or:plsq=on:plsqc=2:plsql=on:plsqr=852219,1048576:rawr=on:sp=const_frequency:spb=units:i=8:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fde=none:ins=2:nwc=10.0:piset=or:i=10170:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_cnfonf=off:e2e=on:nm=4:ntd=on:s2a=on:i=9690:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:bd=off:cbe=off:cha=on:cnfonf=lazy_pi_sigma_gen:fd=off:fe=off:ntd=on:sp=const_frequency:i=17767:si=on:rtra=on_0");
   quick.push("lrs-1666_1:1_bsr=unit_only:cbe=off:cnfonf=lazy_not_gen_be_off:hud=6:kws=inv_arity:prag=on:i=4:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=model:avsq=on:ntd=on:i=1212:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:cs=on:hud=3:prag=on:sup=off:i=3:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_acc=on:amm=sco:cs=on:tgt=full:i=16:si=on:rtra=on_0");
   quick.push("ott+1004_64217:1048576_cnfonf=lazy_simp:fe=off:fsr=off:piset=and:rawr=on:sp=frequency:spb=units:i=4736:si=on:rtra=on_0");
   quick.push("dis+1003_1:6_acc=on:avsq=on:ccuc=small_ones:fe=off:i=8774:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bsd=on:cbe=off:cnfonf=conj_eager:hi=on:i=119:si=on:rtra=on_0");
   quick.push("lrs-1002_8:1_bd=off:bsd=on:e2e=on:fd=off:prag=on:s2a=on:i=15134:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:32_pe=on:i=1761:si=on:rtra=on_0");
   quick.push("lrs+1004_1:4_av=off:bsd=on:e2e=on:i=3368:si=on:rtra=on_0");
   quick.push("lrs+1004_1:1_chr=on:prag=on:i=6:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_anc=all:cbe=off:cnfonf=lazy_not_gen_be_off:fe=off:hud=5:nwc=10.0:plsq=on:plsqr=32,1:prag=on:sp=unary_first:i=198:si=on:rtra=on_0");
   quick.push("dis+1010_4:1_bd=preordered:cnfonf=conj_eager:etr=on:ntd=on:prag=on:i=11264:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_aac=none:au=on:e2e=on:nm=2:nwc=10.0:sd=1:ss=axioms:st=3.0:i=5910:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:avsq=on:bd=off:cbe=off:cnfonf=off:cs=on:hud=5:nm=0:plsq=on:plsqc=1:plsqr=7,1:ss=axioms:tgt=full:i=14145:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:erd=off:s2a=on:s2at=3.0:sos=all:i=1174:si=on:rtra=on_0");
   quick.push("ott+1002_1:4_c=on:chr=on:cnfonf=lazy_not_be_gen:hud=10:nm=10:piset=all_but_not_eq:rp=on:spb=goal:uhcvi=on:i=4573:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=890:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bsd=on:cbe=off:cnfonf=conj_eager:fd=off:fsr=off:hi=on:i=71:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_av=off:fd=off:sos=on:ss=axioms:i=6:si=on:rtra=on_0");
   quick.push("ott+1010_1:1024_au=on:av=off:c=on:cnfonf=conj_eager:piset=equals:s2a=on:sp=occurrence:spb=units:ss=axioms:i=221:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cbe=off:cnfonf=lazy_pi_sigma_gen:fe=off:hud=5:prag=on:i=686:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sd=1:sgt=8:ss=axioms:i=1702:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:bd=preordered:ixr=off:i=3673:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_au=on:cbe=off:sp=occurrence:i=80020:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=9400:si=on:rtra=on_0");
   quick.push("dis+1002_4:1_cha=on:cnfonf=lazy_not_gen:fd=off:hud=8:ntd=on:nwc=5.0:prag=on:rnwc=on:s2a=on:s2agt=8:i=332:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_amm=sco:cnfonf=lazy_pi_sigma_gen:fd=off:fe=off:piset=or:sos=on:sp=occurrence:i=4163:si=on:rtra=on_0");
   quick.push("dis+1003_1:1_hud=1:ins=1:i=15:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_simp:sgt=5:sos=on:ss=axioms:i=319:si=on:rtra=on_0");
   quick.push("lrs+10_121:10_aac=none:abs=on:alpa=false:apa=on:bd=preordered:bs=unit_only:c=on:cbe=off:cha=on:cnfonf=off:e2e=on:fe=off:hud=10:ntd=on:pe=on:piset=all:s2agt=30:s2at=3.5:sd=5:sgt=10:slsq=on:slsqr=2,1:spb=goal_then_units:ss=axioms:uhcvi=on:i=175:si=on:rtra=on_0");
   quick.push("lrs+1010_1:128_chr=on:e2e=on:fde=none:fe=off:nwc=10.0:rp=on:s2at=2.0:slsq=on:slsqc=1:sp=const_min:i=32:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=37256:si=on:rtra=on_0");
   quick.push("dis+1002_1:128_acc=on:er=filter:i=17:si=on:rtra=on_0");
   quick.push("lrs+10_1:3_cnfonf=lazy_gen:fe=off:hud=10:plsq=on:plsqc=1:plsqr=32,1:tnu=2:i=1746:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=conj_eager:fde=none:s2a=on:s2agt=16:sd=1:ss=axioms:st=1.5:i=14612:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:16_aac=none:au=on:cnfonf=lazy_simp:kws=inv_frequency:nwc=10.0:s2a=on:i=24321:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_au=on:cnfonf=conj_eager:nwc=10.0:pe=on:prag=on:s2a=on:ss=axioms:st=1.5:i=29365:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_cbe=off:cnfonf=lazy_not_gen_be_off:ins=1:i=3686:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_etr=on:plsq=on:plsqc=1:plsqr=32,1:i=2073:si=on:rtra=on_0");
   ...
   quick.push("dis+1004_1:1_amm=off:anc=all:avsq=on:avsqr=1,16:cbe=off:chr=on:cnfonf=lazy_pi_sigma_gen:fe=off:kws=frequency:piset=small_set:rawr=on:sp=reverse_arity:i=10487:si=on:rtra=on_0");
   quick.push("dis+10_1:1024_kws=precedence:prag=on:rawr=on:sos=all:sp=unary_first:i=423:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_c=on:cnfonf=lazy_not_gen_be_off:hud=10:i=24:si=on:rtra=on_0");
   quick.push("dis+1002_1:20_c=on:e2e=on:er=filter:piset=pi_sigma:sac=on:i=1472:si=on:rtra=on_0");
   quick.push("lrs+1003_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sp=const_max:i=180:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=conj_eager:s2a=on:sd=4:sgt=16:ss=axioms:i=18293:si=on:rtra=on_0");
   quick.push("dis+1002_1:1024_fe=off:hud=5:prag=on:i=2199:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cbe=off:cnfonf=lazy_not_gen_be_off:fe=off:i=258:si=on:rtra=on_0");
   quick.push("ott+1010_8:1_bs=on:cha=on:cnfonf=lazy_pi_sigma_gen:hud=15:kws=inv_precedence:prag=on:sac=on:i=1978:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_anc=all_dependent:apa=on:au=on:bd=off:c=on:cnfonf=off:ntd=on:i=2510:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_acc=on:bsr=on:cha=on:cnfonf=lazy_not_gen_be_off:fde=unused:ntd=on:piset=all_but_not_eq:s2a=on:s2at=3.0:sfv=off:spb=goal_then_units:i=25758:si=on:rtra=on_0");
   quick.push("dis+2_1:1_au=on:av=off:nwc=5.0:tgt=ground:i=2448:si=on:rtra=on_0");
   quick.push("dis+10_1:4_atotf=0.1:avsq=on:bsr=unit_only:e2e=on:sd=1:sp=const_max:ss=axioms:i=1516:si=on:rtra=on_0");
   quick.push("dis+2_1:1_abs=on:cbe=off:chr=on:hud=10:ntd=on:slsq=on:slsqr=7,3:uhcvi=on:i=15391:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_bd=off:cbe=off:piset=equals:sd=1:sgt=20:sos=all:ss=axioms:i=4218:si=on:rtra=on_0");
   quick.push("dis+1010_1:1024_nwc=10.0:i=3265:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_av=off:cnfonf=lazy_not_be_gen:fd=preordered:hud=5:nm=10:ntd=on:nwc=10.0:piset=and:i=614:si=on:rtra=on_0");
  ...
  // Improves by expected 2713.2081566622014 probs costing 1593017 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("lrs+1010_1:1_anc=all_dependent:cnfonf=conj_eager:cond=fast:fe=axiom:nm=16:s2a=on:s2at=4.0:sd=2:ss=axioms:st=3.0:i=110001:si=on:rtra=on_0");
   quick.push("dis+33_1:128_apa=on:au=on:cnfonf=off:e2e=on:fde=none:kws=inv_frequency:nm=30:ntd=on:plsq=on:sos=on:tgt=ground:i=25001:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1024_add=large:c=on:cbe=off:cnfonf=lazy_gen:fde=none:nm=30:piset=and:sac=on:uhcvi=on:i=578:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=94100:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=45459:si=on:rtra=on_0");
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=21432:si=on:rtra=on_0");
   quick.push("ott+2_1:1024_bd=off:cbe=off:cnfonf=off:e2e=on:fde=none:kws=precedence:pe=on:prag=on:rawr=on:rp=on:ss=included:st=3.0:tgt=full:i=5401:si=on:rtra=on_0");
   quick.push("lrs+1002_1:128_atotf=0.1:au=on:cbe=off:ntd=on:sp=const_frequency:i=17754:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=1902:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:sd=2:sos=on:ss=axioms:i=5844:si=on:rtra=on_0");
   quick.push("ott+10_1:4_cnfonf=lazy_gen:fde=unused:i=15630:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_amm=sco:cnfonf=lazy_pi_sigma_gen:fe=off:nm=60:piset=all_but_not_eq:plsq=on:plsqc=1:plsqr=2,1:rawr=on:sp=occurrence:ss=included:st=-1.0:i=9801:si=on:rtra=on_0");
   quick.push("lrs+10_1:156_afp=4000:avsq=on:avsqr=4,1:fe=axiom:ss=axioms:tgt=ground:i=19001:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:bd=off:bsd=on:ixr=off:sp=const_max:i=30816:si=on:rtra=on_0");
   ...
   quick.push("ott+1004_1:24_anc=none:cbe=off:cnfonf=lazy_not_gen:fe=off:piset=not:prag=on:rp=on:i=4246:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_2:3_apa=on:cnfonf=off:cond=on:e2e=on:gs=on:hud=7:piset=equals:prag=on:s2agt=32:s2at=5.0:s2pl=no:sos=on:sp=const_max:ss=axioms:i=17317:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_aac=none:bd=off:e2e=on:fde=none:fe=off:piset=or:prag=on:rawr=on:sos=on:updr=off:i=66825:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fde=none:ins=2:nwc=10.0:piset=or:i=115308:si=on:rtra=on_0");
   quick.push("lrs-1002_8:1_bd=off:bsd=on:e2e=on:fd=off:prag=on:s2a=on:i=15134:si=on:rtra=on_0");
   quick.push("ott+1010_1:32_apa=on:atotf=0.3:au=on:c=on:cnfonf=off:fe=off:fsr=off:nm=6:piset=or:sac=on:sos=on:i=571:si=on:rtra=on_0");
   ...
   quick.push("lrs+1666_1:1024_apa=on:av=off:cnfonf=off:hud=5:nwc=10.0:piset=all_but_not_eq:i=6382:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:nm=0:i=21829:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=346:si=on:rtra=on_0");
   quick.push("dis+10_1:1_apa=on:bd=off:cnfonf=off:cond=fast:e2e=on:ntd=on:s2a=on:i=84255:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:20_c=on:e2e=on:er=filter:piset=pi_sigma:sac=on:i=93711:si=on:rtra=on_0");
   quick.push("dis+1002_1:1024_fe=off:hud=5:prag=on:i=26966:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:fsr=off:ntd=on:prag=on:i=43406:si=on:rtra=on_0");
   quick.push("dis+2_1:1_abs=on:cbe=off:chr=on:hud=10:ntd=on:slsq=on:slsqr=7,3:uhcvi=on:i=15391:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cond=fast:fde=unused:s2a=on:sd=2:ss=axioms:i=56980:si=on:rtra=on_0");
  // Improves by expected 15.146714889137225 probs costing 1588719 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("dis+1002_1:1_au=on:cnfonf=lazy_gen:ins=3:sac=on:sp=unary_frequency:uhcvi=on:i=57364:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=33036:si=on:rtra=on_0");
   quick.push("dis+33_1:128_apa=on:au=on:cnfonf=off:e2e=on:fde=none:kws=inv_frequency:nm=30:ntd=on:plsq=on:sos=on:tgt=ground:i=25001:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=82591:si=on:rtra=on_0");
   quick.push("dis+10_1:1_anc=none:cnfonf=lazy_gen:fd=preordered:fe=off:hud=10:ins=3:ixr=off:nwc=5.0:plsq=on:plsqc=1:plsqr=32,1:sp=const_frequency:uhcvi=on:i=57872:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_cnfonf=lazy_not_be_gen:fe=off:hud=10:i=5424:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=none:nwc=10.0:s2a=on:s2at=2.0:i=178:si=on:rtra=on_0");
   quick.push("ott+10_1:4_cnfonf=lazy_gen:fde=unused:i=15630:si=on:rtra=on_0");
   quick.push("dis-2_1:16_aac=none:e2e=on:fe=off:hud=5:ntd=on:piset=and:rawr=on:spb=units:i=180001:si=on:rtra=on_0");
   quick.push("dis+10_1:1_fe=axiom:fsr=off:hud=5:nwc=6.0:plsq=on:plsqc=2:plsqr=32,1:s2a=on:s2agt=40:sp=weighted_frequency:i=48767:si=on:rtra=on_0");
   quick.push("lrs+1002_1:16_amm=sco:cnfonf=lazy_pi_sigma_gen:fe=off:nm=60:piset=all_but_not_eq:plsq=on:plsqc=1:plsqr=2,1:rawr=on:sp=occurrence:ss=included:st=-1.0:i=8893:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cbe=off:cnfonf=conj_eager:fd=off:fe=off:hud=10:prag=on:i=74333:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_i=92664:si=on:rtra=on_0");
   quick.push("lrs+10_1:156_afp=4000:avsq=on:avsqr=4,1:fe=axiom:ss=axioms:tgt=ground:i=19001:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:bd=off:bsd=on:ixr=off:sp=const_max:i=51199:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=102602:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_aac=none:bd=preordered:e2e=on:fde=none:fe=axiom:nm=16:nwc=10.0:prag=on:i=48065:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_bd=off:ntd=on:plsq=on:plsqc=1:plsqr=32,1:i=27252:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=164895:si=on:rtra=on_0");
   quick.push("dis+10_1:1_av=off:e2e=on:nm=4:s2a=on:i=45798:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=346:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cbe=off:sp=occurrence:i=68079:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+1002_8:1_au=on:cs=on:e2e=on:nm=0:i=29296:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
  // Improves by expected 6.35945889483717 probs costing 1585431 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("dis+33_1:128_apa=on:au=on:cnfonf=off:e2e=on:fde=none:kws=inv_frequency:nm=30:ntd=on:plsq=on:sos=on:tgt=ground:i=25001:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:chr=on:plsq=on:slsq=on:i=82591:si=on:rtra=on_0");
   quick.push("dis-1002_1:1_alpa=false:apa=on:au=on:bd=off:cnfonf=off:e2e=on:er=filter:fde=unused:plsq=on:plsqr=9699663,1048576:s2a=on:sos=on:sp=unary_first:i=63269:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=102602:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_aac=none:bd=preordered:e2e=on:fde=none:fe=axiom:nm=16:nwc=10.0:prag=on:i=48065:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=19526:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:kws=precedence:i=80853:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_anc=all_dependent:au=on:cbe=off:cnfonf=lazy_pi_sigma_gen:fde=none:ins=2:nwc=10.0:piset=or:i=99377:si=on:rtra=on_0");
   quick.push("ott+1010_1:4_cnfonf=lazy_simp:fe=off:hud=5:piset=or:prag=on:i=112304:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_gen:ixr=off:plsq=on:plsqc=1:plsqr=32,1:i=579:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+10_1:16_aac=none:au=on:cnfonf=lazy_simp:kws=inv_frequency:nwc=10.0:s2a=on:i=55706:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("dis+1002_1:20_c=on:e2e=on:er=filter:piset=pi_sigma:sac=on:i=93711:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
  // Improves by expected 3.419785872813273 probs costing 1590183 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   ...
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=182589:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cnfonf=conj_eager:e2e=on:fe=axiom:fsr=off:ntd=on:nwc=10.0:s2a=on:sgt=5:sp=occurrence:ss=axioms:i=152851:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   quick.push("dis-2_1:16_aac=none:e2e=on:fe=off:hud=5:ntd=on:piset=and:rawr=on:spb=units:i=180001:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cbe=off:cnfonf=conj_eager:fd=off:fe=off:hud=10:prag=on:i=74333:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=98045:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=164895:si=on:rtra=on_0");
   quick.push("lrs+10_1:20_au=on:c=on:cbe=off:cnfonf=lazy_gen:ins=1:plsq=on:plsqc=1:plsqr=46,31:sac=on:i=148622:si=on:rtra=on_0");
   quick.push("ott+1010_1:4_cnfonf=lazy_simp:fe=off:hud=5:piset=or:prag=on:i=112304:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=off:sd=1:ss=axioms:st=3.0:i=13159:si=on:rtra=on_0");
  // Improves by expected 1.9996532316703617 probs costing 1475256 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("lrs+1010_1:1_au=on:cbe=off:cnfonf=lazy_not_be_gen:ntd=on:pe=on:i=193338:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_cnfonf=conj_eager:e2e=on:fe=axiom:fsr=off:ntd=on:nwc=10.0:s2a=on:sgt=5:sp=occurrence:ss=axioms:i=152851:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_fe=axiom:nwc=5.0:prag=on:sos=on:ss=axioms:i=73072:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cbe=off:cnfonf=conj_eager:fd=off:fe=off:hud=10:prag=on:i=74333:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=98045:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_apa=on:au=on:cnfonf=off:e2e=on:flr=on:nm=4:s2a=on:i=164895:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:kws=precedence:i=197362:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_bd=off:c=on:cbe=off:cnfonf=lazy_gen:hud=10:plsq=on:plsqc=1:plsqr=32,1:i=98861:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_ins=1:sgt=8:ss=axioms:i=79792:si=on:rtra=on_0");
  // Improves by expected 1.1675539326676254 probs costing 1132540 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("dis+1010_1:1_cnfonf=conj_eager:e2e=on:fe=axiom:fsr=off:ntd=on:nwc=10.0:s2a=on:sgt=5:sp=occurrence:ss=axioms:i=152851:si=on:rtra=on_0");
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=98045:si=on:rtra=on_0");
  // Improves by expected 0.28954789664162184 probs costing 250894 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=98045:si=on:rtra=on_0");
  // Improves by expected 0.14061730184115986 probs costing 98044 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
   quick.push("dis+1010_1:4_atotf=0.2:c=on:cbe=off:cnfonf=lazy_simp:fe=off:ins=2:ntd=on:s2a=on:s2at=5.0:sgt=5:ss=axioms:st=1.5:i=98045:si=on:rtra=on_0");
  // Improves by expected 0.11641935625168334 probs costing 98044 Mi
  // Sub-schedule for 200000Mi strat cap / 1600000Mi overall limit
  // Improves by expected 0.0 probs costing 0 Mi
  // Overall score 2741.8479080380616 probs on average / budget 9412128 Mi
}