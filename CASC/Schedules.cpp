...
void Schedules::getSnakeSlh2Schedule(const Shell::Property& property, Schedule& quick) {
  // Sub-schedule for 10000Mi strat cap / 10000Mi overall limit
   quick.push("lrs+1002_1:1_au=on:av=off:fd=off:fde=unused:ntd=on:sos=on:sp=frequency:ss=axioms:i=995:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_aac=none:au=on:fde=unused:nm=2:sac=on:sos=all:i=1620:si=on:rtra=on_0");
   quick.push("lrs+1010_1:8_cbe=off:hfsq=on:ixr=off:prag=on:sac=on:sd=1:sgt=40:ss=axioms:i=387:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=632:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=680:si=on:rtra=on_0");
   quick.push("lrs+2_2:1_bd=off:hud=10:sd=1:sp=reverse_arity:spb=goal:ss=axioms:st=1.5:tgt=ground:i=2:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fd=off:fe=off:prag=on:sos=on:i=826:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=541:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fde=unused:fsd=on:hfsq=on:hfsqc=3:hud=10:ins=2:plsq=on:plsqc=4:plsqr=1,2:sp=occurrence:i=14:si=on:rtra=on_0");
   quick.push("lrs+31_1:1_au=on:cnfonf=off:ins=3:plsq=on:sd=1:sgt=32:sos=on:ss=axioms:i=497:si=on:rtra=on_0");
   quick.push("dis+1010_3:1_acc=on:au=on:chr=on:cnfonf=off:fd=preordered:nwc=10.0:s2a=on:i=938:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=814:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_bs=on:e2e=on:prag=on:sos=on:ss=axioms:i=1399:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_fe=off:fsr=off:nm=32:sos=on:sp=unary_first:ss=axioms:i=2:si=on:rtra=on_0");
   quick.push("dis+10_1:32_fd=off:kws=precedence:sd=2:sos=on:ss=axioms:i=195:si=on:rtra=on_0");
   quick.push("dis+10_8:1_au=on:e2e=on:sgt=8:ss=axioms:i=470:si=on:rtra=on_0");
  // Improves by expected 2228.2320446008907 probs costing 9996 Mi
  // Sub-schedule for 20000Mi strat cap / 20000Mi overall limit
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=2133:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:fd=off:sos=all:i=1394:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_au=on:bd=off:e2e=on:sos=on:ss=axioms:i=581:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_au=on:cnfonf=lazy_pi_sigma_gen:fde=none:nwc=10.0:s2a=on:sac=on:i=4188:si=on:rtra=on_0");
   ...
   quick.push("dis+22_1:1_au=on:fe=axiom:ntd=on:nwc=10.0:s2a=on:i=3634:si=on:rtra=on_0");
   quick.push("dis+1002_1:2_au=on:bs=on:bsr=unit_only:c=on:fsr=off:hud=10:kws=inv_precedence:nm=6:ntd=on:nwc=10.0:sac=on:sos=on:i=1161:si=on:rtra=on_0");
   quick.push("ott+2_1:128_bd=off:ins=3:kws=precedence:sd=1:sos=on:sp=frequency:ss=axioms:st=5.0:i=567:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cbe=off:nm=10:sd=1:sos=all:ss=axioms:st=3.0:i=713:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fe=off:nwc=10.0:s2a=on:s2agt=8:sd=1:ss=axioms:st=5.0:i=357:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:hfsq=on:sd=2:sgt=8:ss=axioms:i=313:si=on:rtra=on_0");
   quick.push("dis+21_1:1_au=on:c=on:cnfonf=off:e2e=on:ins=1:kws=precedence:ntd=on:sd=2:sos=on:ss=axioms:st=2.0:i=626:si=on:rtra=on_0");
   quick.push("dis+10_1:32_fd=off:kws=precedence:sd=2:sos=on:ss=axioms:i=787:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=unused:nwc=5.0:sac=on:sos=all:sp=const_frequency:i=1361:si=on:rtra=on_0");
   quick.push("dis+21_1:1_bd=off:e2e=on:s2a=on:s2agt=32:sfv=off:ss=axioms:st=2.0:i=1149:si=on:rtra=on_0");
  // Improves by expected 243.25886019261347 probs costing 19986 Mi
  // Sub-schedule for 30000Mi strat cap / 30000Mi overall limit
   quick.push("lrs+10_1:28_au=on:lma=on:sgt=8:sos=all:ss=axioms:i=923:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cs=on:e2e=on:hfsq=on:i=290:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:av=off:fd=off:fde=unused:ntd=on:sos=on:sp=frequency:ss=axioms:i=1917:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:c=on:ins=3:plsq=on:plsqc=5:sd=1:sos=on:ss=axioms:i=431:si=on:rtra=on_0");
   quick.push("lrs+10_8:1_cbe=off:e2e=on:hud=10:sd=1:ss=axioms:st=3.0:tgt=ground:i=235:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_atotf=0.1:au=on:cnfonf=off:inj=on:piset=and:s2a=on:sos=on:i=1736:si=on:rtra=on_0");
   quick.push("lrs+2_1:64_bd=off:nwc=5.0:sd=2:ss=axioms:i=290:si=on:rtra=on_0");
   quick.push("dis+1002_2:3_aac=none:au=on:cbe=off:fde=none:hfsq=on:hfsqc=2:hfsqr=8,1:lcm=predicate:nm=32:prag=on:sos=on:sp=unary_first:ss=axioms:st=2.0:i=1324:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_erd=off:ins=3:sd=1:sos=on:ss=axioms:i=263:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fd=off:fe=off:prag=on:sos=on:i=3785:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:e2e=on:hud=10:nm=32:plsq=on:plsqc=1:plsqr=32,1:sac=on:sos=on:i=1526:si=on:rtra=on_0");
   quick.push("dis+10_3:1_avsq=on:sd=1:ss=axioms:st=2.0:tgt=ground:i=278:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=1484:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_fde=unused:fe=off:hud=10:nm=2:sos=on:sp=unary_frequency:spb=units:i=1092:si=on:rtra=on_0");
   quick.push("dis+2_1:1_cnfonf=off:e2e=on:kws=inv_frequency:nm=0:nwc=5.0:s2a=on:s2agt=32:ss=axioms:i=487:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:nm=0:sac=on:sd=1:sp=unary_frequency:ss=axioms:st=3.0:i=935:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=2616:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:1_au=on:cnfonf=off:sd=1:sgt=16:sp=occurrence:ss=axioms:i=345:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sd=1:slsq=on:ss=axioms:i=1197:si=on:rtra=on_0");
   quick.push("dis+10_1:1_hud=5:nm=16:prag=on:sac=on:sos=on:ss=axioms:tnu=2:i=1097:si=on:rtra=on_0");
   quick.push("dis+1010_2:1_atotf=0.2:au=on:cnfonf=off:gs=on:nm=0:sd=2:ss=axioms:i=2468:si=on:rtra=on_0");
   quick.push("dis+10_1:1_avsq=on:cnfonf=lazy_pi_sigma_gen:i=978:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=538:si=on:rtra=on_0");
   quick.push("lrs-1002_1:1_au=on:ins=2:sos=on:ss=axioms:st=1.5:i=337:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:3_aac=none:bd=off:cnfonf=off:fde=unused:ins=2:ntd=on:s2a=on:sac=on:i=529:si=on:rtra=on_0");
  // Improves by expected 130.07231747570546 probs costing 29955 Mi
  // Sub-schedule for 60000Mi strat cap / 60000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=1101:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:avsq=on:avsqr=16,1:fd=off:nm=2:sos=all:i=890:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_aac=none:au=on:fde=unused:nm=2:sac=on:sos=all:i=5862:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sos=on:i=688:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_bd=off:cnfonf=off:hud=10:nm=32:sac=on:sd=1:sims=off:sos=all:ss=axioms:st=2.0:i=3046:si=on:rtra=on_0");
   quick.push("dis+1010_1:28_chr=on:cnfonf=lazy_not_be_gen:fde=none:hud=5:ins=2:kws=precedence:prag=on:sos=on:sp=occurrence:spb=goal_then_units:ss=axioms:i=1301:si=on:rtra=on_0");
   ...
   quick.push("dis+10_5:1_au=on:hfsq=on:ss=axioms:i=938:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=3628:si=on:rtra=on_0");
   quick.push("lrs+21_1:1_au=on:e2e=on:hud=10:sd=4:sos=on:ss=axioms:st=2.0:i=1085:si=on:rtra=on_0");
   quick.push("lrs+1010_3:1_au=on:bd=off:fde=none:lecc=1.5:nwc=10.0:i=7344:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:e2e=on:ins=3:sos=on:ss=axioms:i=596:si=on:rtra=on_0");
   quick.push("lrs+10_3:1_au=on:fsr=off:sd=1:sgt=100:ss=axioms:i=2949:si=on:rtra=on_0");
   quick.push("dis+10_1:1_atotf=0.5:fe=axiom:fsr=off:sd=1:sgt=16:sos=all:ss=axioms:i=1467:si=on:rtra=on_0");
   quick.push("lrs+1010_1:5_bd=off:fde=none:hud=10:ins=3:prag=on:sos=on:ss=axioms:i=457:si=on:rtra=on_0");
   quick.push("dis+10_5:1_cnfonf=off:slsq=on:sp=const_max:i=571:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cnfonf=lazy_not_gen_be_off:kws=precedence:prag=on:s2a=on:sp=frequency:ss=axioms:i=569:si=on:rtra=on_0");
   ...
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=3494:si=on:rtra=on_0");
   quick.push("dis+2_2:3_e2e=on:fsr=off:prag=on:sos=on:ss=axioms:i=2297:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cnfonf=off:sd=1:sgt=16:sp=occurrence:ss=axioms:i=1519:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:bd=off:fde=none:plsq=on:plsqc=2:plsqr=10,1:s2a=on:s2agt=16:i=652:si=on:rtra=on_0");
   ...
   quick.push("ott+10_16:1_aac=none:au=on:cnfonf=off:nm=20:s2a=on:ss=axioms:i=7919:si=on:rtra=on_0");
   ...
   quick.push("dis+10_1:1_cnfonf=lazy_pi_sigma_gen:fde=unused:s2a=on:s2agt=8:i=793:si=on:rtra=on_0");
  // Improves by expected 111.56363838898156 probs costing 59724 Mi
  // Sub-schedule for 120000Mi strat cap / 120000Mi overall limit
   ...
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=1336:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=2003:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=9390:si=on:rtra=on_0");
   quick.push("dis+10_4:1_av=off:cnfonf=off:hud=5:nwc=10.0:s2a=on:s2agt=16:i=2731:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_apa=on:bsr=on:cnfonf=off:hud=10:ins=2:kws=inv_frequency:sd=2:slsq=on:slsqc=5:sos=on:ss=axioms:i=240:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=6340:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_acc=on:au=on:bd=off:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=5063:si=on:rtra=on_0");
   quick.push("dis+1010_1:128_apa=on:cha=on:cnfonf=off:ins=2:prag=on:sims=off:sos=on:i=532:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cnfonf=conj_eager:ins=3:ntd=on:plsq=on:plsqc=1:plsqr=32,1:sd=1:sgt=32:ss=axioms:i=1737:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_au=on:bd=off:e2e=on:sos=on:ss=axioms:i=2642:si=on:rtra=on_0");
   quick.push("lrs+2_1:6_au=on:cnfonf=off:ss=axioms:st=1.5:i=1438:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_er=known:fde=none:fe=axiom:flr=on:hud=10:ntd=on:nwc=10.0:sos=all:i=870:si=on:rtra=on_0");
   quick.push("lrs+10_2:1_fde=none:prag=on:sd=2:sgt=8:ss=axioms:tgt=ground:i=2915:si=on:rtra=on_0");
   quick.push("dis+10_1:128_av=off:fde=unused:hud=1:prag=on:sos=all:ss=axioms:i=3425:si=on:rtra=on_0");
   quick.push("lrs+31_1:1_au=on:cnfonf=off:ins=3:plsq=on:sd=1:sgt=32:sos=on:ss=axioms:i=2690:si=on:rtra=on_0");
   quick.push("dis+1010_3:1_bd=off:e2e=on:s2a=on:s2agt=10:sp=unary_first:i=835:si=on:rtra=on_0");
   quick.push("lrs+10_1:128_bd=off:chr=on:erd=off:fd=off:fe=axiom:hud=10:sac=on:sos=on:i=538:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_c=on:fsr=off:hud=0:kws=inv_arity:ntd=on:sos=on:sp=occurrence:i=985:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:nm=0:sac=on:sd=1:sp=unary_frequency:ss=axioms:st=3.0:i=4966:si=on:rtra=on_0");
   quick.push("ott+10_1:1_s2a=on:s2at=2.0:sd=2:ss=axioms:i=6852:si=on:rtra=on_0");
   quick.push("dis+10_16:1_au=on:bet=on:cbe=off:cnfonf=off:hfsq=on:ins=3:ntd=on:plsq=on:plsqc=1:plsqr=32,1:i=1845:si=on:rtra=on_0");
   quick.push("dis+1002_1:2_au=on:bs=on:bsr=unit_only:c=on:fsr=off:hud=10:kws=inv_precedence:nm=6:ntd=on:nwc=10.0:sac=on:sos=on:i=2589:si=on:rtra=on_0");
   quick.push("dis+10_1:8_au=on:cnfonf=lazy_not_gen_be_off:fde=unused:slsq=on:slsqc=1:sp=unary_frequency:tgt=ground:i=1516:si=on:rtra=on_0");
   quick.push("ott+1002_2:1_au=on:ins=1:nm=2:sac=on:sos=all:i=1084:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_acc=model:au=on:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=704:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_atotf=0.2:au=on:bd=off:cnfonf=off:e2e=on:sos=all:i=3323:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fde=none:ss=axioms:i=1579:si=on:rtra=on_0");
   quick.push("lrs+1010_16:1_acc=on:anc=all_dependent:fde=unused:hfsq=on:hfsql=off:hfsqr=4,1:hud=1:ins=2:piset=all_but_not_eq:prag=on:sac=on:i=1630:si=on:rtra=on_0");
   quick.push("lrs+10_5:1_cnfonf=lazy_not_gen_be_off:hud=5:sd=1:ss=axioms:i=1486:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_er=filter:fd=off:flr=on:nwc=10.0:ss=axioms:st=3.0:i=365:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_au=on:cnfonf=off:sd=1:sgt=16:sp=occurrence:ss=axioms:i=577:si=on:rtra=on_0");
   quick.push("ott+2_1:128_bd=off:ins=3:kws=precedence:sd=1:sos=on:sp=frequency:ss=axioms:st=5.0:i=280:si=on:rtra=on_0");
   quick.push("dis+10_1:2_au=on:cnfonf=lazy_pi_sigma_gen:ss=axioms:st=1.2:tgt=ground:i=1348:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_bs=on:e2e=on:prag=on:sos=on:ss=axioms:i=4990:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:bd=off:kws=precedence:sos=on:sp=frequency:ss=axioms:st=3.0:i=728:si=on:rtra=on_0");
   quick.push("dis+21_1:1_au=on:c=on:cnfonf=off:e2e=on:ins=1:kws=precedence:ntd=on:sd=2:sos=on:ss=axioms:st=2.0:i=4318:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_amm=off:cnfonf=off:fd=off:fe=axiom:fs=off:fsr=off:hud=24:plsq=on:plsqr=5,3:prag=on:sos=on:tnu=5:i=840:si=on:rtra=on_0");
   quick.push("lrs+1010_1:2_cnfonf=lazy_pi_sigma_gen:fde=unused:fe=axiom:ss=axioms:tgt=ground:i=1540:si=on:rtra=on_0");
   quick.push("dis+1010_2:1_atotf=0.2:au=on:cnfonf=off:gs=on:nm=0:sd=2:ss=axioms:i=8032:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_sd=2:slsq=on:slsqc=1:ss=axioms:i=751:si=on:rtra=on_0");
   quick.push("ott+10_1:1_atotf=0.1:au=on:cnfonf=off:e2e=on:fsr=off:ins=4:kws=precedence:s2a=on:i=2566:si=on:rtra=on_0");
   quick.push("lrs+10_97:429_c=on:cnfonf=lazy_gen:fe=axiom:ntd=on:s2a=on:sp=const_frequency:tgt=ground:i=1260:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cbe=off:cnfonf=lazy_not_gen:nwc=13.0:prag=on:s2a=on:sp=weighted_frequency:i=2614:si=on:rtra=on_0");
   quick.push("dis+21_1:1_bd=off:e2e=on:s2a=on:s2agt=32:sfv=off:ss=axioms:st=2.0:i=2063:si=on:rtra=on_0");
  // Improves by expected 98.99426126583916 probs costing 119930 Mi
  // Sub-schedule for 240000Mi strat cap / 240000Mi overall limit
   ...
   quick.push("dis+10_1:1_acc=on:fde=none:kws=inv_precedence:nwc=5.0:plsq=on:plsqc=1:plsqr=6,1:prag=on:s2a=on:i=14386:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:av=off:fd=off:fde=unused:ntd=on:sos=on:sp=frequency:ss=axioms:i=2115:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:c=on:ins=3:plsq=on:plsqc=5:sd=1:sos=on:ss=axioms:i=567:si=on:rtra=on_0");
   quick.push("dis+1010_8:1_cnfonf=lazy_gen:fe=off:fsr=off:hud=15:nwc=10.0:s2a=on:i=4309:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=1016:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=4147:si=on:rtra=on_0");
   quick.push("lrs+2_3:1_amm=off:bet=on:e2e=on:ins=3:kws=precedence:sos=on:sp=frequency:i=6130:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:avsq=on:avsqr=16,1:fd=off:nm=2:sos=all:i=5800:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_aac=none:au=on:fde=unused:nm=2:sac=on:sos=all:i=29708:si=on:rtra=on_0");
   quick.push("dis+1010_1:28_chr=on:cnfonf=lazy_not_be_gen:fde=none:hud=5:ins=2:kws=precedence:prag=on:sos=on:sp=occurrence:spb=goal_then_units:ss=axioms:i=1027:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=475:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=394:si=on:rtra=on_0");
   quick.push("dis+10_1:1_hud=15:kws=precedence:nm=30:sos=on:sp=unary_frequency:ss=axioms:i=2111:si=on:rtra=on_0");
   quick.push("lrs+21_16:1_au=on:bd=preordered:fde=none:ins=2:nwc=10.0:ss=axioms:st=2.0:i=13055:si=on:rtra=on_0");
   quick.push("dis+10_1:1_atotf=0.5:fe=axiom:fsr=off:sd=1:sgt=16:sos=all:ss=axioms:i=598:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fd=off:fe=off:prag=on:sos=on:i=6231:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_acc=model:ccuc=small_ones:cnfonf=lazy_simp:hfsq=on:nm=16:nwc=10.0:s2a=on:sac=on:sp=const_frequency:i=13554:si=on:rtra=on_0");
   quick.push("lrs+10_2:1_fde=none:prag=on:sd=2:sgt=8:ss=axioms:tgt=ground:i=11785:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_au=on:cnfonf=lazy_pi_sigma_gen:fde=none:nwc=10.0:s2a=on:sac=on:i=9387:si=on:rtra=on_0");
   quick.push("lrs+1010_4:1_acc=on:au=on:bd=off:sfv=off:ss=axioms:i=10634:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:128_bd=off:chr=on:erd=off:fd=off:fe=axiom:hud=10:sac=on:sos=on:i=538:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:fde=none:s2a=on:s2agt=8:i=2717:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_fe=off:sd=2:sgt=16:ss=axioms:i=3303:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_av=off:bd=off:kws=precedence:sos=on:sp=frequency:ss=axioms:st=3.0:i=728:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:hfsq=on:sd=2:sgt=8:ss=axioms:i=3039:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:cnfonf=lazy_pi_sigma_gen:sd=1:slsq=on:ss=axioms:i=568:si=on:rtra=on_0");
   quick.push("dis+1010_1:6_fd=off:hfsq=on:hud=10:nm=2:rawr=on:sos=all:i=3055:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_cnfonf=lazy_pi_sigma_gen:fe=axiom:hud=5:prag=on:slsq=on:slsqr=4,1:i=6248:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=unused:nwc=5.0:sac=on:sos=all:sp=const_frequency:i=26064:si=on:rtra=on_0");
   quick.push("dis+1010_3:1_au=on:bd=off:cnfonf=lazy_gen:fde=none:sd=1:ss=axioms:i=2759:si=on:rtra=on_0");
  ...
  // Improves by expected 81.55935557921087 probs costing 239942 Mi
  // Sub-schedule for 480000Mi strat cap / 480000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=19468:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:fde=none:kws=inv_precedence:nwc=5.0:plsq=on:plsqc=1:plsqr=6,1:prag=on:s2a=on:i=892:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:av=off:fd=off:fde=unused:ntd=on:sos=on:sp=frequency:ss=axioms:i=1901:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=1016:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:bsd=on:c=on:fde=none:piset=equals:sac=on:sp=const_min:i=5909:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:avsq=on:avsqr=16,1:fd=off:nm=2:sos=all:i=5800:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_cnfonf=lazy_pi_sigma_gen:plsq=on:sos=on:i=9176:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_au=on:cnfonf=off:e2e=on:i=24393:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=15896:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_fsd=on:hud=10:ntd=on:sp=reverse_arity:ss=axioms:i=12055:si=on:rtra=on_0");
   quick.push("lrs+1002_2:3_fde=none:hfsq=on:nwc=3.0:prag=on:sac=on:sd=2:sgt=32:sos=on:sp=unary_frequency:ss=axioms:i=14840:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=11835:si=on:rtra=on_0");
   quick.push("ott+1010_1:64_au=on:cbe=off:cnfonf=off:nwc=10.0:s2a=on:ss=axioms:i=5064:si=on:rtra=on_0");
   ...
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=12797:si=on:rtra=on_0");
   quick.push("dis+1010_1:5_au=on:hfsq=on:hfsql=off:ins=3:nm=0:nwc=10.0:prag=on:sos=all:sp=const_frequency:i=6555:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_4:1_au=on:cnfonf=lazy_pi_sigma_gen:nwc=10.0:i=5692:si=on:rtra=on_0");
   quick.push("lrs+10_3:1_au=on:fsr=off:sd=1:sgt=100:ss=axioms:i=11200:si=on:rtra=on_0");
   quick.push("dis+10_1:1_atotf=0.5:fe=axiom:fsr=off:sd=1:sgt=16:sos=all:ss=axioms:i=491:si=on:rtra=on_0");
   quick.push("lrs+1010_1:5_bd=off:fde=none:hud=10:ins=3:prag=on:sos=on:ss=axioms:i=1854:si=on:rtra=on_0");
   ...
   quick.push("lrs+10_1:1_er=known:fde=none:fe=axiom:flr=on:hud=10:ntd=on:nwc=10.0:sos=all:i=9456:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_au=on:cnfonf=lazy_pi_sigma_gen:fde=none:nwc=10.0:s2a=on:sac=on:i=91028:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:fde=none:nm=10:sos=on:i=6719:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:av=off:br=off:e2e=on:fsr=off:sos=all:i=15597:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cnfonf=lazy_not_be_gen:fs=off:fsr=off:nwc=10.0:ss=axioms:st=3.0:i=945:si=on:rtra=on_0");
   quick.push("lrs+10_2:3_amm=off:au=on:bd=off:fde=unused:fe=off:fsr=off:nm=16:ntd=on:s2a=on:s2at=2.0:ss=axioms:st=3.0:i=5915:si=on:rtra=on_0");
   ...
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=2482:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=3782:si=on:rtra=on_0");
   quick.push("lrs+1010_16:1_acc=on:anc=all_dependent:fde=unused:hfsq=on:hfsql=off:hfsqr=4,1:hud=1:ins=2:piset=all_but_not_eq:prag=on:sac=on:i=58679:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:cbe=off:nm=10:sd=1:sos=all:ss=axioms:st=3.0:i=3280:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_av=off:bd=off:kws=precedence:sos=on:sp=frequency:ss=axioms:st=3.0:i=728:si=on:rtra=on_0");
   quick.push("dis+1002_1:5_au=on:bsr=on:fde=unused:piset=not:sos=on:i=4675:si=on:rtra=on_0");
   quick.push("dis+10_1:1_hud=5:nm=16:prag=on:sac=on:sos=on:ss=axioms:tnu=2:i=1141:si=on:rtra=on_0");
   quick.push("lrs+1010_1:3_alpa=true:au=on:cnfonf=lazy_pi_sigma_gen:sos=on:i=1536:si=on:rtra=on_0");
   quick.push("dis+2_1:1_bd=off:prag=on:sos=all:sp=frequency:ss=axioms:uhcvi=on:i=8613:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_amm=off:cnfonf=off:fd=off:fe=axiom:fs=off:fsr=off:hud=24:plsq=on:plsqr=5,3:prag=on:sos=on:tnu=5:i=7241:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bet=on:fde=none:nm=20:sos=on:i=16001:si=on:rtra=on_0");
   quick.push("dis+1010_73:128_bd=preordered:fsr=off:nwc=3.0:s2a=on:s2at=2.0:i=6455:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_cnfonf=off:fde=none:fe=off:piset=pi_sigma:sos=on:sp=frequency:tnu=9:i=1349:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=4730:si=on:rtra=on_0");
  ...
  // Improves by expected 60.874992003081196 probs costing 478741 Mi
  // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
   ...
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=39263:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=8200:si=on:rtra=on_0");
   quick.push("lrs+2_3:1_amm=off:bet=on:e2e=on:ins=3:kws=precedence:sos=on:sp=frequency:i=14065:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:avsq=on:avsqr=16,1:fd=off:nm=2:sos=all:i=4192:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_aac=none:au=on:fde=unused:nm=2:sac=on:sos=all:i=39599:si=on:rtra=on_0");
   quick.push("dis-1010_1:1_au=on:e2e=on:hfsq=on:nm=0:s2a=on:s2at=1.5:i=9593:si=on:rtra=on_0");
   ...
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=11835:si=on:rtra=on_0");
   quick.push("ott+1010_1:64_au=on:cbe=off:cnfonf=off:nwc=10.0:s2a=on:ss=axioms:i=5064:si=on:rtra=on_0");
   quick.push("dis+1002_2:3_aac=none:au=on:cbe=off:fde=none:hfsq=on:hfsqc=2:hfsqr=8,1:lcm=predicate:nm=32:prag=on:sos=on:sp=unary_first:ss=axioms:st=2.0:i=23249:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_au=on:hud=15:kws=precedence:lcm=reverse:sos=on:sp=frequency:i=6301:si=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:bsr=on:cnfonf=lazy_gen:ntd=on:nwc=10.0:sims=off:sp=const_frequency:i=3527:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=58916:si=on:rtra=on_0");
   ...
   quick.push("lrs+1002_1:1_e2e=on:fd=off:fe=off:prag=on:sos=on:i=6935:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:e2e=on:hud=10:nm=32:plsq=on:plsqc=1:plsqr=32,1:sac=on:sos=on:i=4309:si=on:rtra=on_0");
   quick.push("dis+10_16:1_au=on:cnfonf=conj_eager:hfsq=on:hfsqc=2:piset=equals:s2a=on:sp=occurrence:ss=axioms:i=26143:si=on:rtra=on_0");
   quick.push("lrs+1010_8:1_acc=model:ccuc=small_ones:cnfonf=lazy_simp:hfsq=on:nm=16:nwc=10.0:s2a=on:sac=on:sp=const_frequency:i=24924:si=on:rtra=on_0");
   quick.push("lrs+1010_1:6_bd=off:cnfonf=off:hfsq=on:hfsql=off:ins=2:kws=precedence:ntd=on:sp=const_frequency:spb=units:tgt=full:i=4317:si=on:rtra=on_0");
   quick.push("ott+2_1:1_au=on:cnfonf=off:sos=all:ss=axioms:st=3.0:i=14945:si=on:rtra=on_0");
   quick.push("lrs+2_1:3_au=on:bd=off:e2e=on:sos=on:ss=axioms:i=2642:si=on:rtra=on_0");
   ...
   quick.push("lrs+31_1:1_au=on:cnfonf=off:ins=3:plsq=on:sd=1:sgt=32:sos=on:ss=axioms:i=2676:si=on:rtra=on_0");
   ...
   quick.push("lrs+32_1:2_au=on:cbe=off:lecc=0.75:s2a=on:s2at=6.0:tgt=ground:i=12307:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:fde=none:nm=10:sos=on:i=7053:si=on:rtra=on_0");
   quick.push("lrs+21_8:1_cnfonf=lazy_not_gen:nm=2:nwc=10.0:plsq=on:plsqc=2:plsqr=6,1:prag=on:sgt=8:sp=unary_frequency:ss=axioms:i=9199:si=on:rtra=on_0");
   quick.push("ott+1002_14:1_c=on:cnfonf=lazy_gen:er=tagged:fe=axiom:s2a=on:ss=included:i=14123:si=on:rtra=on_0");
   quick.push("lrs+1010_3:1_bsr=unit_only:cnfonf=lazy_not_be_gen:nwc=10.0:sp=reverse_arity:i=21593:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_cnfonf=lazy_not_be_gen:fs=off:fsr=off:nwc=10.0:ss=axioms:st=3.0:i=945:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_e2e=on:sd=1:ss=axioms:st=3.0:i=4610:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=1458:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_acc=model:au=on:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=32232:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=8732:si=on:rtra=on_0");
   ...
   quick.push("lrs+20_1:1_au=on:bd=off:erd=off:fde=none:sos=on:i=2606:si=on:rtra=on_0");
   ...
   quick.push("dis+1002_1:5_au=on:bsr=on:fde=unused:piset=not:sos=on:i=4675:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fde=unused:fe=off:fs=off:fsr=off:hud=10:sos=on:i=8822:si=on:rtra=on_0");
   quick.push("dis+1010_1:16_amm=sco:cnfonf=off:sd=1:ss=axioms:st=2.0:tgt=full:tnu=5:i=34824:si=on:rtra=on_0");
   quick.push("dis+21_1:1_au=on:c=on:cnfonf=off:e2e=on:ins=1:kws=precedence:ntd=on:sd=2:sos=on:ss=axioms:st=2.0:i=24460:si=on:rtra=on_0");
   quick.push("dis+2_1:1_bd=off:prag=on:sos=all:sp=frequency:ss=axioms:uhcvi=on:i=8613:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_cnfonf=lazy_pi_sigma_gen:fe=axiom:hud=5:prag=on:slsq=on:slsqr=4,1:i=23141:si=on:rtra=on_0");
   ...
   quick.push("dis+1010_73:128_bd=preordered:fsr=off:nwc=3.0:s2a=on:s2at=2.0:i=7322:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=4730:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=unused:nwc=5.0:sac=on:sos=all:sp=const_frequency:i=45918:si=on:rtra=on_0");
   quick.push("dis+1010_3:1_au=on:bd=off:cnfonf=lazy_gen:fde=none:sd=1:ss=axioms:i=2205:si=on:rtra=on_0");
   quick.push("dis+1010_2:1_atotf=0.2:au=on:cnfonf=off:gs=on:nm=0:sd=2:ss=axioms:i=21286:si=on:rtra=on_0");
   quick.push("lrs+1_1:50_bsd=on:hfsq=on:hud=5:piset=or:sac=on:sos=all:sp=reverse_arity:i=3563:si=on:rtra=on_0");
   quick.push("lrs+2_3:2_au=on:cbe=off:hud=15:ins=3:kws=precedence:sp=reverse_arity:uhcvi=on:i=12385:si=on:rtra=on_0");
  // Improves by expected 48.801505968449085 probs costing 958791 Mi
  // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=6230:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:bsd=on:c=on:fde=none:piset=equals:sac=on:sp=const_min:i=76578:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=30267:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=9786:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:avsq=on:avsqr=16,1:fd=off:nm=2:sos=all:i=5800:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_bd=off:fe=off:ins=3:prag=on:sos=on:i=4525:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=lazy_simp:fde=unused:fsr=off:hud=10:nwc=10.0:s2a=on:s2at=4.0:sac=on:i=49493:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_fsd=on:hud=10:ntd=on:sp=reverse_arity:ss=axioms:i=12055:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=45686:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_au=on:hud=15:kws=precedence:lcm=reverse:sos=on:sp=frequency:i=6301:si=on:rtra=on_0");
   quick.push("ott+10_1:1_bd=preordered:bsr=on:cnfonf=lazy_gen:ntd=on:nwc=10.0:sims=off:sp=const_frequency:i=3527:si=on:rtra=on_0");
   quick.push("dis+21_3:1_au=on:hfsq=on:s2a=on:sp=unary_frequency:i=5018:si=on:rtra=on_0");
   quick.push("dis+1010_1:5_au=on:hfsq=on:hfsql=off:ins=3:nm=0:nwc=10.0:prag=on:sos=all:sp=const_frequency:i=15427:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_c=on:cnfonf=off:fd=off:fe=axiom:prag=on:sos=on:i=1993:si=on:rtra=on_0");
   quick.push("lrs+10_4:1_au=on:cnfonf=lazy_pi_sigma_gen:nwc=10.0:i=10083:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_au=on:bd=off:cnfonf=off:fd=off:sos=all:i=9162:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_e2e=on:fd=off:fe=off:prag=on:sos=on:i=6935:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:e2e=on:hud=10:nm=32:plsq=on:plsqc=1:plsqr=32,1:sac=on:sos=on:i=4309:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_atotf=0.0319537:au=on:sos=on:sp=unary_frequency:i=5748:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=6900:si=on:rtra=on_0");
   quick.push("lrs+10_1:4_atotf=0.4:au=on:cnfonf=off:sos=all:i=6020:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_bd=off:cnfonf=lazy_simp:fde=none:sp=occurrence:i=9076:si=on:rtra=on_0");
   quick.push("lrs+32_1:2_au=on:cbe=off:lecc=0.75:s2a=on:s2at=6.0:tgt=ground:i=11844:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_au=on:fde=none:nm=10:sos=on:i=5045:si=on:rtra=on_0");
   quick.push("lrs+21_8:1_cnfonf=lazy_not_gen:nm=2:nwc=10.0:plsq=on:plsqc=2:plsqr=6,1:prag=on:sgt=8:sp=unary_frequency:ss=axioms:i=9199:si=on:rtra=on_0");
   quick.push("ott+1002_14:1_c=on:cnfonf=lazy_gen:er=tagged:fe=axiom:s2a=on:ss=included:i=14123:si=on:rtra=on_0");
   quick.push("lrs+10_2:3_amm=off:au=on:bd=off:fde=unused:fe=off:fsr=off:nm=16:ntd=on:s2a=on:s2at=2.0:ss=axioms:st=3.0:i=4188:si=on:rtra=on_0");
   quick.push("lrs+21_7:1_bd=preordered:c=on:cnfonf=lazy_gen:fde=unused:fe=axiom:hud=10:piset=not:s2at=3.0:slsq=on:slsqr=9,7:ss=axioms:i=98178:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=1458:si=on:rtra=on_0");
   quick.push("dis+10_1:1_acc=on:e2e=on:hfsq=on:hfsqc=1:ixr=off:s2a=on:sd=2:sp=occurrence:ss=axioms:i=7597:si=on:rtra=on_0");
   quick.push("dis+10_3:1_acc=on:bs=unit_only:cnfonf=off:fe=axiom:hfsq=on:hfsqr=1,8:ins=3:plsq=on:plsqc=1:plsqr=32,1:prag=on:i=20702:si=on:rtra=on_0");
   quick.push("lrs+1010_16:1_acc=on:anc=all_dependent:fde=unused:hfsq=on:hfsql=off:hfsqr=4,1:hud=1:ins=2:piset=all_but_not_eq:prag=on:sac=on:i=92639:si=on:rtra=on_0");
   quick.push("lrs+20_1:1_au=on:bd=off:erd=off:fde=none:sos=on:i=111726:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fe=off:nwc=10.0:s2a=on:s2agt=8:sd=1:ss=axioms:st=5.0:i=8973:si=on:rtra=on_0");
   quick.push("ott+1002_1:1_fe=off:fsr=off:nm=32:sos=on:sp=unary_first:ss=axioms:i=34160:si=on:rtra=on_0");
   quick.push("lrs+1002_1:1_au=on:bd=off:bet=on:fde=none:nm=20:sos=on:i=73841:si=on:rtra=on_0");
   quick.push("ott+2_1:1_abs=on:e2e=on:fsd=on:fsr=off:kws=inv_precedence:piset=not:prag=on:s2a=on:s2pl=no:sos=on:i=4730:si=on:rtra=on_0");
   quick.push("lrs+10_16:1_au=on:bd=off:sac=on:sos=all:i=42569:si=on:rtra=on_0");
   quick.push("ott+10_16:1_aac=none:au=on:cnfonf=off:nm=20:s2a=on:ss=axioms:i=84520:si=on:rtra=on_0");
  // Improves by expected 23.161634813375024 probs costing 956372 Mi
  // Sub-schedule for 960000Mi strat cap / 960000Mi overall limit
   quick.push("dis+10_4:1_e2e=on:fde=none:hfsq=on:s2a=on:s2at=3.0:slsq=on:slsqc=1:i=19468:si=on:rtra=on_0");
   quick.push("dis+1002_1:1_fe=off:hud=10:sos=on:ss=axioms:i=6230:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_c=on:cnfonf=lazy_gen:fe=off:ins=2:nwc=5.0:s2a=on:sp=occurrence:i=57495:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_bsr=on:e2e=on:fde=unused:nm=7:sac=on:sos=on:sp=frequency:tnu=9:i=9786:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_fsd=on:hud=10:ntd=on:sp=reverse_arity:ss=axioms:i=12055:si=on:rtra=on_0");
   quick.push("lrs+10_2:3_au=on:bd=off:chr=on:lcm=reverse:ntd=on:sd=1:sgt=100:ss=axioms:i=11408:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_au=on:cnfonf=off:e2e=on:piset=small_set:sac=on:sd=1:sos=all:ss=axioms:st=5.0:i=45686:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_av=off:fe=axiom:hud=15:lwlo=on:prag=on:i=75417:si=on:rtra=on_0");
   quick.push("ott+1010_1:1_au=on:hud=15:kws=precedence:lcm=reverse:sos=on:sp=frequency:i=6301:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_e2e=on:ntd=on:nwc=5.0:sac=on:sd=1:sgt=16:spb=units:ss=axioms:i=62151:si=on:rtra=on_0");
   quick.push("dis+21_3:1_au=on:hfsq=on:s2a=on:sp=unary_frequency:i=5018:si=on:rtra=on_0");
   quick.push("dis+1010_1:5_au=on:hfsq=on:hfsql=off:ins=3:nm=0:nwc=10.0:prag=on:sos=all:sp=const_frequency:i=15424:si=on:rtra=on_0");
   quick.push("lrs+1004_1:32_c=on:cnfonf=off:fd=off:fe=axiom:prag=on:sos=on:i=1993:si=on:rtra=on_0");
   quick.push("lrs+10_4:1_au=on:cnfonf=lazy_pi_sigma_gen:nwc=10.0:i=14412:si=on:rtra=on_0");
   quick.push("lrs+2_1:1_acc=on:au=on:bd=off:bsr=unit_only:cnfonf=off:fsr=off:nm=2:sos=all:i=40194:si=on:rtra=on_0");
   quick.push("lrs-1666_4:1_bd=off:cnfonf=lazy_not_gen_be_off:fde=unused:hud=25:ixr=off:nm=0:sac=on:spb=goal:ss=axioms:st=1.5:i=25547:si=on:rtra=on_0");
   quick.push("lrs+1010_1:4_au=on:e2e=on:hud=10:nm=32:plsq=on:plsqc=1:plsqr=32,1:sac=on:sos=on:i=4309:si=on:rtra=on_0");
   quick.push("dis+10_16:1_au=on:cnfonf=conj_eager:hfsq=on:hfsqc=2:piset=equals:s2a=on:sp=occurrence:ss=axioms:i=26143:si=on:rtra=on_0");
   quick.push("lrs+0_1:1_au=on:ins=3:kws=precedence:ntd=on:sos=on:sp=const_max:ss=axioms:i=41937:si=on:rtra=on_0");
   quick.push("lrs+10_1:4_atotf=0.4:au=on:cnfonf=off:sos=all:i=6020:si=on:rtra=on_0");
   quick.push("lrs+10_1:1_c=on:cnfonf=off:hud=10:nm=10:ntd=on:s2a=on:sac=on:sgt=30:ss=included:i=27150:si=on:rtra=on_0");
   quick.push("lrs+1010_4:1_acc=on:au=on:bd=off:sfv=off:ss=axioms:i=42765:si=on:rtra=on_0");
   quick.push("lrs+32_1:2_au=on:cbe=off:lecc=0.75:s2a=on:s2at=6.0:tgt=ground:i=11844:si=on:rtra=on_0");
   quick.push("lrs+21_8:1_cnfonf=lazy_not_gen:nm=2:nwc=10.0:plsq=on:plsqc=2:plsqr=6,1:prag=on:sgt=8:sp=unary_frequency:ss=axioms:i=22969:si=on:rtra=on_0");
   quick.push("ott+1002_14:1_c=on:cnfonf=lazy_gen:er=tagged:fe=axiom:s2a=on:ss=included:i=94992:si=on:rtra=on_0");
   quick.push("lrs+1010_3:1_bsr=unit_only:cnfonf=lazy_not_be_gen:nwc=10.0:sp=reverse_arity:i=21593:si=on:rtra=on_0");
   quick.push("lrs+1010_1:1_au=on:cnfonf=lazy_pi_sigma_gen:hud=16:nm=10:slsq=on:slsqr=1,16:sp=const_max:i=20710:si=on:rtra=on_0");
   quick.push("lrs+1666_1:1_bd=off:bet=on:bsd=on:bsr=unit_only:fde=none:nwc=10.0:sp=occurrence:i=2482:si=on:rtra=on_0");
   quick.push("dis+1002_1:4_cnfonf=off:e2e=on:fde=unused:fsr=off:sac=on:sfv=off:tgt=full:i=27018:si=on:rtra=on_0");
   quick.push("dis+2_5:1_au=on:e2e=on:fsr=off:sos=on:sp=unary_first:ss=axioms:i=9441:si=on:rtra=on_0");
   quick.push("dis+10_1:1_cnfonf=off:fe=off:nwc=10.0:s2a=on:s2agt=8:sd=1:ss=axioms:st=5.0:i=8973:si=on:rtra=on_0");
   quick.push("dis+1010_1:16_amm=sco:cnfonf=off:sd=1:ss=axioms:st=2.0:tgt=full:tnu=5:i=18184:si=on:rtra=on_0");
   quick.push("ott+1010_16:1_cnfonf=lazy_pi_sigma_gen:fe=axiom:hud=5:prag=on:slsq=on:slsqr=4,1:i=19281:si=on:rtra=on_0");
   quick.push("ott+2_4:1_au=on:cnfonf=lazy_pi_sigma_gen:hud=16:ins=3:nm=20:plsq=on:plsqc=1:plsqr=13,2:rawr=on:sp=reverse_arity:ss=axioms:st=3.0:i=24800:si=on:rtra=on_0");
   quick.push("dis+10_1:1_au=on:e2e=on:fde=unused:nwc=5.0:sac=on:sos=all:sp=const_frequency:i=75375:si=on:rtra=on_0");
   quick.push("dis+1010_1:1_au=on:av=off:e2e=on:fd=off:rawr=on:s2a=on:s2at=3.0:sos=on:sp=occurrence:i=12092:si=on:rtra=on_0");
   quick.push("lrs+2_3:2_au=on:cbe=off:hud=15:ins=3:kws=precedence:sp=reverse_arity:uhcvi=on:i=13505:si=on:rtra=on_0");
  // Improves by expected 10.668307256252 probs costing 940131 Mi
