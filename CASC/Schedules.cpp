...
void Schedules::getCasc2025Schedule(const Property& property, Schedule& quick, Schedule& champions)
{
  ...
  if (property.higherOrder()) {
    ...
    quick.push("ott+21_3:13_chr=on:cnfonf=off:fdi=32:fe=abstraction:hsq=on:hsql=off:lma=off:lsd=10:mep=off:ntd=on:sas=cadical:sd=1:sgt=20:sil=128000:sp=arity:ss=axioms:st=2.0:uwa=one_side_interpreted:i=483:si=on:rtra=on_0");
