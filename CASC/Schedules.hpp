...
public:
  ...
  static void getSmtcomp2018thsqSchedule(const Shell::Property& property, Schedule& quick, Schedule& fallback);
  static void getSmtcomp2018atotfSchedule(const Shell::Property& property, Schedule& quick, Schedule& fallback);
