...
public:
  ...
  bool fulfilsAgeLimit(unsigned age, unsigned w, Inference* inference) const override { return true; }
  bool fulfilsWeightLimit(Clause* cl) const override { return true; }
  // note: w here denotes the weight as returned by weight().
  // this method internally takes care of computing the corresponding weightForClauseSelection.
  bool fulfilsWeightLimit(unsigned w, unsigned age, Inference* inference) const override { return true; }
