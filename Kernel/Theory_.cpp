...
{
  return IntegerConstantType(::abs(_val));
...
{ 
  // mpz_class res;
  mpz_class res;
  mpz_fdiv_q(res.get_mpz_t(), this->_val.get_mpz_t(), num._val.get_mpz_t());
  return IntegerConstantType(std::move(res));
  // if(num.divides(*this)){
...
{ 
  mpz_class res;
  mpz_tdiv_q(res.get_mpz_t(), this->_val.get_mpz_t(), num._val.get_mpz_t());
  return IntegerConstantType(std::move(res));
  // if(num.divides(*this)){
  //   return IntegerConstantType(intDivide(num));
  // }
