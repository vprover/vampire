...
{
  if (higherOrder) {
    return getRewritableSubtermIterator<FirstOrderSubtermIterator</*insideLambdasToo=*/false>>(lit, ord);
  }
...
{
  return getRewritableSubtermIterator<BooleanSubtermIterator>(lit, ord);
}
