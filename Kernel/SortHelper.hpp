...
public:
  ...
  static Option<TermList> tryGetVariableSort(TermList var, Term* t);
  static TermList getVariableSort(TermList var, Term* t) { return tryGetVariableSort(var, t).unwrap(); }
  ...
  static bool areVariableSortsValidPoly(Clause* cl);
