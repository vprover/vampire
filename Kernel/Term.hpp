...
public:
  ...
  vstring toString(bool left = true) const;
...
public:
  ...
  static Term* createFreshConstant(const vstring& suffix, bool dummyArg = false);
  ...
  vstring toString(bool withoutApps = true, bool left = true) const;
