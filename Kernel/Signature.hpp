...
class Signature
{
 public:
  ...
  unsigned addFreshFunction(OperatorType* op, const char* prefix, const char* suffix = 0);
  ...
  unsigned addFreshPredicate(OperatorType* op, const char* prefix, const char* suffix = 0);
