...
public:
  ...
  unsigned getNumSSIs(){
      return _structuredSortInterpretations.size();
  }
  
  typedef std::pair<AKey,unsigned> Item;
  VirtualIterator<Item> getSSIItems(){
      return _structuredSortInterpretations.items();
  }
