 ...
 */
void InferenceStore::recordIntroducedSymbol(Unit* u, SymbolType sym, unsigned number)
{
  CALL("InferenceStore::recordIntroducedSymbol");

  SymbolStack* pStack;
  _introducedSymbols.getValuePtr(u->number(),pStack);
  pStack->push(SymbolId(sym,number));
}
