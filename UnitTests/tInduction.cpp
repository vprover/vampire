...
LiteralIndex* comparisonIndex() {
  return new UnitIntegerComparisonLiteralIndex(new LiteralSubstitutionTree(/* uwa */ nullptr, /* polymorphic */ true));
}

TermIndex* intInductionIndex() {
  return new InductionTermIndex(new TermSubstitutionTree(/* uwa */ nullptr, /* polymorphic */ true, /* extra */ false));
}

TermIndex* structInductionIndex() {
  return new StructInductionTermIndex(new TermSubstitutionTree(/* uwa */ nullptr, /* polymorphic */ true, /* extra */ false));
}
