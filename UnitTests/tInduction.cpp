...
LiteralIndex* comparisonIndex() {
  return new UnitIntegerComparisonLiteralIndex(new LiteralSubstitutionTree(Shell::Options::UnificationWithAbstraction::OFF, /* uwaPostpro */ false));
}

TermIndex* intInductionIndex() {
  return new InductionTermIndex(new TermSubstitutionTree(Shell::Options::UnificationWithAbstraction::OFF, /* uwaPostpro */ false, /* extra */ false));
}

TermIndex* structInductionIndex() {
  return new StructInductionTermIndex(new TermSubstitutionTree(Shell::Options::UnificationWithAbstraction::OFF, /* uwaPostpro */ false, /* extra */ false));
}
