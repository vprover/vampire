...
//
TEST_FUN(kbo_test01) {
  UNSORTED_SUGAR             // <- macro to initialize some syntax sugar for creating terms over a single uninterpreted sort
  UNSORTED_SUGAR_FUN  (f, 1) // <- declares a function symbol with arity 1
  UNSORTED_SUGAR_FUN  (g, 1) // <- declares a function symbol with arity 1
  UNSORTED_SUGAR_CONST(c)    // <- declares a constant symbol
...
TEST_FUN(kbo_test14) {
  UNSORTED_SUGAR
  UNSORTED_SUGAR_CONST(a)
  UNSORTED_SUGAR_FUN (f, 2)
  UNSORTED_SUGAR_FUN (g, 1)
  UNSORTED_SUGAR_FUN (u, 1)
